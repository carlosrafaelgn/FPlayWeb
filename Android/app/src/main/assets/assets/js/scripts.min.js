...
93;for(e=0;4>e&&d[f];)e++,f++;e&&(a.year=parseInt(MetadataExtractor.textDecoderIso88591.decode(d.subarray(93,93+e))))}c&MetadataExtractor.TRACK_B||d[125]||!d[126]||(a.track=d[126]&255)}}catch(g){}})}static extractID3v2Andv1(a,b,c){return __awaiter(this,void 0,void 0,function*(){const d=MetadataExtractor.createBasicMetadata(a);d.url?d.url.startsWith(FileUtils.localURLPrefix)&&(d.file=a):(d.file=a,d.fileSize=a.size,d.fileName=a.name);let e=0;var f=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==
f)if(f|=b.readByte(),1380533830===f){f=yield MetadataExtractor.extractRIFF(d,b,c[0]);if(!f)return null;if(!f[1])return d;d.lengthMS&&(e|=MetadataExtractor.LENGTH_B)}else return yield MetadataExtractor.extractID3v1(d,b,0,c[0]),d;var g=b.readByte(),h=b.readByte();f=b.readByte();const k=b.readByte(),m=b.readByte(),l=b.readByte(),n=b.readByte();f=(f&16?10:0)+(n&127|(l&127)<<7|(m&127)<<14|(k&127)<<21);if(2<(g&255)||h){for(;0<f&&e!==MetadataExtractor.ALL_B;){(g=b.fillBuffer(1024))&&(yield g);h=b.readUInt32BE();
g=b.readUInt32BE();b.skip(2);if(!h||0>=g||g>f)break;switch(h){case 1414091826:e&MetadataExtractor.TITLE_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.title=h&&h.then?yield h:h,d.title&&(e|=MetadataExtractor.TITLE_B));break;case 1414546737:e&MetadataExtractor.ARTIST_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.artist=h&&h.then?yield h:h,d.artist&&(e|=MetadataExtractor.ARTIST_B));break;case 1413565506:e&MetadataExtractor.ALBUM_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.album=
h&&h.then?yield h:h,d.album&&(e|=MetadataExtractor.ALBUM_B));break;case 1414677323:e&MetadataExtractor.TRACK_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.track=h&&h.then?parseInt(yield h):parseInt(h),d.track?e|=MetadataExtractor.TRACK_B:d.track=0);break;case 1414284622:e&MetadataExtractor.LENGTH_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.lengthMS=h&&h.then?parseInt(yield h):parseInt(h),d.lengthMS?e|=MetadataExtractor.LENGTH_B:d.lengthMS=0);break;case 1415136594:case 1413763651:e&
MetadataExtractor.YEAR_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.year=h&&h.then?parseInt(yield h):parseInt(h),d.year?e|=MetadataExtractor.YEAR_B:d.year=0);break;default:b.skip(g)}f-=10+g}(e&MetadataExtractor.ALL_BUT_LENGTH_B)!==MetadataExtractor.ALL_BUT_LENGTH_B&&(yield MetadataExtractor.extractID3v1(d,b,e,c[0]))}return d})}static createBasicMetadata(a){return{url:FileUtils.urlOrPathToURL(a["data-path"])||"",flags:MetadataFlags.Seekable}}static extract(a,b,c){return __awaiter(this,void 0,
void 0,function*(){if(!a)return null;b||(b=new Uint8Array(BufferedReader.minBufferLength));c||(c=[new Uint8Array(256)]);if(!a.name.endsWith(".mp3")&&!a.name.endsWith(".aac")&&!a.name.endsWith(".wav")){if(a.name.endsWith(".flac"))return FLACMetadataExtractor.extract(a,b,c);if(a.name.endsWith(".ogg"))return OggMetadataExtractor.extract(a,b,c);const d=a.name.toLowerCase();if(!d.endsWith(".mp3")&&!d.endsWith(".aac")&&!d.endsWith(".wav"))return d.endsWith(".flac")?FLACMetadataExtractor.extract(a,b,c):
d.endsWith(".ogg")?OggMetadataExtractor.extract(a,b,c):null}try{const d=new BufferedFileReader(a,b);yield d.fillBuffer(-1);return yield MetadataExtractor.extractID3v2Andv1(a,d,c)}catch(d){return null}})}}MetadataExtractor.ALL_B=63;MetadataExtractor.ALL_BUT_LENGTH_B=31;MetadataExtractor.TITLE_B=1;MetadataExtractor.ARTIST_B=2;MetadataExtractor.ALBUM_B=4;MetadataExtractor.TRACK_B=8;MetadataExtractor.YEAR_B=16;MetadataExtractor.LENGTH_B=32;MetadataExtractor.textDecoderIso88591=new TextDecoder("iso-8859-1");
