...
!0,Promise.resolve();this._resumeAudioContext();this._paused=!1;this.updateInterval();this.onplaying&&queueMicrotask(this.onplaying);return Promise.resolve()}pause(){this._alive&&!this._paused&&(this._suspendAudioContext(),this._paused=!0,this.updateInterval(),this.onpause&&queueMicrotask(this.onpause))}destroy(){this._alive&&(this._playAfterLoading=this._loaded=this._alive=!1,this._paused=!0,this._suspendAudioContext(),this._sourceAudioNode&&(this._sourceAudioNode.disconnect(),LibMikMod.stopModule()),
this._volumeAudioNode.disconnect(),this.updateInterval(),zeroObject(this),this._paused=!0)}}
...
c.onplaying=()=>{this._audio===c&&this.playbackStarted()};d=()=>{this._audio===c&&this.playbackAborted()};c.onabort=d;c.onemptied=d;c.ondurationchange=()=>{this._audio===c&&this.playbackLengthChange()};c.ontimeupdate=()=>{this._audio===c&&this.currentTimeChange()};b.enabled=!0;return e}destroyAudioElement(a,b,c){if(a)if("customProvider"in a)a.destroy();else{if(b){for(;a.firstChild;)a.removeChild(a.firstChild);a.load()}c&&a.parentNode&&a.parentNode.removeChild(a)}}recreateAudioPath(a){const b=this._intermediateNodes;
this._sourceNode&&this._sourceNode.disconnectFromDestination();for(let f=b.length-1;0<=f;f--)b[f].disconnectFromDestination();this.destroyAudioElement(this._audio,!1,!0);const {audio:c,sourceNode:d,boundPlaybackError:e}=this.createAudioBundle(null,a);this._audio=c;this._sourceNode=d;this._boundPlaybackError=e;if(b.length){d.connectToDestination(b[0]);for(a=0;a<b.length-1;a++)b[a].connectToDestination(b[a+1]);b[b.length-1].connectToDestination(this._destinationNode)}else d.connectToDestination(this._destinationNode);
