...
AppUI.panelContainerToggled&&(AppUI.panelContainerToggled=!1,AppUI.panelContainer.classList.remove("toggled"),HistoryHandler.popState()))}static toggleView(a){if(AppUI.panelContainer){AppUI.panelContainerToggleVersion++;const b=AppUI.panelContainerToggleVersion,c=function(d,e,f){AppUI.panelContainerToggling=!0;e.classList.remove("in");e.classList.add("fade");d.classList.add("in");d.classList.add("fade");DelayControl.delayShortCB(async function(){AppUI.panelContainerToggleVersion===b&&(d.classList.remove("in"),
await DelayControl.delayFade(),AppUI.panelContainerToggleVersion===b&&(f?AppUI.panelContainer.classList.add("toggled"):AppUI.panelContainer.classList.remove("toggled"),d.classList.remove("fade"),await DelayControl.delayShort(),AppUI.panelContainerToggleVersion===b&&(e.classList.add("in"),await DelayControl.delayFade(),AppUI.panelContainerToggleVersion===b&&(e.classList.remove("fade"),e.classList.remove("in"),AppUI.panelContainerToggling=!1))))})};AppUI.panelContainerToggled?(AppUI.panelContainerToggled=
!1,c(AppUI.optionalPanel,AppUI.fixedPanel,!1),a&&HistoryHandler.popState()):(AppUI.panelContainerToggled=!0,c(AppUI.fixedPanel,AppUI.optionalPanel,!0),HistoryHandler.pushState())}}static showAbout(){Modal.show({html:Strings.AboutHTML+(App.player&&App.player.audioContext?"<br/><br/><small>Base latency: "+(App.player.audioContext.baseLatency||0).toFixed(4)+" s<br/>Output latency: "+(isNaN(App.player.audioContext.outputLatency)?"-":App.player.audioContext.outputLatency.toFixed(4)+" s")+"</small>":""),
title:Strings.About+" (v"+window.CACHE_VERSION+")"})}}AppUI.primaryInputIsTouch="matchMedia"in window?window.matchMedia("(pointer: coarse)").matches:0<navigator.maxTouchPoints||0<navigator.msMaxTouchPoints;AppUI.baseSizePX=4;AppUI.s1PX=AppUI.baseSizePX;AppUI.s2PX=2*AppUI.baseSizePX;AppUI.s3PX=3*AppUI.baseSizePX;AppUI.s4PX=4*AppUI.baseSizePX;AppUI.s5PX=5*AppUI.baseSizePX;AppUI.s6PX=6*AppUI.baseSizePX;AppUI.s7PX=7*AppUI.baseSizePX;AppUI.s8PX=8*AppUI.baseSizePX;AppUI.smallFontSizeREM=3;
AppUI.smallContentsSizeREM=4;AppUI.fontSizeREM=3.5;AppUI.contentsSizeREM=6;AppUI.baseThinBorderPX=1;AppUI.baseThickBorderPX=2;AppUI.zoomHandlers=[];AppUI.rootVariables=document.getElementById("root-variables");AppUI.panelContainer=document.getElementById("panel-container");AppUI.fixedPanel=document.getElementById("fixed-panel");AppUI.middlePanel=document.getElementById("middle-panel");AppUI.optionalPanel=document.getElementById("optional-panel");AppUI.iconPlay=document.getElementById("i-play");
