...
class BufferedFileHandle{constructor(a,b){if(b.length<BufferedFileHandle.minBufferLength)throw Error("Buffer length too small: "+b.length);this.file=a;this.fileLength=a.size;this.buffer=b;this._bufferAvailable=this.bufferPosition=this.position=0;this._eof=!1}get bufferAvailable(){return this._bufferAvailable}get filePosition(){return this.position-this._bufferAvailable}get eof(){return this._eof}seekTo(a){if(0>a)throw Error("Invalid position");this._bufferAvailable=this.bufferPosition=0;a>=this.fileLength?
(this.position=this.fileLength,this._eof=!0):(this.position=a,this._eof=!1)}skip(a){0>=a||(a>=this._bufferAvailable?(a-=this._bufferAvailable,this.position+=a,this.position>=this.fileLength&&(this.position=this.fileLength,this._eof=!0),this._bufferAvailable=this.bufferPosition=0):(this.bufferPosition+=a,this._bufferAvailable-=a))}fillBuffer(a){if(0>=a)a=this.buffer.length;else if(0>a||a>this.buffer.length)throw Error("Invalid length");const b=this._bufferAvailable;if(a<=b||this._eof)return null;a=
this.buffer.length;b&&this.bufferPosition&&(this.buffer.copyWithin(0,this.bufferPosition,this.bufferPosition+b),this.bufferPosition=0);a-=b;return new Promise((c,d)=>{this.file.slice(this.position,this.position+a).arrayBuffer().then(e=>{e.byteLength?(this.position+=e.byteLength,this.position>=this.fileLength&&(this.position=this.fileLength,this._eof=!0),this._bufferAvailable+=e.byteLength):this._eof=!0;this.buffer.set(new Uint8Array(e),b);c()},d)})}readByte(){if(!this._bufferAvailable)return-1;this._bufferAvailable--;
return this.buffer[this.bufferPosition++]}readUInt32BE(){if(4>this._bufferAvailable)return null;this._bufferAvailable-=4;return this.buffer[this.bufferPosition++]<<24|this.buffer[this.bufferPosition++]<<16|this.buffer[this.bufferPosition++]<<8|this.buffer[this.bufferPosition++]}readUInt32LE(){if(4>this._bufferAvailable)return null;this._bufferAvailable-=4;return this.buffer[this.bufferPosition++]|this.buffer[this.bufferPosition++]<<8|this.buffer[this.bufferPosition++]<<16|this.buffer[this.bufferPosition++]<<
...
c,this._bufferAvailable||(this.bufferPosition=0),c;let e=0;d&&(a.set(this.buffer.subarray(this.bufferPosition,this.bufferPosition+d),b),e+=d,b+=d,c-=d,this._bufferAvailable=this.bufferPosition=0);return this._eof?e:new Promise((f,g)=>{this.file.slice(this.position,this.position+c).arrayBuffer().then(h=>{h.byteLength?(this.position+=h.byteLength,this.position>=this.fileLength&&(this.position=this.fileLength,this._eof=!0)):this._eof=!0;a.set(new Uint8Array(h),b);f(h.byteLength+e)},g)})}}
BufferedFileHandle.minBufferLength=32768;
...
(n=b.fillBuffer(1024))&&(yield n);if(4<l){m=b.readByte();var r=b.readByte();n=b.readByte();if(null===m||null===r||null===n)break a;e-=3;l-=3;if(73===m||68===r||51===n)if(d=b.fileLength-e,f&&g){d=-1;break a}}b.skip(l);(n=b.fillBuffer(1024))&&(yield n);continue;default:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;b.skip(l);(n=b.fillBuffer(1024))&&(yield n);continue}for((n=b.fillBuffer(1024))&&(yield n);m&&(!f||!g)||0<l;){var p=b.readUInt32BE();r=0;if(null===p)break a;e-=4;l-=4;if(1229866575!==
p){r=b.readUInt32LE();if(null===r||0>r||r>e||!m&&r>l)break a;e-=4;l-=4}1684108385!==p&&(n=b.fillBuffer(Math.min(264,8+r)))&&(yield n);switch(p){case 1718449184:if(!m)break;n=b.readUInt16LE();p=b.readUInt16LE();var q=b.readUInt32LE(),t=b.readUInt32LE();const u=b.readUInt16LE(),y=b.readUInt16LE();r-=16;e-=16;l-=16;if(null===n||null===p||null===q||null===t||null===u||null===y)break a;f=!0;k||(k=t);break;case 1684108385:m&&(g=!0,h||(h=r));break;case 1229866575:function x(v){b.read(c,0,v);return MetadataExtractor.finishReadingV2Frame(0,
v,c)}for(;0<l;){(n=b.fillBuffer(8))&&(yield n);p=b.readUInt32BE();e-=4;l-=4;if(null===p)break a;q=b.readUInt32LE();e-=4;l-=4;if(null===q||0>q||q>l)break a;if(1>=q)b.skip(q);else{t=Math.min(257,q)-1;(n=b.fillBuffer(t))&&(yield n);switch(p){case 1229865293:a.title=x(t);break;case 1230000708:a.album=x(t);break;case 1229017684:a.artist=x(t);break;case 1229148740:a.year=parseInt(x(t))||0;break;case 1230262859:a.track=parseInt(x(t))||0;break;default:t=0}b.skip(q-t);e-=q;l-=q}}}0<r&&(b.skip(r),e-=r,l-=r);
e&&(n=b.fillBuffer(8))&&(yield n)}}return f&&g?(d&&(0<d&&b.seekTo(d),(e=b.fillBuffer(1024))&&(yield e)),a.lengthMS=Math.floor(1E3*h/k),[a,!!d]):null})}static finishReadingV2Frame(a,b,c){let d=0;var e=b-1;a:for(;0<b;)switch(c[d]){case 0:case 9:case 10:case 11:case 12:case 13:case 32:case 133:case 160:b--;d++;break;default:break a}a:for(;0<b;)switch(c[e]){case 0:case 9:case 10:case 11:case 12:case 13:case 32:case 133:case 160:b--;e--;break;default:break a}e=null;switch(a){case 1:case 2:if(b&1&&d+b<
c.length&&b++,2<=b&&1===a&&(254===c[d]&&255===c[d+1]?(a=2,d+=2,b-=2):255===c[d]&&254===c[d+1]&&(d+=2,b-=2),!b))return null}switch(a){case 0:e=MetadataExtractor.textDecoderIso88591.decode(c.subarray(d,d+b));break;case 1:e=MetadataExtractor.textDecoderUtf16.decode(c.subarray(d,d+b));break;case 2:e=MetadataExtractor.textDecoderUtf16be.decode(c.subarray(d,d+b));break;case 3:e=MetadataExtractor.textDecoderUtf8.decode(c.subarray(d,d+b))}return e&&e.length?e:null}static readV2Frame(a,b,c){if(2>b)return a.skip(b),
...
93+e))))}c&MetadataExtractor.TRACK_B||d[125]||!d[126]||(a.track=d[126]&255)}}catch(g){}})}static extractID3v2Andv1(a,b,c){return __awaiter(this,void 0,void 0,function*(){const d=MetadataExtractor.createBasicMetadata(a);d.url?d.url.startsWith(FileUtils.localURLPrefix)&&(d.file=a):(d.file=a,d.fileSize=a.size,d.fileName=a.name);var e=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==e)if(e|=b.readByte(),1380533830===e){e=yield MetadataExtractor.extractRIFF(d,b,c[0]);if(!e)return null;
...
g,c),d.year=h&&h.then?parseInt(yield h):parseInt(h),d.year?f|=MetadataExtractor.YEAR_B:d.year=0);break;default:b.skip(g)}e-=10+g}(f&MetadataExtractor.ALL_BUT_LENGTH_B)!==MetadataExtractor.ALL_BUT_LENGTH_B&&(yield MetadataExtractor.extractID3v1(d,b,f,c[0]))}return d})}static createBasicMetadata(a){return{url:FileUtils.urlOrPathToURL(a["data-path"])||"",flags:MetadataFlags.Seekable}}static extract(a,b,c){return __awaiter(this,void 0,void 0,function*(){if(!a)return null;b||(b=new Uint8Array(BufferedFileHandle.minBufferLength));
c||(c=[new Uint8Array(256)]);if(!a.name.endsWith(".mp3")&&!a.name.endsWith(".aac")&&!a.name.endsWith(".wav")){if(a.name.endsWith(".flac"))return FLACMetadataExtractor.extract(a,b,c);const d=a.name.toLowerCase();if(!d.endsWith(".mp3")&&!d.endsWith(".aac")&&!d.endsWith(".wav"))return d.endsWith(".flac")?FLACMetadataExtractor.extract(a,b,c):null}try{const d=new BufferedFileHandle(a,b);yield d.fillBuffer(-1);return yield MetadataExtractor.extractID3v2Andv1(a,d,c)}catch(d){return null}})}}
...
class FLACMetadataExtractor extends MetadataExtractor{static readHeaderAndStreamInfo(a,b,c){if(1716281667!==b.readUInt32BE())return 0;var d=b.readUInt32BE();if(!d)return 0;c=d&2147483648;if(34!==(d&2147483647))return 0;b.skip(10);d=b.readUInt32BE();let e=b.readUInt32BE();if(!d||null===e)return 0;b.skip(16);e+=4294967296*(d&15);d>>=4;b=(d&31)+1;d=d>>5>>3;if(4>b||!d)return 0;e&&(a.lengthMS=Math.floor(1E3*e/d));return c?-1:1}static extractVorbisComment(a,b,c,d){return __awaiter(this,void 0,void 0,function*(){debugger;
var e=c.fillBuffer(1024);e&&(yield e);e=c.readUInt32LE();a-=4;if(!e||e>a)return 0;c.skip(e);a-=e;if(!a)return 1;(e=c.fillBuffer(1024))&&(yield e);let f=c.readUInt32LE();a-=4;if(null===f||0>a||f>a)return 0;let g=null,h=null,k=null;for(;0<f;){f--;(e=c.fillBuffer(4))&&(yield e);const m=c.readUInt32LE();a-=4;if(null===m||0>a||m>a)return 0;const l=Math.min(2048,m);let n=d[0];n.length<l&&(n=new Uint8Array(l),d[0]=n);(e=c.fillBuffer(l+4))&&(yield e);c.read(n,0,l);m>l&&c.skip(m-l);a-=m;try{let r;for(r=0;r<
l;r++)if(61===n[r]){if(r&&r<l-1){const p=MetadataExtractor.textDecoderUtf8.decode(n.subarray(0,r)).normalize().trim(),q=MetadataExtractor.textDecoderUtf8.decode(n.subarray(r+1,l)).normalize().trim();if(!q)break;switch(p.toUpperCase()){case "TITLE":b.title=q;break;case "ARTIST":b.artist=b.artist?b.artist+(", "+q):q;break;case "PERFORMER":g=q;break;case "ALBUMARTIST":h=q;break;case "COMPOSER":k=q;break;case "ALBUM":b.album=q;break;case "TRACKNUMBER":b.track=parseInt(q)||0;break;case "DATE":b.year=parseInt(q)||
0}}break}}catch(r){}}b.artist||(g?b.artist=g:h?b.artist=h:k&&(b.artist=k));0<a&&c.skip(a);return 1})}static readMetadataBlock(a,b,c){return __awaiter(this,void 0,void 0,function*(){var d=b.fillBuffer(4);d&&(yield d);d=b.readUInt32BE();if(!d)return 0;const e=d&2147483648;d&=2147483647;const f=d>>24;d&=16777215;if(127===f||d+b.filePosition>b.fileLength)return 0;if(4===f){if(!(yield FLACMetadataExtractor.extractVorbisComment(d,a,b,c)))return 0}else b.skip(d);return e?-1:1})}static extract(a,b,c){return __awaiter(this,
void 0,void 0,function*(){try{const d=new BufferedFileHandle(a,b);yield d.fillBuffer(-1);const e=MetadataExtractor.createBasicMetadata(a);let f=FLACMetadataExtractor.readHeaderAndStreamInfo(e,d,c[0]);if(!f)return null;if(0>f)return e;do if(f=yield FLACMetadataExtractor.readMetadataBlock(e,d,c),!f)return null;while(0<f);return e}catch(d){return null}})}}
...
a}}drawCurve(a,b,c){const d=this.ctx;if(d){var e=1<devicePixelRatio?devicePixelRatio:1;e!==this.pixelRatio&&(this.scaleChanged(),e=this.pixelRatio);var f=this.editor,g=f.filter;e*=f.scale;var h=this.element;f=this.leftMargin;var k=h.width,m=h.height,l=Math.round(8*e),n=Math.round(4*e),r=(k/l|0)+1,p=GraphicalFilterEditor.maximumChannelValueY*e|0,q=1>e?e:e|0;h=.5*q;d.fillStyle="#303030";d.fillRect(0,0,k,m);d.lineWidth=q;d.strokeStyle="#5a5a5a";d.beginPath();q=k+(n>>1);var t=(GraphicalFilterEditor.zeroChannelValueY*
e|0)+h;d.moveTo(q,t);for(let u=r-1;0<=u;u--)d.lineTo(q-n,t),q-=l,d.moveTo(q,t);d.stroke();d.beginPath();q=k+(n>>1);t=(GraphicalFilterEditor.validYRangeHeight*e|0)+h;d.moveTo(q,t);for(k=r-1;0<=k;k--)d.lineTo(q-n,t),q-=l,d.moveTo(q,t);d.stroke();if(a)for(a=g.equivalentZonesFrequencyCount.length-2;0<a;a--){q=((g.equivalentZonesFrequencyCount[a]+f)*e|0)+h;t=p;d.beginPath();for(d.moveTo(q,t);t<m;)d.lineTo(q,t+n),t+=l,d.moveTo(q,t);d.stroke()}q=1>e?2*e:2*e|0;h=.5*q;d.lineWidth=q;a=GraphicalFilterEditor.visibleBinCount-
...
"GEMNUSEP";return h};c=function(h){const k=document.createElement("div");k.className="GEMNULBL";k.appendChild(document.createTextNode(h));return k};d=function(h,k,m,l,n,r){const p=document.createElement("div");p.className=r?"GEMNUIT GECLK "+r:"GEMNUIT GECLK";if(k)if(f&&(l&&f.radioHTML||!l&&f.checkHTML))p.innerHTML=l?f.radioHTML:f.checkHTML,k=p.firstChild,k.style.marginRight=l?f.radioMargin||"2px":f.checkMargin||"2px",m||(k.style.visibility="hidden");else{k=document.createElement("span");r=l?"\u25cf ":
"\u25a0 ";let q=null;if(f){let t=!1;l?f.radioCharacter&&(t=!0,r=f.radioCharacter,q=f.radioMargin||"2px"):f.checkCharacter&&(t=!0,r=f.checkCharacter,q=f.checkMargin||"2px");t&&(f.checkFontFamily&&(k.style.fontFamily=f.checkFontFamily),f.checkFontSize&&(k.style.fontSize=f.checkFontSize))}q&&(k.style.marginRight=q);k.appendChild(document.createTextNode(r));m||(k.style.visibility="hidden");p.appendChild(k)}p.appendChild(document.createTextNode(h));n&&(p.onclick=n);return p};this.element=a;a.className=
...
d=1-d;d*=d;d+=.5*d;.55>d?d=0:1>d&&(d=smoothStep(.55,1,d));h=1-h;h=smoothStep(0,1,h);h*=h;h+=h;1<h&&(h=1);d+=.5*h;d=255*d|0;c[64*e+g]=255<=d?255:d}}a.texImage2D(a.TEXTURE_2D,0,a.ALPHA,64,64,0,a.ALPHA,a.UNSIGNED_BYTE,c)}analyze(a){let b=a-this.lastTime;33<b&&(b=33);this.lastTime=a;a=this.program.gl;var c=.00390625*b,d=1-c;const e=this.processedData,f=this.processedDataR,g=this.fft,h=this.BG_COLUMNS,k=this.BG_PARTICLES_BY_COLUMN,m=this.COLORS,l=this.program,n=this.bgPos,r=this.bgSpeedY,p=this.bgColor,
...
0:-1;this.element.setAttribute("aria-rowcount","0");this.element.removeAttribute("aria-activedescendant");this.adjustScrollbarPadding()}}elementScroll(){var a=this._adapter,b=this.element;if(a&&b){var c=this.items,d=this.itemHeightAndMargin,e=this.firstIndex-2;b=b.scrollTop/d|0;0>e&&(e=0);if(this.ignoreFirstIndex)this.ignoreFirstIndex=!1;else if(this.firstIndex===b)return;this.firstIndex=b;var f=this.visibleCount+(0===b?2:1===b?3:4);f>c.length&&(f=c.length);0>(b-=2)&&(b=0);if(b>e){if((e=b-e)&&e<f)for(let n=
e,r=0;n<f;n++,r++)e=c[r],c[r]=c[n],c[n]=e}else if((e-=b)&&e<f)for(let n=f-1,r=n-e;0<=r;r--,n--)e=c[n],c[n]=c[r],c[r]=e;var g=a.list,h=g.length,k=a.list.currentItem,m=this.keyboardIndex;e=this.container;var l=0;for(let n=b*d;l<f&&b<h;l++,b++,n+=d){const r=g.item(b),p=c[l];if(p.item!==r){let q=k===r;p.current!==q&&((p.current=q)?p.element.classList.add("current"):p.element.classList.remove("current"));q=m===b;p.keyboard!==q&&((p.keyboard=q)?(p.element.classList.add("keyboard"),p.element.setAttribute("aria-selected",
"true"),this.element.setAttribute("aria-activedescendant",p.element.getAttribute("id"))):(this.element.getAttribute("aria-activedescendant")===p.element.getAttribute("id")&&this.element.removeAttribute("aria-activedescendant"),p.element.classList.remove("keyboard"),p.element.setAttribute("aria-selected","false")));a.prepareElement(r,b,h,p.element);p.element.setAttribute("aria-rowindex",b.toString());p.item||e.appendChild(p.element);p.item=r}p.index!==b&&(p.index=b,p.element.style.transform="translateY("+
n+"px)")}for(a=c.length;l<a;l++)d=c[l],d.item&&(d.item=null,e.removeChild(d.element));this.lastIndex=b-1;this.lastIndex<this.firstIndex&&(this.lastIndex=this.firstIndex)}}refreshVisibleItemsInternal(){this.refreshVisibleItemsEnqueued=!1;var a=this._adapter,b=this.element;if(a&&b){this.adjustContainerHeight();b=this.items;var c=this.itemHeightAndMargin,d=a.list,e=d.length,f=a.list.currentItem,g=this.keyboardIndex,h=this.container;if(this.useVirtualItems){this.currentListItem=f;var k=0,m=this.firstIndex,
l=this.visibleCount+(0===m?2:1===m?3:4);l>b.length&&(l=b.length);0>(m-=2)&&(m=0);for(let n=m*c;k<l&&m<e;k++,m++,n+=c){const r=d.item(m),p=b[k];let q=f===r;p.current!==q&&((p.current=q)?p.element.classList.add("current"):p.element.classList.remove("current"));q=g===m;p.keyboard!==q&&((p.keyboard=q)?(p.element.classList.add("keyboard"),p.element.setAttribute("aria-selected","true"),this.element.setAttribute("aria-activedescendant",p.element.getAttribute("id"))):(this.element.getAttribute("aria-activedescendant")===
p.element.getAttribute("id")&&this.element.removeAttribute("aria-activedescendant"),p.element.classList.remove("keyboard"),p.element.setAttribute("aria-selected","false")));a.prepareElement(r,m,e,p.element);p.element.setAttribute("aria-rowindex",m.toString());p.item||h.appendChild(p.element);p.item=r;p.index!==m&&(p.index=m,p.element.style.transform="translateY("+n+"px)")}for(a=b.length;k<a;k++)d=b[k],d.item&&(d.item=null,h.removeChild(d.element))}else{h=this.visibleCount;k=0<=g&&g<b.length?b[g]:
null;this.keyboardItem!==k&&(this.keyboardItem&&(this.keyboardItem.element.classList.remove("keyboard"),this.keyboardItem.element.setAttribute("aria-selected","false")),k?(k.element.classList.add("keyboard"),k.element.setAttribute("aria-selected","true"),this.element.setAttribute("aria-activedescendant",k.element.getAttribute("id"))):this.element.removeAttribute("aria-activedescendant"),this.keyboardItem=k);for(let n=0,r=this.indexFromY(0);n<=h&&r<e;n++,r++)k=b[r].element,a.prepareElement(d.item(r),
...
(App.player&&App.player.audioContext?`
				<br/><br/>
				<small>
