...
d=this._sampleRate/2048,e=this._visibleFrequencies,f=Analyzer.colors;var g;let h,k,p,l;this._analyzerL.getByteTimeDomainData(this._data);cLib._plainAnalyzer(this._fft4gfPtr,this._windowPtr,this._dataPtr,this._tmpPtr);let m=this._prevL;c.lineWidth=1;c.fillStyle="#000000";c.fillRect(0,0,512,512);for(k=h=0;511>k&&1024>h&&d>e[k+1]-e[k];){for(g=d*h;1024>h&&g+d<e[k];)h++,g=d*h;g=(4*m[k]+a[k]*lerp(g,b[h],g+d,b[h+1],e[k]))/2.5>>1;255<g?g=255:0>g&&(g=0);m[k]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(k-.5,
256.5-g);c.lineTo(k-.5,256.5);c.stroke();k++}for(h++;1024>h&&512>k;){l=p=0;do p+=b[h],l++,h++,g=d*h;while(g<e[k]&&1024>h);g=(4*m[k]+a[k]*p/l)/2.5>>1;255<g?g=255:0>g&&(g=0);m[k]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(k-.5,256.5-g);c.lineTo(k-.5,256.5);c.stroke();k++}this._analyzerR.getByteTimeDomainData(this._data);cLib._plainAnalyzer(this._fft4gfPtr,this._windowPtr,this._dataPtr,this._tmpPtr);m=this._prevR;for(k=h=0;511>k&&1024>h&&d>e[k+1]-e[k];){for(g=d*h;1024>h&&g+d<e[k];)h++,g=d*h;g=(4*m[k]+
a[k]*lerp(g,b[h],g+d,b[h+1],e[k]))/2.5>>1;255<g?g=255:0>g&&(g=0);m[k]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(k-.5,256.5);c.lineTo(k-.5,256.5+g);c.stroke();k++}for(h++;1024>h&&512>k;){l=p=0;do p+=b[h],l++,h++,g=d*h;while(g<e[k]&&1024>h);g=(4*m[k]+a[k]*p/l)/2.5>>1;255<g?g=255:0>g&&(g=0);m[k]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(k-.5,256.5);c.lineTo(k-.5,256.5+g);c.stroke();k++}}cleanUp(){this._ptr&&cLib._freeBuffer(this._ptr)}}
