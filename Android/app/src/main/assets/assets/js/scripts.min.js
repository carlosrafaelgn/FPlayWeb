'use strict';class Icon extends HTMLElement{static createSVG(a){const b=document.createElementNS("http://www.w3.org/2000/svg","svg"),c=document.createElementNS("http://www.w3.org/2000/svg","use");b.ariaHidden="true";b.appendChild(c);a&&c.setAttribute("href","#"+a);return{svg:b,use:c}}static createHTML(a,b,c,d,e,f){return`<f-icon name="${a}"${b?' color="'+b+'"':""}${c?" large":""}${d?' class="'+d+'"':""}${e?' id="'+e+'"':""}${f?' sr-title="'+f+'"':""} />`}static create(a,b,c,d,e,f){const g=document.createElement("f-icon");
g.name=a;b&&(g.color=b);c&&(g.large=c);d&&(g.className=d);e&&(g.id=e);f&&(g.srTitle=f);return g}constructor(){super();this._color=this._name=null;this._large=!1;this._use=this._svg=this._srTitleElement=this._srTitle=null}get name(){return this._name}set name(a){null!==a?this.setAttribute("name",a):this.removeAttribute("name")}get color(){return this._color}set color(a){null!==a?this.setAttribute("color",a):this.removeAttribute("color")}get large(){return this._large}set large(a){a?this.setAttribute("large",
""):this.removeAttribute("large")}get srTitle(){return this._srTitle}set srTitle(a){null!==a?this.setAttribute("sr-title",a):this.removeAttribute("sr-title")}connectedCallback(){if(!this._use){var a=Icon.createSVG(this._name);this._svg=a.svg;this._use=a.use;if(a=this._color)this._color=null,this.attributeChangedCallback("color",null,a);this._large=!this._large;this.attributeChangedCallback("large",null,this._large?null:"");if(a=this._srTitle)this._srTitle=null,this.attributeChangedCallback("sr-title",
null,a);this.appendChild(this._svg)}}attributeChangedCallback(a,b,c){b=this._use;switch(a){case "name":if(this._name===c)break;this._name=c;if(!b)break;b.setAttribute("href","#"+c);break;case "color":if(this._color===c)break;if(!b){this._color=c;break}this._color&&this.classList.remove(this._color);(this._color=c)&&this.classList.add(c);break;case "large":a=null!==c;if(this._large===a)break;if(!b){this._large=a;break}this._large&&this.classList.remove("large");(this._large=a)&&this.classList.add("large");
break;case "sr-title":this._srTitle!==c&&(this._srTitle=c,b&&(c?this._srTitleElement?Strings.changeText(this._srTitleElement,c):(this._srTitleElement=Strings.createSrOnlyText(c),this.insertAdjacentElement("afterbegin",this._srTitleElement)):this._srTitleElement&&(this.removeChild(this._srTitleElement),this._srTitleElement=null)))}}}Icon.disabledFeatures=["shadow"];Icon.observedAttributes=["name","color","large","sr-title"];Icon.baseSizePX=12;customElements.define("f-icon",Icon);
...
Strings.Duration="Dura\u00e7\u00e3o",Strings.DurationLabel="Dura\u00e7\u00e3o: ",Strings.Track="Faixa",Strings.TrackLabel="Faixa: ",Strings.TrackAlbum="Faixa e \u00e1lbum",Strings.TrackAlbumLabel="Faixa e \u00e1lbum: ",Strings.Year="Ano",Strings.YearLabel="Ano: ",Strings.SampleRate="Taxa de amostragem",Strings.SampleRateLabel="Taxa de amostragem: ",Strings.Channels="Canais",Strings.ChannelsLabel="Canais: ",Strings.ShowInfo="Exibir informa\u00e7\u00f5es",Strings.SongInfo="Informa\u00e7\u00f5es da m\u00fasica",
Strings.Search="Pesquisar",Strings.SearchResults="Resultados da pesquisa",Strings.SearchPlaceholder="T\u00edtulo, artista, \u00e1lbum, ano ou caminho",Strings.NoSongPlaying="Nenhuma m\u00fasica tocando! \ud83d\ude05",Strings.Playlist="Playlist",Strings.FileList="Lista de arquivos",Strings.CurrentPathLabel="Caminho atual: ",Strings.Loading="Carregando",Strings.LoadingLabel="Carregando\u2026 ",Strings.LoadingCurrentPathLabel="Carregando camino atual: ",Strings.Folder="Pasta",Strings.FolderLabel="Pasta: ",
Strings.LeftAbbrev="E",Strings.RightAbbrev="D",Strings.DownMixToMono="Fazer down-mix para mono",Strings.UnknownError="Algo saiu errado durante a reprodu\u00e7\u00e3o. \ud83d\ude22",Strings.Add="Adicionar",Strings.AddFiles="Adicionar arquivos",Strings.AddSongs="Adicionar m\u00fasicas",Strings.AddFolders="Adicionar pastas",Strings.AddMoreFolders="Adicionar mais pastas\u2026",Strings.ShowEffects="Exibir efeitos",Strings.ShowPlaylist="Exibir playlist",Strings.NoSongsInFolder="Nenhuma m\u00fasica na pasta. \ud83d\ude33",
Strings.NoSongsFoundInPlaylist="Nenhuma m\u00fasica encontrada na playlist. \ud83d\ude33",Strings.PlaylistControlEmptyMessage=`Utilize o bot\u00e3o \"${Strings.AddSongs}\" para adicionar m\u00fasicas \u00e0 playlist. \ud83d\ude0a`,Strings.UpdateAvailable="Atualiza\u00e7\u00e3o dispon\u00edvel!",Strings.PleaseRefresh="Por favor, recarregue a p\u00e1gina para atualizar a aplica\u00e7\u00e3o. \ud83d\ude0a",Strings.RGBMode="Modo RGB",Strings.AnimatedRGBMode="Modo RGB Animado",Strings.ExtraRGBMode="Modo RGB Extra",
Strings.NeonMode="Modo Neon",Strings.ShowPlaylistAlbumArt="Exibir arte do \u00e1lbum na playlist",Strings.ShowPlaylistIcons="Exibir \u00edcones na playlist",Strings.AboutHTML='<p>FPlay Web \u00e9 um player de \u00e1udio experimental. \ud83d\ude0a</p>\n<p>Para mais informa\u00e7\u00f5es sobre o projeto, seu c\u00f3digo-fonte e depend\u00eancias, confira seu reposit\u00f3rio em <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb">github.com/carlosrafaelgn/FPlayWeb</a>.</p>\n<p>Este projeto \u00e9 licenciado sob a <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb/blob/master/LICENSE">MIT License</a>.</p>',
Strings.DeleteModeHTML="Clique as m\u00fasicas para exclu\u00ed-las.",Strings.LibMikModNotSupported="LibMikMod n\u00e3o suportada",Strings.LibMikModFailedToInitialize="LibMikMod falhou ao inicializar",Strings.LibMikModErrorInitializing="Erro ao inicializar a LibMikMod",Strings.LibMikModErrorReadingModuleFile="Erro ao ler o arquivo do m\u00f3dulo",Strings.LibMikModErrorLoadingModule="Erro ao carregar o m\u00f3dulo")}static translate(a){const b=Strings[a];return void 0!==b?b:a}static translateChildren(a){a=
a.childNodes;for(let d=a.length-1;0<=d;d--){const e=a[d];if(!e.tagName)continue;e.childNodes&&e.childNodes.length&&Strings.translateChildren(e);let f;if(f=e.title)e.title=Strings.translate(f);if(f=e.dataset.string){delete e.dataset.string;var b=0;do{let g=f.indexOf(";",b);g<b&&(g=f.length);var c=f.indexOf("|",b);0>c||c>=g?e.appendChild(document.createTextNode(Strings.translate(f))):(b=f.substring(b,c),c=f.substring(c+1,g),e[b]=Strings.translate(c));b=g+1}while(b<f.length)}}}static changeText(a,b){if(a){null===
b&&(b="");var c=a.lastChild;c?c.nodeValue=b:a.appendChild(document.createTextNode(b))}}static createSrOnlyText(a){const b=document.createElement("span");b.className="sr-only";Strings.changeText(b,a);return b}static htmlEncode(a){return a?a.replace(Strings._regExpAmp,"&amp;").replace(Strings._regExpLT,"&lt;").replace(Strings._regExpGT,"&gt;"):""}static htmlEncodeValue(a){return a?a.replace(Strings._regExpAmp,"&amp;").replace(Strings._regExpLT,"&lt;").replace(Strings._regExpGT,"&gt;").replace(Strings._regExpQuot,
"&#34;").replace(Strings._regExpApos,"&#39;").replace(Strings._regExpGrave,"&#96;"):""}static removeDiacritics(a){return a?a.normalize("NFD").replace(Strings._regExpDiacritics,"").toLowerCase():""}}Strings._regExpAmp=/&/g;Strings._regExpLT=/</g;Strings._regExpGT=/>/g;Strings._regExpQuot=/"/g;Strings._regExpApos=/'/g;Strings._regExpGrave=/`/g;Strings._regExpDiacritics=/[\u0300-\u036f]/g;Strings.language="en";Strings.decimalSeparator=".";Strings.oppositeDecimalSeparator=",";Strings.Oops="Oops\u2026";
Strings.AppName="FPlay";Strings.Menu="Menu";Strings.About="About";Strings.Options="Options";Strings.Edit="Edit";Strings.Delete="Delete";Strings.DeleteSongs="Delete songs";Strings.DeleteAllSongs="Delete all";Strings.Enable="Enable";Strings.Disable="Disable";Strings.Enabled="Enabled";Strings.Disabled="Disabled";Strings.Selected="Selected";Strings.AdvancedFilter="Advanced filter";Strings.TraditionalFilter="Traditional filter";Strings.Missing="Missing";Strings.MissingSongError="The song is missing! \ud83d\ude22 Please, just add it again before playing it. When you add a missing song, it keeps its position in the playlist! \ud83d\ude0a";
...
Strings.PlayPause="Play / Pause";Strings.Stop="Stop";Strings.Next="Next";Strings.Seek="Seek";Strings.Path="Path";Strings.PathLabel="Path: ";Strings.Title="Title";Strings.TitleLabel="Title: ";Strings.CurrentTitleLabel="Current title: ";Strings.Album="Album";Strings.AlbumLabel="Album: ";Strings.CurrentAlbumLabel="Current album: ";Strings.Artist="Artist";Strings.ArtistLabel="Artist: ";Strings.CurrentArtistLabel="Current artist: ";Strings.Duration="Duration";Strings.DurationLabel="Duration: ";
Strings.Track="Track";Strings.TrackLabel="Track: ";Strings.TrackAlbum="Track and album";Strings.TrackAlbumLabel="Track and album: ";Strings.Year="Year";Strings.YearLabel="Year: ";Strings.SampleRate="Sample rate";Strings.SampleRateLabel="Sample rate: ";Strings.Channels="Channels";Strings.ChannelsLabel="Channels: ";Strings.ShowInfo="Show information";Strings.SongInfo="Song information";Strings.Search="Search";Strings.SearchResults="Search results";Strings.SearchPlaceholder="Title, artist, album, year or path";
Strings.NoSongPlaying="No song playing! \ud83d\ude05";Strings.Playlist="Playlist";Strings.FileList="File list";Strings.CurrentPathLabel="Current path: ";Strings.Loading="Loading";Strings.LoadingLabel="Loading\u2026 ";Strings.LoadingCurrentPathLabel="Loading current path: ";Strings.Folder="Folder";Strings.FolderLabel="Folder: ";Strings.LeftAbbrev="L";Strings.RightAbbrev="R";Strings.Volume="Volume";Strings.Fade="Fade";Strings.DownMixToMono="Down-mix to mono";Strings.UnknownError="Something went wrong during playback. \ud83d\ude22";
Strings.Add="Add";Strings.AddFiles="Add files";Strings.AddSongs="Add songs";Strings.AddFolders="Add folders";Strings.AddMoreFolders="Add more folders\u2026";Strings.ShowEffects="Show effects";Strings.ShowPlaylist="Show playlist";Strings.NoSongsInFolder="No songs in folder. \ud83d\ude33";Strings.NoSongsFoundInPlaylist="No songs found in the playlist. \ud83d\ude33";Strings.PlaylistControlEmptyMessage=`Use the \"${Strings.AddSongs}\" button to add songs to the playlist. \ud83d\ude0a`;
Strings.UpdateAvailable="Update available!";Strings.PleaseRefresh="Please, refresh the page to update the app. \ud83d\ude0a";Strings.RGBMode="RGB Mode";Strings.AnimatedRGBMode="Animated RGB Mode";Strings.ExtraRGBMode="Extra RGB Mode";Strings.NeonMode="Neon Mode";Strings.ShowPlaylistAlbumArt="Show playlist album art";Strings.ShowPlaylistIcons="Show playlist icons";Strings.AboutHTML='<p>FPlay Web is an experimental audio player. \ud83d\ude0a</p>\n<p>For more information about the project, its source code and dependencies, check out its repository at <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb">github.com/carlosrafaelgn/FPlayWeb</a>.</p>\n<p>This project is licensed under the <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb/blob/master/LICENSE">MIT License</a>.</p>';
Strings.DeleteModeHTML="Click songs to delete them.";Strings.LibMikModNotSupported="LibMikMod not supported";Strings.LibMikModFailedToInitialize="LibMikMod failed to initialize";Strings.LibMikModErrorInitializing="Error initializing LibMikMod";Strings.LibMikModErrorReadingModuleFile="Error reading module file";Strings.LibMikModErrorLoadingModule="Error loading module";
class DelayControl{static delayShortCB(a){return setTimeout(a,DelayControl.shortDelayMS)}static delayFadeCB(a){return setTimeout(a,DelayControl.fadeDelayMS)}static delayShort(){return new Promise(function(a){setTimeout(a,DelayControl.shortDelayMS)})}static delayFade(){return new Promise(function(a){setTimeout(a,DelayControl.fadeDelayMS)})}}DelayControl.shortDelayMS=50;DelayControl.fadeDelayMS=350;
...
class FileUtils{static init(){FileUtils.concatenatedSupportedExtensions=Array.from(FileUtils.supportedExtensions.keys()).join(",")}static addSupportedExtension(a,b,c){FileUtils.supportedExtensions.set(a,{extension:a,mimeType:b,customProvider:c})}static getSupportedExtensionInfoByPath(a){const b=a.lastIndexOf(".");if(0>b)return null;a=a.substring(b);return FileUtils.supportedExtensions.get(a)||FileUtils.supportedExtensions.get(a.toLowerCase())||null}static getCustomProviderByExtension(a){return(a=
FileUtils.supportedExtensions.get(a))?a.customProvider:null}static urlOrPathToURL(a){return!a||a.startsWith(FileUtils.httpURLPrefix)||a.startsWith(FileUtils.fileURLPrefix)||a.startsWith(FileUtils.localURLPrefix)?a:FileUtils.pathToURL(a)}static pathToURL(a){return encodeURI(47===a.charCodeAt(0)?FileUtils.fileURLPrefix+a:FileUtils._fileURLPrefixWindows+a.replace(FileUtils._regExpSepWindows,"/")).replace(FileUtils._regExpHash,"%23")}static nameFromLinuxPath(a){if(!a)return a;let b=a.lastIndexOf("/");
return 0<=b?a.substring(b+1):a}}FileUtils.separator="\u0004";FileUtils.httpURLPrefix="http";FileUtils.fileURLPrefix="file://";FileUtils.localURLPrefix="local://";FileUtils._fileURLPrefixWindows="file:///";FileUtils._regExpSepWindows=/\\/g;FileUtils._regExpHash=/#/g;
FileUtils.supportedExtensions=new Map([[".aac",{extension:".aac",mimeType:"audio/aac",customProvider:null}],[".flac",{extension:".flac",mimeType:"audio/flac",customProvider:null}],[".mp3",{extension:".mp3",mimeType:"audio/mpeg",customProvider:null}],[".ogg",{extension:".ogg",mimeType:"audio/ogg",customProvider:null}],[".wav",{extension:".wav",mimeType:"audio/wav",customProvider:null}]]);
...
break;case 1:a.sampleRate=12E3;break;case 2:a.sampleRate=8E3}break;case 2:switch(d){case 0:a.sampleRate=22050;break;case 1:a.sampleRate=24E3;break;case 2:a.sampleRate=16E3}break;case 3:switch(d){case 0:a.sampleRate=44100;break;case 1:a.sampleRate=48E3;break;case 2:a.sampleRate=32E3}}a.channels=3===(e>>6&3)?1:2}}catch(f){}}static async extractID3v2Andv1(a,b,c,d,e,f){a=MetadataExtractor.createBasicMetadata(a);let g=0;var h=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==h)if(h|=b.readByte(),
1380533830===h){e=!1;h=await MetadataExtractor.extractRIFF(a,b,c.buffer);if(!h)return null;if(!h[1])return a;a.lengthMS&&(g|=MetadataExtractor.LENGTH_B)}else return e&&await MetadataExtractor.extractSampleRateAndChannels(a,b,0,d),await MetadataExtractor.extractID3v1(a,b,0,c.buffer),a;var k=b.readByte(),n=b.readByte();h=b.readByte();var m=b.readByte(),l=b.readByte();const p=b.readByte(),r=b.readByte();h=(h&16?10:0)+(r&127|(p&127)<<7|(l&127)<<14|(m&127)<<21);m=10+h;if(2<(k&255)||n){for(;0<h&&g!==MetadataExtractor.ALL_B;){(k=
b.fillBuffer(1024))&&await k;n=b.readUInt32BE();k=b.readUInt32BE();b.skip(2);if(!n||0>=k||k>h)break;switch(n){case 1414091826:g&MetadataExtractor.TITLE_B?b.skip(k):(n=MetadataExtractor.readV2Frame(b,k,c),a.title=n&&n.then?await n:n,a.title&&(g|=MetadataExtractor.TITLE_B));break;case 1414546737:g&MetadataExtractor.ARTIST_B?b.skip(k):(n=MetadataExtractor.readV2Frame(b,k,c),a.artist=n&&n.then?await n:n,a.artist&&(g|=MetadataExtractor.ARTIST_B));break;case 1413565506:g&MetadataExtractor.ALBUM_B?b.skip(k):
(n=MetadataExtractor.readV2Frame(b,k,c),a.album=n&&n.then?await n:n,a.album&&(g|=MetadataExtractor.ALBUM_B));break;case 1414677323:g&MetadataExtractor.TRACK_B?b.skip(k):(n=MetadataExtractor.readV2Frame(b,k,c),a.track=n&&n.then?parseInt(await n):parseInt(n),a.track?g|=MetadataExtractor.TRACK_B:a.track=0);break;case 1414284622:g&MetadataExtractor.LENGTH_B?b.skip(k):(n=MetadataExtractor.readV2Frame(b,k,c),a.lengthMS=n&&n.then?parseInt(await n):parseInt(n),a.lengthMS?g|=MetadataExtractor.LENGTH_B:a.lengthMS=
0);break;case 1415136594:case 1413763651:g&MetadataExtractor.YEAR_B?b.skip(k):(n=MetadataExtractor.readV2Frame(b,k,c),a.year=n&&n.then?parseInt(await n):parseInt(n),a.year?g|=MetadataExtractor.YEAR_B:a.year=0);break;case 1095780675:if(f){(n=b.fillBuffer(-1))&&await n;n=0;b.skip(1);n++;l=b.readByte();for(n++;0<l;)l=b.readByte(),n++;b.skip(1);n++;l=b.readByte();for(n++;0<l;)l=b.readByte(),n++;l=new Uint8Array(k-n);n=await b.read(l,0,l.length);n===l.length&&(a.albumArt=l)}else b.skip(k);break;default:b.skip(k)}h-=
10+k}e&&await MetadataExtractor.extractSampleRateAndChannels(a,b,m,d);(g&MetadataExtractor.ALL_BUT_LENGTH_B)!==MetadataExtractor.ALL_BUT_LENGTH_B&&await MetadataExtractor.extractID3v1(a,b,g,c.buffer)}return a}static createBasicMetadata(a){const b={url:FileUtils.urlOrPathToURL(a["data-path"])||"",flags:MetadataFlags.Seekable};b.url?b.url.startsWith(FileUtils.localURLPrefix)&&(b.file=a):(b.file=a,b.fileSize=a.size,b.fileName=a.name);return b}static async extract(a,b,c,d=!1,e=null){if(!a)return null;
b||(b=new Uint8Array(BufferedReader.minBufferLength));c||(c=new ResizeableBuffer(2048));if(e)try{return await e.extractMetadata(MetadataExtractor.createBasicMetadata(a),a,b,c,d)}catch(f){return null}e=!1;if(!a.name.endsWith(".mp3")&&!(e=a.name.endsWith(".aac"))&&!a.name.endsWith(".wav")){if(a.name.endsWith(".flac"))return FLACMetadataExtractor.extract(a,b,c,d);if(a.name.endsWith(".ogg"))return OggMetadataExtractor.extract(a,b,c,d);const f=a.name.toLowerCase();if(!f.endsWith(".mp3")&&!(e=f.endsWith(".aac"))&&
!f.endsWith(".wav"))return f.endsWith(".flac")?FLACMetadataExtractor.extract(a,b,c,d):f.endsWith(".ogg")?OggMetadataExtractor.extract(a,b,c,d):null}try{const f=new BufferedFileReader(a,b);await f.fillBuffer(-1);return await MetadataExtractor.extractID3v2Andv1(a,f,c,e,!0,d)}catch(f){return null}}}MetadataExtractor.ALL_B=63;MetadataExtractor.ALL_BUT_LENGTH_B=31;MetadataExtractor.TITLE_B=1;MetadataExtractor.ARTIST_B=2;MetadataExtractor.ALBUM_B=4;MetadataExtractor.TRACK_B=8;MetadataExtractor.YEAR_B=16;
MetadataExtractor.LENGTH_B=32;MetadataExtractor.textDecoderIso88591=new TextDecoder("iso-8859-1");MetadataExtractor.textDecoderUtf16=new TextDecoder("utf-16");MetadataExtractor.textDecoderUtf16be=new TextDecoder("utf-16be");MetadataExtractor.textDecoderUtf8=new TextDecoder("utf-8");function decodeBase64(a){return 65<=a&&90>=a?a-65:97<=a&&122>=a?a-97+26:48<=a&&57>=a?a-48+52:43===a?62:63}
...
this.control.notifyCurrentItemChanged(a,b)}synchronizeElementToEnvironment(a,b,c,d){}}
...
this._currentIndex+1;a>=this.items.length&&(a=0);return 0<=a&&a<this.items.length?this.items[a]:null}item(a){return this.items[a]}estimateSerializedLength(){const a=this.items;if(!(a&&a[0]&&"estimateSerializedLength"in a[0]))return 0;let b=0;for(let c=a.length-1;0<=c;c--)b+=a[c].estimateSerializedLength();return b+128}get version(){return 0}serializeExtraProperties(a,b){return a}serializeExtraPropertiesWeb(a){return a}serialize(a){a||(a=new DataWriter(this.estimateSerializedLength()));const b=this.items,
c=b&&b[0]&&"serialize"in b[0]?b.length:0;a.writeUint8(this.version).writeInt32(c).writeInt32(this._currentIndex);this.serializeExtraProperties(a,c);for(let d=0;d<c;d++)b[d].serialize(a);return a}serializeWeb(){const a=this.items,b=a&&a[0]&&"serializeWeb"in a[0]?a.length:0,c=Array(b);for(let d=0;d<b;d++)c[d]=a[d].serializeWeb();return this.serializeExtraPropertiesWeb({currentIndex:this._currentIndex,items:c})}moveCurrentToPrevious(){this.currentIndex=this._currentItem?0>=this._currentIndex?this.items.length-
1:this._currentIndex-1:this._currentIndex;return this._currentIndex}moveCurrentToNext(){this.currentIndex=this._currentItem?this._currentIndex>=this.items.length-1?0:this._currentIndex+1:this._currentIndex;return this._currentIndex}clear(){const a=this._currentIndex,b=this._currentItem;this.items&&this.items.fill(null);this.modified=!0;this.items=[];this._currentIndex=-1;this._currentItem=null;this._adapter&&(this._adapter.cleared(),b&&this._adapter.currentItemChanged(a,-1))}changeItems(a){a&&a.length?
(this.items&&this.items.fill(null),this.modified=!0,this.items=a.slice(),this._currentIndex=-1,this._currentItem=null,this._adapter&&this._adapter.itemsChanged(a.length)):this.clear()}addItem(a,b){if(!this.items||!a)return-1;void 0===b||0>b||b>=this.items.length?(b=this.items.length,this.items.push(a)):this.items.splice(b,0,a);this.modified=!0;this._adapter&&this._adapter.itemsAdded(b,b);0<=this._currentIndex&&b<=this._currentIndex&&this._currentIndex++;return b}addItems(a,b){if(!this.items||!a||
!a.length)return-1;void 0===b||0>b||b>=this.items.length?(b=this.items.length,this.items.push(...a)):this.items.splice(b,0,...a);this.modified=!0;this._adapter&&this._adapter.itemsAdded(b,b+a.length-1);0<=this._currentIndex&&b<=this._currentIndex&&(this._currentIndex+=a.length);return b}removeItems(a,b){if(!this.items||0>a||a>=this.items.length)return 0;void 0===b||b>=this.items.length?b=this.items.length-1:b<a&&(b=a);const c=b-a+1;this.items.splice(a,c);this.modified=!0;0<=this._currentIndex&&(b<
this._currentIndex?this._currentIndex-=c:a<=this._currentIndex&&this._currentItem&&(this._currentItem=null,this._adapter&&this._adapter.currentItemChanged(this._currentIndex,-1)));this._adapter&&this._adapter.itemsRemoved(a,b);return c}}
...
FilePickerAndroidProvider._callbackClickDoneResolve=null;FilePickerAndroidProvider._permissionGranted=!1;class AudioElement{constructor(){this.onwaiting=this.ontimeupdate=this.onplaying=this.onpause=this.onloadstart=this.onerror=this.onended=this.onemptied=this.ondurationchange=this.oncanplay=this.onabort=null}}var CustomProviderId;(function(a){a[a.LibMikMod=1]="LibMikMod"})(CustomProviderId||(CustomProviderId={}));class CustomProvider{constructor(a){this.id=a}}
class LibMikModAudioElement extends AudioElement{constructor(a,b,c,d,e){super();this._alive=!0;this._playAfterLoading=this._loading=this._loaded=!1;this._volume=0;this._muted=!1;this._currentTimeInterval=this._currentTime=this._audioContextStartTime=0;this._boundUpdateCurrentTime=()=>{if(this._alive&&(this._currentTime=this._audioContext.currentTime-this._audioContextStartTime,this.ontimeupdate))this.ontimeupdate()};this._duration=0;this._paused=!0;this._audioContext=a;this._customProvider=b;this._song=
c;this._sourceAudioNode=null;this._volumeAudioNode=new GainNode(a,{gain:0});this._suspendAudioContext=d;this._resumeAudioContext=e}get volume(){return this._volume}set volume(a){this._volume=a;this._volumeAudioNode.gain.value=this._muted?0:a}get muted(){return this._muted}set muted(a){this._muted=a;this._volumeAudioNode.gain.value=a?0:this._volume}get currentTime(){return this._currentTime}set currentTime(a){}get duration(){return this._duration}get paused(){return this._paused}get seekable(){return null}get customProvider(){return this._customProvider}get audioNode(){return this._volumeAudioNode}updateInterval(){!this._alive||
this._paused?this._currentTimeInterval&&(clearInterval(this._currentTimeInterval),this._currentTimeInterval=0):this._currentTimeInterval||(this._currentTimeInterval=setInterval(this._boundUpdateCurrentTime,200))}load(){!this._alive||this._loaded||this._loading||(this._loading=!0,this.onloadstart&&queueMicrotask(this.onloadstart),LibMikMod.isSupported()?LibMikMod.initializing||(LibMikMod.initializationError?queueMicrotask(()=>{if(this._alive&&this.onerror)this.onerror(Strings.LibMikModFailedToInitialize)}):
LibMikMod.init(this._audioContext,"assets/lib/libmikmod/").then(async()=>{let a;try{if(a=await this._song.readAsArrayBuffer(),!a){queueMicrotask(()=>{if(this._alive&&this.onerror)this.onerror(Strings.LibMikModErrorReadingModuleFile)});return}}catch(b){queueMicrotask(()=>{if(this._alive&&this.onerror)this.onerror(Strings.LibMikModErrorReadingModuleFile+": "+b)});return}this._alive&&LibMikMod.loadModule({audioContext:this._audioContext,source:a,reverb:0,interpolation:!0,noiseReduction:!0,hqMixer:!0,
wrap:!1,loop:!1,fadeout:!0,onload:b=>{if(this._alive){this._loading=!1;this._loaded=!0;this._sourceAudioNode=b;this._sourceAudioNode.connect(this._volumeAudioNode);this._audioContextStartTime=this._audioContext.currentTime;if(this.oncanplay)this.oncanplay();this._playAfterLoading&&this.play()}},onerror:(b,c)=>{if(this._alive&&this.onerror)this.onerror(Strings.LibMikModErrorLoadingModule+": "+(c||Strings.UnknownError)+" ("+b+")")},onended:()=>{if(this._alive){this._loaded=!1;this._paused=!0;this._currentTimeInterval&&
(clearInterval(this._currentTimeInterval),this._currentTimeInterval=0);this._duration=this._currentTime;if(this._song.lengthMS<this.duration&&this.ondurationchange)this.ondurationchange();if(this.onended)this.onended()}}})},a=>{queueMicrotask(()=>{if(this._alive&&this.onerror)this.onerror(Strings.LibMikModErrorInitializing+": "+a)})})):queueMicrotask(()=>{if(this._alive&&this.onerror)this.onerror(Strings.LibMikModNotSupported)}))}play(){if(!this._alive||!this._paused||!this._loaded)return this._playAfterLoading=
!0,Promise.resolve();this._resumeAudioContext();this._paused=!1;this.updateInterval();this.onplaying&&queueMicrotask(this.onplaying);return Promise.resolve()}pause(){this._alive&&!this._paused&&(this._suspendAudioContext(),this._paused=!0,this.updateInterval(),this.onpause&&queueMicrotask(this.onpause))}destroy(){this._alive&&(this._playAfterLoading=this._loaded=this._alive=!1,this._paused=!0,this._sourceAudioNode&&(this._sourceAudioNode.disconnect(),LibMikMod.stopModule()),this._volumeAudioNode.disconnect(),
this.updateInterval(),zeroObject(this),this._paused=!0)}}
class LibMikModCustomProvider extends CustomProvider{static init(){const a=".669 .amf .asy .dsm .far .gdm .gt2 .imf .it .m15 .med .mod .mtm .okt .s3m .stm .stx .ult .umx .uni .xm".split(" "),b=new LibMikModCustomProvider;for(let c=a.length-1;0<=c;c--)FileUtils.addSupportedExtension(a[c],"application/octet-stream",b)}constructor(){super(CustomProviderId.LibMikMod)}async extractMetadata(a,b,c,d,e){a.flags&=~MetadataFlags.Seekable;return a}createAudioElement(a,b,c,d){return new LibMikModAudioElement(a,
this,b,c,d)}}
class Song{static deserialize(a){a.readUint8();return new Song(a.readString(),a.readInt32(),a.readString(),a.readString(),a.readString(),a.readInt16(),a.readInt32(),a.readInt16(),a.readInt32(),a.readInt8(),a.readString(),a.readInt32())}constructor(a,b,c,d,e,f,g,h,k,n,m,l){if("string"!==typeof a){l=a;a=l.url;b=l.flags;c=l.title;d=l.artist;e=l.album;f=l.track;g=l.lengthMS;h=l.year;k=l.sampleRate;n=l.channels;if(l.file){if(!a||a.startsWith(FileUtils.localURLPrefix))this.file=l.file;c||(c=l.file.name.lastIndexOf("."),
c=0<c?l.file.name.substring(0,c):l.file.name)}m=l.fileName;l=l.fileSize}this.id=++Song._lastId;this.url=a;this.flags=b||0;this.isHttpURL=this.url.startsWith("http:")||this.url.startsWith("https:")||this.url.startsWith("icy:");this.isLocalURL=this.url.startsWith(FileUtils.localURLPrefix);this.isFileURL=this.url.startsWith(FileUtils.fileURLPrefix);b=this.url.lastIndexOf(".");this.fileExtension=(this.isLocalURL||this.isFileURL)&&0<=b?this.url.substring(b).toLowerCase()||null:null;c||(a=decodeURI(a),
b=a.lastIndexOf("/"),c=0<=b?a.substring(b+1):a,this.isHttpURL||(b=c.lastIndexOf("."),0<b&&(c=c.substring(0,b))));this.title=c||Formatter.none;this.artist=d||Formatter.none;this.album=e||Formatter.none;this.track=f&&0<f?f:Formatter.noneInt;this.trackLabel=f&&0<f?f.toString():"";this.albumLine=`${f&&0<f?f+" ":""}${this.album}`;this.lengthMS=g&&0<g?g:Formatter.noneInt;this.year=h&&0<h?h:Formatter.noneInt;this.sampleRate=k&&0<k?k:Formatter.noneInt;this.channels=n&&0<n?n:Formatter.noneInt;this.length=
Formatter.formatTimeMS(this.lengthMS);this.fileName=m||null;this.fileSize=l||0;this.customProvider=this.fileExtension&&FileUtils.getCustomProviderByExtension(this.fileExtension)||null}get isSeekable(){return this.flags&MetadataFlags.Seekable?!0:!1}get absolutePath(){return this.isLocalURL?this.url.substring(FileUtils.localURLPrefix.length):this.isFileURL?decodeURI(this.url.substring(FileUtils.fileURLPrefix.length)):this.url}estimateSerializedLength(){return(this.url.length+this.title.length+this.artist.length+
this.album.length+(this.fileName?this.fileName.length:0)<<1)+17}serialize(a){return a.writeUint8(0).writeString(this.url).writeInt32(this.flags).writeString(this.title).writeString(this.artist).writeString(this.album).writeInt16(this.track).writeInt32(this.lengthMS).writeInt16(this.year).writeInt32(this.sampleRate).writeInt8(this.channels).writeString(this.fileName||null).writeInt32(this.fileSize||0)}serializeWeb(){return{url:this.url,flags:this.flags,title:this.title,artist:this.artist,album:this.album,
track:this.track,lengthMS:this.lengthMS,year:this.year,sampleRate:this.sampleRate,channels:this.channels,fileName:this.fileName,fileSize:this.fileSize}}normalizedInfoContainsAllTerms(a){var b=this._normalizedInfo;void 0===b&&(b=[],this.title&&this.title!==Formatter.none&&b.push(this.title),this.artist&&this.artist!==Formatter.none&&b.push(this.artist),this.albumLine&&this.albumLine!==Formatter.none&&b.push(this.albumLine),this.year&&0<this.year&&b.push(this.year.toString()),this.url&&b.push(this.url),
this._normalizedInfo=b=Strings.removeDiacritics(b.join(" ")));for(let c=a.length-1;0<=c;c--)if(!b.includes(a[c]))return!1;return!0}async readAsArrayBuffer(){if(!this.file)if(this.isLocalURL){var a=await FileSystemAPI.getFile(this.absolutePath);if(!a)return null;this.file=a}else return a=await fetch(this.url),a.ok?a.arrayBuffer():null;return this.file.arrayBuffer()}}Song._lastId=0;
class PlaylistAdapter extends ListAdapter{constructor(a){super(a)}get itemHeight(){return AppUI.playlistItemSizePX}createEmptyElement(a){const b=document.createElement("div");b.className=a+" playlist-item"+(PlaylistAdapter.showAlbumArt?" album-art":"")+(PlaylistAdapter.showIcons?" icons":"");a=document.createElement("span");a.className="playlist-item-row1";a.appendChild(Icon.create("icon-title","pink",!1,"playlist-item-icon",null,Strings.TitleLabel));a.appendChild(document.createTextNode(Formatter.none));
b.appendChild(a);a=document.createElement("span");a.className="playlist-item-s-row1";a.appendChild(Strings.createSrOnlyText(Strings.DurationLabel));a.appendChild(document.createTextNode(Formatter.none));b.appendChild(a);a=document.createElement("span");a.className="playlist-item-row2";a.appendChild(Icon.create("icon-artist","orange",!1,"playlist-item-icon",null,Strings.ArtistLabel));a.appendChild(document.createTextNode(Formatter.none));b.appendChild(a);a=document.createElement("span");a.className=
"playlist-item-row3";a.appendChild(Icon.create("icon-album","green",!1,"playlist-item-icon",null,Strings.TrackAlbumLabel));var c=document.createElement("span");c.className="playlist-item-row3-track";c.appendChild(document.createTextNode(""));a.appendChild(c);c=document.createElement("span");c.className="sr-only";c.appendChild(document.createTextNode(" "));a.appendChild(c);a.appendChild(document.createTextNode(Formatter.none));b.appendChild(a);a=document.createElement("span");a.className="playlist-item-s-row3";
a.ariaHidden="true";a.appendChild(document.createTextNode(Formatter.none));b.appendChild(a);a=Icon.createSVG("icon-album").svg;a.classList.add("playlist-item-placeholder","white","disabled");a.ariaHidden="true";b.appendChild(a);return b}synchronizeElementToEnvironment(a,b,c,d){PlaylistAdapter.showAlbumArt?d.classList.add("album-art"):d.classList.remove("album-art");PlaylistAdapter.showIcons?d.classList.add("icons"):d.classList.remove("icons")}prepareElement(a,b,c,d){d=d.childNodes;d[0].childNodes[1].nodeValue=
a.title;d[1].childNodes[1].nodeValue=a.length;d[2].childNodes[1].nodeValue=a.artist;const e=0<a.track?"playlist-item-row3-track":"playlist-item-row3-track sr-only",f=d[3].childNodes[1];f.className!==e&&(f.className=e);f.childNodes[0].nodeValue=a.trackLabel;d[3].childNodes[3].nodeValue=a.album;d[4].firstChild.nodeValue=a.url||a.file?`${b+1} / ${c}`:`(${Strings.Missing}) ${b+1} / ${c}`}prepareElementIndexOrLengthChanged(a,b,c,d){d.childNodes[8].firstChild.nodeValue=a.url||a.file?`${b+1} / ${c}`:`(${Strings.Missing}) ${b+
1} / ${c}`}}PlaylistAdapter.showAlbumArt=!1;PlaylistAdapter.showIcons=!0;
...
(this._missingSongs.clear(),this._missingSongs=null);super.changeItems(a)}removeItems(a,b){if(this._missingSongs&&this.items&&0<=a&&a<this.items.length){const c=this._missingSongs,d=this.items;void 0===b||b>=d.length?b=d.length-1:b<a&&(b=a);for(let e=a;e<=b;e++){const f=d[e];if(!f.url&&!f.file&&f.fileName&&(c.delete(f.fileName+f.fileSize),!c.size)){this._missingSongs=null;break}}}return super.removeItems(a,b)}async addSong(a,b){let c,d=0;"string"!==typeof a?(c=a.fileURL,d=a.fileSize):c=a;if(!FileUtils.getSupportedExtensionInfoByPath(c))return!1;
a=await App.extractMetadata(c,d);if(!a)return!1;super.addItem(new Song(a),b);return!0}async addSongWeb(a,b,c,d){const e=FileUtils.getSupportedExtensionInfoByPath(a.name);if(!e)return!1;if(this._missingSongs){const f=a.name+a.size,g=this._missingSongs.get(f);if(g)return g.file=a,this._missingSongs.delete(f),this._missingSongs.size||(this._missingSongs=null),!0}a=await MetadataExtractor.extract(a,b,c,!1,e.customProvider);if(!a)return!1;super.addItem(new Song(a),d);return!0}findItems(a){a=Strings.removeDiacritics(a.trim()).split(" ");
for(var b=a.length-1;0<=b;b--)a[b]||a.splice(b,1);b=[];if(a.length){const c=this.items;for(let d=0;d<c.length;d++)c[d].normalizedInfoContainsAllTerms(a)&&b.push(c[d])}return b}}
...
class LibMikMod{static isSupported(){return"AudioWorklet"in window&&"AudioWorkletNode"in window&&"WebAssembly"in window}static createAudioWorkletNode(a){return new AudioWorkletNode(a,"libmikmodprocessor",{channelCount:2,channelCountMode:"explicit",channelInterpretation:"speakers",numberOfInputs:0,numberOfOutputs:1,outputChannelCount:[2]})}static async init(a,b){if(!(LibMikMod.initialized||LibMikMod.initializing||LibMikMod.initializationError)){b?b.endsWith("/")||(b+="/"):b="";LibMikMod.initializing=
!0;LibMikMod._currentId=0;try{const c=await (await fetch(b+"libmikmodclib.wasm?"+LibMikMod.WEB_VERSION)).arrayBuffer();await a.audioWorklet.addModule(b+"libmikmodprocessor.min.js?"+LibMikMod.WEB_VERSION);await new Promise(function(d,e){const f=LibMikMod.createAudioWorkletNode(a);f.port.onmessage=function(g){(g=g.data)&&g.messageId===LibMikModMessageId.INIT&&LibMikMod.initializing&&!LibMikMod._currentId&&(g.errorStr?e(g.errorStr):(LibMikMod.LIB_VERSION=(g.id>>>16&255)+"."+(g.id>>>8&255)+"."+(g.id&
255),d()))};f.onprocessorerror=function(g){e(g)};LibMikMod._audioNode=f;LibMikMod.postMessage({id:LibMikMod._currentId,messageId:LibMikModMessageId.INIT,buffer:c})});LibMikMod.initialized=!0}finally{LibMikMod.initialized||(LibMikMod.initializationError=!0),LibMikMod.initializing=!1,LibMikMod.stopModule()}}}static postMessage(a){LibMikMod._audioNode&&(a.buffer?LibMikMod._audioNode.port.postMessage(a,[a.buffer]):LibMikMod._audioNode.port.postMessage(a))}static loadModule(a){if(!LibMikMod.initialized)throw Error("Library not initialized");
if(!a)throw Error("Null options");if(!a.audioContext)throw Error("Null audioContext");const b=a.source;if(!b)throw Error("Null source");LibMikMod.stopModule();const c=LibMikMod.createAudioWorkletNode(a.audioContext);LibMikMod._currentId++;c.port.onmessage=LibMikMod.handleResponse;c.onprocessorerror=LibMikMod.notifyProcessorError;LibMikMod._audioNode=c;LibMikMod.infoSongName=null;LibMikMod.infoModType=null;LibMikMod.infoComment=null;LibMikMod._onload=a.onload;LibMikMod._onerror=a.onerror;LibMikMod._onended=
a.onended;const d=LibMikMod._currentId,e={hqMixer:a.hqMixer,wrap:a.wrap,loop:a.loop,fadeout:a.fadeout,reverb:a.reverb,interpolation:a.interpolation,noiseReduction:a.noiseReduction};if("lastModified"in b)if("arrayBuffer"in b)b.arrayBuffer().then(function(f){d===LibMikMod._currentId&&LibMikMod.postMessage({id:LibMikMod._currentId,messageId:LibMikModMessageId.LOAD_MODULE_BUFFER,buffer:f,options:e})},function(f){d===LibMikMod._currentId&&LibMikMod.notifyReaderError(f)});else{const f=new FileReader;f.onerror=
function(g){d===LibMikMod._currentId&&LibMikMod.notifyReaderError(g)};f.onload=function(){d===LibMikMod._currentId&&(f.result?LibMikMod.postMessage({id:LibMikMod._currentId,messageId:LibMikModMessageId.LOAD_MODULE_BUFFER,buffer:f.result,options:e}):LibMikMod.notifyReaderError("Empty reader result"))};f.readAsArrayBuffer(b)}else LibMikMod.postMessage({id:LibMikMod._currentId,messageId:LibMikModMessageId.LOAD_MODULE_BUFFER,buffer:b,options:e})}static changeGeneralOptions(a){if(!LibMikMod.initialized)throw Error("Library not initialized");
LibMikMod.postMessage({id:LibMikMod._currentId,messageId:LibMikModMessageId.CHANGE_GENERAL_OPTIONS,options:a})}static cleanUp(){LibMikMod._currentId++;LibMikMod.infoSongName=null;LibMikMod.infoModType=null;LibMikMod.infoComment=null;LibMikMod._audioNode&&LibMikMod._audioNode.port&&LibMikMod._audioNode.port.close();LibMikMod._audioNode=null;LibMikMod._onload=null;LibMikMod._onerror=null;LibMikMod._onended=null}static stopModule(){LibMikMod._audioNode&&(LibMikMod.postMessage({id:LibMikMod._currentId,
messageId:LibMikModMessageId.STOP_MODULE}),LibMikMod.cleanUp())}static notifyReaderError(a){LibMikMod.notifyError(LibMikMod.ERROR_FILE_READ,a)}static notifyProcessorError(a){LibMikMod.notifyError(LibMikMod.ERROR_PLAYBACK,a)}static notifyError(a,b){if(LibMikMod._audioNode){var c=LibMikMod._onerror;LibMikMod.stopModule();c&&c(a,b)}}static notifyEnded(){if(LibMikMod._audioNode){var a=LibMikMod._onended;LibMikMod.cleanUp();a&&a()}}static handleResponse(a){if(a=a.data)switch(a.messageId){case LibMikModMessageId.LOAD_MODULE_BUFFER:if(a.id!==
LibMikMod._currentId||!LibMikMod._audioNode)break;a.errorCode?LibMikMod.notifyError(LibMikMod.ERROR_MODULE_LOAD,a.errorStr||a.errorCode.toString()):(LibMikMod.infoSongName=a.infoSongName||null,LibMikMod.infoModType=a.infoModType||null,LibMikMod.infoComment=a.infoComment||null,LibMikMod._onload&&LibMikMod._onload(LibMikMod._audioNode));break;case LibMikModMessageId.PLAYBACK_ERROR:if(a.id!==LibMikMod._currentId)break;LibMikMod.notifyProcessorError(a.errorStr||a.errorCode?.toString());break;case LibMikModMessageId.PLAYBACK_ENDED:a.id===
LibMikMod._currentId&&LibMikMod.notifyEnded()}}}LibMikMod.WEB_VERSION=7;LibMikMod.LIB_VERSION=null;LibMikMod.ERROR_FILE_READ=1;LibMikMod.ERROR_MODULE_LOAD=2;LibMikMod.ERROR_PLAYBACK=3;LibMikMod.initialized=!1;LibMikMod.initializing=!1;LibMikMod.initializationError=!1;LibMikMod.infoSongName=null;LibMikMod.infoModType=null;LibMikMod.infoComment=null;LibMikMod._currentId=0;LibMikMod._audioNode=null;LibMikMod._onload=null;LibMikMod._onerror=null;LibMikMod._onended=null;
...
class ListControl extends HTMLElement{constructor(){super();this._useVirtualItems=!0;this._adapter=null;this._boundZoomChanged=this.zoomChanged.bind(this);this._boundRefreshVisibleItemsInternal=this.refreshVisibleItemsInternal.bind(this);this._boundAdjustScrollbarPaddingFromResize=this.adjustScrollbarPaddingFromResize.bind(this);this._boundScrollStopIntervalHandler=this.scrollStopIntervalHandler.bind(this);var a=document.createElement("div");a.className="f-list-container";this._container=a;a=document.createElement("div");
a.className="f-list-empty-message";this._emptyMessageAdded=!1;this._emptyMessage=a;this._useVirtualItems||(this._boundNotifyCurrentItemChangedInternal=this.notifyCurrentItemChangedInternal.bind(this));this._resizeObserver=new ResizeObserver(this.resize.bind(this));this._itemMargin=this._itemHeight=1;this._itemHeightAndMargin=2;this._ignoreFirstIndex=!1;this._lastIndex=this._firstIndex=0;this._keyboardItem=this._currentItem=this._currentListItem=null;this._clientHeight=1;this._containerHeight=0;this._scrollbarPaddingScheduled=
this._scrollbarPadding=!1;this._visibleCount=1;this._items=[];this._focused=this._initialized=this._notifyCurrentItemChangedEnqueued=this._refreshVisibleItemsEnqueued=!1;this._lastKeyboardIndex=this._keyboardIndex=-1;this._scrollStopInterval=this._lastScrollTime=0;this.deleteMode=!1;this.onscrollstop=this.onscrollstart=this.onitemcontextmenu=this.onitemcontrolclick=this.onitemclick=null}destroy(){this._adapter&&(this._adapter.control=null);this._resizeObserver&&this._resizeObserver.unobserve(this);
this._scrollStopInterval&&(clearInterval(this._scrollStopInterval),this._scrollStopInterval=0);this._items&&this._items.fill(null);this._boundZoomChanged&&AppUI.removeZoomHandler(this._boundZoomChanged);zeroObject(this)}get adapter(){return this._adapter}set adapter(a){this._adapter!==a&&(this._adapter&&(this._adapter.control=null),this._adapter=a,this.clear(),a&&(a.control=this,this.prepareAdapter(),this._useVirtualItems?this.ariaRowCount=a.list.length.toString():a.list.length&&this.notifyItemsAdded(0,
a.list.length-1)))}get emptyMessage(){return(this._emptyMessage?this._emptyMessage.textContent:null)||""}set emptyMessage(a){this._emptyMessage&&(this._emptyMessage.textContent=a)}prepareAdapter(){const a=this._adapter;a&&(this._itemHeight=a.itemHeight,this._itemMargin=AppUI.thickBorderPX,this._itemHeightAndMargin=this._itemHeight+this._itemMargin,this._currentListItem=a.list.currentItem,this.adjustContainerHeight(),this.resize())}zoomChanged(){if(this._adapter){this.prepareAdapter();var a=this._items;
for(let b=a.length-1;0<=b;b--)a[b].index=-1;this._useVirtualItems&&this.elementScroll()}}adjustScrollbarPadding(){const a=(this._containerHeight|0)>this._clientHeight;this._scrollbarPadding!==a&&(this._scrollbarPadding=a,this._useVirtualItems?a?this.classList.add("virtual-padding"):this.classList.remove("virtual-padding"):this.style.padding=a?"":"0")}adjustScrollbarPaddingFromResize(){this._scrollbarPaddingScheduled=!1;this.adjustScrollbarPadding()}adjustContainerHeight(){var a=this._adapter;const b=
this._container;if(a&&b){var c=(a=a.list.length)?a*this._itemHeightAndMargin-this._itemMargin:0;this._containerHeight!==c&&(this._containerHeight=c,b.style.height=c+"px",this.adjustScrollbarPadding(),a?this._emptyMessageAdded&&(this._emptyMessageAdded=!1,this.removeChild(this._emptyMessage)):this._emptyMessageAdded||(this._emptyMessageAdded=!0,this.appendChild(this._emptyMessage)))}}clear(){if(this._container){var a=this._items;for(var b=a.length-1;0<=b;b--)if(a[b].element){const c=a[b].element.parentNode;
c&&c.removeChild(a[b].element)}if(this._useVirtualItems)for(b=a.length-1;0<=b;b--)a[b].reset();else{for(b=a.length-1;0<=b;b--)a[b].zero();a.splice(0)}this._lastIndex=this._firstIndex=0;this._keyboardItem=this._currentItem=this._currentListItem=null;this._containerHeight=this.scrollTop=0;this._container.style.height="0";this._emptyMessageAdded||(this._emptyMessageAdded=!0,this.appendChild(this._emptyMessage));this._lastKeyboardIndex=0<this._keyboardIndex?this._keyboardIndex=0:-1;this.ariaRowCount=
"0";this.removeAttribute("aria-activedescendant");this.adjustScrollbarPadding()}}scrollStopIntervalHandler(){if(this._scrollStopInterval&&150<=Date.now()-this._lastScrollTime&&(clearInterval(this._scrollStopInterval),this._scrollStopInterval=0,this.onscrollstop))this.onscrollstop()}elementScroll(){if(this.onscrollstop&&(this._lastScrollTime=Date.now(),!this._scrollStopInterval&&(this._scrollStopInterval=setInterval(this._boundScrollStopIntervalHandler,40),this.onscrollstart)))this.onscrollstart();
var a=this._adapter;if(a){var b=this._items,c=this._itemHeightAndMargin,d=this._firstIndex-2,e=this.scrollTop/c|0;0>d&&(d=0);if(this._ignoreFirstIndex)this._ignoreFirstIndex=!1;else if(this._firstIndex===e)return;this._firstIndex=e;var f=this._visibleCount+(0===e?2:1===e?3:4);f>b.length&&(f=b.length);0>(e-=2)&&(e=0);if(e>d){if((d=e-d)&&d<f)for(let m=d,l=0;m<f;m++,l++)d=b[l],b[l]=b[m],b[m]=d}else if((d-=e)&&d<f)for(let m=f-1,l=m-d;0<=l;l--,m--)d=b[m],b[m]=b[l],b[l]=d;var g=a.list,h=g.length,k=a.list.currentItem,
n=this._keyboardIndex;d=0;for(let m=e*c;d<f&&e<h;d++,e++,m+=c){const l=g.item(e),p=b[d];if(p.item!==l){let r=k===l;p.current!==r&&((p.current=r)?p.element.classList.add("current"):p.element.classList.remove("current"));r=n===e;p.keyboard!==r&&((p.keyboard=r)?(p.element.classList.add("keyboard"),p.element.ariaSelected="true",this.setAttribute("aria-activedescendant",p.element.id)):(this.getAttribute("aria-activedescendant")===p.element.id&&this.removeAttribute("aria-activedescendant"),p.element.classList.remove("keyboard"),
p.element.ariaSelected="false"));a.prepareElement(l,e,h,p.element);p.element.ariaRowIndex=e.toString();p.item||this.appendChild(p.element);p.item=l}p.index!==e&&(p.index=e,p.element.style.transform="translateY("+m+"px)")}for(a=b.length;d<a;d++)c=b[d],c.item&&(c.item=null,this.removeChild(c.element));this._lastIndex=e-1;this._lastIndex<this._firstIndex&&(this._lastIndex=this._firstIndex)}}refreshVisibleItemsInternal(){this._refreshVisibleItemsEnqueued=!1;var a=this._adapter;if(a){this.adjustContainerHeight();
var b=this._items,c=this._itemHeightAndMargin,d=a.list,e=d.length,f=a.list.currentItem,g=this._keyboardIndex;if(this._useVirtualItems){this._currentListItem=f;var h=0,k=this._firstIndex,n=this._visibleCount+(0===k?2:1===k?3:4);n>b.length&&(n=b.length);0>(k-=2)&&(k=0);for(let m=k*c;h<n&&k<e;h++,k++,m+=c){const l=d.item(k),p=b[h];let r=f===l;p.current!==r&&((p.current=r)?p.element.classList.add("current"):p.element.classList.remove("current"));r=g===k;p.keyboard!==r&&((p.keyboard=r)?(p.element.classList.add("keyboard"),
p.element.ariaSelected="true",this.setAttribute("aria-activedescendant",p.element.id)):(this.getAttribute("aria-activedescendant")===p.element.id&&this.removeAttribute("aria-activedescendant"),p.element.classList.remove("keyboard"),p.element.ariaSelected="false"));a.prepareElement(l,k,e,p.element);p.element.ariaRowIndex=k.toString();p.item||this.appendChild(p.element);p.item=l;p.index!==k&&(p.index=k,p.element.style.transform="translateY("+m+"px)")}for(a=b.length;h<a;h++)d=b[h],d.item&&(d.item=null,
this.removeChild(d.element))}else{h=this._visibleCount;g=0<=g&&g<b.length?b[g]:null;this._keyboardItem!==g&&(this._keyboardItem&&(this._keyboardItem.element.classList.remove("keyboard"),this._keyboardItem.element.ariaSelected="false"),g?(g.element.classList.add("keyboard"),g.element.ariaSelected="true",this.setAttribute("aria-activedescendant",g.element.id)):this.removeAttribute("aria-activedescendant"),this._keyboardItem=g);for(let m=0,l=this.indexFromY(0);m<=h&&l<e;m++,l++)g=b[l].element,a.prepareElement(d.item(l),
l,e,g),g.ariaRowIndex=l.toString()}}}resize(){const a=this._adapter;if(a){var b=this._clientHeight,c=this.clientHeight;0>c&&(c=0);var d=Math.ceil(c/this._itemHeightAndMargin)+1;if(this._visibleCount!==d&&(this._visibleCount=d,this._useVirtualItems)){const e=this._items;for(;d+4>e.length;)e.push(new ListControlItem(a.createEmptyElement("f-list-item virtual")))}b!==c&&(this._clientHeight=c,this._useVirtualItems&&(this._ignoreFirstIndex=!0,this.elementScroll()),this._scrollbarPaddingScheduled||(this._scrollbarPaddingScheduled=
!0,requestAnimationFrame(this._boundAdjustScrollbarPaddingFromResize)))}}elementClick(a){if(this._adapter&&a.target){var b=this.getBoundingClientRect();b=this.indexFromY(a.clientY-b.top);0<=this._keyboardIndex&&(this._keyboardIndex=-1,this.refreshVisibleItems());if(0<=b){this._lastKeyboardIndex=b;const c=this._adapter.list.item(b);if(c)if(a.target.classList.contains("f-list-item"))if(this.deleteMode)this._adapter.list.removeItems(b,b);else{if(this.onitemclick)this.onitemclick(c,b,a.button)}else if(this.onitemcontrolclick)this.onitemcontrolclick(c,
b,a.button,a.target)}}}elementContextMenu(a){if(!this._adapter||!this.onitemcontextmenu||!a.target)return cancelEvent(a);var b=this.getBoundingClientRect();b=this.indexFromY(a.clientY-b.top);0<=this._keyboardIndex&&(this._keyboardIndex=-1,this.refreshVisibleItems());if(0<=b){this._lastKeyboardIndex=b;const c=this._adapter.list.item(b);if(c)this.onitemcontextmenu(c,b)}return cancelEvent(a)}elementFocus(){this._focused=!0}elementKeyDown(a){var b=this._adapter;if(!(!b||a.ctrlKey||a.metaKey||a.shiftKey||
a.altKey)){var c=0,d=0;switch(a.key){case "ArrowDown":case "ArrowRight":c=1;break;case "ArrowUp":case "ArrowLeft":c=-1;break;case "PageDown":c=this._clientHeight/this._itemHeightAndMargin|0;break;case "PageUp":c=-(this._clientHeight/this._itemHeightAndMargin|0);break;case "Home":d=-1;break;case "End":d=1;break;case "Enter":a.repeat||(d=2);break;case " ":a.repeat||(d=3);break;default:return}var e=b.list.length;if(0<e){let f=this._keyboardIndex;0>f&&(f=this._lastKeyboardIndex);this.isItemVisible(f)||
(f=this.isItemVisible(b.list.currentIndex)?b.list.currentIndex:this.indexFromY(0));f=Math.min(e-1,Math.max(0,f));if(-1===d)f=0;else if(1===d)f=e-1;else{const g=f;f+=c;0>f?f=g?0:e-1:f>=e&&(f=g===e-1?0:e-1)}this._keyboardIndex=f;this.bringItemIntoView(f);this.refreshVisibleItems();if(1<d&&(c=b.list.item(f)))switch(d){case 2:if(this.deleteMode)b.list.removeItems(f,f);else if(this.onitemclick)this.onitemclick(c,f,0);break;case 3:if(this.deleteMode)b.list.removeItems(f,f);else if(this.onitemcontrolclick&&
(b=this.listControlItemFromIndex(f)))this.onitemcontrolclick(c,f,0,b.element)}}else this._keyboardIndex=-1;return cancelEvent(a)}}elementKeyUp(a){const b=this._adapter;b&&!a.ctrlKey&&!a.metaKey&&!a.altKey&&"Tab"===a.key&&this._focused&&(a=b.list.length)&&(a=Math.min(a-1,Math.max(0,this._lastKeyboardIndex)),this.isItemVisible(a)||(a=this.isItemVisible(b.list.currentIndex)?b.list.currentIndex:this.indexFromY(0)),this._keyboardIndex=a,this.bringItemIntoView(a),this.refreshVisibleItems())}elementBlur(){this._focused=
!1;this._lastKeyboardIndex=this._keyboardIndex;0<=this._keyboardIndex&&(this._keyboardIndex=-1,this.refreshVisibleItems())}listControlItemFromIndex(a){if(!this._items)return null;const b=this._items;for(let c=b.length-1;0<=c;c--)if(b[c].index===a&&b[c].item&&b[c].element)return b[c];return null}yFromIndex(a){return a*this._itemHeightAndMargin-this.scrollTop}indexFromY(a){if(!this._adapter)return-1;a=(a+this.scrollTop+.9)/this._itemHeightAndMargin|0;return 0>a||a>=this._adapter.list.length?-1:a}isItemVisible(a){a=
this.yFromIndex(a);return a>-this._itemHeight&&a<this._clientHeight}bringItemIntoView(a,b){const c=this.yFromIndex(a);0>c?b?this.centerItemIntoView(a):this.scrollTop+=c:c>this._clientHeight-this._itemHeight&&(b?this.centerItemIntoView(a):this.scrollTop+=c-(this._clientHeight-this._itemHeight))}centerItemIntoView(a){this.scrollTop=a*this._itemHeightAndMargin-(this._clientHeight-this._itemHeight>>1)}refreshVisibleItems(){this._refreshVisibleItemsEnqueued||(this._refreshVisibleItemsEnqueued=!0,queueMicrotask(this._boundRefreshVisibleItemsInternal))}synchronizeElementsToEnvironment(){const a=
this._adapter;if(a){var b=this._items,c=a.list.length;for(let d=b.length-1;0<=d;d--){const e=b[d];e&&e.item&&e.element&&a.synchronizeElementToEnvironment(e.item,e.index,c,e.element)}}}notifyCleared(){this.clear()}notifyItemsAdded(a,b){if(this._useVirtualItems)this.refreshVisibleItems();else{const g=this._adapter;var c=b-a+1;if(!g||0>=c)return;const h=this._items,k=g.list,n=k.length;var d=k.currentItem,e=Array(c);for(var f=b;f>=a;f--){const m=k.item(f),l=new ListControlItem(g.createEmptyElement("f-list-item real"));
g.prepareElement(m,f,n,l.element);l.element.ariaRowIndex=f.toString();e[f-a]=l;d===m&&(this._currentItem&&(this._currentItem.current=!1,this._currentItem.element.classList.remove("current")),this._currentItem=l,l.current=!0,l.element.classList.add("current"))}d=a>=h.length?null:h[a].element;a>=h.length?h.push(...e):h.splice(a,0,...e);if(this._items.length!==k.length)throw Error("Assertion error: this.items.length !== list.length");this.adjustContainerHeight();for(f=0;f<c;f++)this.insertBefore(e[f].element,
d);for(c=h.length-1;c>b;c--)e=h[c].element,g.prepareElementIndexOrLengthChanged(k.item(c),c,n,e),e.ariaRowIndex=c.toString();for(--a;0<=a;a--)b=h[a].element,g.prepareElementIndexOrLengthChanged(k.item(a),a,n,b),b.ariaRowIndex=a.toString()}this._adapter&&(this.ariaRowCount=this._adapter.list.length.toString())}notifyItemsRemoved(a,b){if(this._useVirtualItems)this.refreshVisibleItems();else{const d=this._adapter;var c=b-a+1;if(!d||0>=c)return;b=this._items;const e=d.list,f=e.length;a=b.splice(a,c);
for(c=a.length-1;0<=c;c--){const g=a[c];g.current&&(this._currentItem=null);this.removeChild(g.element);g.zero()}if(this._items.length!==e.length)throw Error("Assertion error: this.items.length !== list.length");for(a=b.length-1;0<=a;a--)c=b[a].element,d.prepareElementIndexOrLengthChanged(e.item(a),a,f,c),c.ariaRowIndex=a.toString();this.adjustContainerHeight()}this._adapter&&(this.ariaRowCount=this._adapter.list.length.toString())}notifyCurrentItemChanged(a,b){this._useVirtualItems?this.refreshVisibleItems():
this._notifyCurrentItemChangedEnqueued||(this._notifyCurrentItemChangedEnqueued=!0,queueMicrotask(this._boundNotifyCurrentItemChangedInternal))}notifyCurrentItemChangedInternal(){this._notifyCurrentItemChangedEnqueued=!1;var a=this._adapter;a&&(this._currentItem&&(this._currentItem.current=!1,this._currentItem.element.classList.remove("current")),a=a.list.currentIndex,0<=a&&a<this._items.length?(this._currentItem=this._items[a],this._currentItem.current=!0,this._currentItem.element.classList.add("current")):
this._currentItem=null)}connectedCallback(){if(!this._initialized){this._initialized=!0;this.classList.add("scrollable");this.style.padding="0";this.role="grid";this.ariaReadOnly="true";this.ariaRowCount="0";this.removeAttribute("aria-activedescendant");if(!this.tabIndex||0>=this.tabIndex)this.tabIndex=0;this._useVirtualItems&&this.appendChild(this._container);this._emptyMessageAdded||(this._emptyMessageAdded=!0,this.appendChild(this._emptyMessage));this.addEventListener("focus",this.elementFocus.bind(this));
this.addEventListener("keydown",this.elementKeyDown.bind(this));this.addEventListener("keyup",this.elementKeyUp.bind(this));this.addEventListener("blur",this.elementBlur.bind(this));this._useVirtualItems&&this.addEventListener("scroll",this.elementScroll.bind(this),{passive:!0});this._resizeObserver.observe(this,{box:"border-box"});this.addEventListener("click",this.elementClick.bind(this));this.addEventListener("contextmenu",this.elementContextMenu.bind(this));this.resize();AppUI.addZoomHandler(this._boundZoomChanged)}}}
customElements.define("f-list",ListControl);var SliderControlValueChild;(function(a){a[a.None=0]="None";a[a.LeftChild=1]="LeftChild";a[a.RightChild=2]="RightChild"})(SliderControlValueChild||(SliderControlValueChild={}));
...
null;this.recreateAudioPath();this._mediaSession=c||null;b&&(this.playlist=b)}createAudioBundle(a,b){const c=b||document.createElement("audio");b="customProvider"in c?c.audioNode:this.audioContext.createMediaElementSource(c);b=new SourceNode(b);var d=a?(g,h,k,n,m)=>{this._audio===c?this.playbackError(g,h,k,n,m):this._nextAudioBundle&&this._nextAudioBundle.audio&&this._nextAudioBundle.audio===c&&this._nextAudioBundle.nextSong===a&&(this._nextSongLoading=!1,this._nextSongLoadedWithError=!0)}:(g,h,k,
n,m)=>{this._audio===c&&this.playbackError(g,h,k,n,m)};const e={audio:c,sourceNode:b,nextSong:a,boundPlaybackError:d};"customProvider"in c||(c.style.pointerEvents="none",c.style.position="absolute",c.style.left="0",c.style.top="0",c.style.zIndex="-1",c.loop=!1,c.controls=!1,c.autoplay=!1,document.body.appendChild(c));const f=()=>{this._audio===c&&this.playbackLoadStart()};c.onwaiting=f;c.onloadstart=f;c.oncanplay=a?()=>{this._audio===c?(this.playbackLoadEnd(),this._nextSongToPlayAfterLoading&&(this._nextSongToPlayAfterLoading===
a&&(this._nextSongLoadedWithError=this._nextSongLoading=!1,this.nextSongPerformFinalPlaybackSteps()),this._nextSongToPlayAfterLoading=null)):this._playlist&&this._nextAudioBundle&&this._nextAudioBundle.audio&&this._nextAudioBundle.audio===c&&this._nextAudioBundle.nextSong===a&&(this._nextSongLoadedWithError=this._nextSongLoading=!1)}:()=>{this._audio===c&&this.playbackLoadEnd()};c.onended=()=>{this._audio===c&&this.playbackEnd()};c.onerror=d;c.onpause=()=>{this._audio===c&&this.playbackPaused()};
c.onplaying=()=>{this._audio===c&&this.playbackStarted()};d=()=>{this._audio===c&&this.playbackAborted()};c.onabort=d;c.onemptied=d;c.ondurationchange=()=>{this._audio===c&&this.playbackLengthChange()};c.ontimeupdate=()=>{this._audio===c&&this.currentTimeChange()};b.enabled=!0;return e}destroyAudioElement(a,b,c){if(a)if("customProvider"in a)a.destroy();else{if(b){for(;a.firstChild;)a.removeChild(a.firstChild);a.load()}c&&a.parentNode&&a.parentNode.removeChild(a)}}recreateAudioPath(a){this.suspendAudioContext(!1);
const b=this._intermediateNodes;this._sourceNode&&this._sourceNode.disconnectFromDestination();for(let f=b.length-1;0<=f;f--)b[f].disconnectFromDestination();this.destroyAudioElement(this._audio,!1,!0);const {audio:c,sourceNode:d,boundPlaybackError:e}=this.createAudioBundle(null,a);this._audio=c;this._sourceNode=d;this._boundPlaybackError=e;if(b.length){d.connectToDestination(b[0]);for(a=0;a<b.length-1;a++)b[a].connectToDestination(b[a+1]);b[b.length-1].connectToDestination(this._destinationNode)}else d.connectToDestination(this._destinationNode);
this.volume=this._volume}destroy(a){this.stop();if(a){if(this._alive=!1,this._sourceNode&&this._sourceNode.disconnectFromDestination(),(a=this._intermediateNodes)&&a.length)for(let b=a.length-1;0<=b;b--)a[b].disconnectFromDestination()}else this._playlist&&this._playlist.destroy(),(a=this._mediaSession)&&a.cleanUpMediaSession&&a.cleanUpMediaSession(),zeroObject(this)}get alive(){return this._alive}get loading(){return this._loading}get paused(){return this._paused}get volume(){return this._volume}set volume(a){this._volume=
Math.max(Player.minVolume,Math.min(0,a|0));this._audio&&(this._audio.volume=a<=Player.minVolume?0:Math.pow(10,this._volume/20))}get playlist(){return this._playlist}set playlist(a){if(this._alive){var b=this._currentPlaylistSong;this.stop();if(this._playlist=a)this._currentPlaylistSong=a.currentItem,0<a.currentIndexResumeTimeS&&this._currentPlaylistSong?(this._songToResumeTime=this._currentPlaylistSong,this._lastTimeS=a.currentIndexResumeTimeS):this._lastTimeS=0;b!==this._currentPlaylistSong&&this.notifySongChange()}}get currentSong(){return this._currentPlaylistSong}get currentTimeMS(){if(this._loadedSong&&
this._audio)try{const a=this._audio.currentTime||0;this._lastTimeS=a;return 1E3*a|0}catch(a){}return 1E3*this._lastTimeS|0}handleError(a){const b=this._lastTimeS;this.stop();this.recreateAudioPath();if(this.haltOnAllErrors){if(this.onerror)this.onerror(a)}else{var c=!1;this._playlist&&this._playlist.length?0>b&&((c=!this._songStartedAutomatically)?this._firstFailedSongIndex=-1:0>this._firstFailedSongIndex||this._firstFailedSongIndex>=this._playlist.length?this._firstFailedSongIndex=this._playlist.currentIndex:
this._firstFailedSongIndex===this._playlist.currentIndex&&(this._firstFailedSongIndex=-1,c=!0)):c=!0;if(c&&this.onerror)this.onerror(a);else queueMicrotask(this._boundAutoNext)}}audioContextStateChange(){this._alive&&"running"!==this.audioContext.state&&!this._audioContextSuspended&&(this._audioContextSuspended=!0,this.playbackPaused())}playbackLoadStart(){if(this._alive&&!this._loading){this._loading=!0;if(this.onloadingchange)this.onloadingchange(!0);this._mediaSession&&this._mediaSession.setLoading(!0,
this._currentPlaylistSong?this._currentPlaylistSong.lengthMS:0,this._lastTimeS)}}playbackLoadEnd(){if(this._alive&&this._loading){this._loading=!1;if(this._songToResumeTime){if(this._audio&&this._songToResumeTime===this._loadedSong&&0<this._resumeTimeS){try{this._audio.currentTime=this._resumeTimeS}catch(b){}const a=this._audio.play();a&&a.catch(Player._nop)}this._songToResumeTime=null}if(this.onloadingchange)this.onloadingchange(!1);this._mediaSession&&this._mediaSession.setLoading(!1,this._currentPlaylistSong?
this._currentPlaylistSong.lengthMS:0,this._lastTimeS)}}playbackEnd(){this._alive&&this.next(!0)}playbackError(a,b,c,d,e){this._alive&&this.handleError(e?e.message?e.message:"string"===typeof e?e:e.toString():"string"===typeof a?a:Strings.UnknownError)}suspendAudioContext(a){this._audioContextTimeout&&(clearTimeout(this._audioContextTimeout),this._audioContextTimeout=0);this._audioContextSuspended||(a?this._audioContextTimeout=window.setTimeout(this._boundCheckAudioContext,5E3):(this._audioContextSuspended=
!0,this.audioContext.suspend()))}resumeAudioContext(){this._audioContextTimeout&&(clearTimeout(this._audioContextTimeout),this._audioContextTimeout=0);if(this._audioContextSuspended||"running"!==this.audioContext.state)this._audioContextSuspended=!1,this.audioContext.resume()}checkAudioContext(){this._audioContextTimeout=0;this._paused?this._audioContextSuspended||(this._audioContextSuspended=!0,this.audioContext.suspend()):this._audioContextSuspended&&(this._audioContextSuspended=!1,this.audioContext.resume())}playbackPaused(){if(this._alive&&
!this._paused){this._paused=!0;this.suspendAudioContext(!0);if(this._audio)try{this._lastTimeS=this._audio.currentTime||0}catch(a){}if(this.onpausedchange)this.onpausedchange(!0);this._mediaSession&&this._mediaSession.setPaused(!0,this._currentPlaylistSong?this._currentPlaylistSong.lengthMS:0,this._lastTimeS)}}playbackStarted(){if(this._alive&&this._paused){if(this._mutedByHeadsetRemoval&&(this._mutedByHeadsetRemoval=!1,this._audio)){this._audio.pause();this._audio.muted=!1;return}this._firstFailedSongIndex=
-1;this._paused=!1;this.resumeAudioContext();if(this._audio)try{this._lastTimeS=this._audio.currentTime||0}catch(a){}if(this.onpausedchange)this.onpausedchange(!1);this._mediaSession&&this._mediaSession.setPaused(!1,this._currentPlaylistSong?this._currentPlaylistSong.lengthMS:0,this._lastTimeS)}}playbackAborted(){if(this._alive){if(this._loading){this._loading=!1;if(this.onloadingchange)this.onloadingchange(!1);this._mediaSession&&this._mediaSession.setLoading(!1,this._currentPlaylistSong?this._currentPlaylistSong.lengthMS:
0,0)}if(!this._paused){this._paused=!0;this.suspendAudioContext(!0);if(this.onpausedchange)this.onpausedchange(!0);this._mediaSession&&this._mediaSession.setPaused(!0,this._currentPlaylistSong?this._currentPlaylistSong.lengthMS:0,0)}}}playbackLengthChange(){this._alive&&this._audio&&this._playlist&&this._loadedSong&&this._playlist.updateSongLength(this._loadedSong,this._audio.duration)&&this.notifySongChange()}currentTimeChange(){if(this._alive&&this._audio&&this._loadedSong){try{this._lastTimeS=
this._audio.currentTime||0}catch(a){}if(this.oncurrenttimeschange)this.oncurrenttimeschange(this._lastTimeS)}}notifyMediaSessionChange(){if(this._mediaSession){var a=this._currentPlaylistSong;a?this._mediaSession.setMetadata(a.id,a.title,a.artist,a.album,a.track,a.year,a.lengthMS,this._lastTimeS):this._mediaSession.setMetadata(0,null,null,null,0,0,0,0)}}notifyCurrentTimeSChange(){if(this._alive){if(this.oncurrenttimeschange)this.oncurrenttimeschange(this._lastTimeS);this.notifyMediaSessionChange()}}notifySongChange(){if(this._alive){if(this.onsongchange)this.onsongchange(this._currentPlaylistSong,
this._lastTimeS);this.notifyMediaSessionChange()}}destroyNextAudioBundle(){this._nextSongVersion++;this._nextSongObjectURL&&(URL.revokeObjectURL(this._nextSongObjectURL),this._nextSongObjectURL=null);if(this._nextAudioBundle){const a=this._nextAudioBundle;this._nextAudioBundle=null;this.destroyAudioElement(a.audio,!0,!0);zeroObject(a,!0)}this._nextSongLoadedWithError=this._nextSongLoading=!1;this._nextSongAlreadyChecked=this._nextSongToPlayAfterLoading=null}preloadNextSong(){if(this._alive&&this._playlist){var a=
this._playlist.nextItem;if(this._nextSongAlreadyChecked!==a&&(this.destroyNextAudioBundle(),(this._nextSongAlreadyChecked=a)&&!a.customProvider&&(a.isLocalURL||a.isFileURL)))try{const b=this._nextSongVersion,c=this.createAudioBundle(a),d=c.boundPlaybackError;this._nextAudioBundle=c;this._nextSongLoading=!0;this._nextSongToPlayAfterLoading=null;const e=f=>{if(b===this._nextSongVersion)if(c.audio){f||(this._nextSongObjectURL=URL.createObjectURL(a.file));var g=document.createElement("source");g.src=
f||this._nextSongObjectURL;g.onerror=d;c.audio.appendChild(g);c.audio.load()}else this._audio&&(f||(this._lastObjectURL=URL.createObjectURL(a.file)),g=document.createElement("source"),g.src=f||this._lastObjectURL,g.onerror=d,this._audio.appendChild(g),this._audio.load())};a.file||a.isFileURL?e(a.file?null:a.url):FileSystemAPI.getFile(a.absolutePath).then(f=>{if(this._playlist&&b===this._nextSongVersion){if(!this._nextAudioBundle){if(!this._nextSongLoading||this._nextSongToPlayAfterLoading!==a)return}else if(this._nextAudioBundle!==
c||this._nextAudioBundle.nextSong!==a)return;f?(a.file=f,e(null)):d(Strings.FileNotFoundOrNoPermissionError)}},f=>{d(Strings.UnknownError,void 0,void 0,void 0,f)})}catch(b){this.destroyNextAudioBundle()}}}nextSongPerformFinalPlaybackSteps(){this.resumeAudioContext();this._audio.play().catch(Player._nop);this.playbackLengthChange()}setPlaylistData(){const a=this._playlist;a&&(a.currentIndexResumeTimeS=this._lastTimeS)}previous(a){this._alive&&this._playlist&&(this._playlist.moveCurrentToPrevious(),
this.play(-1,a))}seekBackward(){this._alive&&this.seekTo(-1E4,!0)}pause(){this._alive&&(this.suspendAudioContext(!1),this._loadedSong&&this._audio&&this._audio.pause())}playCustomProvider(a){a.customProvider&&(a=a.customProvider.createAudioElement(this.audioContext,a,()=>this.suspendAudioContext(!1),()=>this.resumeAudioContext()),this.recreateAudioPath(a),a.load(),a.play().catch(Player._nop))}play(a,b){if(this._alive&&this._audio){this._mutedByHeadsetRemoval&&this._audio&&(this._mutedByHeadsetRemoval=
!1,this._audio.muted=!1);if(this._loadedSong&&void 0===a){this.resumeAudioContext();var c=this._audio.play()}else if(this._playlist){void 0!==a&&0<=a&&(this._playlist.currentIndex=a);a=this._playlist.currentItem;!a&&this._playlist.length&&(this._playlist.moveCurrentToNext(),a=this._playlist.currentItem);if(!a){this.stop();return}this._loadedSong=a;this._resumeTimeS=this._lastTimeS;this._lastTimeS=-1;this._songStartedAutomatically=!!b;this._currentPlaylistSong!==a&&(this._currentPlaylistSong=a,queueMicrotask(this._boundNotifySongChange));
this._nextSongToPlayAfterLoading=null;if(this._nextAudioBundle){var d=this._nextAudioBundle;if(d.nextSong===a&&!this._nextSongLoadedWithError){c=this._audio;this._resumeTimeS=-1;this._songToResumeTime=null;this._lastObjectURL&&URL.revokeObjectURL(this._lastObjectURL);this._lastObjectURL=this._nextSongObjectURL;this._nextAudioBundle=this._nextSongObjectURL=null;this._nextSongLoading?(this.pause(),this.playbackLoadStart(),this._nextSongToPlayAfterLoading=a):this._audio.pause();this._sourceNode&&this._sourceNode.disconnectFromDestination();
this._sourceNode=d.sourceNode;this._sourceNode.connectToDestination(this._intermediateNodes.length?this._intermediateNodes[0]:this._destinationNode);this._audio=d.audio;this.volume=this._volume;this._nextSongLoading||this.nextSongPerformFinalPlaybackSteps();zeroObject(d,!0);this.destroyAudioElement(c,!0,!0);return}}this.destroyNextAudioBundle();if("customProvider"in this._audio)this._audio.destroy(),a.customProvider||this.recreateAudioPath();else for(;this._audio.firstChild;)this._audio.removeChild(this._audio.firstChild);
if(a.customProvider){this.playCustomProvider(a);return}this.resumeAudioContext();d=document.createElement("source");if(a.url&&!a.isLocalURL)d.src=a.url;else if(a.file)this._lastObjectURL&&URL.revokeObjectURL(this._lastObjectURL),this._lastObjectURL=URL.createObjectURL(a.file),d.src=this._lastObjectURL;else{if(a.url){this.pause();const e=this._playlist.currentIndex,f=this._playlist.currentItem;FileSystemAPI.getFile(a.absolutePath).then(g=>{f&&!f.file&&g&&(f.file=g);this._playlist&&e===this._playlist.currentIndex&&
f===this._playlist.currentItem&&(g?(this._lastTimeS=this._resumeTimeS,this.play(e,b)):this.handleError(Strings.FileNotFoundOrNoPermissionError))},()=>{this._playlist&&e===this._playlist.currentIndex&&f===this._playlist.currentItem&&this.handleError(Strings.FileNotFoundOrNoPermissionError)})}else this.handleError(Strings.MissingSongError);return}d.onerror=this._boundPlaybackError;this._audio.appendChild(d);this._audio.load();if(this._songToResumeTime!==a||!this._resumeTimeS||0>=this._resumeTimeS)c=
this._audio.play()}c&&c.catch(Player._nop)}}playSongId(a,b){if(!this._alive||!this._audio||!this._playlist)return!1;a=this._playlist.findIndexById(a);return 0<=a?(this.play(a,b),!0):!1}playPause(){this._alive&&this._audio&&(!this._loadedSong||this._audio.paused?this.play():this.pause())}stop(){if(this._alive&&this._audio){this._songToResumeTime=this._loadedSong=null;this._lastTimeS=-1;this.destroyNextAudioBundle();if(this._currentPlaylistSong){this.destroyAudioElement(this._audio,!0,!1);this._lastObjectURL&&
...
a&&((AppUI._extraRGBMode=a)?(AppUI._rgbMode=!0,document.body.classList.add("rgb"),document.body.classList.add("rgb-extra")):document.body.classList.remove("rgb-extra"))}static get neonMode(){return AppUI._neonMode}static set neonMode(a){AppUI._neonMode!==a&&((AppUI._neonMode=a)?document.body.classList.add("neon"):document.body.classList.remove("neon"))}static get showPlaylistAlbumArt(){return PlaylistAdapter.showAlbumArt}static set showPlaylistAlbumArt(a){PlaylistAdapter.showAlbumArt!==a&&(PlaylistAdapter.showAlbumArt=
a,AppUI._playlistControl.synchronizeElementsToEnvironment())}static get showPlaylistIcons(){return PlaylistAdapter.showIcons}static set showPlaylistIcons(a){PlaylistAdapter.showIcons!==a&&(PlaylistAdapter.showIcons=a,AppUI._playlistControl.synchronizeElementsToEnvironment())}static addZoomHandler(a){a&&AppUI._zoomHandlers.push(a)}static removeZoomHandler(a){if(a)for(let b=AppUI._zoomHandlers.length-1;0<=b;b--)if(AppUI._zoomHandlers[b]===a){AppUI._zoomHandlers.splice(b,1);break}}static factorToZoom(a){return 1>=
a?0:Math.round(4*a)-4}static zoomToFactor(a){return 0>=a?1:.25*(a+4)}static remToPX(a){return a*AppUI._1remInPX}static pxToREM(a){return a/AppUI._1remInPX}static playerSongChange(a,b){App.player&&AppUI._playlistControl&&(document.title=a&&a.title?a.title+" - FPlay":"FPlay",Strings.changeText(AppUI._titleLabel,a&&a.title||Formatter.none),Strings.changeText(AppUI._artistLabel,a&&a.artist||Formatter.none),App.player.playlist&&0<=App.player.playlist.currentIndex&&!AppUI._playlistControl.deleteMode&&a&&
AppUI._playlistControl.bringItemIntoView(App.player.playlist.currentIndex),0>b&&(b=0),AppUI._currentTimeS=b|0,a?(Strings.changeText(AppUI._songLengthLabel,a.length),Strings.changeText(AppUI._assistiveSongLengthLabel,a.length),AppUI._seekSlider&&(0<a.lengthMS&&a.isSeekable?(AppUI._seekSlider.disabled=!1,AppUI._seekSlider.max=a.lengthMS):(AppUI._seekSlider.disabled=!0,AppUI._seekSlider.max=Math.max(1,a.lengthMS)),AppUI._seekSlider.manuallyChangeAll(1E3*b,Formatter.formatTimeS(AppUI._currentTimeS),SliderControlValueChild.LeftChild))):
(Strings.changeText(AppUI._songLengthLabel,Formatter.none),Strings.changeText(AppUI._assistiveSongLengthLabel,Formatter.none),AppUI._seekSlider&&(AppUI._seekSlider.disabled=!0,AppUI._seekSlider.manuallyChangeAll(0,Formatter.none,SliderControlValueChild.LeftChild))))}static playerLoadingChange(a){App.updateLoadingIcon()}static playerPausedChange(a){AppUI._playButton&&(AppUI._playButton.iconName=a?"icon-play":"icon-pause")}static playerCurrentTimeSChange(a){if(AppUI._seekSlider&&!AppUI._seekSlider.dragging&&
App.player){0>a&&(a=0);var b=a|0;if(AppUI._currentTimeS!==b){AppUI._currentTimeS=b;a=1E3*b;if(App.player.currentSong){const c=App.player.currentSong.lengthMS-a;5500>c&&2500<c&&App.player.preloadNextSong()}AppUI._seekSlider.manuallyChangeAll(a,Formatter.formatTimeS(b),SliderControlValueChild.LeftChild)}else AppUI._seekSlider.value=1E3*a}}static playerError(a){Modal.show({text:a,returnFocusElement:AppUI._playlistControl})}static playlistSongLengthChange(a){App.player&&(a===App.player.currentSong&&(Strings.changeText(AppUI._songLengthLabel,
a.length),Strings.changeText(AppUI._assistiveSongLengthLabel,a.length),AppUI._seekSlider&&(0<a.lengthMS&&a.isSeekable?(AppUI._seekSlider.disabled=!1,AppUI._seekSlider.max=a.lengthMS):(AppUI._seekSlider.disabled=!0,AppUI._seekSlider.value=0,AppUI._seekSlider.max=Math.max(1,a.lengthMS)))),AppUI._playlistControl&&AppUI._playlistControl.refreshVisibleItems())}static seekSliderValueChange(a){AppUI._seekSlider&&AppUI._seekSlider.dragging&&(a=a/1E3|0,AppUI._currentTimeS!==a&&(AppUI._currentTimeS=a,AppUI._seekSlider.manuallyChangeAria(Formatter.formatTimeS(a),
SliderControlValueChild.LeftChild)))}static seekSliderDragChangeCommit(a){App.player&&App.player.seekTo(a)}static volumeSliderValueChange(a){App.player&&(App.player.volume=a)}static playlistControlItemClick(a,b,c){App.player&&!c&&App.player.play(b)}static playlistControlItemContextMenu(a,b){App.player&&a&&AppUI._playlistControl&&!AppUI._playlistControl.deleteMode&&AppUI.showSongInfo(a)}static playlistControlItemControlClick(a,b,c,d){AppUI.playlistControlItemContextMenu(a,b)}static graphicalFilterControlTypeClick(){App.graphicalFilterControl&&
(App.graphicalFilterControl.simpleMode=!App.graphicalFilterControl.simpleMode,AppUI._graphicalFilterControlType.text=App.graphicalFilterControl.simpleMode?Strings.TraditionalFilter:Strings.AdvancedFilter)}static graphicalFilterControlEnabledClick(){App.graphicalFilterControl&&(App.graphicalFilterControl.enabled=AppUI._graphicalFilterControlEnabled.checked)}static stereoPannerControlEnabledClick(){App.stereoPannerControl&&(App.stereoPannerControl.enabled=AppUI._stereoPannerControlEnabled.checked)}static monoDownMixerControlEnabledClick(){App.monoDownMixerControl&&
...
AppUI._titleLabel.classList.remove("behind"),AppUI._artistLabel&&AppUI._artistLabel.classList.remove("behind"))}))}static showTopMessage(a,b){AppUI._topMessage&&(AppUI._topMessageTimeout&&clearTimeout(AppUI._topMessageTimeout),AppUI._topMessageFading=1,AppUI._titleLabel&&AppUI._titleLabel.classList.add("behind"),AppUI._artistLabel&&AppUI._artistLabel.classList.add("behind"),AppUI._topMessage.innerHTML=a,b&&b(AppUI._topMessage),AppUI._topMessage.style.visibility="visible",AppUI._topMessageTimeout=
DelayControl.delayShortCB(function(){0>=AppUI._topMessageFading||1!==AppUI._topMessageFading||(AppUI._topMessageFading=2,AppUI._topMessage.classList.add("in"),AppUI._topMessageTimeout=DelayControl.delayFadeCB(function(){2===AppUI._topMessageFading&&(AppUI._topMessageFading=0,AppUI._topMessageTimeout=0)}))}))}static async addFiles(a){if(App.player&&!AppUI._loading&&!Modal.visible&&!FilePicker.visible){var b=App.hostType===App.hostTypeElectron;if(FilePicker.isSupported()){a=null;var c=FilePicker.showAddPlay(AppUI._playlistControl)}else a=
await App.showOpenDialogWeb(a),c=null;if((a||c)&&App.player)try{App.player.playlist||(App.player.playlist=new Playlist,AppUI.preparePlaylist());const d=App.player.playlist,e=b?null:new Uint8Array(BufferedReader.minBufferLength),f=b?null:new ResizeableBuffer(2048);let g=!1;do{let h=!1;if(c){const k=await c();if(!k)break;h=k.play;a=k.files}if(!a)break;AppUI._loading=!0;App.updateLoadingIcon();for(let k=0;k<a.length&&App.player;k++)if(b)await d.addSong(a[k])&&h&&(h=!1,App.player&&App.player.play(d.length-
1));else{const n=d.length;await d.addSongWeb(a[k],e,f)&&(n==d.length?g=!0:h&&(h=!1,App.player&&App.player.play(n)))}AppUI._loading=!1;App.updateLoadingIcon()}while(c);g&&AppUI._playlistControl&&AppUI._playlistControl.refreshVisibleItems()}catch(d){Modal.show({text:"addFiles error: "+(d.message||d.toString()),returnFocusElement:AppUI._playlistControl})}finally{AppUI._loading=!1,App.updateLoadingIcon()}}}static toggleDeleteMode(a){if(AppUI._playlistControl){AppUI._focusBlocker&&(AppUI._focusBlocker.unblock(),
AppUI._focusBlocker=null);AppUI._playlistControl.deleteMode?(AppUI._playlistControl.deleteMode=!1,AppUI.hideTopMessage(),a&&HistoryHandler.popState()):(AppUI._playlistControl.deleteMode=!0,AppUI._focusBlocker=new FocusBlocker,AppUI._focusBlocker.block(AppUI._middlePanel),AppUI.showTopMessage(Strings.DeleteModeHTML,function(b){const c=document.createElement("div");c.innerHTML=`
...
(a=App.player&&App.player.currentSong);a?Modal.show({html:`<div class="selectable-text">
				...
				${a.url?`<p class="top-margin"><b>${Strings.Path}</b><br/>${Strings.htmlEncode(a.absolutePath)}</p>`:""}
...
parent:a,onclick:function(){AppUI.extraRGBMode=e.checked;b()}}),f=ButtonControl.create({text:Strings.NeonMode,checkable:!0,checked:AppUI.neonMode,parent:a,onclick:function(){AppUI.neonMode=f.checked}}),g=ButtonControl.create({text:Strings.ShowPlaylistAlbumArt,checkable:!0,checked:AppUI.showPlaylistAlbumArt,parent:a,onclick:function(){AppUI.showPlaylistAlbumArt=g.checked}}),h=ButtonControl.create({text:Strings.ShowPlaylistIcons,checkable:!0,checked:AppUI.showPlaylistIcons,parent:a,onclick:function(){AppUI.showPlaylistIcons=
h.checked}});a.insertAdjacentHTML("beforeend",`
...
App.monoDownMixerControl.enabled:!1,filePickerLastPath:FilePicker.lastPath,filePickerRootLength:FilePicker.lastRootLength,rgbMode:AppUI.rgbMode,animatedRGBMode:AppUI.animatedRGBMode,extraRGBMode:AppUI.extraRGBMode,neonMode:AppUI.neonMode,showPlaylistAlbumArt:AppUI.showPlaylistAlbumArt,showPlaylistIcons:AppUI.showPlaylistIcons}),App.graphicalFilterControl&&App.graphicalFilterControl.saveSettings(),App.stereoPannerControl&&App.stereoPannerControl.saveSettings(),a&&App.player.playlist&&InternalStorage.savePlaylistWeb(App.player.playlist))}static mainWindowStateChanged(a,
b,c){if(App._isMinimized!==b||App._isMaximized!==c)App._isMinimized=b,App._isMaximized=c,b||(App._titleBar&&(App._titleBar.className=c?"maximized":""),App._iconRestore&&(App._iconRestore.className=c?"":"hidden"),App._iconMaximize&&(App._iconMaximize.className=c?"hidden":""))}static mainWindowClosing(){if(App.player&&App.player.alive){const a=App._closeHandlers,b=[];App.saveSettings(!0);App.player.destroy(!0);if(a&&a.length)for(let c=a.length-1;0<=c;c--)if(a[c]){const d=a[c]();d&&b.push(d)}App.hostInterface&&
(b.length?Promise.all(b).then(App.destroy,App.destroy):App.destroy())}}static destroy(){App.player&&App.player.destroy();AppUI.destroy();const a=App._ipcRenderer,b=App._exitOnDestroy?App.hostInterface:null;zeroObject(App);a&&a.invoke("mainWindowFinalClose");b&&b.exit()}static updateLoadingIcon(){App._iconLoading&&(App._iconLoading.style.display=App.loading?"":"none")}static get loading(){return(App.player?App.player.loading:!1)||AppUI.loading||App._loading}static set loading(a){App._loading!==a&&
(App._loading=a,App.updateLoadingIcon())}static get installPromptReady(){return!!App._installPrompt}static showInstallPrompt(){const a=App._installPrompt;if(a&&a.prompt)try{App._installPrompt=null,a.prompt()}catch(b){}}static beforeInstallPrompt(a){"preventDefault"in a&&a.preventDefault();App._installPrompt=a}static sortFiles(a){if(a.length){const b=Strings.comparer;a[0]["data-path"]?a.sort(function(c,d){return b(c["data-path"],d["data-path"])}):a[0].webkitRelativePath?a.sort(function(c,d){return b(c.webkitRelativePath,
d.webkitRelativePath)}):a.sort(function(c,d){return b(c.name,d.name)})}return a}static async preInit(){Strings.init();GraphicalFilterEditorStrings.init(Strings.language);Strings.toFixed=GraphicalFilterEditorStrings.toFixed;LibMikModCustomProvider.init();FileUtils.init();if(!App.hostInterface&&FileSystemAPI.isSupported())try{await FileSystemAPI.init()}catch(c){Alert.show(c.message||c.toString())}const a=InternalStorage.loadAppSettings(),b=window.electronWebFrame;App._ipcRenderer&&delete window.electronIpcRenderer;
b&&delete window.electronWebFrame;if("serviceWorker"in navigator&&!location.href.startsWith("file://")){window.addEventListener("beforeinstallprompt",App.beforeInstallPrompt);const c=navigator.serviceWorker.register("sw.js");c&&"then"in c&&c.then(function(d){d&&"onupdatefound"in d&&d.active&&(d.onupdatefound=function(){Modal.show({html:Strings.PleaseRefresh,title:Strings.UpdateAvailable,returnFocusElement:AppUI.playlistControlElement,okText:Strings.Refresh,okCancel:!0,onok:function(){window.location.reload()}})})})}App._ipcRenderer?
(App._ipcRenderer.on("mainWindowStateChanged",App.mainWindowStateChanged),App._ipcRenderer.on("mainWindowClosing",App.mainWindowClosing),App.triggerMainWindowStateChanged()):App.hostInterface||window.addEventListener("onpagehide"in window?"pagehide":"unload",App.mainWindowClosing);App.frameless&&(App._titleBar=document.createElement("h1"),App._titleBar.className="title-bar",App._titleBar.innerHTML=`
				<div></div>
				<i id="icon-main"></i>
				FPlay
...
(1!==c.files.length||FileUtils.getSupportedExtensionInfoByPath(c.files[0].name))){var f=Array(c.files.length);for(let g=f.length-1;0<=g;g--)f[g]=c.files[g];c.value="";e(b?f:App.sortFiles(f))}else e(null)}};a=App._fileInputPromiseResolve;App._fileInputPromiseResolve=null;const d=new Promise(function(e){App._fileInputPromiseResolve=e});c.click();a&&a(null);return d}static exit(){App._exitOnDestroy=!0;App.mainWindowClosing()}}App.hostTypeElectron="Electron";App.hostTypeAndroid="Android";
