...
this.currentPlaylistSong=this._playlist=null;this._volume=0;this.lastObjectURL=null;this.resumeTimeS=this.lastTimeS=-1;this.songStartedAutomatically=!0;this.haltOnAllErrors=!1;this.nextSongVersion=0;this.nextSongObjectURL=null;this.nextSongLoadedWithError=this.nextSongLoading=!1;this.nextAudioBundle=this.nextSongAlreadyChecked=this.nextSongToPlayAfterLoading=null;this.volume=a||0;this.sourceNode=this.audio=null;this.recreateAudioPath();this.mediaSession=c||null;b&&(this.playlist=b)}createAudioBundle(a){const b=
document.createElement("audio");var c=this.audioContext.createMediaElementSource(b);c=new SourceNode(c);var d=a?(g,k,h,m,l)=>{this.audio===b?this.playbackError(g,k,h,m,l):this.nextAudioBundle&&this.nextAudioBundle.audio&&this.nextAudioBundle.audio===b&&this.nextAudioBundle.nextSong===a&&(this.nextSongLoading=!1,this.nextSongLoadedWithError=!0)}:(g,k,h,m,l)=>{this.audio===b&&this.playbackError(g,k,h,m,l)};const e={audio:b,sourceNode:c,nextSong:a,boundPlaybackError:d};b.style.pointerEvents="none";b.style.position=
"absolute";b.style.left="0";b.style.top="0";b.style.zIndex="-1";b.loop=!1;b.controls=!1;b.autoplay=!1;document.body.appendChild(b);const f=()=>{this.audio===b&&this.playbackLoadStart()};b.onwaiting=f;b.onloadstart=f;b.oncanplay=a?()=>{this.audio===b?(this.playbackLoadEnd(),this.nextSongToPlayAfterLoading&&(this.nextSongToPlayAfterLoading===a&&(this.nextSongLoadedWithError=this.nextSongLoading=!1,this.nextSongPerformFinalPlaybackSteps()),this.nextSongToPlayAfterLoading=null)):this._playlist&&this.nextAudioBundle&&
this.nextAudioBundle.audio&&this.nextAudioBundle.audio===b&&this.nextAudioBundle.nextSong===a&&(this.nextSongLoadedWithError=this.nextSongLoading=!1)}:()=>{this.audio===b&&this.playbackLoadEnd()};b.onended=()=>{this.audio===b&&this.playbackEnd()};b.onerror=d;b.onpause=()=>{this.audio===b&&this.playbackPaused()};b.onplaying=()=>{this.audio===b&&this.playbackStarted()};d=()=>{this.audio===b&&this.playbackAborted()};b.onabort=d;b.onemptied=d;b.ondurationchange=()=>{this.audio===b&&this.playbackLengthChange()};
b.ontimeupdate=()=>{this.audio===b&&this.currentTimeChange()};c.enabled=!0;return e}recreateAudioPath(){const a=this.intermediateNodes;this.sourceNode&&this.sourceNode.disconnectFromDestination();for(var b=a.length-1;0<=b;b--)a[b].disconnectFromDestination();this.audio&&document.body.removeChild(this.audio);const {audio:c,sourceNode:d,boundPlaybackError:e}=this.createAudioBundle(null);this.audio=c;this.sourceNode=d;this.boundPlaybackError=e;if(a.length){d.connectToDestination(a[0]);for(b=0;b<a.length-
1;b++)a[b].connectToDestination(a[b+1]);a[a.length-1].connectToDestination(this.destinationNode)}else d.connectToDestination(this.destinationNode);this.volume=this._volume}destroy(a){this.stop();if(a){if(this._alive=!1,this.sourceNode&&this.sourceNode.disconnectFromDestination(),(a=this.intermediateNodes)&&a.length)for(let b=a.length-1;0<=b;b--)a[b].disconnectFromDestination()}else this._playlist&&this._playlist.destroy(),(a=this.mediaSession)&&a.cleanUpMediaSession&&a.cleanUpMediaSession(),zeroObject(this)}get alive(){return this._alive}get loading(){return this._loading}get paused(){return this._paused}get volume(){return this._volume}set volume(a){this._volume=
...
a/1E3+(b?this.audio.currentTime||0:0)));this.lastTimeS=c;this.audio.currentTime=c}catch(c){}this.notifyCurrentTimeSChange()}}}Player.minVolume=-40;Player.nop=function(){};
