...
c.fillBuffer(1024);e&&(yield e);e=c.readUInt32LE();a-=4;if(!e||e>a)return 0;c.skip(e);a-=e;if(!a)return 1;(e=c.fillBuffer(1024))&&(yield e);let f=c.readUInt32LE();a-=4;if(null===f||0>a||f>a)return 0;let g=null,h=null,k=null;for(;0<f;){f--;(e=c.fillBuffer(4))&&(yield e);const m=c.readUInt32LE();a-=4;if(null===m||0>a||m>a)return 0;const l=Math.min(2048,m);let n=d[0];n.length<l&&(n=new Uint8Array(l),d[0]=n);(e=c.fillBuffer(l+4))&&(yield e);c.read(n,0,l);m>l&&c.skip(m-l);a-=m;try{let r;for(r=0;r<l;r++)if(61===
n[r]){if(r&&r<l-1){const p=MetadataExtractor.textDecoderUtf8.decode(n.subarray(0,r)).normalize().trim(),q=MetadataExtractor.textDecoderUtf8.decode(n.subarray(r+1,l)).normalize().trim();if(!q)break;switch(p.toUpperCase()){case "TITLE":b.title=q;break;case "ARTIST":b.artist=b.artist?b.artist+(", "+q):q;break;case "PERFORMER":g=q;break;case "ALBUMARTIST":h=q;break;case "COMPOSER":k=q;break;case "ALBUM":b.album=q;break;case "TRACKNUMBER":b.track=parseInt(q)||0;break;case "DATE":b.year=parseInt(q)||0}}break}}catch(r){}}b.artist||
(g?b.artist=g:h?b.artist=h:k&&(b.artist=k));0<a&&c.skip(a);return 1})}static readMetadataBlock(a,b,c){return __awaiter(this,void 0,void 0,function*(){var d=b.fillBuffer(4);d&&(yield d);d=b.readUInt32BE();if(!d)return 0;const e=d&2147483648;d&=2147483647;const f=d>>24;d&=16777215;if(127===f||d+b.filePosition>b.fileLength)return 0;if(4===f){if(!(yield FLACMetadataExtractor.extractVorbisComment(d,a,b,c)))return 0}else b.skip(d);return e?-1:1})}static extract(a,b,c){return __awaiter(this,void 0,void 0,
function*(){try{const d=new BufferedFileHandle(a,b);yield d.fillBuffer(-1);const e=MetadataExtractor.createBasicMetadata(a);let f=FLACMetadataExtractor.readHeaderAndStreamInfo(e,d,c[0]);if(!f)return null;if(0>f)return e;do if(f=yield FLACMetadataExtractor.readMetadataBlock(e,d,c),!f)return null;while(0<f);return e}catch(d){return null}})}}
