...
this.album!==Formatter.none&&b.push(this.album),this.year&&0<this.year&&b.push(this.year.toString()),this.fileName&&b.push(this.fileName),this._normalizedInfo=b=Strings.removeDiacritics(b.join(" ")));for(let c=a.length-1;0<=c;c--)if(!b.includes(a[c]))return!1;return!0}}Song._lastId=0;
...
const n=document.createElement("f-list");n.className="full-height-list fade";this._callback=c||null;this._resolve=a;this._provider=App.hostType===App.hostTypeAndroid?new FilePickerAndroidProvider:new FilePickerFileSystemAPIProvider;this._list=new List;this._listAdapter=new FilePickerListAdapter(this._list);this._listControl=n;this._listControl.addEventListener("keydown",this.listKeyDown.bind(this));this._listControl.onitemclick=this.itemClick.bind(this);this._listControl.onitemcontrolclick=this.itemControlClick.bind(this);
...
(a=App.player&&App.player.currentSong);a?Modal.show({html:`<div class="selectable-text">
			...
			</div>`,title:Strings.SongInfo,returnFocusElement:AppUI._playlistControl}):Alert.show(Strings.NoSongPlaying)}static showSearch(){if(App.player&&App.player.playlist&&AppUI._playlistControl){var a=new Playlist,b=document.createElement("f-list");b.className="full-height-list";b.ariaLabel=Strings.SearchResults;b.adapter=new PlaylistAdapter(a);b.onitemclick=function(d,e,f){App.player&&App.player.playlist&&!f&&(e=App.player.playlist.findIndexById(d.id),0<=e&&App.player.play(e))};var c=document.createElement("input");
c.type="text";c.className="bottom-border";c.placeholder=Strings.SearchPlaceholder;c.oninput=function(){a.clear();if(App.player&&App.player.playlist){const d=App.player.playlist.findItems(c.value);d.length&&a.addItems(d)}};Modal.show({html:[c,b],skipBody:!0,fullHeight:!0,title:Strings.Search,returnFocusElement:AppUI._playlistControl,onshown:function(){return c}})}}static showAbout(){const a=document.createElement("div"),b=function(){c.checked=AppUI.rgbMode;d.checked=AppUI.animatedRGBMode;e.checked=
AppUI.extraRGBMode},c=ButtonControl.create({text:Strings.RGBMode,checkable:!0,checked:AppUI.rgbMode,parent:a,onclick:function(){AppUI.rgbMode=c.checked;b()}}),d=ButtonControl.create({text:Strings.AnimatedRGBMode,checkable:!0,checked:AppUI.animatedRGBMode,parent:a,onclick:function(){AppUI.animatedRGBMode=d.checked;b()}}),e=ButtonControl.create({text:Strings.ExtraRGBMode,checkable:!0,checked:AppUI.extraRGBMode,parent:a,onclick:function(){AppUI.extraRGBMode=e.checked;b()}}),f=ButtonControl.create({text:Strings.NeonMode,
checkable:!0,checked:AppUI.neonMode,parent:a,onclick:function(){AppUI.neonMode=f.checked}});a.insertAdjacentHTML("beforeend",`
