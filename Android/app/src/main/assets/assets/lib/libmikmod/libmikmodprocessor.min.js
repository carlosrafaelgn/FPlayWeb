...
(h?h.message||h.toString():null)||"Unknown error while loading the library")}))})}static terminate(){LibMikMod.cLib&&(LibMikMod.cLib._terminate(),LibMikMod.cLib=null,LibMikMod.tmpBuffer=null,LibMikMod.audioBufferPtr=0,LibMikMod.audioBufferUsedLength=0)}static getVersion(){return LibMikMod.cLib?LibMikMod.cLib._getVersion():0}static loadModule(b,d,e){if(!LibMikMod.cLib)return 3;if(!d)return 2;var h=LibMikMod.cLib._preLoadModule(d.byteLength);if(!h)return 2;h=new Uint8Array(LibMikMod.cLib.HEAP8.buffer,
h,d.byteLength);"set"in d?h.set(d,0):h.set(new Uint8Array(d,0,d.byteLength),0);LibMikMod.tmpBuffer=null;LibMikMod.audioBufferPtr=0;LibMikMod.audioBufferUsedLength=0;e&&(void 0!==e.reverb&&0<=e.reverb&&15>=e.reverb&&(LibMikMod.lastReverb=e.reverb),void 0!==e.hqMixer&&(LibMikMod.lastHqMixer=e.hqMixer?1:0),void 0!==e.interpolation&&(LibMikMod.lastInterpolation=e.interpolation?1:0),void 0!==e.noiseReduction&&(LibMikMod.lastNoiseReduction=e.noiseReduction?1:0),void 0!==e.wrap&&(LibMikMod.lastWrap=e.wrap?
1:0),void 0!==e.loop&&(LibMikMod.lastLoop=e.loop?1:0),void 0!==e.fadeout&&(LibMikMod.lastFadeout=e.fadeout?1:0));return(b=LibMikMod.cLib._loadModule(b,LibMikMod.lastReverb,LibMikMod.lastHqMixer,LibMikMod.lastInterpolation,LibMikMod.lastNoiseReduction,LibMikMod.lastWrap,LibMikMod.lastLoop,LibMikMod.lastFadeout))||LibMikMod.cLib._getAudioBuffer()?b:2}static changeGeneralOptions(b){b&&(void 0!==b.reverb&&0<=b.reverb&&15>=b.reverb&&(LibMikMod.lastReverb=b.reverb),void 0!==b.interpolation&&(LibMikMod.lastInterpolation=
b.interpolation?1:0),void 0!==b.noiseReduction&&(LibMikMod.lastNoiseReduction=b.noiseReduction?1:0),LibMikMod.cLib&&LibMikMod.cLib._changeGeneralOptions(LibMikMod.lastReverb,LibMikMod.lastInterpolation,LibMikMod.lastNoiseReduction))}static stopModule(){LibMikMod.cLib&&(LibMikMod.cLib._freeModule(),LibMikMod.tmpBuffer=null,LibMikMod.audioBufferPtr=0,LibMikMod.audioBufferUsedLength=0)}static getString(b){if(LibMikMod.cLib&&b){const e=LibMikMod.cLib.HEAP8;let h=0;for(var d=b;e[d]&&1024>h;d++)h++;if(!h)return"";
for(d=Array(h);0<h--;)d[h]=e[b+h];return String.fromCharCode.apply(String,d)}return null}static getSongName(){return LibMikMod.cLib?LibMikMod.getString(LibMikMod.cLib._getSongName()):null}static getModType(){return LibMikMod.cLib?LibMikMod.getString(LibMikMod.cLib._getModType()):null}static getComment(){return LibMikMod.cLib?LibMikMod.getString(LibMikMod.cLib._getComment()):null}static getErrno(){return LibMikMod.cLib?LibMikMod.cLib._getErrno():0}static getStrerr(b){return LibMikMod.cLib?LibMikMod.getString(LibMikMod.cLib._getStrerr(b)):
null}static process(b){if(!LibMikMod.cLib)return!1;let d=LibMikMod.audioBufferUsedLength;var e=b[0];b=e[0];e=e[1];const h=b.length;let l=LibMikMod.tmpBuffer,p=l?l.length-(d>>2):0,z=!0;a:for(let q=0;q<h;){if(0>=d){for(var m=0;3>m;m++){d=LibMikMod.cLib._update();if(0>d){z=!1;l=null;d=0;break a}if(d){LibMikMod.audioBufferPtr=LibMikMod.cLib._getAudioBuffer();l=new Float32Array(LibMikMod.cLib.HEAP8.buffer,LibMikMod.audioBufferPtr,d>>2);p=0;break}}if(!d){l=null;break a}}m=d>>3;const u=h-q;for(m=m<=u?m:
u;0<m;)b[q]=l[p],e[q]=l[p+1],q++,p+=2,d-=8,m--}LibMikMod.tmpBuffer=l;LibMikMod.audioBufferUsedLength=d;return z}}LibMikMod.cLib=null;LibMikMod.tmpBuffer=null;LibMikMod.audioBufferPtr=0;LibMikMod.audioBufferUsedLength=0;LibMikMod.lastReverb=0;LibMikMod.lastHqMixer=1;LibMikMod.lastInterpolation=1;LibMikMod.lastNoiseReduction=1;LibMikMod.lastWrap=0;LibMikMod.lastLoop=0;LibMikMod.lastFadeout=1;LibMikMod.loading=!1;LibMikMod.loaded=!1;LibMikMod.loadErrorStr=null;
...
var LibMikModCLib=(()=>{var b="undefined"!==typeof document&&document.currentScript?document.currentScript.src:void 0;return function(d={}){function e(c){return a.locateFile?a.locateFile(c,n):n+c}function h(){var c=A.buffer;a.HEAP8=new Int8Array(c);a.HEAP16=new Int16Array(c);a.HEAP32=new Int32Array(c);a.HEAPU8=F=new Uint8Array(c);a.HEAPU16=new Uint16Array(c);a.HEAPU32=new Uint32Array(c);a.HEAPF32=new Float32Array(c);a.HEAPF64=new Float64Array(c)}function l(c){if(a.onAbort)a.onAbort(c);c="Aborted("+
c+")";v(c);J=!0;c=new WebAssembly.RuntimeError(c+". Build with -sASSERTIONS for more info.");B(c);throw c;}function p(c){try{if(c==w&&x)return new Uint8Array(x);if(G)return G(c);throw"both async and sync fetching of the wasm failed";}catch(f){l(f)}}function z(c){if(!x&&(K||C)){if("function"==typeof fetch&&!c.startsWith("file://"))return fetch(c,{credentials:"same-origin"}).then(f=>{if(!f.ok)throw"failed to load wasm binary file at '"+c+"'";return f.arrayBuffer()}).catch(()=>p(c));if(L)return new Promise((f,
k)=>{L(c,g=>f(new Uint8Array(g)),k)})}return Promise.resolve().then(()=>p(c))}function m(c,f,k){return z(c).then(g=>WebAssembly.instantiate(g,f)).then(g=>g).then(k,g=>{v("failed to asynchronously prepare wasm: "+g);l(g)})}function q(c,f,k,g){return c||"function"!=typeof WebAssembly.instantiateStreaming||f.startsWith("data:application/octet-stream;base64,")||f.startsWith("file://")||"function"!=typeof fetch?m(f,k,g):fetch(f,{credentials:"same-origin"}).then(t=>WebAssembly.instantiateStreaming(t,k).then(g,
function(D){v("wasm streaming compile failed: "+D);v("falling back to ArrayBuffer instantiation");return m(f,k,g)}))}function u(){function c(){if(!E&&(E=!0,a.calledRun=!0,!J)){H(M);N(a);if(a.onRuntimeInitialized)a.onRuntimeInitialized();if(a.postRun)for("function"==typeof a.postRun&&(a.postRun=[a.postRun]);a.postRun.length;)O.unshift(a.postRun.shift());H(O)}}if(!(0<r)){if(a.preRun)for("function"==typeof a.preRun&&(a.preRun=[a.preRun]);a.preRun.length;)P.unshift(a.preRun.shift());H(P);0<r||(a.setStatus?
(a.setStatus("Running..."),setTimeout(function(){setTimeout(function(){a.setStatus("")},1);c()},1)):c())}}var a=d,N,B;a.ready=new Promise((c,f)=>{N=c;B=f});var Q=Object.assign({},a),K="object"==typeof window,C="function"==typeof importScripts,n="",G;if(K||C){C?n=self.location.href:"undefined"!=typeof document&&document.currentScript&&(n=document.currentScript.src);b&&(n=b);n=0!==n.indexOf("blob:")?n.substr(0,n.replace(/[?#].*/,"").lastIndexOf("/")+1):"";C&&(G=c=>{var f=new XMLHttpRequest;f.open("GET",
c,!1);f.responseType="arraybuffer";f.send(null);return new Uint8Array(f.response)});var L=(c,f,k)=>{var g=new XMLHttpRequest;g.open("GET",c,!0);g.responseType="arraybuffer";g.onload=()=>{200==g.status||0==g.status&&g.response?f(g.response):k()};g.onerror=k;g.send(null)}}a.print||console.log.bind(console);var v=a.printErr||console.error.bind(console);Object.assign(a,Q);Q=null;var x;a.wasmBinary&&(x=a.wasmBinary);"object"!=typeof WebAssembly&&l("no native wasm support detected");var A,J=!1,F,P=[],M=
[],O=[],r=0,I=null,y=null;var w="libmikmodclib.wasm";w.startsWith("data:application/octet-stream;base64,")||(w=e(w));var H=c=>{for(;0<c.length;)c.shift()(a)},R={b:(c,f,k)=>F.copyWithin(c,f,f+k),a:c=>{var f=F.length;c>>>=0;if(33554432<c)return!1;for(var k=1;4>=k;k*=2){var g=f*(1+.2/k);g=Math.min(g,c+100663296);var t=Math;g=Math.max(c,g);a:{t=t.min.call(t,33554432,g+(65536-g%65536)%65536)-A.buffer.byteLength+65535>>>16;try{A.grow(t);h();var D=1;break a}catch(S){}D=void 0}if(D)return!0}return!1}};(function(){function c(k,
g){k=k.exports;a.asm=k;A=a.asm.c;h();M.unshift(a.asm.d);r--;a.monitorRunDependencies&&a.monitorRunDependencies(r);0==r&&(null!==I&&(clearInterval(I),I=null),y&&(g=y,y=null,g()));return k}var f={a:R};r++;a.monitorRunDependencies&&a.monitorRunDependencies(r);if(a.instantiateWasm)try{return a.instantiateWasm(f,c)}catch(k){v("Module.instantiateWasm callback failed with error: "+k),B(k)}q(x,w,f,function(k){c(k.instance)}).catch(B);return{}})();a._getAudioBuffer=function(){return(a._getAudioBuffer=a.asm.f).apply(null,
