...
$jscomp.propertyToPolyfillSymbol[e],$jscomp.defineProperty(d,e,{configurable:!0,writable:!0,value:b})))};$jscomp.stringPadding=function(a,b){a=void 0!==a?String(a):" ";return 0<b&&a?a.repeat(Math.ceil(b/a.length)).substring(0,b):""};$jscomp.polyfill("String.prototype.padEnd",function(a){return a?a:function(b,c){var d=$jscomp.checkStringArgs(this,null,"padStart");return d+$jscomp.stringPadding(c,b-d.length)}},"es8","es3");
var __awaiter=this&&this.__awaiter||function(a,b,c,d){function e(f){return f instanceof c?f:new c(function(g){g(f)})}return new (c||(c=Promise))(function(f,g){function h(l){try{m(d.next(l))}catch(n){g(n)}}function k(l){try{m(d["throw"](l))}catch(n){g(n)}}function m(l){l.done?f(l.value):e(l.value).then(h,k)}m((d=d.apply(a,b||[])).next())})};
...
c||c>=g?e.appendChild(document.createTextNode(Strings.translate(f))):(b=f.substring(b,c),c=f.substring(c+1,g),e.setAttribute(b,Strings.translate(c)));b=g+1}while(b<f.length)}}}}Strings.language="en";Strings.DecimalSeparator=".";Strings.OppositeDecimalSeparator=",";Strings.Oops="Oops\u2026";Strings.Menu="Menu";Strings.About="About";Strings.Edit="Edit";Strings.Delete="Delete";Strings.Enable="Enable";Strings.Disable="Disable";Strings.Enabled="Enabled";Strings.Disabled="Disabled";
...
class MetadataExtractor{static extractRIFF(a,b,c){return __awaiter(this,void 0,void 0,function*(){if(44>b.fileLength)return null;var d=b.readUInt32LE();if(null===d||b.fileLength<8+d)return null;var e=d;let f=!1,g=!1,h=d=0,k=0;a:for(;0<e;){var m=!1,l=0,n=void 0;switch(b.readUInt32BE()){case null:break a;case 1463899717:m=!0;e-=4;break;case 1279873876:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;break;case 1768174368:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;
(n=b.fillBuffer(1024))&&(yield n);if(4<l){m=b.readByte();var p=b.readByte();n=b.readByte();if(null===m||null===p||null===n)break a;e-=3;l-=3;if(73===m||68===p||51===n)if(d=b.fileLength-e,f&&g){d=-1;break a}}b.skip(l);(n=b.fillBuffer(1024))&&(yield n);continue;default:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;b.skip(l);(n=b.fillBuffer(1024))&&(yield n);continue}for((n=b.fillBuffer(1024))&&(yield n);m&&(!f||!g)||0<l;){var q=b.readUInt32BE();p=0;if(null===q)break a;e-=4;l-=4;if(1229866575!==
q){p=b.readUInt32LE();if(null===p||0>p||p>e||!m&&p>l)break a;e-=4;l-=4}1684108385!==q&&(n=b.fillBuffer(Math.min(264,8+p)))&&(yield n);switch(q){case 1718449184:if(!m)break;n=b.readUInt16LE();q=b.readUInt16LE();var t=b.readUInt32LE(),u=b.readUInt32LE(),r=b.readUInt16LE();const y=b.readUInt16LE();p-=16;e-=16;l-=16;if(null===n||null===q||null===t||null===u||null===r||null===y)break a;f=!0;k||(k=u);break;case 1684108385:m&&(g=!0,h||(h=p));break;case 1229866575:for(q=function(x){b.read(c,0,x);return MetadataExtractor.finishReadingV2Frame(0,
x,c)};0<l;){(n=b.fillBuffer(8))&&(yield n);t=b.readUInt32BE();e-=4;l-=4;if(null===t)break a;u=b.readUInt32LE();e-=4;l-=4;if(null===u||0>u||u>l)break a;if(1>=u)b.skip(u);else{r=Math.min(257,u)-1;(n=b.fillBuffer(r))&&(yield n);switch(t){case 1229865293:a.title=q(r);break;case 1230000708:a.album=q(r);break;case 1229017684:a.artist=q(r);break;case 1229148740:a.year=parseInt(q(r))||0;break;case 1230262859:a.track=parseInt(q(r))||0;break;default:r=0}b.skip(u-r);e-=u;l-=u}}}0<p&&(b.skip(p),e-=p,l-=p);e&&
(n=b.fillBuffer(8))&&(yield n)}}return f&&g?(d&&(0<d&&b.seekTo(d),(e=b.fillBuffer(1024))&&(yield e)),a.lengthMS=1E3*h/k|0,[a,!!d]):null})}static finishReadingV2Frame(a,b,c){let d=0;var e=b-1;a:for(;0<b;)switch(c[d]){case 0:case 9:case 10:case 11:case 12:case 13:case 32:case 133:case 160:b--;d++;break;default:break a}a:for(;0<b;)switch(c[e]){case 0:case 9:case 10:case 11:case 12:case 13:case 32:case 133:case 160:b--;e--;break;default:break a}e=null;switch(a){case 1:case 2:if(b&1&&d+b<c.length&&b++,
2<=b&&1===a&&(254===c[d]&&255===c[d+1]?(a=2,d+=2,b-=2):255===c[d]&&254===c[d+1]&&(d+=2,b-=2),!b))return null}switch(a){case 0:e=MetadataExtractor.textDecoderIso88591.decode(c.subarray(d,d+b));break;case 1:e=MetadataExtractor.textDecoderUtf16.decode(c.subarray(d,d+b));break;case 2:e=MetadataExtractor.textDecoderUtf16be.decode(c.subarray(d,d+b));break;case 3:e=MetadataExtractor.textDecoderUtf8.decode(c.subarray(d,d+b))}return e&&e.length?e:null}static readV2Frame(a,b,c){if(2>b)return a.skip(b),null;
const d=a.readByte();b--;if(0>d||3<d)return a.skip(b),null;let e=c[0];b>e.length&&(e=new Uint8Array(b+16),c[0]=e);a=a.read(e,0,b);return"number"===typeof a?MetadataExtractor.finishReadingV2Frame(d,a,e):a.then(function(f){return MetadataExtractor.finishReadingV2Frame(d,f,e)})}static extractID3v1(a,b,c,d){return __awaiter(this,void 0,void 0,function*(){try{b.seekTo(b.fileLength-128);const g=b.read(d,0,128);"number"!==typeof g&&(yield g);if(84==d[0]&&65==d[1]&&71==d[2]){var e;if(!(c&MetadataExtractor.TITLE_B)){var f=
...
93+e))))}c&MetadataExtractor.TRACK_B||d[125]||!d[126]||(a.track=d[126]&255)}}catch(g){}})}static extractID3v2Andv1(a,b,c){return __awaiter(this,void 0,void 0,function*(){const d={url:Formatter.pathToURL(a["data-path"])||Formatter.empty};d.url||(d.file=a,d.fileSize=a.size,d.fileName=a.name);var e=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==e)if(e|=b.readByte(),1380533830===e){e=yield MetadataExtractor.extractRIFF(d,b,c[0]);if(!e)return null;if(!e[1])return d}else return yield MetadataExtractor.extractID3v1(d,
b,0,c[0]),d;var f=b.readByte(),g=b.readByte();e=b.readByte();var h=b.readByte();const k=b.readByte(),m=b.readByte(),l=b.readByte();e=(e&16?10:0)+(l&127|(m&127)<<7|(k&127)<<14|(h&127)<<21);if(2<(f&255)||g){for(f=0;0<e&&f!==MetadataExtractor.ALL_B;){(g=b.fillBuffer(1024))&&(yield g);h=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();g=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();b.skip(2);if(!h||0>=g||g>e)break;switch(h){case 1414091826:f&MetadataExtractor.TITLE_B?b.skip(g):
(h=MetadataExtractor.readV2Frame(b,g,c),d.title=h&&h.then?yield h:h,d.title&&(f|=MetadataExtractor.TITLE_B));break;case 1414546737:f&MetadataExtractor.ARTIST_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.artist=h&&h.then?yield h:h,d.artist&&(f|=MetadataExtractor.ARTIST_B));break;case 1413565506:f&MetadataExtractor.ALBUM_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.album=h&&h.then?yield h:h,d.album&&(f|=MetadataExtractor.ALBUM_B));break;case 1414677323:f&MetadataExtractor.TRACK_B?
b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.track=h&&h.then?parseInt(yield h):parseInt(h),d.track?f|=MetadataExtractor.TRACK_B:d.track=0);break;case 1414284622:f&MetadataExtractor.LENGTH_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.lengthMS=h&&h.then?parseInt(yield h):parseInt(h),d.lengthMS?f|=MetadataExtractor.LENGTH_B:d.lengthMS=0);break;case 1415136594:case 1413763651:f&MetadataExtractor.YEAR_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.year=h&&h.then?parseInt(yield h):
parseInt(h),d.year?f|=MetadataExtractor.YEAR_B:d.year=0);break;default:b.skip(g)}e-=10+g}(f&MetadataExtractor.ALL_BUT_LENGTH_B)!==MetadataExtractor.ALL_BUT_LENGTH_B&&(yield MetadataExtractor.extractID3v1(d,b,f,c[0]))}return d})}static extract(a,b,c){return __awaiter(this,void 0,void 0,function*(){if(!a)return null;if(!a.name.endsWith(".mp3")&&!a.name.endsWith(".aac")&&!a.name.endsWith(".wav")){const d=a.name.toLowerCase();if(!d.endsWith(".mp3")&&!d.endsWith(".aac")&&!d.endsWith(".wav"))return null}b||
(b=new Uint8Array(BufferedFileHandle.minBufferLength));c||(c=[new Uint8Array(256)]);try{const d=new BufferedFileHandle(a,b);yield d.fillBuffer(-1);return yield MetadataExtractor.extractID3v2Andv1(a,d,c)}catch(d){return null}})}}MetadataExtractor.ALL_B=63;MetadataExtractor.ALL_BUT_LENGTH_B=31;MetadataExtractor.TITLE_B=1;MetadataExtractor.ARTIST_B=2;MetadataExtractor.ALBUM_B=4;MetadataExtractor.TRACK_B=8;MetadataExtractor.YEAR_B=16;MetadataExtractor.LENGTH_B=32;
MetadataExtractor.textDecoderIso88591=new TextDecoder("iso-8859-1");MetadataExtractor.textDecoderUtf16=new TextDecoder("utf-16");MetadataExtractor.textDecoderUtf16be=new TextDecoder("utf-16be");MetadataExtractor.textDecoderUtf8=new TextDecoder("utf-8");
...
Formatter.formatTimeMS(b);if(this.onsonglengthchanged)this.onsonglengthchanged(a)}addSong(a,b){const c=Object.create(null,{addItem:{get:()=>super.addItem}});return __awaiter(this,void 0,void 0,function*(){let d=0;if("string"!==typeof a){var e=a.fileURL;d=a.fileSize}else e=a;if(!Playlist.isTypeSupported(e))return!1;e=yield App.extractMetadata(e,d);if(!e)return!1;c.addItem.call(this,new Song(e),b);return!0})}addSongWeb(a,b,c,d){const e=Object.create(null,{addItem:{get:()=>super.addItem}});return __awaiter(this,
void 0,void 0,function*(){if(!Playlist.isTypeSupported(a.name))return!1;if(this.missingSongs){var f=this.missingSongs;const g=f.length;for(let h=0;h<g;h++){const k=f[h];if(k.fileName===a.name&&k.fileSize===a.size)return k.file=a,f.splice(h,1),f.length||(this.missingSongs=null),!0}}f=yield MetadataExtractor.extract(a,b,c);if(!f)return!1;e.addItem.call(this,new Song(f),d);return!0})}}Playlist.supportedExtensions={".aac":!0,".mp3":!0,".wav":!0};
Playlist.concatenatedSupportedExtensions=(()=>{let a="";for(let b in Playlist.supportedExtensions)a=a?a+","+b:b;return a})();
...
if(d){var e=1<devicePixelRatio?devicePixelRatio:1;e!==this.pixelRatio&&(this.scaleChanged(),e=this.pixelRatio);var f=this.editor,g=f.filter;e*=f.scale;var h=this.element;f=this.leftMargin;var k=h.width,m=h.height,l=Math.round(8*e),n=Math.round(4*e),p=(k/l|0)+1,q=GraphicalFilterEditor.maximumChannelValueY*e|0,t=1>e?e:e|0;h=.5*t;d.fillStyle="#303030";d.fillRect(0,0,k,m);d.lineWidth=t;d.strokeStyle="#5a5a5a";d.beginPath();t=k+(n>>1);var u=(GraphicalFilterEditor.zeroChannelValueY*e|0)+h;d.moveTo(t,u);
for(let r=p-1;0<=r;r--)d.lineTo(t-n,u),t-=l,d.moveTo(t,u);d.stroke();d.beginPath();t=k+(n>>1);u=(GraphicalFilterEditor.validYRangeHeight*e|0)+h;d.moveTo(t,u);for(k=p-1;0<=k;k--)d.lineTo(t-n,u),t-=l,d.moveTo(t,u);d.stroke();if(a)for(a=g.equivalentZonesFrequencyCount.length-2;0<a;a--){t=((g.equivalentZonesFrequencyCount[a]+f)*e|0)+h;u=q;d.beginPath();for(d.moveTo(t,u);u<m;)d.lineTo(t,u+n),u+=l,d.moveTo(t,u);d.stroke()}t=1>e?2*e:2*e|0;h=.5*t;d.lineWidth=t;a=GraphicalFilterEditor.visibleBinCount-1;for(m=
...
if(a&&b&&c&&d){var e=GraphicalFilterEditorControl.controlWidth,f=GraphicalFilterEditorControl.controlHeight,g=1<devicePixelRatio?devicePixelRatio:1,h=b.scale;b=h*g;var k=this.leftMargin,m=this.svgLines,l=1>b?b:b|0,n=.5*l,p=(e*b|0).toString(),q=(f*b|0).toString();d.setAttribute("width",p);d.setAttribute("height",q);d.setAttribute("viewBox",`0 0 ${p} ${q}`);d.style.transform=1===g?"":"scale("+1/g+")";this.svgGradient.setAttribute("y2",q);a.style.width=(e*h|0)+"px";a.style.height=(f*h|0)+"px";m[0].setAttribute("x2",
p);m[1].setAttribute("x2",p);for(p=m.length-1;2<=p;p--)m[p].setAttribute("y2",q);q=((GraphicalFilterEditor.zeroChannelValueY*b|0)+n).toString();m[0].setAttribute("y1",q);m[0].setAttribute("y2",q);q=((GraphicalFilterEditor.validYRangeHeight*b|0)+n).toString();m[1].setAttribute("y1",q);m[1].setAttribute("y2",q);for(q=c.equivalentZonesFrequencyCount.length-2;0<q;q--)p=(((c.equivalentZonesFrequencyCount[q]+k)*b|0)+n).toString(),m[q+1].setAttribute("x1",p),m[q+1].setAttribute("x2",p);p=l.toString()+"px";
q=(4*b|0).toString();for(c=m.length-1;0<=c;c--)m[c].setAttribute("stroke-width",p),m[c].setAttribute("stroke-dasharray",q);p=(1>b?2*b:2*b|0).toString()+"px";this.svgGrayCurve.style.strokeWidth=p;this.svgCurve.style.strokeWidth=p;this.pixelRatio=g}}drawCurve(a,b,c){var d=1<devicePixelRatio?devicePixelRatio:1;d!==this.pixelRatio&&(this.scaleChanged(),d=this.pixelRatio);this.showZones!==a&&(this.showZones=a,this.svgZones.style.display=a?"":"none");var e=this.editor;a=e.filter;d*=e.scale;e=.5*(1>d?2*
d:2*d|0);const f=this.leftMargin,g=GraphicalFilterEditor.visibleBinCount;for(let h=b?1:0;0<=h;h--){const k=h||!b?a.channelCurves[c]:a.actualChannelCurve,m=h?this.svgGrayCurve:this.svgCurve;let l=1,n=0,p=k[0],q="M "+(f*d|0)+","+(p*d+e);for(;l<g;l++)k[l]!==p&&(l>n+1&&1<l&&(q+=" "+((f+l-1)*d|0)+","+(k[l-1]*d+e)),n=l,p=k[l],q+=" "+((f+n)*d|0)+","+(p*d+e));q+=" "+((f+l)*d|0)+","+(k[l-1]*d+e);m.setAttribute("d",q)}this.isActualChannelCurveNeeded!==b&&(this.isActualChannelCurveNeeded=b,this.svgGrayCurve.style.display=
b?"":"none")}}
...
"GEMNUSEP";return h};c=h=>{const k=document.createElement("div");k.className="GEMNULBL";k.appendChild(document.createTextNode(h));return k};d=(h,k,m,l,n,p)=>{const q=document.createElement("div");q.className=p?"GEMNUIT GECLK "+p:"GEMNUIT GECLK";if(k)if(f&&(l&&f.radioHTML||!l&&f.checkHTML))q.innerHTML=l?f.radioHTML:f.checkHTML,k=q.firstChild,k.style.marginRight=l?f.radioMargin||"2px":f.checkMargin||"2px",m||(k.style.visibility="hidden");else{k=document.createElement("span");p=l?"\u25cf ":"\u25a0 ";
let t=null;if(f){let u=!1;l?f.radioCharacter&&(u=!0,p=f.radioCharacter,t=f.radioMargin||"2px"):f.checkCharacter&&(u=!0,p=f.checkCharacter,t=f.checkMargin||"2px");u&&(f.checkFontFamily&&(k.style.fontFamily=f.checkFontFamily),f.checkFontSize&&(k.style.fontSize=f.checkFontSize))}t&&(k.style.marginRight=t);k.appendChild(document.createTextNode(p));m||(k.style.visibility="hidden");q.appendChild(k)}q.appendChild(document.createTextNode(h));n&&(q.onclick=n);return q};this.element=a;a.className="GE";this.boundMouseMove=
...
d=1-d;d*=d;d+=.5*d;.55>d?d=0:1>d&&(d=smoothStep(.55,1,d));h=1-h;h=smoothStep(0,1,h);h*=h;h+=h;1<h&&(h=1);d+=.5*h;d=255*d|0;c[64*e+g]=255<=d?255:d}}a.texImage2D(a.TEXTURE_2D,0,a.ALPHA,64,64,0,a.ALPHA,a.UNSIGNED_BYTE,c)}analyze(a){let b=a-this.lastTime;33<b&&(b=33);this.lastTime=a;a=this.program.gl;var c=.00390625*b,d=1-c;const e=this.processedData,f=this.processedDataR,g=this.fft,h=this.BG_COLUMNS,k=this.BG_PARTICLES_BY_COLUMN,m=this.COLORS,l=this.program,n=this.bgPos,p=this.bgSpeedY,q=this.bgColor,
...
class ButtonControl{static init(){const a=document.getElementsByTagName("button");if(a)for(let b=a.length-1;0<=b;b--)ButtonControl.prepare(a[b])}static create(a,b){const c=document.createElement("button");c.setAttribute("type","button");a.id&&c.setAttribute("id",a.id);let d="btn";a.color&&(d+=" "+a.color);a.square&&(d+=" square");a.opaque||(d+=" transparent");a.className&&(d+=" "+a.className);c.className=d;const e=ButtonControl.prepare(c),f=a.text||(a.stringKey?Strings.translate(a.stringKey):"");
a.icon&&(d="large",!a.square&&f&&(d+=" margin"),!a.opaque&&a.color&&(d+=" "+a.color),e.appendChild(Icon.create(a.icon,d)));a.square?(c.setAttribute("aria-label",f),c.setAttribute("title",f)):e.appendChild(document.createTextNode(f));b||(a.onclick&&(c.onclick=a.onclick),a.parent&&a.parent.appendChild(c));return c}static prepare(a){const b=document.createElement("span");for(b.setAttribute("tabindex","-1");a.firstChild;){const c=a.firstChild;a.removeChild(c);b.appendChild(c)}a.appendChild(b);return b}static setText(a,
...
e=document.createElement("span"),f=a.parentNode,g=a.getAttribute("title")||Strings.translate(a.value);d.setAttribute("type","button");d.setAttribute("role","checkbox");d.setAttribute("aria-label",g);e.setAttribute("tabindex","-1");a.setAttribute("tabindex","-1");a.setAttribute("aria-label",g);d.className=a.className;a.className="";b||(b=a.getAttribute("data-icon"));b&&!c&&(c=a.getAttribute("data-icon-color"));f&&(f.insertBefore(d,a),f.removeChild(a));d.appendChild(e);e.appendChild(a);e.appendChild(Icon.createLarge("icon-checkbox-0",
"margin"));e.appendChild(Icon.createLarge("icon-checkbox-1","margin orange"));b&&e.appendChild(Icon.createLarge(b,c?"margin "+c:"margin"));e.appendChild(document.createTextNode(g));a.removeAttribute("value");a.removeAttribute("title");d.onclick=CheckboxControl.click;return d}static click(a){(a=(a.target||this).getElementsByTagName("input"))&&a[0]&&a[0].click()}}
...
break;case 3:e.innerHTML="500<br/>1k";break;case 4:e.innerHTML="2k<br/>4k";break;case 5:e.innerHTML="<br/>8k";break;case 6:e.innerHTML="<br/>16k"}AppUI.changeText(f,SimpleFilterEditorControl.sliderToDB(g));f.className="small-top-margin";d.className="simple-filter-slider";a.appendChild(d);b[c]=new SliderControl(d,!0,!0,-30,30,g,f,e);this.createHandler(b[c],c)}}static sliderToDB(a){return Formatter.formatDB(.5*a)}static sliderToY(a){return GraphicalFilterEditor.zeroChannelValueY-(a<<1)}static yToSlider(a){return Math.max(-30,
...
a.splice(0)}this.lastIndex=this.firstIndex=0;this.currentItem=this.currentListItem=null;this.containerHeight=this.element.scrollTop=0;this.container.style.height="0"}}scroll(){var a=this._adapter,b=this.element;if(a&&b){var c=this.items,d=this.itemHeightAndMargin,e=this.firstIndex-2;b=b.scrollTop/d|0;0>e&&(e=0);this.firstIndex=b;var f=this.visibleCount+(0===b?2:1===b?3:4);0>(b-=2)&&(b=0);if(b>e){if((e=b-e)&&e<f)for(let l=e,n=0;l<f;l++,n++)e=c[n],c[n]=c[l],c[l]=e}else if((e-=b)&&e<f)for(let l=f-1,
n=l-e;0<=n;n--,l--)e=c[l],c[l]=c[n],c[n]=e;var g=a.list,h=g.length,k=a.list.currentItem;e=this.container;var m=0;for(let l=b*d;m<f&&b<h;m++,b++,l+=d){const n=g.item(b),p=c[m];if(p.item!==n){const q=k===n;p.current!==q&&((p.current=q)?p.element.classList.add("current"):p.element.classList.remove("current"));a.prepareElement(n,b,h,p.element);p.item||e.appendChild(p.element);p.item=n}p.index!==b&&(p.index=b,p.element.style.transform="translateY("+l+"px)")}for(a=c.length;m<a;m++)d=c[m],d.item&&(d.item=
null,e.removeChild(d.element));this.lastIndex=b-1;this.lastIndex<this.firstIndex&&(this.lastIndex=this.firstIndex)}}refreshVisibleItemsInternal(){this.refreshVisibleItemsEnqueued=!1;var a=this._adapter,b=this.element;if(a&&b){this.adjustContainerHeight();b=this.items;var c=this.itemHeightAndMargin,d=a.list,e=d.length,f=a.list.currentItem,g=this.container;if(this.useVirtualItems){this.currentListItem=f;var h=0,k=this.firstIndex,m=this.visibleCount+(0===k?2:1===k?3:4);0>(k-=2)&&(k=0);for(let l=k*c;h<
m&&k<e;h++,k++,l+=c){const n=d.item(k),p=b[h],q=f===n;p.current!==q&&((p.current=q)?p.element.classList.add("current"):p.element.classList.remove("current"));a.prepareElement(n,k,e,p.element);p.item||g.appendChild(p.element);p.item=n;p.index!==k&&(p.index=k,p.element.style.transform="translateY("+l+"px)")}for(a=b.length;h<a;h++)d=b[h],d.item&&(d.item=null,g.removeChild(d.element))}else{g=this.visibleCount;for(let l=0,n=this.indexFromY(0);l<=g&&n<e;l++,n++)a.prepareElement(d.item(n),n,e,b[n].element)}}}resize(){const a=
...
(this.clientHeight-this.itemHeight>>1)}refreshVisibleItems(){this.refreshVisibleItemsEnqueued||(this.refreshVisibleItemsEnqueued=!0,queueMicrotask(this.boundRefreshVisibleItemsInternal))}notifyCleared(){this.clear()}notifyItemsAdded(a,b){if(this.useVirtualItems)this.refreshVisibleItems();else{const m=this.adapter,l=b-a+1;if(m&&!(0>=l)){var c=this.container,d=this.items,e=m.list,f=e.length,g=e.currentItem,h=Array(l);for(var k=b;k>=a;k--){const n=e.item(k),p=new ListControlItem(m.createEmptyElement("list-item real"));
m.prepareElement(n,k,f,p.element);h[k-a]=p;g===n&&(this.currentItem&&(this.currentItem.current=!1,this.currentItem.element.classList.remove("current")),this.currentItem=p,p.current=!0,p.element.classList.add("current"))}g=a>=d.length?null:d[a].element;a>=d.length?d.push(...h):d.splice(a,0,...h);if(this.items.length!==e.length)throw Error("Assertion error: this.items.length !== list.length");this.adjustContainerHeight();for(k=0;k<l;k++)c.insertBefore(h[k].element,g);for(c=d.length-1;c>b;c--)m.prepareElementIndexOrLengthChanged(e.item(c),
c,f,d[c].element);for(--a;0<=a;a--)m.prepareElementIndexOrLengthChanged(e.item(a),a,f,d[a].element)}}}notifyItemsRemoved(a,b){if(this.useVirtualItems)this.refreshVisibleItems();else{const g=this.adapter;var c=b-a+1;if(g&&!(0>=c)){var d=this.container;b=this.items;var e=g.list,f=e.length;a=b.splice(a,c);for(c=a.length-1;0<=c;c--){const h=a[c];h.current&&(this.currentItem=null);d.removeChild(h.element);h.zero()}if(this.items.length!==e.length)throw Error("Assertion error: this.items.length !== list.length");
for(d=b.length-1;0<=d;d--)g.prepareElementIndexOrLengthChanged(e.item(d),d,f,b[d].element);this.adjustContainerHeight()}}}notifyCurrentItemChanged(a,b){this.useVirtualItems?this.refreshVisibleItems():this.notifyCurrentItemChangedEnqueued||(this.notifyCurrentItemChangedEnqueued=!0,queueMicrotask(this.boundNotifyCurrentItemChangedInternal))}notifyCurrentItemChangedInternal(){this.notifyCurrentItemChangedEnqueued=!1;var a=this.adapter;a&&(this.currentItem&&(this.currentItem.current=!1,this.currentItem.element.classList.remove("current")),
...
a)}}}}
class Player{constructor(a,b,c,d,e,f,g,h){this.audioContextTimeout=0;this.audioContextSuspended=!0;const k=navigator.userAgent&&0<=navigator.userAgent.indexOf("Firefox")?1:"playback";this.audioContext=window.AudioContext?new window.AudioContext({latencyHint:k}):new window.webkitAudioContext({latencyHint:k});this.audioContext.suspend();this.audioContext.onstatechange=this.audioContextStateChanged.bind(this);this.graphicalFilterControl=new GraphicalFilterControl(a,b,this.audioContext,f);this.graphicalFilterControl.enabled=!!e;
this.stereoPannerControl=new StereoPannerControl(c,this.audioContext);this.stereoPannerControl.enabled=!!g;this.monoDownMixerControl=new MonoDownMixerControl(this.audioContext);this.monoDownMixerControl.enabled=MonoDownMixerControl.isSupported()&&!!h;this.stereoPannerControl.onappliedgainchanged=m=>{this.monoDownMixerControl&&(this.monoDownMixerControl.multiplier=1/(1+m))};this.onerror=this.oncurrenttimeschanged=this.onpausedchanged=this.onloadingchanged=this.onsongchanged=null;this.boundPlaybackError=
...
class InternalStorage{static cacheGet(a,b){return __awaiter(this,void 0,void 0,function*(){var c=yield caches.open(a);b=b?InternalStorage.cachePrefix+b:InternalStorage.cachePrefix;return(c=yield c.match(b))?c.arrayBuffer():null})}static cachePut(a,b,c){return __awaiter(this,void 0,void 0,function*(){const d=yield caches.open(a);b=b?InternalStorage.cachePrefix+b:InternalStorage.cachePrefix;return d.put(b,c)})}static loadAppSettings(){try{const a=localStorage.getItem("appSettings");if(a){const b=JSON.parse(a);
if(b)return b}}catch(a){}return{playerVolume:100,graphicalFilterControlEnabled:!1,graphicalFilterControlSimpleMode:544>window.innerWidth,stereoPannerControlEnabled:!1,monoDownMixerControlEnabled:!1}}static saveAppSettings(a){a?localStorage.setItem("appSettings",JSON.stringify(a)):localStorage.removeItem("appSettings")}static loadGraphicalFilterEditorSettings(){try{const a=localStorage.getItem("graphicalFilterEditorSettings");if(a){const b=JSON.parse(a);if(b)return b}}catch(a){}return{currentChannelIndex:0,
editMode:GraphicalFilterEditorControl.editModeShelfEq,isActualChannelCurveNeeded:!0,isNormalized:!1,isSameFilterLR:!0,showZones:!0}}static saveGraphicalFilterEditorSettings(a){a?localStorage.setItem("graphicalFilterEditorSettings",JSON.stringify(a)):localStorage.removeItem("graphicalFilterEditorSettings")}static loadStereoPannerSettings(){return Math.max(-StereoPannerControl.maxAbsoluteValue,Math.min(StereoPannerControl.maxAbsoluteValue,parseInt(localStorage.getItem("stereoPannerSettings"))|0))}static saveStereoPannerSettings(a){localStorage.setItem("stereoPannerSettings",
(a|0).toString())}static loadPlaylist(a){return __awaiter(this,void 0,void 0,function*(){const b=yield InternalStorage.cacheGet(InternalStorage.cacheNamePlaylists,a);if(!b)return null;try{return Playlist.deserialize(new DataReader(b))}catch(c){return null}})}static loadPlaylistWeb(a){return(a=localStorage.getItem(a||"defaultPlaylist"))?Playlist.deserializeWeb(a):null}static savePlaylist(a,b){return InternalStorage.cachePut(InternalStorage.cacheNamePlaylists,b,new Response(a.serialize().trimmedArrayBuffer))}static savePlaylistWeb(a,
b){return localStorage.setItem(b||"defaultPlaylist",JSON.stringify(a.serializeWeb()))}}InternalStorage.cachePrefix="https://fplay.com.br/";InternalStorage.cacheNamePlaylists="playlists";
class Modal{constructor(a){this.options=a;var b=document.querySelectorAll("button,input,select,textarea,.slider-control"),c=Array(b.length);for(let d=b.length-1;0<=d;d--){const e=b[d],f=e.getAttribute("tabindex");e.setAttribute("tabindex","-1");c[d]={element:e,tabindex:f}}this.changedElements=c;this.oldBodyOverflow=document.body.style.overflow;document.body.style.overflow="hidden";this.containerElement=document.createElement("div");this.containerElement.className=a.transparentBackground?"modal-container fade":
...
(App.player.stereoPannerControl.enabled=AppUI.stereoPannerControlEnabled.checked)}static monoDownMixerControlEnabledClicked(){App.player&&(App.player.monoDownMixerControl.enabled=AppUI.monoDownMixerControlEnabled.checked)}static addFiles(a){return __awaiter(this,void 0,void 0,function*(){if(App.player&&!AppUI._loading){var b=App.hostType===App.hostTypeElectron,c=b?yield App.showOpenFileDialog():yield App.showOpenDialogWeb(a);if(c&&App.player)try{AppUI._loading=!0;App.updateLoadingIcon();App.player.playlist||
(App.player.playlist=new Playlist,AppUI.preparePlaylist());const d=App.player.playlist,e=b?null:new Uint8Array(BufferedFileHandle.minBufferLength<<1),f=b?null:[new Uint8Array(256)];let g=!1;for(let h=0;h<c.length&&App.player;h++)if(b)yield d.addSong(c[h]);else{const k=d.length;(yield d.addSongWeb(c[h],e,f))&&k===d.length&&(g=!0)}g&&AppUI.playlistControl&&AppUI.playlistControl.refreshVisibleItems()}catch(d){Modal.show({text:"addFiles error: "+(d.message||d.toString())})}finally{AppUI._loading=!1,App.updateLoadingIcon()}}})}static addDirectory(a){return __awaiter(this,
void 0,void 0,function*(){const b=yield App.listDirectory(a);if(!App.player||!App.player.playlist||AppUI.directoryCancelled)return!1;if(!b)return!0;for(let c=0;c<b.length;c++)if(b[c].isDirectory){if(!(yield AppUI.addDirectory(b[c].fileURL)))return!1}else{if(!App.player||!App.player.playlist||AppUI.directoryCancelled)return!1;yield App.player.playlist.addSong(b[c])}return!0})}static addDirectories(){return __awaiter(this,void 0,void 0,function*(){if(App.player&&!AppUI._loading){if(App.hostType!==App.hostTypeElectron)return AppUI.addFiles(!0);
var a=yield App.showOpenDirectoryDialog();if(a&&App.player)try{AppUI._loading=!0;AppUI.directoryCancelled=!1;App.updateLoadingIcon();App.player.playlist||(App.player.playlist=new Playlist,AppUI.preparePlaylist());for(let b=0;b<a.length&&(yield AppUI.addDirectory(a[b]));b++);}catch(b){Modal.show({text:"addDirectories error: "+(b.message||b.toString())})}finally{AppUI._loading=!1,AppUI.directoryCancelled=!1,App.updateLoadingIcon()}}})}static switchView(){AppUI.panelContainer&&AppUI.panelContainer.classList.toggle("toggled")}static showAbout(){Modal.show({html:Strings.AboutHTML+
...
"file"),App.fileInput.setAttribute("multiple","multiple"),App.fileInput.setAttribute("aria-label",Strings.AddFiles),App.fileInput.onchange=function(){if(App.fileInput&&App.fileInputPromiseResolve&&parseInt(App.fileInput.getAttribute("data-version"))===App.fileInputVersion){App.fileInputVersion++;var d=App.fileInputPromiseResolve;App.fileInputPromiseResolve=null;if(App.fileInput.files&&App.fileInput.files.length){var e=Array(App.fileInput.files.length),f=null;try{var g=App.hostInterface&&App.hostInterface.getFileURLsJSON()||
null;g&&(f=JSON.parse(g))}catch(h){}if(f&&f.length===e.length)for(g=e.length-1;0<=g;g--)e[g]=App.fileInput.files[g],e[g]["data-path"]=f[g];else for(f=e.length-1;0<=f;f--)e[f]=App.fileInput.files[f];App.fileInput.value="";d(App.sortFiles(e))}else d(null)}},c.appendChild(App.fileInput),document.getElementById("top-panel").appendChild(c));AppUI.preInit(b,a)}static init(){return __awaiter(this,void 0,void 0,function*(){if(!App.player){var a=InternalStorage.loadAppSettings();App.player=new Player(document.getElementById("filter-container"),
document.getElementById("optional-panel-container"),document.getElementById("stereo-panner-slider"),a.playerVolume,a.graphicalFilterControlEnabled,a.graphicalFilterControlSimpleMode,a.stereoPannerControlEnabled,a.monoDownMixerControlEnabled);try{const b=App.insideNativeHost?yield InternalStorage.loadPlaylist():InternalStorage.loadPlaylistWeb();if(!App.player||!App.player.alive)return;b&&(App.player.playlist=b)}catch(b){}App.player&&App.player.alive&&(AppUI.init(a),(a=document.getElementById("cover"))&&
a.classList.remove("in"),setTimeout(function(){window.removeEventListener("resize",App.adjustCover);const b=document.getElementById("cover");b&&document.body.removeChild(b)},320),App.loading=!1)}})}static triggerMainWindowStateChanged(){App.ipcRenderer&&App.ipcRenderer.invoke("triggerMainWindowStateChanged")}static mainWindowMinimize(){App.ipcRenderer&&App.ipcRenderer.invoke("mainWindowMinimize")}static mainWindowRestoreOrMaximize(){App.ipcRenderer&&App.ipcRenderer.invoke(App.isMaximized?"mainWindowRestore":
"mainWindowMaximize")}static mainWindowClose(){App.ipcRenderer&&App.ipcRenderer.invoke("mainWindowClose")}static showOpenFileDialog(){return __awaiter(this,void 0,void 0,function*(){if(App.fileInput||App._showingDialog)return null;try{return App._showingDialog=!0,yield App.ipcRenderer.invoke("showOpenFileDialog")}finally{App._showingDialog=!1}})}static convertFilePathsToAppFiles(a){return App.ipcRenderer.invoke("convertFilePathsToAppFiles",a)}static showOpenDirectoryDialog(){return __awaiter(this,
void 0,void 0,function*(){if(App._showingDialog)return null;try{return App._showingDialog=!0,yield App.ipcRenderer.invoke("showOpenDirectoryDialog")}finally{App._showingDialog=!1}})}static listDirectory(a){return App.ipcRenderer.invoke("listDirectory",a)}static extractMetadata(a,b){return App.ipcRenderer.invoke("extractMetadata",a,b)}static showOpenDialogWeb(a){if(!App.fileInput)return Promise.resolve(null);App.fileInputPromiseResolve&&(App.fileInputPromiseResolve(null),App.fileInputPromiseResolve=
null);App.fileInput.setAttribute("data-version",(++App.fileInputVersion).toString());a?(App.fileInput.setAttribute("webkitdirectory","webkitdirectory"),App.fileInput.setAttribute("directory","directory"),App.fileInput.removeAttribute("accept")):(App.fileInput.removeAttribute("webkitdirectory"),App.fileInput.removeAttribute("directory"),App.fileInput.setAttribute("accept",Playlist.concatenatedSupportedExtensions));return new Promise(b=>{App.fileInputPromiseResolve=b;App.fileInput.click()})}}
App.hostTypeElectron="Electron";App.ipcRenderer=window.electronIpcRenderer||null;App.closeHandlers=[];App.frameless=!!window.electronIpcRenderer;App.hostInterface=window.hostInterface||null;App.insideNativeHost=App.frameless||!!App.hostInterface;App.hostType=App.hostInterface&&App.hostInterface.getHostType()||null;App.iconLoading=document.getElementById("icon-loading");App.titleBar=null;App.iconRestore=null;App.iconMaximize=null;App.installPrompt=null;App.fileInputVersion=0;App._loading=!0;
App._showingDialog=!1;App.isMinimized=!1;App.isMaximized=!1;function main(){App.init()}App.preInit();let cLib;function cancelEvent(a){a&&("isCancelled"in a&&(a.isCancelled=!0),!("preventDefault"in a)||"cancelable"in a&&!a.cancelable||a.preventDefault(),"stopPropagation"in a&&a.stopPropagation());return!1}function lerp(a,b,c,d,e){return(e-a)*(d-b)/(c-a)+b}function smoothStep(a,b,c){a=(c-a)/(b-a);return 0>=a?0:1<=a?1:a*a*(3-2*a)}
