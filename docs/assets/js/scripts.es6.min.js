...
a.html:this.modalBodyElement.appendChild(a.html);if((b=this.modalBodyElement.getElementsByTagName("button"))&&b.length)for(c=b.length-1;0<=c;c--){const d=b[c];ButtonControl.prepare(d);d.onclick=()=>{if(!this.fading&&this.options.onbuttonclick)this.options.onbuttonclick(d.id,d)}}this.modalFooterElement=document.createElement("div");this.modalFooterElement.className=a.buttons&&1===a.buttons.length?"modal-footer right":"modal-footer";this.defaultSubmitButton=this.defaultCancelButton=null;if(a.buttons)for(b=
