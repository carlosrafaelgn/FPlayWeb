...
class Strings{static toFixed(a,b){return a.toFixed(b)}static init(){const a=navigator.userLanguage||navigator.language;a&&0===a.toLowerCase().indexOf("pt")&&(Strings.language="pt-br",document.documentElement.setAttribute("lang","pt-br"),Strings.DecimalSeparator=",",Strings.OppositeDecimalSeparator=".",Strings.Edit="Edit",Strings.Delete="Excluir",Strings.Enable="Habilitar",Strings.Disable="Desabilitar",Strings.Enabled="Habilitado",Strings.Disabled="Desabilitado",Strings.Cancel="Cancelar",Strings.Clear=
...
Strings.PleaseRefresh="Por favor, recarregue a p\u00e1gina para atualizar a aplica\u00e7\u00e3o \ud83d\ude0a");Strings.translateChildren(document.body)}static translate(a){const b=Strings[a];return void 0!==b?b:a}static translateChildren(a){a=a.childNodes;for(let d=a.length-1;0<=d;d--){const e=a[d];if(!e.tagName)continue;e.childNodes&&e.childNodes.length&&Strings.translateChildren(e);let f;(f=e.getAttribute("title"))&&e.setAttribute("title",Strings.translate(f));if(f=e.getAttribute("data-string")){e.removeAttribute("data-string");
var b=0;do{let g=f.indexOf(";",b);g<b&&(g=f.length);var c=f.indexOf("|",b);0>c||c>=g?e.appendChild(document.createTextNode(Strings.translate(f))):(b=f.substring(b,c),c=f.substring(c+1,g),e.setAttribute(b,Strings.translate(c)));b=g+1}while(b<f.length)}}}}Strings.language="en";Strings.DecimalSeparator=".";Strings.OppositeDecimalSeparator=",";Strings.Oops="Oops\u2026";Strings.Menu="Menu";Strings.Edit="Edit";Strings.Delete="Delete";Strings.Enable="Enable";Strings.Disable="Disable";Strings.Enabled="Enabled";
Strings.Disabled="Disabled";Strings.OK="OK";Strings.Cancel="Cancel";Strings.Clear="Clear";Strings.Back="Back";Strings.Close="Close";Strings.Refresh="Refresh";Strings.Exit="Exit";Strings.Previous="Previous";Strings.Play="Play";Strings.Pause="Pause";Strings.PlayPause="Play / Pause";Strings.Stop="Stop";Strings.Next="Next";Strings.Volume="Volume";Strings.UnknownError="Unknown error";Strings.AddFiles="Add Files";Strings.AddFolders="Add Folders";Strings.ShowFilter="Show Filter";Strings.ShowPlaylist="Show Playlist";
Strings.UpdateAvailable="Update Available!";Strings.PleaseRefresh="Please, refresh the page to update the app \ud83d\ude0a";
...
this.pointerId&&"mouse"!==a.pointerType)return cancelEvent(a);if("touch"===a.pointerType&&a.target&&a.target.tagName){var b=a.target.getBoundingClientRect();if(a.clientX<b.left||a.clientX>=b.right||a.clientY<b.top||a.clientY>=b.bottom)return cancelEvent(a)}b=this.mouseDown(a);this._captured&&(this.pointerId=a.pointerId);return b}pointerMove(a){if(this._captured&&a.pointerId===this.pointerId)return this.mouseMove(a)}pointerUp(a){if(this._captured&&a.pointerId===this.pointerId)return this.pointerId=
-1,this.mouseUp(a)}touchStart(a){if(!(1<a.touches.length))return 0<=this.pointerId&&this.touchEnd(a),this.pointerId=1,a.clientX=a.touches[0].clientX,a.clientY=a.touches[0].clientY,a=this.mouseDown(a),void 0===a&&(this.pointerId=-1),a}touchMove(a){if(this._captured&&!(1<a.touches.length))return a.clientX=a.touches[0].clientX,a.clientY=a.touches[0].clientY,this.mouseMove(a)}touchEnd(a){if(this._captured&&!(0>this.pointerId))return this.pointerId=-1,this.mouseUp(a)}mouseDown(a){this.mouseUp(a);if(!a.button&&
(!a.target||a.target===this.element||this.outsidePointerHandler&&this.outsidePointerHandler(a))){if(this.downCallback&&!this.downCallback(a))return cancelEvent(a);this._captured=!0;this.lazy&&this.addSecondaryHandlers();return cancelEvent(a)}}mouseMove(a){if(this._captured)return this.moveCallback&&this.moveCallback(a),cancelEvent(a)}mouseUp(a){if(this._captured)return this._captured=!1,this.lazy&&this.removeSecondaryHandlers(),this.upCallback&&this.upCallback(a),cancelEvent(a)}}
