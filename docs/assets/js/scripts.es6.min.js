...
a.childNodes;for(let d=a.length-1;0<=d;d--){const e=a[d];if(!e.tagName)continue;e.childNodes&&e.childNodes.length&&Strings.translateChildren(e);let f;(f=e.getAttribute("title"))&&e.setAttribute("title",Strings.translate(f));if(f=e.getAttribute("data-string")){e.removeAttribute("data-string");var b=0;do{let g=f.indexOf(";",b);g<b&&(g=f.length);var c=f.indexOf("|",b);0>c||c>=g?e.appendChild(document.createTextNode(Strings.translate(f))):(b=f.substring(b,c),c=f.substring(c+1,g),e.setAttribute(b,Strings.translate(c)));
b=g+1}while(b<f.length)}}}}Strings.language="en";Strings.DecimalSeparator=".";Strings.OppositeDecimalSeparator=",";Strings.Oops="Oops\u2026";Strings.Menu="Menu";Strings.Edit="Edit";Strings.Delete="Delete";Strings.Enable="Enable";Strings.Disable="Disable";Strings.Enabled="Enabled";Strings.Disabled="Disabled";Strings.OK="OK";Strings.Cancel="Cancel";Strings.Clear="Clear";Strings.Back="Back";Strings.Close="Close";Strings.Exit="Exit";Strings.Previous="Previous";Strings.Play="Play";Strings.Pause="Pause";
...
typeof a?MetadataExtractor.finishReadingV2Frame(d,a,e):a.then(function(f){return MetadataExtractor.finishReadingV2Frame(d,f,e)})}static extractID3v1(a,b,c,d){return __awaiter(this,void 0,void 0,function*(){try{b.seekTo(b.fileLength-128);const g=b.read(d,0,128);"number"!==typeof g&&(yield g);if(84==d[0]&&65==d[1]&&71==d[2]){var e;if(!(c&MetadataExtractor.TITLE_B)){var f=3;for(e=0;30>e&&d[f];)e++,f++;e&&(a.title=MetadataExtractor.textDecoderIso88591.decode(d.subarray(3,3+e)))}if(!(c&MetadataExtractor.ARTIST_B)){f=
33;for(e=0;30>e&&d[f];)e++,f++;e&&(a.artist=MetadataExtractor.textDecoderIso88591.decode(d.subarray(33,33+e)))}if(!(c&MetadataExtractor.ALBUM_B)){f=63;for(e=0;30>e&&d[f];)e++,f++;e&&(a.album=MetadataExtractor.textDecoderIso88591.decode(d.subarray(63,63+e)))}if(!(c&MetadataExtractor.YEAR_B)){f=93;for(e=0;4>e&&d[f];)e++,f++;e&&(a.year=parseInt(MetadataExtractor.textDecoderIso88591.decode(d.subarray(93,93+e))))}c&MetadataExtractor.TRACK_B||d[125]||!d[126]||(a.track=d[126]&255)}}catch(g){}})}static extractID3v2Andv1(a,
b,c){return __awaiter(this,void 0,void 0,function*(){const d={url:Formatter.pathToURL(a.path)||Formatter.empty,file:a};var e=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==e)if(e|=b.readByte(),1380533830===e){e=yield MetadataExtractor.extractRIFF(d,b,c[0]);if(!e)return null;if(!e[1])return d}else return yield MetadataExtractor.extractID3v1(d,b,0,c[0]),d;var f=b.readByte(),g=b.readByte();e=b.readByte();var h=b.readByte();const k=b.readByte(),m=b.readByte(),l=b.readByte();e=(e&16?
10:0)+(l&127|(m&127)<<7|(k&127)<<14|(h&127)<<21);if(2<(f&255)||g){for(f=0;0<e&&f!==MetadataExtractor.ALL_B;){(g=b.fillBuffer(1024))&&(yield g);h=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();g=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();b.skip(2);if(!h||0>=g||g>e)break;switch(h){case 1414091826:f&MetadataExtractor.TITLE_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.title=h&&h.then?yield h:h,d.title&&(f|=MetadataExtractor.TITLE_B));break;case 1414546737:f&
MetadataExtractor.ARTIST_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.artist=h&&h.then?yield h:h,d.artist&&(f|=MetadataExtractor.ARTIST_B));break;case 1413565506:f&MetadataExtractor.ALBUM_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.album=h&&h.then?yield h:h,d.album&&(f|=MetadataExtractor.ALBUM_B));break;case 1414677323:f&MetadataExtractor.TRACK_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.track=h&&h.then?parseInt(yield h):parseInt(h),d.track?f|=MetadataExtractor.TRACK_B:
d.track=0);break;case 1414284622:f&MetadataExtractor.LENGTH_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.lengthMS=h&&h.then?parseInt(yield h):parseInt(h),d.lengthMS?f|=MetadataExtractor.LENGTH_B:d.lengthMS=0);break;case 1415136594:case 1413763651:f&MetadataExtractor.YEAR_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.year=h&&h.then?parseInt(yield h):parseInt(h),d.year?f|=MetadataExtractor.YEAR_B:d.year=0);break;default:b.skip(g)}e-=10+g}(f&MetadataExtractor.ALL_BUT_LENGTH_B)!==MetadataExtractor.ALL_BUT_LENGTH_B&&
(yield MetadataExtractor.extractID3v1(d,b,f,c[0]))}return d})}static extract(a,b,c){return __awaiter(this,void 0,void 0,function*(){if(!a)return null;if(!a.name.endsWith(".mp3")&&!a.name.endsWith(".aac")&&!a.name.endsWith(".wav")){const d=a.name.toLowerCase();if(!d.endsWith(".mp3")&&!d.endsWith(".aac")&&!d.endsWith(".wav"))return null}b||(b=new Uint8Array(BufferedFileHandle.minBufferLength));c||(c=[new Uint8Array(256)]);try{const d=new BufferedFileHandle(a,b);yield d.fillBuffer(-1);return yield MetadataExtractor.extractID3v2Andv1(a,
d,c)}catch(d){return null}})}}MetadataExtractor.ALL_B=63;MetadataExtractor.ALL_BUT_LENGTH_B=31;MetadataExtractor.TITLE_B=1;MetadataExtractor.ARTIST_B=2;MetadataExtractor.ALBUM_B=4;MetadataExtractor.TRACK_B=8;MetadataExtractor.YEAR_B=16;MetadataExtractor.LENGTH_B=32;MetadataExtractor.textDecoderIso88591=new TextDecoder("iso-8859-1");MetadataExtractor.textDecoderUtf16=new TextDecoder("utf-16");MetadataExtractor.textDecoderUtf16be=new TextDecoder("utf-16be");MetadataExtractor.textDecoderUtf8=new TextDecoder("utf-8");
...
AppUI.minWidthREM=216;AppUI.minWidthPX=AppUI.remToPX(AppUI.minWidthREM);AppUI.baseThinBorderPX=1;AppUI.baseThickBorderPX=2;AppUI.zoomHandlers=[];AppUI.rootVariables=document.getElementById("root-variables");AppUI.panelContainer=document.getElementById("panel-container");AppUI.fixedPanel=document.getElementById("fixed-panel");AppUI.optionalPanel=document.getElementById("optional-panel");AppUI.iconPlay=document.getElementById("icon-play");AppUI.iconPause=document.getElementById("icon-pause");
AppUI.artistLabel=document.getElementById("artist-label");AppUI.titleLabel=document.getElementById("title-label");AppUI._loading=!1;AppUI.devicePixelRatio=-1;AppUI._smallIconSizePX=Icon.baseSizePX;AppUI._largeIconSizePX=Icon.baseSizePX<<1;AppUI._thinBorderPX=AppUI.baseThinBorderPX;AppUI._thickBorderPX=AppUI.baseThickBorderPX;AppUI.directoryCancelled=!1;
...
App.ipcRenderer.invoke(App.isMaximized?"mainWindowRestore":"mainWindowMaximize")}static mainWindowClose(){App.ipcRenderer&&App.ipcRenderer.invoke("mainWindowClose")}static readWasmLibrary(){return __awaiter(this,void 0,void 0,function*(){return(yield fetch("assets/lib/graphicalFilterEditor/lib.wasm")).arrayBuffer()})}static showOpenFileDialog(){return __awaiter(this,void 0,void 0,function*(){if(App.fileInput||App._showingDialog)return null;try{return App._showingDialog=!0,yield App.ipcRenderer.invoke("showOpenFileDialog")}finally{App._showingDialog=
!1}})}static convertFilePathsToAppFiles(a){return App.ipcRenderer.invoke("convertFilePathsToAppFiles",a)}static showOpenDirectoryDialog(){return __awaiter(this,void 0,void 0,function*(){if(App._showingDialog)return null;try{return App._showingDialog=!0,yield App.ipcRenderer.invoke("showOpenDirectoryDialog")}finally{App._showingDialog=!1}})}static listDirectory(a){return App.ipcRenderer.invoke("listDirectory",a)}static extractMetadata(a,b){return App.ipcRenderer.invoke("extractMetadata",a,b)}static showOpenDialogWeb(a){return __awaiter(this,
void 0,void 0,function*(){if(!App.fileInput)return null;App.fileInputPromiseResolve&&(App.fileInputPromiseResolve(null),App.fileInputPromiseResolve=null);App.fileInput.setAttribute("data-version",(++App.fileInputVersion).toString());a?(App.fileInput.setAttribute("webkitdirectory","webkitdirectory"),App.fileInput.setAttribute("directory","directory"),App.fileInput.removeAttribute("accept")):(App.fileInput.removeAttribute("webkitdirectory"),App.fileInput.removeAttribute("directory"),App.fileInput.setAttribute("accept",
Playlist.concatenatedSupportedExtensions));return new Promise(b=>{App.fileInputPromiseResolve=b;App.fileInput.click()})})}}App.electron=!!window.electronIpcRenderer;App.frameless=App.electron;App.ipcRenderer=window.electronIpcRenderer;App.closeHandlers=[];App.iconLoading=document.getElementById("icon-loading");App.titleBar=null;App.iconRestore=null;App.iconMaximize=null;App.installPrompt=null;App.fileInputVersion=0;App._loading=!0;App._showingDialog=!1;App.isMinimized=!1;App.isMaximized=!1;
function main(){App.init()}App.preInit();let cLib;function cancelEvent(a){a&&("isCancelled"in a&&(a.isCancelled=!0),"preventDefault"in a&&a.preventDefault(),"stopPropagation"in a&&a.stopPropagation());return!1}function lerp(a,b,c,d,e){return(e-a)*(d-b)/(c-a)+b}function smoothStep(a,b,c){a=(c-a)/(b-a);return 0>=a?0:1<=a?1:a*a*(3-2*a)}
