...
class StereoPannerControl extends Filter{constructor(a,b,c,d){super(d);this._enabled=!!c;this._pan=InternalStorage.loadStereoPannerSettings();this.stereoPanner=b.createStereoPanner();this.stereoPanner.pan.value=this._pan;b=e=>{this._pan=e;this.stereoPanner&&(this.stereoPanner.pan.value=e/10)};this.slider=new SliderControl(a,!0,!1,-10,10,this._pan);this.slider.ondragended=b;this.slider.onkeyboardchanged=b}get enabled(){return this._enabled}set enabled(a){this._enabled!==a&&(this._enabled=a,this.stereoPanner&&
this.filterChangedCallback&&this.filterChangedCallback())}get pan(){return this._pan}set pan(a){this._pan!==a&&(this._pan=Math.max(-10,Math.min(10,a|0)),this.stereoPanner&&(this.stereoPanner.pan.value=this._pan/10))}saveSettings(){InternalStorage.saveStereoPannerSettings(this._pan)}get inputNode(){return this.stereoPanner}get outputNode(){return this.stereoPanner}destroy(){this.stereoPanner&&(super.destroy(),zeroObject(this))}}var LibMikModMessageId;
