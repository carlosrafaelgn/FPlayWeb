...
class Strings{static toFixed(a,b){return a.toFixed(b)}static init(){const a=navigator.userLanguage||navigator.language;a&&0===a.toLowerCase().indexOf("pt")&&(Strings.language="pt-br",document.documentElement.setAttribute("lang","pt-br"),Strings.DecimalSeparator=",",Strings.OppositeDecimalSeparator=".",Strings.About="Sobre",Strings.Edit="Edit",Strings.Delete="Excluir",Strings.Enable="Ativar",Strings.Disable="Desativar",Strings.Enabled="Ativado",Strings.Disabled="Desativado",Strings.AdvancedFilter=
"Filtro avan\u00e7ado",Strings.TraditionalFilter="Filtro tradicional",Strings.Cancel="Cancelar",Strings.Clear="Limpar",Strings.Back="Voltar",Strings.Close="Fechar",Strings.Refresh="Recarregar",Strings.Exit="Sair",Strings.Previous="Anterior",Strings.Play="Tocar",Strings.Pause="Pausar",Strings.PlayPause="Tocar / Pausar",Strings.Stop="Parar",Strings.Next="Pr\u00f3xima",Strings.LeftAbbrev="E",Strings.RightAbbrev="D",Strings.DownMixToMono="Fazer down-mix para mono",Strings.UnknownError="Erro desconhecido",
...
93+e))))}c&MetadataExtractor.TRACK_B||d[125]||!d[126]||(a.track=d[126]&255)}}catch(g){}})}static extractID3v2Andv1(a,b,c){return __awaiter(this,void 0,void 0,function*(){const d={url:Formatter.pathToURL(a.path)||Formatter.empty,file:a};var e=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==e)if(e|=b.readByte(),1380533830===e){e=yield MetadataExtractor.extractRIFF(d,b,c[0]);if(!e)return null;if(!e[1])return d}else return yield MetadataExtractor.extractID3v1(d,b,0,c[0]),d;var f=b.readByte(),
g=b.readByte();e=b.readByte();var h=b.readByte();const k=b.readByte(),m=b.readByte(),l=b.readByte();e=(e&16?10:0)+(l&127|(m&127)<<7|(k&127)<<14|(h&127)<<21);if(2<(f&255)||g){for(f=0;0<e&&f!==MetadataExtractor.ALL_B;){(g=b.fillBuffer(1024))&&(yield g);h=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();g=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();b.skip(2);if(!h||0>=g||g>e)break;switch(h){case 1414091826:f&MetadataExtractor.TITLE_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,
g,c),d.title=h&&h.then?yield h:h,d.title&&(f|=MetadataExtractor.TITLE_B));break;case 1414546737:f&MetadataExtractor.ARTIST_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.artist=h&&h.then?yield h:h,d.artist&&(f|=MetadataExtractor.ARTIST_B));break;case 1413565506:f&MetadataExtractor.ALBUM_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.album=h&&h.then?yield h:h,d.album&&(f|=MetadataExtractor.ALBUM_B));break;case 1414677323:f&MetadataExtractor.TRACK_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,
g,c),d.track=h&&h.then?parseInt(yield h):parseInt(h),d.track?f|=MetadataExtractor.TRACK_B:d.track=0);break;case 1414284622:f&MetadataExtractor.LENGTH_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.lengthMS=h&&h.then?parseInt(yield h):parseInt(h),d.lengthMS?f|=MetadataExtractor.LENGTH_B:d.lengthMS=0);break;case 1415136594:case 1413763651:f&MetadataExtractor.YEAR_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.year=h&&h.then?parseInt(yield h):parseInt(h),d.year?f|=MetadataExtractor.YEAR_B:
d.year=0);break;default:b.skip(g)}e-=10+g}(f&MetadataExtractor.ALL_BUT_LENGTH_B)!==MetadataExtractor.ALL_BUT_LENGTH_B&&(yield MetadataExtractor.extractID3v1(d,b,f,c[0]))}return d})}static extract(a,b,c){return __awaiter(this,void 0,void 0,function*(){if(!a)return null;if(!a.name.endsWith(".mp3")&&!a.name.endsWith(".aac")&&!a.name.endsWith(".wav")){const d=a.name.toLowerCase();if(!d.endsWith(".mp3")&&!d.endsWith(".aac")&&!d.endsWith(".wav"))return null}b||(b=new Uint8Array(BufferedFileHandle.minBufferLength));
c||(c=[new Uint8Array(256)]);try{const d=new BufferedFileHandle(a,b);yield d.fillBuffer(-1);return yield MetadataExtractor.extractID3v2Andv1(a,d,c)}catch(d){return null}})}}MetadataExtractor.ALL_B=63;MetadataExtractor.ALL_BUT_LENGTH_B=31;MetadataExtractor.TITLE_B=1;MetadataExtractor.ARTIST_B=2;MetadataExtractor.ALBUM_B=4;MetadataExtractor.TRACK_B=8;MetadataExtractor.YEAR_B=16;MetadataExtractor.LENGTH_B=32;MetadataExtractor.textDecoderIso88591=new TextDecoder("iso-8859-1");
MetadataExtractor.textDecoderUtf16=new TextDecoder("utf-16");MetadataExtractor.textDecoderUtf16be=new TextDecoder("utf-16be");MetadataExtractor.textDecoderUtf8=new TextDecoder("utf-8");
class Formatter{static formatTimeMS(a){if(0>a)return Formatter.none;a=a/1E3|0;let b=(a/60|0)+":";a%=60;10>a&&(b+="0");return b+a}static formatTimeS(a){if(0>a)return Formatter.none;let b=(a/60|0)+":";a%=60;10>a&&(b+="0");return b+a}static formatDB(a){return 0>a?Strings.toFixed(a,1):0===a?"-"+Strings.toFixed(a,1):"+"+Strings.toFixed(a,1)}static pathToURL(a){return!a||a.startsWith(Formatter.fileURLPrefix)?a:encodeURI(a.startsWith("/")?Formatter.fileURLPrefix+a:Formatter.fileURLPrefixWindows+a.replace(Formatter.regExpSepWindows,
"/"))}}Formatter.zero="0:00";Formatter.none="-";Formatter.noneInt=-1;Formatter.empty="";Formatter.fileURLPrefix="file://";Formatter.fileURLPrefixWindows="file:///";Formatter.regExpSepWindows=/\\/g;class ListItem{constructor(){this.id=++ListItem.Id}}ListItem.Id=0;
...
(App.player.stereoPannerControl.enabled=AppUI.stereoPannerControlEnabled.checked)}static monoDownMixerControlEnabledClicked(){App.player&&(App.player.monoDownMixerControl.enabled=AppUI.monoDownMixerControlEnabled.checked)}static addFiles(a){return __awaiter(this,void 0,void 0,function*(){if(App.player&&!AppUI._loading){var b=App.electron?yield App.showOpenFileDialog():yield App.showOpenDialogWeb(a);if(b&&App.player)try{AppUI._loading=!0;App.updateLoadingIcon();App.player.playlist||(App.player.playlist=
new Playlist,AppUI.preparePlaylist());const c=App.electron?null:new Uint8Array(BufferedFileHandle.minBufferLength<<1),d=App.electron?null:[new Uint8Array(256)];for(let e=0;e<b.length&&App.player&&App.player.playlist;e++)App.electron?yield App.player.playlist.addSong(b[e]):yield App.player.playlist.addSongWeb(b[e],c,d)}catch(c){alert("addFiles error: "+(c.message||c.toString()))}finally{AppUI._loading=!1,App.updateLoadingIcon()}}})}static addDirectory(a){return __awaiter(this,void 0,void 0,function*(){const b=
yield App.listDirectory(a);if(!App.player||!App.player.playlist||AppUI.directoryCancelled)return!1;if(!b)return!0;for(let c=0;c<b.length;c++)if(b[c].isDirectory){if(!(yield AppUI.addDirectory(b[c].fileURL)))return!1}else{if(!App.player||!App.player.playlist||AppUI.directoryCancelled)return!1;yield App.player.playlist.addSong(b[c])}return!0})}static addDirectories(){return __awaiter(this,void 0,void 0,function*(){if(App.player&&!AppUI._loading){if(!App.electron)return AppUI.addFiles(!0);var a=yield App.showOpenDirectoryDialog();
if(a&&App.player)try{AppUI._loading=!0;AppUI.directoryCancelled=!1;App.updateLoadingIcon();App.player.playlist||(App.player.playlist=new Playlist,AppUI.preparePlaylist());for(let b=0;b<a.length&&(yield AppUI.addDirectory(a[b]));b++);}catch(b){alert("addDirectories error: "+(b.message||b.toString()))}finally{AppUI._loading=!1,AppUI.directoryCancelled=!1,App.updateLoadingIcon()}}})}static switchView(){AppUI.panelContainer&&AppUI.panelContainer.classList.toggle("toggled")}static showAbout(){Modal.show({html:Strings.AboutHTML+
...
graphicalFilterControlEnabled:App.player.graphicalFilterControl.enabled,graphicalFilterControlSimpleMode:App.player.graphicalFilterControl.simpleMode,stereoPannerControlEnabled:App.player.stereoPannerControl.enabled,monoDownMixerControlEnabled:App.player.monoDownMixerControl.enabled});App.player.destroy(!0);if(a&&a.length)for(let d=a.length-1;0<=d;d--)if(a[d]){const e=a[d]();e&&b.push(e)}App.electron&&(c&&b.push(InternalStorage.savePlaylist(c)),b.length?Promise.all(b).then(App.destroy,App.destroy):
...
window.addEventListener("onpagehide"in window?"pagehide":"unload",App.mainWindowClosing);App.frameless&&(App.titleBar=document.createElement("h1"),App.titleBar.innerHTML=`
				<div></div>
				<i id="icon-main"></i>
				FPlay
