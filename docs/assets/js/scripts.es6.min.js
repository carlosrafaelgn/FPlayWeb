...
(n=b.fillBuffer(1024))&&(yield n);if(4<l){m=b.readByte();var p=b.readByte();n=b.readByte();if(null===m||null===p||null===n)break a;e-=3;l-=3;if(73===m||68===p||51===n)if(d=b.fileLength-e,f&&g){d=-1;break a}}b.skip(l);(n=b.fillBuffer(1024))&&(yield n);continue;default:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;b.skip(l);(n=b.fillBuffer(1024))&&(yield n);continue}for((n=b.fillBuffer(1024))&&(yield n);m&&(!f||!g)||0<l;){var r=b.readUInt32BE();p=0;if(null===r)break a;e-=4;l-=4;if(1229866575!==
r){p=b.readUInt32LE();if(null===p||0>p||p>e||!m&&p>l)break a;e-=4;l-=4}1684108385!==r&&(n=b.fillBuffer(Math.min(264,8+p)))&&(yield n);switch(r){case 1718449184:if(!m)break;n=b.readUInt16LE();r=b.readUInt16LE();var q=b.readUInt32LE(),u=b.readUInt32LE(),t=b.readUInt16LE();const y=b.readUInt16LE();p-=16;e-=16;l-=16;if(null===n||null===r||null===q||null===u||null===t||null===y)break a;f=!0;k||(k=u);break;case 1684108385:m&&(g=!0,h||(h=p));break;case 1229866575:for(r=function(x){b.read(c,0,x);return MetadataExtractor.finishReadingV2Frame(0,
x,c)};0<l;){(n=b.fillBuffer(8))&&(yield n);q=b.readUInt32BE();e-=4;l-=4;if(null===q)break a;u=b.readUInt32LE();e-=4;l-=4;if(null===u||0>u||u>l)break a;if(1>=u)b.skip(u);else{t=Math.min(257,u)-1;(n=b.fillBuffer(t))&&(yield n);switch(q){case 1229865293:a.title=r(t);break;case 1230000708:a.album=r(t);break;case 1229017684:a.artist=r(t);break;case 1229148740:a.year=parseInt(r(t))||0;break;case 1230262859:a.track=parseInt(r(t))||0;break;default:t=0}b.skip(u-t);e-=u;l-=u}}}0<p&&(b.skip(p),e-=p,l-=p);e&&
...
f=Array(a);g=Array(a);const l=Array(a);var k=.5*Math.log(2),m=this.audioContext.sampleRate;const n=2*Math.PI;for(let p=a-1;0<=p;p--){const r=n*d[p]/m;l[p]=1/(2*Math.sinh(r/Math.sin(r)*k))}for(k=a-1;0<=k;k--)m=b.createBiquadFilter(),m.type="peaking",m.frequency.value=d[k],m.Q.value=l[k],f[k]=m,k<a-1&&f[k+1].connect(f[k]);this.biquadFilters=f;this.biquadFilterInput=f[a-1];this.biquadFilterOutput=f[0]}for(b=a-1;0<=b;b--)g[b]=Math.max(-40,this.yToDB(c[e[b]]));for(b=a-1;0<=b;b--)f[b].gain.value=g[b]+(b<
...
a}}drawCurve(a,b,c){const d=this.ctx;if(d){var e=1<devicePixelRatio?devicePixelRatio:1;e!==this.pixelRatio&&(this.scaleChanged(),e=this.pixelRatio);var f=this.editor,g=f.filter;e*=f.scale;var h=this.element;f=this.leftMargin;var k=h.width,m=h.height,l=Math.round(8*e),n=Math.round(4*e),p=(k/l|0)+1,r=GraphicalFilterEditor.maximumChannelValueY*e|0,q=1>e?e:e|0;h=.5*q;d.fillStyle="#303030";d.fillRect(0,0,k,m);d.lineWidth=q;d.strokeStyle="#5a5a5a";d.beginPath();q=k+(n>>1);var u=(GraphicalFilterEditor.zeroChannelValueY*
e|0)+h;d.moveTo(q,u);for(let t=p-1;0<=t;t--)d.lineTo(q-n,u),q-=l,d.moveTo(q,u);d.stroke();d.beginPath();q=k+(n>>1);u=(GraphicalFilterEditor.validYRangeHeight*e|0)+h;d.moveTo(q,u);for(k=p-1;0<=k;k--)d.lineTo(q-n,u),q-=l,d.moveTo(q,u);d.stroke();if(a)for(a=g.equivalentZonesFrequencyCount.length-2;0<a;a--){q=((g.equivalentZonesFrequencyCount[a]+f)*e|0)+h;u=r;d.beginPath();for(d.moveTo(q,u);u<m;)d.lineTo(q,u+n),u+=l,d.moveTo(q,u);d.stroke()}q=1>e?2*e:2*e|0;h=.5*q;d.lineWidth=q;a=GraphicalFilterEditor.visibleBinCount-
...
if(a&&b&&c&&d){var e=GraphicalFilterEditorControl.controlWidth,f=GraphicalFilterEditorControl.controlHeight,g=1<devicePixelRatio?devicePixelRatio:1,h=b.scale,k=h*g,m=this.leftMargin,l=this.svgLines,n=1>k?k:k|0,p=.5*n,r=(e*k|0).toString(),q=(f*k|0).toString();d.setAttribute("width",r);d.setAttribute("height",q);d.setAttribute("viewBox",`0 0 ${r} ${q}`);d.style.transform=1===g?"":"scale("+1/g+")";this.svgGradient.setAttribute("y2",q);b.element.style.width=(e*h|0)+"px";a.style.width=(e*h|0)+"px";a.style.height=
(f*h|0)+"px";l[0].setAttribute("x2",r);l[1].setAttribute("x2",r);for(r=l.length-1;2<=r;r--)l[r].setAttribute("y2",q);q=((GraphicalFilterEditor.zeroChannelValueY*k|0)+p).toString();l[0].setAttribute("y1",q);l[0].setAttribute("y2",q);q=((GraphicalFilterEditor.validYRangeHeight*k|0)+p).toString();l[1].setAttribute("y1",q);l[1].setAttribute("y2",q);for(q=c.equivalentZonesFrequencyCount.length-2;0<q;q--)r=(((c.equivalentZonesFrequencyCount[q]+m)*k|0)+p).toString(),l[q+1].setAttribute("x1",r),l[q+1].setAttribute("x2",
r);r=n.toString()+"px";q=(4*k|0).toString();for(c=l.length-1;0<=c;c--)l[c].setAttribute("stroke-width",r),l[c].setAttribute("stroke-dasharray",q);r=(1>k?2*k:2*k|0).toString()+"px";this.svgGrayCurve.style.strokeWidth=r;this.svgCurve.style.strokeWidth=r;this.pixelRatio=g}}drawCurve(a,b,c){var d=1<devicePixelRatio?devicePixelRatio:1;d!==this.pixelRatio&&(this.scaleChanged(),d=this.pixelRatio);this.showZones!==a&&(this.showZones=a,this.svgZones.style.display=a?"":"none");var e=this.editor;a=e.filter;
d*=e.scale;e=.5*(1>d?2*d:2*d|0);const f=this.leftMargin,g=GraphicalFilterEditor.visibleBinCount;for(let h=b?1:0;0<=h;h--){const k=h||!b?a.channelCurves[c]:a.actualChannelCurve,m=h?this.svgGrayCurve:this.svgCurve;let l=1,n=0,p=k[0],r="M "+(f*d|0)+","+(p*d+e);for(;l<g;l++)k[l]!==p&&(l>n+1&&1<l&&(r+=" "+((f+l-1)*d|0)+","+(k[l-1]*d+e)),n=l,p=k[l],r+=" "+((f+n)*d|0)+","+(p*d+e));r+=" "+((f+l)*d|0)+","+(k[l-1]*d+e);m.setAttribute("d",r)}this.isActualChannelCurveNeeded!==b&&(this.isActualChannelCurveNeeded=
...
"GEMNUSEP";return h};c=function(h){const k=document.createElement("div");k.className="GEMNULBL";k.appendChild(document.createTextNode(h));return k};d=function(h,k,m,l,n,p){const r=document.createElement("div");r.className=p?"GEMNUIT GECLK "+p:"GEMNUIT GECLK";if(k)if(f&&(l&&f.radioHTML||!l&&f.checkHTML))r.innerHTML=l?f.radioHTML:f.checkHTML,k=r.firstChild,k.style.marginRight=l?f.radioMargin||"2px":f.checkMargin||"2px",m||(k.style.visibility="hidden");else{k=document.createElement("span");p=l?"\u25cf ":
"\u25a0 ";let q=null;if(f){let u=!1;l?f.radioCharacter&&(u=!0,p=f.radioCharacter,q=f.radioMargin||"2px"):f.checkCharacter&&(u=!0,p=f.checkCharacter,q=f.checkMargin||"2px");u&&(f.checkFontFamily&&(k.style.fontFamily=f.checkFontFamily),f.checkFontSize&&(k.style.fontSize=f.checkFontSize))}q&&(k.style.marginRight=q);k.appendChild(document.createTextNode(p));m||(k.style.visibility="hidden");r.appendChild(k)}r.appendChild(document.createTextNode(h));n&&(r.onclick=n);return r};this.element=a;a.className=
...
d=1-d;d*=d;d+=.5*d;.55>d?d=0:1>d&&(d=smoothStep(.55,1,d));h=1-h;h=smoothStep(0,1,h);h*=h;h+=h;1<h&&(h=1);d+=.5*h;d=255*d|0;c[64*e+g]=255<=d?255:d}}a.texImage2D(a.TEXTURE_2D,0,a.ALPHA,64,64,0,a.ALPHA,a.UNSIGNED_BYTE,c)}analyze(a){let b=a-this.lastTime;33<b&&(b=33);this.lastTime=a;a=this.program.gl;var c=.00390625*b,d=1-c;const e=this.processedData,f=this.processedDataR,g=this.fft,h=this.BG_COLUMNS,k=this.BG_PARTICLES_BY_COLUMN,m=this.COLORS,l=this.program,n=this.bgPos,p=this.bgSpeedY,r=this.bgColor,
...
class FocusBlocker{constructor(){this.cover=this.parentContainer=this.oldBodyOverflow=this.changedElements=null;this.coverTimeout=0}block(a){this.unblock();const b=(a||document).querySelectorAll("button,input,select,textarea,.slider-control"),c=[];for(let d=b.length-1;0<=d;d--){const e=b[d],f=e.getAttribute("tabindex");"-1"!==f&&(e.setAttribute("tabindex","-1"),c.push({element:e,tabindex:f}))}this.changedElements=c;a?(this.parentContainer=a,this.cover=document.createElement("div"),this.cover.className=
...
var h=0,k=this.firstIndex,m=this.visibleCount+(0===k?2:1===k?3:4);m>b.length&&(m=b.length);0>(k-=2)&&(k=0);for(let l=k*c;h<m&&k<e;h++,k++,l+=c){const n=d.item(k),p=b[h],r=f===n;p.current!==r&&((p.current=r)?p.element.classList.add("current"):p.element.classList.remove("current"));a.prepareElement(n,k,e,p.element);p.item||g.appendChild(p.element);p.item=n;p.index!==k&&(p.index=k,p.element.style.transform="translateY("+l+"px)")}for(a=b.length;h<a;h++)d=b[h],d.item&&(d.item=null,g.removeChild(d.element))}else{g=
...
var d=null;this.listControl.element.classList.contains("in")&&(this.fading=!0,this.listControl.element.classList.remove("in"),DelayControl.delayFadeCB(()=>{FilePicker.filePicker===this&&this.provider&&c===this.providerVersion&&(this.list.clear(),this.fading=!1,d&&this.finishNavigation(d))}));this.provider.navigate(a).then(e=>{FilePicker.filePicker===this&&this.provider&&c===this.providerVersion&&(d=e||[],this.fading||this.finishNavigation(d))},e=>{FilePicker.filePicker===this&&this.provider&&c===
this.providerVersion&&(this.updateIconLoading(!1),Alert.show(e.message||("string"===typeof e.error?e.error:e.error&&e.error.message||e.toString()),!0))})}}navigateUp(){let a=this.path,b;!a||0>=(b=a.lastIndexOf("/"))?this.navigate(null):(a=a.substring(0,b),this.navigate(a.length<this.rootLength?null:a))}toggleAll(){if(FilePicker.filePicker===this&&!this.gettingFiles&&!this.fading){var a=this.list,b=!1;for(var c=a.length-1;0<=c;c--)if(!a.item(c).selected){b=!0;break}for(c=a.length-1;0<=c;c--)a.item(c).selected=
b;this.listControl.refreshVisibleItems()}}modalShown(){this.navigate(this.path)}modalHiding(){if(FilePicker.filePicker!==this)return!0;FilePicker.filePicker=null;this.provider&&this.provider.destroy();return!0}modalHidden(){const a=this.resolve,b=this.selectedFiles;this.selectedFiles=null;zeroObject(this);a&&a(b)}modalOk(){if(FilePicker.filePicker===this&&!this.gettingFiles&&!this.fading){var a=[],b=[],c=this.list,d=c.length;if(this.path)for(let f=0;f<d;f++){const g=c.item(f);g.selected&&(g.dir?a:
b).push(g)}if(this.path&&(a.length||b.length)){FilePicker.lastPath=this.path;FilePicker.lastRootLength=this.rootLength;this.gettingFiles=!0;this.providerVersion++;var e=this.providerVersion;this.updateIconLoading(!0);this.provider.getFiles(a,b).then(f=>{FilePicker.filePicker===this&&this.provider&&e===this.providerVersion&&(this.selectedFiles=f,Modal.hide())},f=>{FilePicker.filePicker===this&&this.provider&&e===this.providerVersion&&(this.updateIconLoading(!1),this.gettingFiles=!1,Alert.show(f.message||
("string"===typeof f.error?f.error:f.error&&f.error.message||f.toString()),!0))})}else Alert.show(Strings.NothingSelected)}}}FilePicker.filePicker=null;FilePicker.lastPath=null;FilePicker.lastRootLength=0;
...
case 3:AppUI.webFrame.setZoomFactor(.8);break;case 4:AppUI.webFrame.setZoomFactor(.9);break;default:AppUI.webFrame.setZoomFactor((a-1)/4)}}static globalKeyHandler(a){if(a.ctrlKey||a.metaKey){if(AppUI.webFrame)switch(a.key){case "-":return a.repeat||AppUI.changeZoom(-1),cancelEvent(a);case "+":case "=":return a.repeat||AppUI.changeZoom(1),cancelEvent(a);case "0":return cancelEvent(a)}}else switch(a.key){case "Escape":return a.repeat||(Modal.visible?Modal.hide():App.player&&App.player.playPause()),
cancelEvent(a);case "F1":return!a.repeat&&App.player&&App.player.previous(),cancelEvent(a);case "F2":return!a.repeat&&App.player&&App.player.playPause(),cancelEvent(a);case "F3":return!a.repeat&&App.player&&App.player.stop(),cancelEvent(a);case "F4":return!a.repeat&&App.player&&App.player.next(),cancelEvent(a)}}static historyStatePopped(){if(!AppUI.playlistControl||!AppUI.playlistControl.deleteMode){if(!AppUI.panelContainerToggled)return null;AppUI.toggleView(!1);return!0}AppUI.toggleDeleteMode(!1);
return!0}static preInit(a,b){AppUI.webFrame=a;window.addEventListener("keydown",AppUI.globalKeyHandler,!0);a&&b.devicePixelRatio&&b.devicePixelRatio!==devicePixelRatio&&a.setZoomFactor(b.devicePixelRatio);FilePicker.isSupported()&&(FilePicker.lastPath=b.filePickerLastPath||null,FilePicker.lastRootLength=b.filePickerRootLength||0,a=document.getElementById("add-folder-button"),a.parentNode.removeChild(a));ButtonControl.init();CheckboxControl.init();AppUI.seekSlider=new SliderControl("seek-slider",!1,
!1,0,1);AppUI.seekSlider.disabled=!0;AppUI.seekSlider.onvaluechanged=AppUI.seekSliderValueChanged;AppUI.seekSlider.ondragended=AppUI.seekSliderDragEnded;AppUI.currentTimeLabel=document.createElement("span");AppUI.currentTimeLabel.className="seek-label";AppUI.currentTimeS=0;Strings.changeText(AppUI.currentTimeLabel,Formatter.none);AppUI.seekSlider.leftChild=AppUI.currentTimeLabel;AppUI.songLengthLabel=document.createElement("span");AppUI.songLengthLabel.className="seek-label";Strings.changeText(AppUI.songLengthLabel,
...
(AppUI.playlistControl.deleteMode=!0,AppUI.focusBlocker=new FocusBlocker,AppUI.focusBlocker.block(AppUI.middlePanel),AppUI.showTopMessage(Strings.DeleteModeHTML,function(b){const c=document.createElement("div");ButtonControl.create({color:"red",icon:"icon-delete-all",text:Strings.DeleteAllSongs,parent:c,onclick:function(){App.player&&App.player.playlist&&App.player.playlist.clear();AppUI.playlistControl&&AppUI.playlistControl.deleteMode&&AppUI.toggleDeleteMode(!0)}});ButtonControl.create({color:"green",
icon:"icon-check",text:Strings.Done,parent:c,onclick:function(){AppUI.playlistControl&&AppUI.playlistControl.deleteMode&&AppUI.toggleDeleteMode(!0)}});b.appendChild(c)}),HistoryHandler.pushState()))}static checkPanelContainerToggleState(){875>=window.innerWidth||!AppUI.fixedPanel||!AppUI.optionalPanel||(AppUI.panelContainerToggling&&(AppUI.panelContainerToggleVersion++,AppUI.panelContainerToggling=!1,AppUI.fixedPanel.classList.remove("fade"),AppUI.fixedPanel.classList.remove("in"),AppUI.optionalPanel.classList.remove("fade"),
