...
class AppUI{static preparePlaylist(){if(App.player&&AppUI.playlistControl){var a=App.player.playlist;a?(a.onsonglengthchanged=AppUI.playlistSongLengthChanged,AppUI.playlistControl.adapter=new PlaylistAdapter(a)):AppUI.playlistControl.adapter=null}}static adjustWindow(){if(AppUI.devicePixelRatio!==devicePixelRatio&&AppUI.rootVariables){AppUI.devicePixelRatio=devicePixelRatio;var a=AppUI.factorToZoom(devicePixelRatio);const b=AppUI.zoomToFactor(a),c=AppUI.remToPX(Icon.outerSizeREM),d=/[,\.]$/,e=/0+$/;
AppUI._smallIconSizePX=Icon.baseSizePX*((a+1>>2)+1)/devicePixelRatio;AppUI._largeIconSizePX=Icon.baseSizePX*(b<<1)/devicePixelRatio;AppUI._thinBorderPX=(AppUI.baseThinBorderPX*devicePixelRatio|0)/devicePixelRatio;AppUI._thickBorderPX=(AppUI.baseThickBorderPX*devicePixelRatio|0)/devicePixelRatio;AppUI.rootVariables.textContent=`:root {
				--button-size: ${AppUI.buttonSizePX}px;
				--button-padding-top: ${.5*(AppUI.buttonSizePX-c)}px;
				--extra-touch-padding-top: ${.5*(AppUI.buttonSizePX-AppUI.buttonRegularSizePX)}px;
				--icon-size: ${AppUI._smallIconSizePX}px;
				--icon-padding: ${(.5*(c-AppUI._smallIconSizePX)).toFixed(6).replace(e,"").replace(d,"")}px;
				--large-icon-size: ${AppUI._largeIconSizePX}px;
				--large-icon-padding: ${(.5*(c-AppUI._largeIconSizePX)).toFixed(6).replace(e,"").replace(d,"")}px;
