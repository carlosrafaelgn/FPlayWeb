...
Strings.AdvancedFilter="Advanced filter";Strings.TraditionalFilter="Traditional filter";Strings.OK="OK";Strings.Cancel="Cancel";Strings.Clear="Clear";Strings.Back="Back";Strings.Close="Close";Strings.Refresh="Refresh";Strings.Exit="Exit";Strings.Previous="Previous";Strings.Play="Play";Strings.Pause="Pause";Strings.PlayPause="Play / Pause";Strings.Stop="Stop";Strings.Next="Next";Strings.LeftAbbrev="L";Strings.RightAbbrev="R";Strings.Volume="Volume";Strings.Panning="Panning";Strings.DownMixToMono="Down-mix to mono";
Strings.UnknownError="Unknown error";Strings.AddFiles="Add files";Strings.AddFolders="Add folders";Strings.ShowEffects="Show effects";Strings.ShowPlaylist="Show playlist";Strings.UpdateAvailable="Update available!";Strings.PleaseRefresh="Please, refresh the page to update the app. \ud83d\ude0a";Strings.AboutHTML='FPlay for web is an experimental audio player. \ud83d\ude0a<br />\n<br />\nFor more information about the project, its source code and dependencies, check out its repository at <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb">github.com/carlosrafaelgn/FPlayWeb</a>.<br />\n<br />\nThis project is licensed under the <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb/blob/master/LICENSE">MIT License</a>.';
...
93+e))))}c&MetadataExtractor.TRACK_B||d[125]||!d[126]||(a.track=d[126]&255)}}catch(g){}})}static extractID3v2Andv1(a,b,c){return __awaiter(this,void 0,void 0,function*(){const d={url:Formatter.pathToURL(a["data-path"])||Formatter.empty};d.url||(d.file=a);var e=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==e)if(e|=b.readByte(),1380533830===e){e=yield MetadataExtractor.extractRIFF(d,b,c[0]);if(!e)return null;if(!e[1])return d}else return yield MetadataExtractor.extractID3v1(d,b,
0,c[0]),d;var f=b.readByte(),g=b.readByte();e=b.readByte();var h=b.readByte();const k=b.readByte(),m=b.readByte(),l=b.readByte();e=(e&16?10:0)+(l&127|(m&127)<<7|(k&127)<<14|(h&127)<<21);if(2<(f&255)||g){for(f=0;0<e&&f!==MetadataExtractor.ALL_B;){(g=b.fillBuffer(1024))&&(yield g);h=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();g=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();b.skip(2);if(!h||0>=g||g>e)break;switch(h){case 1414091826:f&MetadataExtractor.TITLE_B?b.skip(g):
...
return b}addItems(a,b){if(!this.items||!a||!a.length)return-1;void 0===b||0>b||b>=this.items.length?(b=this.items.length,this.items.push(...a)):this.items.splice(b,0,...a);this.modified=!0;this._adapter&&this._adapter.itemsAdded(b,b+a.length-1);0<=this._currentIndex&&b<=this._currentIndex&&(this._currentIndex+=a.length);return b}removeItems(a,b){if(!this.items||0>a||a>=this.items.length)return 0;void 0===b||b<a?b=a:b>=this.items.length&&(b=this.items.length-1);const c=b-a+1;this.items.splice(a,c);
this.modified=!0;0<=this._currentIndex&&(b<this._currentIndex?this._currentIndex-=c:a<=this._currentIndex&&this._currentItem&&(this._currentItem=null,this._adapter&&this._adapter.currentItemChanged(this._currentIndex,-1)));this._adapter&&this._adapter.itemsRemoved(a,b);return c}}
...
a[c].estimateSerializedLength();return b+128}songLengthChanged(a,b){if(0>=b||isNaN(b)||!isFinite(b)){if(0>a.lengthMS)return;b=-1}else{if(0<=a.lengthMS&&(a.lengthMS/1E3|0)===(b|0))return;b=1E3*b|0}this.modified=!0;a.lengthMS=b;a.length=Formatter.formatTimeMS(b);if(this.onsonglengthchanged)this.onsonglengthchanged(a)}addSong(a,b){const c=Object.create(null,{addItem:{get:()=>super.addItem}});return __awaiter(this,void 0,void 0,function*(){let d=0;if("string"!==typeof a){var e=a.fileURL;d=a.fileSize}else e=
a;if(!Playlist.isTypeSupported(e))return!1;e=yield App.extractMetadata(e,d);if(!e)return!1;c.addItem.call(this,new Song(e),b);return!0})}addSongWeb(a,b,c,d){const e=Object.create(null,{addItem:{get:()=>super.addItem}});return __awaiter(this,void 0,void 0,function*(){if(!Playlist.isTypeSupported(a.name))return!1;const f=yield MetadataExtractor.extract(a,b,c);if(!f)return!1;e.addItem.call(this,new Song(f),d);return!0})}}Playlist.supportedExtensions={".aac":!0,".mp3":!0,".wav":!0};
...
if(!a){this.stop();return}this._currentSong=a;queueMicrotask(this.boundNotifySongChanged);for(this.resumeAudioContext();this.audio.firstChild;)this.audio.removeChild(this.audio.firstChild);b=document.createElement("source");a.url?b.src=a.url:a.file&&(this.lastObjectURL&&URL.revokeObjectURL(this.lastObjectURL),this.lastObjectURL=URL.createObjectURL(a.file),b.src=this.lastObjectURL);b.onerror=this.boundPlaybackError;this.audio.appendChild(b);this.audio.load();b=this.audio.play()}b&&b.catch(Player.nop)}}playPause(){this._alive&&
...
"modal-container fade background";this.modalElement=document.createElement("form");this.modalElement.className="modal";this.modalElement.onsubmit=this.submit.bind(this);this.modalHeaderElement=document.createElement("div");this.modalHeaderElement.className="modal-header";this.modalHeaderElement.innerHTML=a.title||(a.titleStringKey?Strings.translate(a.titleStringKey):Strings.Oops);this.modalBodyElement=document.createElement("div");this.modalBodyElement.className="modal-body";"string"===typeof a.html?
this.modalBodyElement.innerHTML=a.html:this.modalBodyElement.appendChild(a.html);if((b=this.modalBodyElement.getElementsByTagName("button"))&&b.length)for(c=b.length-1;0<=c;c--){const d=b[c];ButtonControl.prepare(d);d.onclick=()=>{if(!this.fading&&this.options.onbuttonclick)this.options.onbuttonclick(d.id,d)}}this.modalFooterElement=document.createElement("div");this.modalFooterElement.className=a.buttons&&1===a.buttons.length?"modal-footer right":"modal-footer";this.defaultSubmitButton=this.defaultCancelButton=
null;if(a.buttons)for(b=0;b<a.buttons.length;b++){const d=a.buttons[b],e=ButtonControl.create(d,!0);d.defaultCancel&&(this.defaultCancelButton=e);d.defaultSubmit&&(this.defaultSubmitButton=e);b&&(e.style.float="right");e.onclick=()=>{if(!this.fading){if(d.onclick)d.onclick(d.id,e);if(this.options.onbuttonclick)this.options.onbuttonclick(d.id,e)}};this.modalFooterElement.appendChild(e)}this.modalElement.appendChild(this.modalHeaderElement);this.modalElement.appendChild(this.modalBodyElement);this.modalElement.appendChild(this.modalFooterElement);
this.containerElement.appendChild(this.modalElement);document.body.appendChild(this.containerElement);this.boundDocumentKeyDown=this.documentKeyDown.bind(this);document.addEventListener("keydown",this.boundDocumentKeyDown,!0);this.fading=!0;setTimeout(()=>{if(a.onshowing)a.onshowing();this.containerElement.classList.add("in");setTimeout(()=>{this.fading=!1;if(this.options.onshown)this.options.onshown()},320)},20)}static get visible(){return!!Modal.modal}static get currentModalElement(){return Modal.modal?
...
defaultSubmit:a.okcancelsubmit,icon:"icon-check",text:a.oktext||Strings.OK,color:"green",onclick:a.onok||Modal.hide}]:a.buttons&&a.buttons.length||(a.buttons=[{id:"cancel",defaultCancel:!0,icon:"icon-clear",text:Strings.Close,onclick:Modal.hide}]);Modal.modal=new Modal(a);return!0}static hide(){Modal.modal&&Modal.modal.hideInternal()}static defaultCancelAction(){Modal.modal&&Modal.modal.defaultCancelActionInternal()}hideInternal(){if(!(Modal.modal!==this||this.fading||this.options.onhiding&&!1===
this.options.onhiding())){document.removeEventListener("keydown",this.boundDocumentKeyDown,!0);var a=this.changedElements;for(let b=a.length-1;0<=b;b--){const c=a[b].element,d=a[b].tabindex;d?c.setAttribute("tabindex",d):c.removeAttribute("tabindex")}document.body.style.overflow=this.oldBodyOverflow;this.fading=!0;this.containerElement.classList.remove("in");setTimeout(()=>{Modal.modal=null;if(this.options.onhidden)this.options.onhidden();document.body.removeChild(this.containerElement);if(this.options.buttons)for(let b=
...
class AppUI{static preparePlaylist(){if(App.player&&AppUI.playlistControl){var a=App.player.playlist;a?(a.onsonglengthchanged=AppUI.playlistSongLengthChanged,AppUI.playlistControl.adapter=new PlaylistAdapter(a)):AppUI.playlistControl.adapter=null}}static adjustDecimal(a){var b=!0;let c=a.toFixed(5);for(c=c.substr(0,c.length-1);;){var d=c.charAt(c.length-1),e=c.charAt(c.length-2);if(d===e){if("0"!==d&&(c=c.padEnd(24,d),"9"===d&&b)){c=parseFloat(c).toFixed(5);b=!1;continue}}else if(b=c.lastIndexOf("."),
d=c.substr(b+1,2),e=c.substr(b+3,2),d===e)for(c=c.substr(0,b+1);24>c.length;)c+=d;else if(c=a.toFixed(7),b=c.lastIndexOf("."),d=c.substr(b+1,3),e=c.substr(b+4,3),d===e)for(c=c.substr(0,b+1);24>c.length;)c+=d;else c=a.toFixed(18);break}return c.replace(/0+$/,"").replace(/[,\.]$/,"")}static adjustWindow(){if(AppUI.devicePixelRatio!==devicePixelRatio&&AppUI.rootVariables){AppUI.devicePixelRatio=devicePixelRatio;var a=AppUI.factorToZoom(devicePixelRatio),b=AppUI.zoomToFactor(a),c=AppUI.remToPX(Icon.outerSizeREM);
a=AppUI.adjustDecimal(Icon.baseSizePX*((a+1>>2)+1)/devicePixelRatio);AppUI._smallIconSizePX=parseFloat(a);b=AppUI.adjustDecimal(Icon.baseSizePX*(b<<1)/devicePixelRatio);AppUI._largeIconSizePX=parseFloat(b);var d=(AppUI.baseThinBorderPX*devicePixelRatio|0)/devicePixelRatio;d||(d=1);const e=AppUI.adjustDecimal(d);AppUI._thinBorderPX=parseFloat(e);(d=(AppUI.baseThickBorderPX*devicePixelRatio|0)/devicePixelRatio)||(d=1);d=AppUI.adjustDecimal(d);AppUI._thickBorderPX=parseFloat(d);AppUI.rootVariables.textContent=
`:root {
...
(App.player.playlist=new Playlist,AppUI.preparePlaylist());const d=b?null:new Uint8Array(BufferedFileHandle.minBufferLength<<1),e=b?null:[new Uint8Array(256)];for(let f=0;f<c.length&&App.player&&App.player.playlist;f++)b?yield App.player.playlist.addSong(c[f]):yield App.player.playlist.addSongWeb(c[f],d,e)}catch(d){alert("addFiles error: "+(d.message||d.toString()))}finally{AppUI._loading=!1,App.updateLoadingIcon()}}})}static addDirectory(a){return __awaiter(this,void 0,void 0,function*(){const b=
yield App.listDirectory(a);if(!App.player||!App.player.playlist||AppUI.directoryCancelled)return!1;if(!b)return!0;for(let c=0;c<b.length;c++)if(b[c].isDirectory){if(!(yield AppUI.addDirectory(b[c].fileURL)))return!1}else{if(!App.player||!App.player.playlist||AppUI.directoryCancelled)return!1;yield App.player.playlist.addSong(b[c])}return!0})}static addDirectories(){return __awaiter(this,void 0,void 0,function*(){if(App.player&&!AppUI._loading){if(App.hostType!==App.hostTypeElectron)return AppUI.addFiles(!0);
var a=yield App.showOpenDirectoryDialog();if(a&&App.player)try{AppUI._loading=!0;AppUI.directoryCancelled=!1;App.updateLoadingIcon();App.player.playlist||(App.player.playlist=new Playlist,AppUI.preparePlaylist());for(let b=0;b<a.length&&(yield AppUI.addDirectory(a[b]));b++);}catch(b){alert("addDirectories error: "+(b.message||b.toString()))}finally{AppUI._loading=!1,AppUI.directoryCancelled=!1,App.updateLoadingIcon()}}})}static switchView(){AppUI.panelContainer&&AppUI.panelContainer.classList.toggle("toggled")}static showAbout(){Modal.show({html:Strings.AboutHTML+
...
document.getElementById("optional-panel-container"),document.getElementById("stereo-panner-slider"),a.playerVolume,a.graphicalFilterControlEnabled,a.graphicalFilterControlSimpleMode,a.stereoPannerControlEnabled,a.monoDownMixerControlEnabled);try{const b=yield InternalStorage.loadPlaylist();if(!App.player||!App.player.alive)return;b&&(App.player.playlist=b)}catch(b){}App.player&&App.player.alive&&(AppUI.init(a),(a=document.getElementById("cover"))&&a.classList.remove("in"),setTimeout(function(){window.removeEventListener("resize",
App.adjustCover);const b=document.getElementById("cover");b&&document.body.removeChild(b)},320),App.loading=!1)}})}static triggerMainWindowStateChanged(){App.ipcRenderer&&App.ipcRenderer.invoke("triggerMainWindowStateChanged")}static mainWindowMinimize(){App.ipcRenderer&&App.ipcRenderer.invoke("mainWindowMinimize")}static mainWindowRestoreOrMaximize(){App.ipcRenderer&&App.ipcRenderer.invoke(App.isMaximized?"mainWindowRestore":"mainWindowMaximize")}static mainWindowClose(){App.ipcRenderer&&App.ipcRenderer.invoke("mainWindowClose")}static showOpenFileDialog(){return __awaiter(this,
void 0,void 0,function*(){if(App.fileInput||App._showingDialog)return null;try{return App._showingDialog=!0,yield App.ipcRenderer.invoke("showOpenFileDialog")}finally{App._showingDialog=!1}})}static convertFilePathsToAppFiles(a){return App.ipcRenderer.invoke("convertFilePathsToAppFiles",a)}static showOpenDirectoryDialog(){return __awaiter(this,void 0,void 0,function*(){if(App._showingDialog)return null;try{return App._showingDialog=!0,yield App.ipcRenderer.invoke("showOpenDirectoryDialog")}finally{App._showingDialog=
!1}})}static listDirectory(a){return App.ipcRenderer.invoke("listDirectory",a)}static extractMetadata(a,b){return App.ipcRenderer.invoke("extractMetadata",a,b)}static showOpenDialogWeb(a){return __awaiter(this,void 0,void 0,function*(){if(!App.fileInput)return null;App.fileInputPromiseResolve&&(App.fileInputPromiseResolve(null),App.fileInputPromiseResolve=null);App.fileInput.setAttribute("data-version",(++App.fileInputVersion).toString());a?(App.fileInput.setAttribute("webkitdirectory","webkitdirectory"),
