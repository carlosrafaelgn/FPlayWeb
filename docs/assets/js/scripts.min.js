...
(p=b.fillBuffer(1024))&&(yield p);if(4<l){m=b.readByte();var r=b.readByte();p=b.readByte();if(null===m||null===r||null===p)break a;e-=3;l-=3;if(73===m||68===r||51===p)if(d=b.fileLength-e,f&&g){d=-1;break a}}b.skip(l);(p=b.fillBuffer(1024))&&(yield p);continue;default:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;b.skip(l);(p=b.fillBuffer(1024))&&(yield p);continue}for((p=b.fillBuffer(1024))&&(yield p);m&&(!f||!g)||0<l;){var n=b.readUInt32BE();r=0;if(null===n)break a;e-=4;l-=4;if(1229866575!==
n){r=b.readUInt32LE();if(null===r||0>r||r>e||!m&&r>l)break a;e-=4;l-=4}1684108385!==n&&(p=b.fillBuffer(Math.min(264,8+r)))&&(yield p);switch(n){case 1718449184:if(!m)break;p=b.readUInt16LE();n=b.readUInt16LE();var q=b.readUInt32LE(),t=b.readUInt32LE();const u=b.readUInt16LE(),y=b.readUInt16LE();r-=16;e-=16;l-=16;if(null===p||null===n||null===q||null===t||null===u||null===y)break a;f=!0;k||(k=t);break;case 1684108385:m&&(g=!0,h||(h=r));break;case 1229866575:function x(v){b.read(c,0,v);return MetadataExtractor.finishReadingV2Frame(0,
v,c)}for(;0<l;){(p=b.fillBuffer(8))&&(yield p);n=b.readUInt32BE();e-=4;l-=4;if(null===n)break a;q=b.readUInt32LE();e-=4;l-=4;if(null===q||0>q||q>l)break a;if(1>=q)b.skip(q);else{t=Math.min(257,q)-1;(p=b.fillBuffer(t))&&(yield p);switch(n){case 1229865293:a.title=x(t);break;case 1230000708:a.album=x(t);break;case 1229017684:a.artist=x(t);break;case 1229148740:a.year=parseInt(x(t))||0;break;case 1230262859:a.track=parseInt(x(t))||0;break;default:t=0}b.skip(q-t);e-=q;l-=q}}}0<r&&(b.skip(r),e-=r,l-=r);
e&&(p=b.fillBuffer(8))&&(yield p)}}return f&&g?(d&&(0<d&&b.seekTo(d),(e=b.fillBuffer(1024))&&(yield e)),a.lengthMS=1E3*h/k|0,[a,!!d]):null})}static finishReadingV2Frame(a,b,c){let d=0;var e=b-1;a:for(;0<b;)switch(c[d]){case 0:case 9:case 10:case 11:case 12:case 13:case 32:case 133:case 160:b--;d++;break;default:break a}a:for(;0<b;)switch(c[e]){case 0:case 9:case 10:case 11:case 12:case 13:case 32:case 133:case 160:b--;e--;break;default:break a}e=null;switch(a){case 1:case 2:if(b&1&&d+b<c.length&&
b++,2<=b&&1===a&&(254===c[d]&&255===c[d+1]?(a=2,d+=2,b-=2):255===c[d]&&254===c[d+1]&&(d+=2,b-=2),!b))return null}switch(a){case 0:e=MetadataExtractor.textDecoderIso88591.decode(c.subarray(d,d+b));break;case 1:e=MetadataExtractor.textDecoderUtf16.decode(c.subarray(d,d+b));break;case 2:e=MetadataExtractor.textDecoderUtf16be.decode(c.subarray(d,d+b));break;case 3:e=MetadataExtractor.textDecoderUtf8.decode(c.subarray(d,d+b))}return e&&e.length?e:null}static readV2Frame(a,b,c){if(2>b)return a.skip(b),
null;const d=a.readByte();b--;if(0>d||3<d)return a.skip(b),null;let e=c[0];b>e.length&&(e=new Uint8Array(b+16),c[0]=e);a=a.read(e,0,b);return"number"===typeof a?MetadataExtractor.finishReadingV2Frame(d,a,e):a.then(function(f){return MetadataExtractor.finishReadingV2Frame(d,f,e)})}static extractID3v1(a,b,c,d){return __awaiter(this,void 0,void 0,function*(){try{b.seekTo(b.fileLength-128);const g=b.read(d,0,128);"number"!==typeof g&&(yield g);if(84==d[0]&&65==d[1]&&71==d[2]){var e;if(!(c&MetadataExtractor.TITLE_B)){var f=
...
a}}drawCurve(a,b,c){const d=this.ctx;if(d){var e=1<devicePixelRatio?devicePixelRatio:1;e!==this.pixelRatio&&(this.scaleChanged(),e=this.pixelRatio);var f=this.editor,g=f.filter;e*=f.scale;var h=this.element;f=this.leftMargin;var k=h.width,m=h.height,l=Math.round(8*e),p=Math.round(4*e),r=(k/l|0)+1,n=GraphicalFilterEditor.maximumChannelValueY*e|0,q=1>e?e:e|0;h=.5*q;d.fillStyle="#303030";d.fillRect(0,0,k,m);d.lineWidth=q;d.strokeStyle="#5a5a5a";d.beginPath();q=k+(p>>1);var t=(GraphicalFilterEditor.zeroChannelValueY*
e|0)+h;d.moveTo(q,t);for(let u=r-1;0<=u;u--)d.lineTo(q-p,t),q-=l,d.moveTo(q,t);d.stroke();d.beginPath();q=k+(p>>1);t=(GraphicalFilterEditor.validYRangeHeight*e|0)+h;d.moveTo(q,t);for(k=r-1;0<=k;k--)d.lineTo(q-p,t),q-=l,d.moveTo(q,t);d.stroke();if(a)for(a=g.equivalentZonesFrequencyCount.length-2;0<a;a--){q=((g.equivalentZonesFrequencyCount[a]+f)*e|0)+h;t=n;d.beginPath();for(d.moveTo(q,t);t<m;)d.lineTo(q,t+p),t+=l,d.moveTo(q,t);d.stroke()}q=1>e?2*e:2*e|0;h=.5*q;d.lineWidth=q;a=GraphicalFilterEditor.visibleBinCount-
1;for(m=b?1:0;0<=m;m--){l=m||!b?g.channelCurves[c]:g.actualChannelCurve;d.strokeStyle=m?"#707070":this.rangeImage;d.beginPath();d.moveTo(f*e|0,l[0]*e+h);for(q=1;q<a;q++)d.lineTo((f+q)*e|0,l[q]*e+h);d.lineTo((f+q+1)*e|0,l[q]*e+h);d.stroke()}}}}
...
if(a&&b&&c&&d){var e=GraphicalFilterEditorControl.controlWidth,f=GraphicalFilterEditorControl.controlHeight,g=1<devicePixelRatio?devicePixelRatio:1,h=b.scale,k=h*g,m=this.leftMargin,l=this.svgLines,p=1>k?k:k|0,r=.5*p,n=(e*k|0).toString(),q=(f*k|0).toString();d.setAttribute("width",n);d.setAttribute("height",q);d.setAttribute("viewBox",`0 0 ${n} ${q}`);d.style.transform=1===g?"":"scale("+1/g+")";this.svgGradient.setAttribute("y2",q);b.element.style.width=(e*h|0)+"px";a.style.width=(e*h|0)+"px";a.style.height=
(f*h|0)+"px";l[0].setAttribute("x2",n);l[1].setAttribute("x2",n);for(n=l.length-1;2<=n;n--)l[n].setAttribute("y2",q);q=((GraphicalFilterEditor.zeroChannelValueY*k|0)+r).toString();l[0].setAttribute("y1",q);l[0].setAttribute("y2",q);q=((GraphicalFilterEditor.validYRangeHeight*k|0)+r).toString();l[1].setAttribute("y1",q);l[1].setAttribute("y2",q);for(q=c.equivalentZonesFrequencyCount.length-2;0<q;q--)n=(((c.equivalentZonesFrequencyCount[q]+m)*k|0)+r).toString(),l[q+1].setAttribute("x1",n),l[q+1].setAttribute("x2",
n);n=p.toString()+"px";q=(4*k|0).toString();for(c=l.length-1;0<=c;c--)l[c].setAttribute("stroke-width",n),l[c].setAttribute("stroke-dasharray",q);n=(1>k?2*k:2*k|0).toString()+"px";this.svgGrayCurve.style.strokeWidth=n;this.svgCurve.style.strokeWidth=n;this.pixelRatio=g}}drawCurve(a,b,c){var d=1<devicePixelRatio?devicePixelRatio:1;d!==this.pixelRatio&&(this.scaleChanged(),d=this.pixelRatio);this.showZones!==a&&(this.showZones=a,this.svgZones.style.display=a?"":"none");var e=this.editor;a=e.filter;
d*=e.scale;e=.5*(1>d?2*d:2*d|0);const f=this.leftMargin,g=GraphicalFilterEditor.visibleBinCount;for(let h=b?1:0;0<=h;h--){const k=h||!b?a.channelCurves[c]:a.actualChannelCurve,m=h?this.svgGrayCurve:this.svgCurve;let l=1,p=0,r=k[0],n="M "+(f*d|0)+","+(r*d+e);for(;l<g;l++)k[l]!==r&&(l>p+1&&1<l&&(n+=" "+((f+l-1)*d|0)+","+(k[l-1]*d+e)),p=l,r=k[l],n+=" "+((f+p)*d|0)+","+(r*d+e));n+=" "+((f+l)*d|0)+","+(k[l-1]*d+e);m.setAttribute("d",n)}this.isActualChannelCurveNeeded!==b&&(this.isActualChannelCurveNeeded=
...
"GEMNUSEP";return h};c=function(h){const k=document.createElement("div");k.className="GEMNULBL";k.appendChild(document.createTextNode(h));return k};d=function(h,k,m,l,p,r){const n=document.createElement("div");n.className=r?"GEMNUIT GECLK "+r:"GEMNUIT GECLK";if(k)if(f&&(l&&f.radioHTML||!l&&f.checkHTML))n.innerHTML=l?f.radioHTML:f.checkHTML,k=n.firstChild,k.style.marginRight=l?f.radioMargin||"2px":f.checkMargin||"2px",m||(k.style.visibility="hidden");else{k=document.createElement("span");r=l?"\u25cf ":
"\u25a0 ";let q=null;if(f){let t=!1;l?f.radioCharacter&&(t=!0,r=f.radioCharacter,q=f.radioMargin||"2px"):f.checkCharacter&&(t=!0,r=f.checkCharacter,q=f.checkMargin||"2px");t&&(f.checkFontFamily&&(k.style.fontFamily=f.checkFontFamily),f.checkFontSize&&(k.style.fontSize=f.checkFontSize))}q&&(k.style.marginRight=q);k.appendChild(document.createTextNode(r));m||(k.style.visibility="hidden");n.appendChild(k)}n.appendChild(document.createTextNode(h));p&&(n.onclick=p);return n};this.element=a;a.className=
...
0:-1;this.element.setAttribute("aria-rowcount","0");this.element.removeAttribute("aria-activedescendant");this.adjustScrollbarPadding()}}elementScroll(){var a=this._adapter,b=this.element;if(a&&b){var c=this.items,d=this.itemHeightAndMargin,e=this.firstIndex-2;b=b.scrollTop/d|0;0>e&&(e=0);this.firstIndex=b;var f=this.visibleCount+(0===b?2:1===b?3:4);f>c.length&&(f=c.length);0>(b-=2)&&(b=0);if(b>e){if((e=b-e)&&e<f)for(let p=e,r=0;p<f;p++,r++)e=c[r],c[r]=c[p],c[p]=e}else if((e-=b)&&e<f)for(let p=f-
1,r=p-e;0<=r;r--,p--)e=c[p],c[p]=c[r],c[r]=e;var g=a.list,h=g.length,k=a.list.currentItem,m=this.keyboardIndex;e=this.container;var l=0;for(let p=b*d;l<f&&b<h;l++,b++,p+=d){const r=g.item(b),n=c[l];if(n.item!==r){let q=k===r;n.current!==q&&((n.current=q)?n.element.classList.add("current"):n.element.classList.remove("current"));q=m===b;n.keyboard!==q&&((n.keyboard=q)?(n.element.classList.add("keyboard"),n.element.setAttribute("aria-selected","true"),this.element.setAttribute("aria-activedescendant",
n.element.getAttribute("id"))):(this.element.getAttribute("aria-activedescendant")===n.element.getAttribute("id")&&this.element.removeAttribute("aria-activedescendant"),n.element.classList.remove("keyboard"),n.element.setAttribute("aria-selected","false")));a.prepareElement(r,b,h,n.element);n.element.setAttribute("aria-rowindex",b.toString());n.item||e.appendChild(n.element);n.item=r}n.index!==b&&(n.index=b,n.element.style.transform="translateY("+p+"px)")}for(a=c.length;l<a;l++)d=c[l],d.item&&(d.item=
...
(l=b.length);0>(m-=2)&&(m=0);for(let p=m*c;k<l&&m<e;k++,m++,p+=c){const r=d.item(m),n=b[k];let q=f===r;n.current!==q&&((n.current=q)?n.element.classList.add("current"):n.element.classList.remove("current"));q=g===m;n.keyboard!==q&&((n.keyboard=q)?(n.element.classList.add("keyboard"),n.element.setAttribute("aria-selected","true"),this.element.setAttribute("aria-activedescendant",n.element.getAttribute("id"))):(this.element.getAttribute("aria-activedescendant")===n.element.getAttribute("id")&&this.element.removeAttribute("aria-activedescendant"),
n.element.classList.remove("keyboard"),n.element.setAttribute("aria-selected","false")));a.prepareElement(r,m,e,n.element);n.element.setAttribute("aria-rowindex",m.toString());n.item||h.appendChild(n.element);n.item=r;n.index!==m&&(n.index=m,n.element.style.transform="translateY("+p+"px)")}for(a=b.length;k<a;k++)d=b[k],d.item&&(d.item=null,h.removeChild(d.element))}else{h=this.visibleCount;k=0<=g&&g<b.length?b[g]:null;this.keyboardItem!==k&&(this.keyboardItem&&(this.keyboardItem.element.classList.remove("keyboard"),
this.keyboardItem.element.setAttribute("aria-selected","false")),k?(k.element.classList.add("keyboard"),k.element.setAttribute("aria-selected","true"),this.element.setAttribute("aria-activedescendant",k.element.getAttribute("id"))):this.element.removeAttribute("aria-activedescendant"),this.keyboardItem=k);for(let p=0,r=this.indexFromY(0);p<=h&&r<e;p++,r++)k=b[r].element,a.prepareElement(d.item(r),r,e,k),k.setAttribute("aria-rowindex",r.toString())}}}resize(){const a=this._adapter;var b=this.element;
...
b){if(this.useVirtualItems)this.refreshVisibleItems();else{const g=this._adapter;var c=b-a+1;if(!g||0>=c)return;var d=this.container;const h=this.items,k=g.list,m=k.length;var e=k.currentItem;const l=Array(c);for(var f=b;f>=a;f--){const p=k.item(f),r=new ListControlItem(g.createEmptyElement("list-item real"));g.prepareElement(p,f,m,r.element);r.element.setAttribute("aria-rowindex",f.toString());l[f-a]=r;e===p&&(this.currentItem&&(this.currentItem.current=!1,this.currentItem.element.classList.remove("current")),
this.currentItem=r,r.current=!0,r.element.classList.add("current"))}e=a>=h.length?null:h[a].element;a>=h.length?h.push(...l):h.splice(a,0,...l);if(this.items.length!==k.length)throw Error("Assertion error: this.items.length !== list.length");this.adjustContainerHeight();for(f=0;f<c;f++)d.insertBefore(l[f].element,e);for(c=h.length-1;c>b;c--)d=h[c].element,g.prepareElementIndexOrLengthChanged(k.item(c),c,m,d),d.setAttribute("aria-rowindex",c.toString());for(--a;0<=a;a--)b=h[a].element,g.prepareElementIndexOrLengthChanged(k.item(a),
