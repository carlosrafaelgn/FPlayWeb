...
n=c?null:a.getAttribute("data-square"),q=Strings.translate(a.getAttribute("title")||a.value);let p=a.getAttribute("id");p||(p="checkBoxControl"+CheckboxControl.internalId++,a.setAttribute("id",p));h.setAttribute("aria-label",q);h.setAttribute("aria-pressed",a.checked?"true":"false");h.setAttribute("role","button");h.setAttribute("for",p);h.setAttribute("tabindex","0");m.setAttribute("tabindex","-1");m.setAttribute("aria-hidden","true");a.setAttribute("tabindex","-1");a.setAttribute("aria-hidden",
"true");h.className=a.className;a.className="";c||(c=a.getAttribute("data-icon"));c&&!d&&(d=a.getAttribute("data-icon-color"));e||(e=a.getAttribute("data-checkbox0-color"));f||(f=a.getAttribute("data-checkbox1-color"))||(f="orange");l&&(l.insertBefore(h,a),l.removeChild(a));h.appendChild(m);m.appendChild(a);m.appendChild(Icon.createLarge("icon-checkbox-0",(n?"":"margin")+(e?" "+e:"")));m.appendChild(Icon.createLarge("icon-checkbox-1",n?f:"margin "+f));c&&m.appendChild(Icon.createLarge(c,d?"margin "+
d:"margin"));n||m.appendChild(document.createTextNode(q));a.removeAttribute("value");a.removeAttribute("title");h.childInput=a;h.addEventListener("click",CheckboxControl.buttonClick);(b||void 0===b)&&h.addEventListener("keydown",CheckboxControl.buttonKeyDown);g&&CheckboxControl.setChecked(h,g);k&&(a.onclick=k);return h}static buttonClick(a){(a=this.childInput)&&this.setAttribute("aria-pressed",a.checked?"true":"false")}static buttonKeyDown(a){if(!(a.ctrlKey||a.metaKey||a.shiftKey||a.altKey||a.repeat||
"Enter"!==a.key&&" "!==a.key)){cancelEvent(a);this.click();try{this.focus()}catch(b){}return!1}}}CheckboxControl.internalId=0;
...
f.className="slider-control-ruler"+a;d.appendChild(f);this.ruler=f;f=document.createElement("span");f.className="slider-control-color slider-control-filled-ruler"+a;d.appendChild(f);this.filledRuler=f;f=document.createElement("span");f.className="slider-control-color slider-control-thumb"+a;d.appendChild(f);this.thumb=f;this.element.appendChild(b);g>k?(this._min=k|0,this._max=g|0):(this._min=g|0,this._max=k|0);this.delta=this._max-this._min;this.delta||(this.delta=1);this._disabled=!1;this._value=
g-1;this.percent=0;this.valueChangedDragging=this.forcedDragging=!1;this.value=void 0===h?g:h;this.pointerHandler=new PointerHandler(c,this.mouseDown.bind(this),this.mouseMove.bind(this),this.mouseUp.bind(this));this.element.setAttribute("aria-valuemin",g.toString());this.element.setAttribute("aria-valuemax",k.toString());e&&(this.element.addEventListener("keydown",this.keyDown.bind(this)),this.element.addEventListener("focus",this.focus.bind(this)),this.element.addEventListener("blur",this.blur.bind(this)));
