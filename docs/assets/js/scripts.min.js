...
if(65535<a.written)throw Error("String too large");this.dataView.setUint16(this._length,a.written,!0);this._length+=2+a.written;return this}}var MetadataFlags;(function(a){a[a.Seekable=1]="Seekable"})(MetadataFlags||(MetadataFlags={}));
...
93+e))))}c&MetadataExtractor.TRACK_B||d[125]||!d[126]||(a.track=d[126]&255)}}catch(g){}})}static extractID3v2Andv1(a,b,c){return __awaiter(this,void 0,void 0,function*(){const d={url:FileUtils.urlOrPathToURL(a["data-path"])||"",flags:MetadataFlags.Seekable};d.url?d.url.startsWith(FileUtils.localURLPrefix)&&(d.file=a):(d.file=a,d.fileSize=a.size,d.fileName=a.name);var e=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==e)if(e|=b.readByte(),1380533830===e){e=yield MetadataExtractor.extractRIFF(d,
b,c[0]);if(!e)return null;if(!e[1])return d}else return yield MetadataExtractor.extractID3v1(d,b,0,c[0]),d;var f=b.readByte(),g=b.readByte();e=b.readByte();var h=b.readByte();const k=b.readByte(),m=b.readByte(),l=b.readByte();e=(e&16?10:0)+(l&127|(m&127)<<7|(k&127)<<14|(h&127)<<21);if(2<(f&255)||g){for(f=0;0<e&&f!==MetadataExtractor.ALL_B;){(g=b.fillBuffer(1024))&&(yield g);h=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();g=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();
b.skip(2);if(!h||0>=g||g>e)break;switch(h){case 1414091826:f&MetadataExtractor.TITLE_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.title=h&&h.then?yield h:h,d.title&&(f|=MetadataExtractor.TITLE_B));break;case 1414546737:f&MetadataExtractor.ARTIST_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.artist=h&&h.then?yield h:h,d.artist&&(f|=MetadataExtractor.ARTIST_B));break;case 1413565506:f&MetadataExtractor.ALBUM_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.album=h&&h.then?yield h:
h,d.album&&(f|=MetadataExtractor.ALBUM_B));break;case 1414677323:f&MetadataExtractor.TRACK_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.track=h&&h.then?parseInt(yield h):parseInt(h),d.track?f|=MetadataExtractor.TRACK_B:d.track=0);break;case 1414284622:f&MetadataExtractor.LENGTH_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.lengthMS=h&&h.then?parseInt(yield h):parseInt(h),d.lengthMS?f|=MetadataExtractor.LENGTH_B:d.lengthMS=0);break;case 1415136594:case 1413763651:f&MetadataExtractor.YEAR_B?
b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.year=h&&h.then?parseInt(yield h):parseInt(h),d.year?f|=MetadataExtractor.YEAR_B:d.year=0);break;default:b.skip(g)}e-=10+g}(f&MetadataExtractor.ALL_BUT_LENGTH_B)!==MetadataExtractor.ALL_BUT_LENGTH_B&&(yield MetadataExtractor.extractID3v1(d,b,f,c[0]))}return d})}static extract(a,b,c){return __awaiter(this,void 0,void 0,function*(){if(!a)return null;if(!a.name.endsWith(".mp3")&&!a.name.endsWith(".aac")&&!a.name.endsWith(".wav")){const d=a.name.toLowerCase();
if(!d.endsWith(".mp3")&&!d.endsWith(".aac")&&!d.endsWith(".wav"))return null}b||(b=new Uint8Array(BufferedFileHandle.minBufferLength));c||(c=[new Uint8Array(256)]);try{const d=new BufferedFileHandle(a,b);yield d.fillBuffer(-1);return yield MetadataExtractor.extractID3v2Andv1(a,d,c)}catch(d){return null}})}}MetadataExtractor.ALL_B=63;MetadataExtractor.ALL_BUT_LENGTH_B=31;MetadataExtractor.TITLE_B=1;MetadataExtractor.ARTIST_B=2;MetadataExtractor.ALBUM_B=4;MetadataExtractor.TRACK_B=8;
MetadataExtractor.YEAR_B=16;MetadataExtractor.LENGTH_B=32;MetadataExtractor.textDecoderIso88591=new TextDecoder("iso-8859-1");MetadataExtractor.textDecoderUtf16=new TextDecoder("utf-16");MetadataExtractor.textDecoderUtf16be=new TextDecoder("utf-16be");MetadataExtractor.textDecoderUtf8=new TextDecoder("utf-8");
...
class Song{constructor(a,b,c,d,e,f,g,h,k,m){if("string"!==typeof a){m=a;a=m.url;b=m.flags;c=m.title;d=m.artist;e=m.album;f=m.track;g=m.lengthMS;h=m.year;if(m.file){if(!a||a.startsWith(FileUtils.localURLPrefix))this.file=m.file;c||(c=m.file.name.lastIndexOf("."),c=0<c?m.file.name.substring(0,c):m.file.name)}k=m.fileName;m=m.fileSize}this.url=a;this.flags=b||0;this.isHttp=Song.isPathHttp(this.url);c||(a=decodeURI(a),b=a.lastIndexOf("/"),c=0<=b?a.substring(b+1):a,this.isHttp||(b=c.lastIndexOf("."),0<
b&&(c=c.substring(0,b))));this.title=c||Formatter.none;this.artist=d||Formatter.none;this.album=e||Formatter.none;this.track=f&&0<f?f:Formatter.noneInt;this.lengthMS=g&&0<g?g:Formatter.noneInt;this.year=h&&0<h?h:Formatter.noneInt;this.length=Formatter.formatTimeMS(this.lengthMS);this.fileName=k||null;this.fileSize=m||0}static isPathHttp(a){return a.startsWith("http:")||a.startsWith("https:")||a.startsWith("icy:")}static deserialize(a){a.readUint8();return new Song(a.readString(),a.readInt32(),a.readString(),
a.readString(),a.readString(),a.readInt16(),a.readInt32(),a.readInt16(),a.readString(),a.readInt32())}get isSeekable(){return this.flags&MetadataFlags.Seekable?!0:!1}estimateSerializedLength(){return(this.url.length+this.title.length+this.artist.length+this.album.length+(this.fileName?this.fileName.length:0)<<1)+17}serialize(a){return a.writeUint8(0).writeString(this.url).writeInt32(this.flags).writeString(this.title).writeString(this.artist).writeString(this.album).writeInt16(this.track).writeInt32(this.lengthMS).writeInt16(this.year).writeString(this.fileName||
null).writeInt32(this.fileSize||0)}serializeWeb(){return{url:this.url,flags:this.flags,title:this.title,artist:this.artist,album:this.album,track:this.track,lengthMS:this.lengthMS,year:this.year,fileName:this.fileName,fileSize:this.fileSize}}}
...
this._currentIndexResumeTimeS;return a}updateSongLength(a,b){if(0>=b||isNaN(b)||!isFinite(b)){if(0>a.lengthMS)return;b=-1}else{if(0<=a.lengthMS&&(a.lengthMS/1E3|0)===(b|0))return;b=1E3*b|0}this.modified=!0;a.lengthMS=b;a.length=Formatter.formatTimeMS(b);if(this.onsonglengthchange)this.onsonglengthchange(a)}clear(){this.missingSongs&&(this.missingSongs.clear(),this.missingSongs=null);super.clear()}changeItems(a){this.missingSongs&&(this.missingSongs.clear(),this.missingSongs=null);super.changeItems(a)}removeItems(a,
b){if(this.missingSongs&&this.items&&0<=a&&a<this.items.length){const c=this.missingSongs,d=this.items;void 0===b||b>=d.length?b=d.length-1:b<a&&(b=a);for(let e=a;e<=b;e++){const f=d[e];if(!f.url&&!f.file&&f.fileName&&(c.delete(f.fileName+f.fileSize),!c.size)){this.missingSongs=null;break}}}return super.removeItems(a,b)}addSong(a,b){const c=Object.create(null,{addItem:{get:()=>super.addItem}});return __awaiter(this,void 0,void 0,function*(){let d=0;if("string"!==typeof a){var e=a.fileURL;d=a.fileSize}else e=
a;if(!FileUtils.isTypeSupported(e))return!1;e=yield App.extractMetadata(e,d);if(!e)return!1;c.addItem.call(this,new Song(e),b);return!0})}addSongWeb(a,b,c,d){const e=Object.create(null,{addItem:{get:()=>super.addItem}});return __awaiter(this,void 0,void 0,function*(){if(!FileUtils.isTypeSupported(a.name))return!1;if(this.missingSongs){var f=a.name+a.size;const g=this.missingSongs.get(f);if(g)return g.file=a,this.missingSongs.delete(f),this.missingSongs.size||(this.missingSongs=null),!0}f=yield MetadataExtractor.extract(a,
b,c);if(!f)return!1;e.addItem.call(this,new Song(f),d);return!0})}}
...
a)}}}}
class Player{constructor(a,b,...c){this.audioContextTimeout=0;this.audioContextSuspended=!0;var d=navigator.userAgent&&0<=navigator.userAgent.indexOf("Firefox")?1:"playback";this.audioContext=window.AudioContext?new window.AudioContext({latencyHint:d}):new window.webkitAudioContext({latencyHint:d});this.audioContext.suspend();this.audioContext.onstatechange=this.audioContextStateChange.bind(this);if(c&&c.length){d=Array(c.length);for(let e=0;e<c.length;e++)d[e]=c[e](this.audioContext)}else d=[];this.intermediateNodes=
d;this.destinationNode=new DestinationNode(this.audioContext.destination);this.destinationNode.enabled=!0;this.boundPlaybackError=this.onerror=this.oncurrenttimeschange=this.onpausedchange=this.onloadingchange=this.onsongchange=null;this.boundNotifySongChange=this.notifySongChange.bind(this);this.boundCheckAudioContext=this.checkAudioContext.bind(this);this.boundAutoNext=this.next.bind(this,!0);this._alive=!0;this._loading=!1;this._paused=!0;this._currentSong=this._playlist=null;this._volume=0;this.lastObjectURL=
null;this.lastTimeS=-1;this.songStartedAutomatically=!0;this.songToResumeTime=null;this.resumeTimeS=0;this.haltOnAllErrors=!1;this.volume=a||0;this.sourceNode=this.audio=null;this.recreateAudioPath();(this.mediaSession=a="mediaSession"in navigator&&"MediaMetadata"in window?navigator.mediaSession:null)&&"setActionHandler"in a&&(c=this.playPause.bind(this),a.setActionHandler("previoustrack",()=>{this.previous()}),a.setActionHandler("seekbackward",this.seekBackward.bind(this)),a.setActionHandler("pause",
c),a.setActionHandler("play",c),a.setActionHandler("seekforward",this.seekForward.bind(this)),a.setActionHandler("nexttrack",()=>{this.next()}));b&&(this.playlist=b)}recreateAudioPath(){const a=this.intermediateNodes;this.sourceNode&&this.sourceNode.disconnectFromDestination();for(var b=a.length-1;0<=b;b--)a[b].disconnectFromDestination();const c=new Audio;b=this.audioContext.createMediaElementSource(c);b=new SourceNode(b);this.audio=c;this.sourceNode=b;c.loop=!1;c.controls=!1;var d=()=>{this.audio===
c&&this.playbackLoadStart()};c.onwaiting=d;c.onloadstart=d;c.oncanplay=()=>{this.audio===c&&this.playbackLoadEnd()};c.onended=()=>{this.audio===c&&this.playbackEnd()};this.boundPlaybackError=d=(e,f,g,h,k)=>{this.audio===c&&this.playbackError(e,f,g,h,k)};c.onerror=d;c.onpause=()=>{this.audio===c&&this.playbackPaused()};d=()=>{this.audio===c&&this.playbackStarted()};c.onplay=d;c.onplaying=d;d=()=>{this.audio===c&&this.playbackAborted()};c.onabort=d;c.onemptied=d;c.ondurationchange=()=>{this.audio===
c&&this.playbackLengthChange()};c.ontimeupdate=()=>{this.audio===c&&this.currentTimeChange()};b.enabled=!0;if(a.length){b.connectToDestination(a[0]);for(b=0;b<a.length-1;b++)a[b].connectToDestination(a[b+1]);a[a.length-1].connectToDestination(this.destinationNode)}else b.connectToDestination(this.destinationNode);this.volume=this._volume}destroy(a){this.stop();if(a){if(this._alive=!1,this.sourceNode&&this.sourceNode.disconnectFromDestination(),(a=this.intermediateNodes)&&a.length)for(let b=a.length-
1;0<=b;b--)a[b].disconnectFromDestination()}else this._playlist&&this._playlist.destroy(),(a=this.mediaSession)&&"setActionHandler"in a&&(a.setActionHandler("previoustrack",null),a.setActionHandler("seekbackward",null),a.setActionHandler("pause",null),a.setActionHandler("play",null),a.setActionHandler("seekforward",null),a.setActionHandler("nexttrack",null)),zeroObject(this)}get alive(){return this._alive}get loading(){return this._loading}get paused(){return this._paused}get volume(){return this._volume}set volume(a){this._volume=
Math.max(Player.minVolume,Math.min(0,a|0));this.audio&&(this.audio.volume=a<=Player.minVolume?0:Math.pow(10,this._volume/20))}get playlist(){return this._playlist}set playlist(a){this._alive&&(this.stop(),this._playlist=a,this.songToResumeTime=null,this.resumeTimeS=0,a&&0<a.currentIndexResumeTimeS&&(this.songToResumeTime=a.currentItem)&&(this.resumeTimeS=a.currentIndexResumeTimeS))}get currentSong(){return this._currentSong}get currentTimeMS(){if(this._currentSong&&this.audio){const a=this.audio.currentTime;
this.lastTimeS=a;return 1E3*a|0}return-1}get currentIndexResumeTimeS(){if(this.songToResumeTime)return this.resumeTimeS;let a=0;if(this._currentSong&&this._currentSong.isSeekable&&this._playlist&&this._playlist.currentItem===this._currentSong){try{this.audio&&(a=this.audio.currentTime||0)}catch(b){}0>=a&&(a=this.lastTimeS)}return a}set currentIndexResumeTimeS(a){this.songToResumeTime&&(this.resumeTimeS=a)}handleError(a){const b=this.lastTimeS;this.stop();this.recreateAudioPath();if(this.haltOnAllErrors){if(this.onerror)this.onerror(a)}else{var c=
!1;this._playlist&&this._playlist.length?0>b&&(c=!this.songStartedAutomatically):c=!0;if(c&&this.onerror)this.onerror(a);else queueMicrotask(this.boundAutoNext)}}audioContextStateChange(){this._alive&&"running"!==this.audioContext.state&&!this.audioContextSuspended&&(this.audioContextSuspended=!0,this.playbackPaused())}playbackLoadStart(){if(this._alive&&!this._loading&&(this._loading=!0,this.onloadingchange))this.onloadingchange(!0)}playbackLoadEnd(){if(this._alive&&this._loading){this._loading=
!1;if(this.songToResumeTime){if(this.audio&&this.songToResumeTime===this._currentSong&&0<this.resumeTimeS){this.lastTimeS=this.resumeTimeS;try{this.audio.currentTime=this.resumeTimeS}catch(b){}const a=this.audio.play();a&&a.catch(Player.nop)}this.songToResumeTime=null;this.resumeTimeS=0}if(this.onloadingchange)this.onloadingchange(!1)}}playbackEnd(){this._alive&&this.next(!0)}playbackError(a,b,c,d,e){this._alive&&this.handleError(e?e.message?e.message:"string"===typeof e?e:e.toString():"string"===
typeof a?a:Strings.UnknownError)}suspendAudioContext(a){this.audioContextTimeout&&(clearTimeout(this.audioContextTimeout),this.audioContextTimeout=0);this.audioContextSuspended||(a?this.audioContextTimeout=window.setTimeout(this.boundCheckAudioContext,5E3):(this.audioContextSuspended=!0,this.audioContext.suspend()))}resumeAudioContext(){this.audioContextTimeout&&(clearTimeout(this.audioContextTimeout),this.audioContextTimeout=0);if(this.audioContextSuspended||"running"!==this.audioContext.state)this.audioContextSuspended=
!1,this.audioContext.resume()}checkAudioContext(){this.audioContextTimeout=0;this._paused?this.audioContextSuspended||(this.audioContextSuspended=!0,this.audioContext.suspend()):this.audioContextSuspended&&(this.audioContextSuspended=!1,this.audioContext.resume())}playbackPaused(){if(this._alive&&!this._paused){this._paused=!0;this.suspendAudioContext(!0);if(this.onpausedchange)this.onpausedchange(!0);App.hostInterface&&App.hostInterface.setPaused(!0)}}playbackStarted(){if(this._alive&&this._paused){this._paused=
!1;this.resumeAudioContext();if(this.onpausedchange)this.onpausedchange(!1);App.hostInterface&&App.hostInterface.setPaused(!1)}}playbackAborted(){if(this._alive){if(this._loading&&(this._loading=!1,this.onloadingchange))this.onloadingchange(!1);if(!this._paused){this._paused=!0;this.suspendAudioContext(!0);if(this.onpausedchange)this.onpausedchange(!0);App.hostInterface&&App.hostInterface.setPaused(!0)}}}playbackLengthChange(){this._alive&&this.audio&&this._playlist&&this._currentSong&&(this._playlist.updateSongLength(this._currentSong,
this.audio.duration),this.mediaSession&&0<this.audio.duration&&"setPositionState"in this.mediaSession&&this.mediaSession.setPositionState({duration:this.audio.duration}))}currentTimeChange(){if(this._alive&&this.audio&&this._currentSong){var a=this.audio.currentTime;this.lastTimeS=a;if(this.oncurrenttimeschange)this.oncurrenttimeschange(a)}}notifySongChange(){if(this._alive){const a=this._currentSong,b=this.mediaSession;b&&(a?(b.metadata=new window.MediaMetadata({title:a.title,artist:a.artist,album:a.album,
artwork:[{src:"assets/images/albumArts/64x64.png",sizes:"64x64",type:"image/png"},{src:"assets/images/albumArts/96x96.png",sizes:"96x96",type:"image/png"},{src:"assets/images/albumArts/192x192.png",sizes:"192x192",type:"image/png"},{src:"assets/images/albumArts/256x256.png",sizes:"256x256",type:"image/png"},{src:"assets/images/albumArts/512x512.png",sizes:"512x512",type:"image/png"}]}),0<a.lengthMS&&"setPositionState"in b&&b.setPositionState({duration:a.lengthMS/1E3})):b.playbackState="none");if(this.onsongchange)this.onsongchange(a)}}setPlaylistData(){const a=
this._playlist;a&&(a.currentIndexResumeTimeS=this.currentIndexResumeTimeS)}previous(a){this._alive&&this._playlist&&(this._playlist.moveCurrentToPrevious(),this.play(-1,a))}seekBackward(){this._alive&&this.seekTo(-1E4,!0)}pause(){this._alive&&(this.suspendAudioContext(!1),this._currentSong&&this.audio&&this.audio.pause())}play(a,b){if(this._alive&&this.audio){if(this._currentSong&&void 0===a){this.resumeAudioContext();var c=this.audio.play()}else if(this._playlist){void 0!==a&&0<=a&&(this._playlist.currentIndex=
a);a=this._playlist.currentItem;!a&&this._playlist.length&&(this._playlist.moveCurrentToNext(),a=this._playlist.currentItem);if(!a){this.stop();return}this._currentSong=a;this.lastTimeS=-1;this.songStartedAutomatically=!!b;queueMicrotask(this.boundNotifySongChange);for(this.resumeAudioContext();this.audio.firstChild;)this.audio.removeChild(this.audio.firstChild);const d=document.createElement("source");if(a.url&&!a.url.startsWith(FileUtils.localURLPrefix))d.src=a.url;else if(a.file)this.lastObjectURL&&
URL.revokeObjectURL(this.lastObjectURL),this.lastObjectURL=URL.createObjectURL(a.file),d.src=this.lastObjectURL;else{if(a.url){this.pause();const e=this._playlist.currentIndex,f=this._playlist.currentItem;FileSystemAPI.getFile(a.url.substring(FileUtils.localURLPrefix.length)).then(g=>{f&&!f.file&&g&&(f.file=g);this._playlist&&e===this._playlist.currentIndex&&f===this._playlist.currentItem&&(g?this.play(e,b):this.handleError(Strings.FileNotFoundOrNoPermissionError))},()=>{this._playlist&&e===this._playlist.currentIndex&&
f===this._playlist.currentItem&&this.handleError(Strings.FileNotFoundOrNoPermissionError)})}else this.handleError(Strings.MissingSongError);return}d.onerror=this.boundPlaybackError;this.audio.appendChild(d);this.audio.load();this.songToResumeTime!==a&&(c=this.audio.play())}c&&c.catch(Player.nop)}}playPause(){this._alive&&this.audio&&(!this._currentSong||this.audio.paused?this.play():this.pause())}stop(){if(this._alive&&this.audio){if(this._currentSong){for(;this.audio.firstChild;)this.audio.removeChild(this.audio.firstChild);
this.audio.load();this.lastObjectURL&&(URL.revokeObjectURL(this.lastObjectURL),this.lastObjectURL=null);if(this._loading&&(this._loading=!1,this.onloadingchange))this.onloadingchange(!1);if(!this._paused){this._paused=!0;if(this.onpausedchange)this.onpausedchange(!0);App.hostInterface&&App.hostInterface.setPaused(!0)}this._currentSong=null;this.lastTimeS=-1;this.songToResumeTime=null;this.resumeTimeS=0;this.notifySongChange()}this.suspendAudioContext(!1)}}seekForward(){this._alive&&this.seekTo(1E4,
!0)}next(a){this._alive&&this._playlist&&(this._playlist.moveCurrentToNext(),this.play(-1,a))}seekTo(a,b){this._alive&&this.audio&&this._currentSong&&this._currentSong.isSeekable&&!(0>=this._currentSong.lengthMS)&&this.audio.seekable&&this.audio.seekable.length&&(this.lastTimeS=a=Math.min(this.audio.duration||0,Math.max(0,a/1E3+(b?this.audio.currentTime:0))),this.audio.currentTime=a)}}Player.minVolume=-40;Player.nop=function(){};
...
`
			...
			`,document.body.insertBefore(App.titleBar,document.body.firstChild),App.iconRestore=document.getElementById("icon-restore-i"),App.iconMaximize=document.getElementById("icon-maximize-i"));AppUI.preInit(b,a);App.init(a)})}static init(a){App.player||(App.player=new Player(a.playerVolume,InternalStorage.loadPlaylistWeb(),function(b){App.graphicalFilterControl=new GraphicalFilterControl(document.getElementById("filter-container"),document.getElementById("optional-panel-container"),b,a.graphicalFilterControlSimpleMode);
App.graphicalFilterControl.enabled=!!a.graphicalFilterControlEnabled;return App.graphicalFilterControl},function(b){App.stereoPannerControl=new StereoPannerControl(document.getElementById("stereo-panner-slider"),b);App.stereoPannerControl.enabled=!!a.stereoPannerControlEnabled;App.stereoPannerControl.onappliedgainchange=function(c){App.monoDownMixerControl&&(App.monoDownMixerControl.multiplier=1/(1+c))};return App.stereoPannerControl},function(b){App.monoDownMixerControl=new MonoDownMixerControl(b);
App.monoDownMixerControl.enabled=MonoDownMixerControl.isSupported()&&!!a.monoDownMixerControlEnabled;return App.monoDownMixerControl}),AppUI.init(a),App.loading=!1)}static triggerMainWindowStateChanged(){App.ipcRenderer&&App.ipcRenderer.invoke("triggerMainWindowStateChanged")}static mainWindowMinimize(){App.ipcRenderer&&App.ipcRenderer.invoke("mainWindowMinimize")}static mainWindowRestoreOrMaximize(){App.ipcRenderer&&App.ipcRenderer.invoke(App.isMaximized?"mainWindowRestore":"mainWindowMaximize")}static mainWindowClose(){App.ipcRenderer&&
App.ipcRenderer.invoke("mainWindowClose")}static extractMetadata(a,b){return App.ipcRenderer.invoke("extractMetadata",a,b)}static showOpenDialogWeb(a,b){const c=document.createElement("input");c.setAttribute("type","file");c.setAttribute("multiple","multiple");c.setAttribute("aria-label",Strings.AddSongs);a?(c.setAttribute("webkitdirectory","webkitdirectory"),c.setAttribute("directory","directory")):c.setAttribute("accept",FileUtils.concatenatedSupportedExtensions);c.onchange=function(){if(App.fileInputPromiseResolve){var e=
