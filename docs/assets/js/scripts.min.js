...
var __awaiter=this&&this.__awaiter||function(a,b,c,d){function e(f){return f instanceof c?f:new c(function(g){g(f)})}return new (c||(c=Promise))(function(f,g){function h(l){try{m(d.next(l))}catch(p){g(p)}}function k(l){try{m(d["throw"](l))}catch(p){g(p)}}function m(l){l.done?f(l.value):e(l.value).then(h,k)}m((d=d.apply(a,b||[])).next())})},__asyncValues=this&&this.__asyncValues||function(a){function b(f){e[f]=a[f]&&function(g){return new Promise(function(h,k){g=a[f](g);c(h,k,g.done,g.value)})}}function c(f,
...
Strings.Close="Close";Strings.Refresh="Refresh";Strings.Exit="Exit";Strings.Done="Done";Strings.Up="Up";Strings.All="All";Strings.Storage="Storage";Strings.Previous="Previous";Strings.Play="Play";Strings.Pause="Pause";Strings.PlayPause="Play / Pause";Strings.Stop="Stop";Strings.Next="Next";Strings.Seek="Seek";Strings.Title="Title";Strings.TitleLabel="Title: ";Strings.CurrentTitleLabel="Current title: ";Strings.Artist="Artist";Strings.ArtistLabel="Artist: ";Strings.CurrentArtistLabel="Current artist: ";
Strings.Duration="Duration";Strings.DurationLabel="Duration: ";Strings.Playlist="Playlist";Strings.FileList="File list";Strings.CurrentPathLabel="Current path: ";Strings.Loading="Loading";Strings.LoadingLabel="Loading\u2026 ";Strings.LoadingCurrentPathLabel="Loading current path: ";Strings.Folder="Folder";Strings.FolderLabel="Folder: ";Strings.LeftAbbrev="L";Strings.RightAbbrev="R";Strings.Volume="Volume";Strings.Panning="Panning";Strings.DownMixToMono="Down-mix to mono";Strings.UnknownError="Something went wrong during playback. \ud83d\ude22";
Strings.AddFiles="Add files";Strings.AddSongs="Add songs";Strings.AddFolders="Add folders";Strings.AddMoreFolders="Add more folders\u2026";Strings.ShowEffects="Show effects";Strings.ShowPlaylist="Show playlist";Strings.UpdateAvailable="Update available!";Strings.PleaseRefresh="Please, refresh the page to update the app. \ud83d\ude0a";Strings.AboutHTML='FPlay Web is an experimental audio player. \ud83d\ude0a<br />\n<br />\nFor more information about the project, its source code and dependencies, check out its repository at <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb">github.com/carlosrafaelgn/FPlayWeb</a>.<br />\n<br />\nThis project is licensed under the <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb/blob/master/LICENSE">MIT License</a>.';
...
class MetadataExtractor{static extractRIFF(a,b,c){return __awaiter(this,void 0,void 0,function*(){if(44>b.fileLength)return null;var d=b.readUInt32LE();if(null===d||b.fileLength<8+d)return null;var e=d;let f=!1,g=!1,h=d=0,k=0;a:for(;0<e;){var m=!1,l=0,p=void 0;switch(b.readUInt32BE()){case null:break a;case 1463899717:m=!0;e-=4;break;case 1279873876:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;break;case 1768174368:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;
(p=b.fillBuffer(1024))&&(yield p);if(4<l){m=b.readByte();var q=b.readByte();p=b.readByte();if(null===m||null===q||null===p)break a;e-=3;l-=3;if(73===m||68===q||51===p)if(d=b.fileLength-e,f&&g){d=-1;break a}}b.skip(l);(p=b.fillBuffer(1024))&&(yield p);continue;default:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;b.skip(l);(p=b.fillBuffer(1024))&&(yield p);continue}for((p=b.fillBuffer(1024))&&(yield p);m&&(!f||!g)||0<l;){var n=b.readUInt32BE();q=0;if(null===n)break a;e-=4;l-=4;if(1229866575!==
n){q=b.readUInt32LE();if(null===q||0>q||q>e||!m&&q>l)break a;e-=4;l-=4}1684108385!==n&&(p=b.fillBuffer(Math.min(264,8+q)))&&(yield p);switch(n){case 1718449184:if(!m)break;p=b.readUInt16LE();n=b.readUInt16LE();var r=b.readUInt32LE(),u=b.readUInt32LE(),t=b.readUInt16LE();const y=b.readUInt16LE();q-=16;e-=16;l-=16;if(null===p||null===n||null===r||null===u||null===t||null===y)break a;f=!0;k||(k=u);break;case 1684108385:m&&(g=!0,h||(h=q));break;case 1229866575:for(n=function(x){b.read(c,0,x);return MetadataExtractor.finishReadingV2Frame(0,
x,c)};0<l;){(p=b.fillBuffer(8))&&(yield p);r=b.readUInt32BE();e-=4;l-=4;if(null===r)break a;u=b.readUInt32LE();e-=4;l-=4;if(null===u||0>u||u>l)break a;if(1>=u)b.skip(u);else{t=Math.min(257,u)-1;(p=b.fillBuffer(t))&&(yield p);switch(r){case 1229865293:a.title=n(t);break;case 1230000708:a.album=n(t);break;case 1229017684:a.artist=n(t);break;case 1229148740:a.year=parseInt(n(t))||0;break;case 1230262859:a.track=parseInt(n(t))||0;break;default:t=0}b.skip(u-t);e-=u;l-=u}}}0<q&&(b.skip(q),e-=q,l-=q);e&&
(p=b.fillBuffer(8))&&(yield p)}}return f&&g?(d&&(0<d&&b.seekTo(d),(e=b.fillBuffer(1024))&&(yield e)),a.lengthMS=1E3*h/k|0,[a,!!d]):null})}static finishReadingV2Frame(a,b,c){let d=0;var e=b-1;a:for(;0<b;)switch(c[d]){case 0:case 9:case 10:case 11:case 12:case 13:case 32:case 133:case 160:b--;d++;break;default:break a}a:for(;0<b;)switch(c[e]){case 0:case 9:case 10:case 11:case 12:case 13:case 32:case 133:case 160:b--;e--;break;default:break a}e=null;switch(a){case 1:case 2:if(b&1&&d+b<c.length&&b++,
...
93+e))))}c&MetadataExtractor.TRACK_B||d[125]||!d[126]||(a.track=d[126]&255)}}catch(g){}})}static extractID3v2Andv1(a,b,c){return __awaiter(this,void 0,void 0,function*(){const d={url:FileUtils.urlOrPathToURL(a["data-path"])||""};d.url?d.url.startsWith(FileUtils.localURLPrefix)&&(d.file=a):(d.file=a,d.fileSize=a.size,d.fileName=a.name);var e=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==e)if(e|=b.readByte(),1380533830===e){e=yield MetadataExtractor.extractRIFF(d,b,c[0]);if(!e)return null;
if(!e[1])return d}else return yield MetadataExtractor.extractID3v1(d,b,0,c[0]),d;var f=b.readByte(),g=b.readByte();e=b.readByte();var h=b.readByte();const k=b.readByte(),m=b.readByte(),l=b.readByte();e=(e&16?10:0)+(l&127|(m&127)<<7|(k&127)<<14|(h&127)<<21);if(2<(f&255)||g){for(f=0;0<e&&f!==MetadataExtractor.ALL_B;){(g=b.fillBuffer(1024))&&(yield g);h=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();g=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();b.skip(2);if(!h||0>=
g||g>e)break;switch(h){case 1414091826:f&MetadataExtractor.TITLE_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.title=h&&h.then?yield h:h,d.title&&(f|=MetadataExtractor.TITLE_B));break;case 1414546737:f&MetadataExtractor.ARTIST_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.artist=h&&h.then?yield h:h,d.artist&&(f|=MetadataExtractor.ARTIST_B));break;case 1413565506:f&MetadataExtractor.ALBUM_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.album=h&&h.then?yield h:h,d.album&&(f|=MetadataExtractor.ALBUM_B));
break;case 1414677323:f&MetadataExtractor.TRACK_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.track=h&&h.then?parseInt(yield h):parseInt(h),d.track?f|=MetadataExtractor.TRACK_B:d.track=0);break;case 1414284622:f&MetadataExtractor.LENGTH_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,g,c),d.lengthMS=h&&h.then?parseInt(yield h):parseInt(h),d.lengthMS?f|=MetadataExtractor.LENGTH_B:d.lengthMS=0);break;case 1415136594:case 1413763651:f&MetadataExtractor.YEAR_B?b.skip(g):(h=MetadataExtractor.readV2Frame(b,
g,c),d.year=h&&h.then?parseInt(yield h):parseInt(h),d.year?f|=MetadataExtractor.YEAR_B:d.year=0);break;default:b.skip(g)}e-=10+g}(f&MetadataExtractor.ALL_BUT_LENGTH_B)!==MetadataExtractor.ALL_BUT_LENGTH_B&&(yield MetadataExtractor.extractID3v1(d,b,f,c[0]))}return d})}static extract(a,b,c){return __awaiter(this,void 0,void 0,function*(){if(!a)return null;if(!a.name.endsWith(".mp3")&&!a.name.endsWith(".aac")&&!a.name.endsWith(".wav")){const d=a.name.toLowerCase();if(!d.endsWith(".mp3")&&!d.endsWith(".aac")&&
!d.endsWith(".wav"))return null}b||(b=new Uint8Array(BufferedFileHandle.minBufferLength));c||(c=[new Uint8Array(256)]);try{const d=new BufferedFileHandle(a,b);yield d.fillBuffer(-1);return yield MetadataExtractor.extractID3v2Andv1(a,d,c)}catch(d){return null}})}}MetadataExtractor.ALL_B=63;MetadataExtractor.ALL_BUT_LENGTH_B=31;MetadataExtractor.TITLE_B=1;MetadataExtractor.ARTIST_B=2;MetadataExtractor.ALBUM_B=4;MetadataExtractor.TRACK_B=8;MetadataExtractor.YEAR_B=16;MetadataExtractor.LENGTH_B=32;
...
class PlaylistAdapter extends ListAdapter{constructor(a){super(a)}get itemHeight(){return AppUI.playlistItemSizePX}createEmptyElement(a){const b=document.createElement("div");b.className=a+" playlist-item";b.appendChild(Icon.create("icon-title","pink margin",null,Strings.TitleLabel));b.appendChild(document.createTextNode(Formatter.none));b.appendChild(document.createElement("br"));b.appendChild(Icon.create("icon-artist","orange margin",null,Strings.ArtistLabel));a=document.createElement("span");Strings.changeText(a,
Formatter.none);b.appendChild(a);b.appendChild(document.createElement("br"));b.appendChild(Strings.createSrOnlyText(Strings.DurationLabel));a=document.createElement("span");a.className="length";Strings.changeText(a,Formatter.none);b.appendChild(a);a=document.createElement("span");a.setAttribute("aria-hidden","true");a.className="float-right";Strings.changeText(a,Formatter.none);b.appendChild(a);return b}prepareElement(a,b,c,d){d=d.childNodes;d[1].nodeValue=a.title;d[4].firstChild.nodeValue=a.artist;
d[7].firstChild.nodeValue=a.length;d[8].firstChild.nodeValue=a.url||a.file?`${b+1} / ${c}`:`(${Strings.Missing}) ${b+1} / ${c}`}prepareElementIndexOrLengthChanged(a,b,c,d){d.childNodes[8].firstChild.nodeValue=a.url||a.file?`${b+1} / ${c}`:`(${Strings.Missing}) ${b+1} / ${c}`}}
class Playlist extends List{constructor(a,b,c){super(a,b);this.missingSongs=c||null;this.onsonglengthchange=null}static deserialize(a){a.readUint8();const b=a.readInt32(),c=a.readInt32(),d=Array(b);for(let e=0;e<b;e++)d[e]=Song.deserialize(a);return new Playlist(d,c)}static deserializeWeb(a){try{const b=JSON.parse(a);if(!b||!b.items||!b.items.length)return null;const c=b.items,d=c.length,e=Array(d),f=new Map;for(a=0;a<d;a++){const g=new Song(c[a]);e[a]=g;!g.url&&g.fileName&&f.set(g.fileName+g.fileSize,
g)}return new Playlist(e,b.currentIndex||0,f.size?f:null)}catch(b){return null}}updateSongLength(a,b){if(0>=b||isNaN(b)||!isFinite(b)){if(0>a.lengthMS)return;b=-1}else{if(0<=a.lengthMS&&(a.lengthMS/1E3|0)===(b|0))return;b=1E3*b|0}this.modified=!0;a.lengthMS=b;a.length=Formatter.formatTimeMS(b);if(this.onsonglengthchange)this.onsonglengthchange(a)}clear(){this.missingSongs&&(this.missingSongs.clear(),this.missingSongs=null);super.clear()}changeItems(a){this.missingSongs&&(this.missingSongs.clear(),
this.missingSongs=null);super.changeItems(a)}removeItems(a,b){if(this.missingSongs&&this.items&&0<=a&&a<this.items.length){const c=this.missingSongs,d=this.items;void 0===b||b>=d.length?b=d.length-1:b<a&&(b=a);for(let e=a;e<=b;e++){const f=d[e];if(!f.url&&!f.file&&f.fileName&&(c.delete(f.fileName+f.fileSize),!c.size)){this.missingSongs=null;break}}}return super.removeItems(a,b)}addSong(a,b){const c=Object.create(null,{addItem:{get:()=>super.addItem}});return __awaiter(this,void 0,void 0,function*(){let d=
0;if("string"!==typeof a){var e=a.fileURL;d=a.fileSize}else e=a;if(!FileUtils.isTypeSupported(e))return!1;e=yield App.extractMetadata(e,d);if(!e)return!1;c.addItem.call(this,new Song(e),b);return!0})}addSongWeb(a,b,c,d){const e=Object.create(null,{addItem:{get:()=>super.addItem}});return __awaiter(this,void 0,void 0,function*(){if(!FileUtils.isTypeSupported(a.name))return!1;if(this.missingSongs){var f=a.name+a.size;const g=this.missingSongs.get(f);if(g)return g.file=a,this.missingSongs.delete(f),
this.missingSongs.size||(this.missingSongs=null),!0}f=yield MetadataExtractor.extract(a,b,c);if(!f)return!1;e.addItem.call(this,new Song(f),d);return!0})}}
...
f=Array(a);g=Array(a);const l=Array(a);var k=.5*Math.log(2),m=this.audioContext.sampleRate;const p=2*Math.PI;for(let q=a-1;0<=q;q--){const n=p*d[q]/m;l[q]=1/(2*Math.sinh(n/Math.sin(n)*k))}for(k=a-1;0<=k;k--)m=b.createBiquadFilter(),m.type="peaking",m.frequency.value=d[k],m.Q.value=l[k],f[k]=m,k<a-1&&f[k+1].connect(f[k]);this.biquadFilters=f;this.biquadFilterInput=f[a-1];this.biquadFilterOutput=f[0]}for(b=a-1;0<=b;b--)g[b]=Math.max(-40,this.yToDB(c[e[b]]));for(b=a-1;0<=b;b--)f[b].gain.value=g[b]+(b<
...
a}}drawCurve(a,b,c){const d=this.ctx;if(d){var e=1<devicePixelRatio?devicePixelRatio:1;e!==this.pixelRatio&&(this.scaleChanged(),e=this.pixelRatio);var f=this.editor,g=f.filter;e*=f.scale;var h=this.element;f=this.leftMargin;var k=h.width,m=h.height,l=Math.round(8*e),p=Math.round(4*e),q=(k/l|0)+1,n=GraphicalFilterEditor.maximumChannelValueY*e|0,r=1>e?e:e|0;h=.5*r;d.fillStyle="#303030";d.fillRect(0,0,k,m);d.lineWidth=r;d.strokeStyle="#5a5a5a";d.beginPath();r=k+(p>>1);var u=(GraphicalFilterEditor.zeroChannelValueY*
e|0)+h;d.moveTo(r,u);for(let t=q-1;0<=t;t--)d.lineTo(r-p,u),r-=l,d.moveTo(r,u);d.stroke();d.beginPath();r=k+(p>>1);u=(GraphicalFilterEditor.validYRangeHeight*e|0)+h;d.moveTo(r,u);for(k=q-1;0<=k;k--)d.lineTo(r-p,u),r-=l,d.moveTo(r,u);d.stroke();if(a)for(a=g.equivalentZonesFrequencyCount.length-2;0<a;a--){r=((g.equivalentZonesFrequencyCount[a]+f)*e|0)+h;u=n;d.beginPath();for(d.moveTo(r,u);u<m;)d.lineTo(r,u+p),u+=l,d.moveTo(r,u);d.stroke()}r=1>e?2*e:2*e|0;h=.5*r;d.lineWidth=r;a=GraphicalFilterEditor.visibleBinCount-
...
if(a&&b&&c&&d){var e=GraphicalFilterEditorControl.controlWidth,f=GraphicalFilterEditorControl.controlHeight,g=1<devicePixelRatio?devicePixelRatio:1,h=b.scale,k=h*g,m=this.leftMargin,l=this.svgLines,p=1>k?k:k|0,q=.5*p,n=(e*k|0).toString(),r=(f*k|0).toString();d.setAttribute("width",n);d.setAttribute("height",r);d.setAttribute("viewBox",`0 0 ${n} ${r}`);d.style.transform=1===g?"":"scale("+1/g+")";this.svgGradient.setAttribute("y2",r);b.element.style.width=(e*h|0)+"px";a.style.width=(e*h|0)+"px";a.style.height=
(f*h|0)+"px";l[0].setAttribute("x2",n);l[1].setAttribute("x2",n);for(n=l.length-1;2<=n;n--)l[n].setAttribute("y2",r);r=((GraphicalFilterEditor.zeroChannelValueY*k|0)+q).toString();l[0].setAttribute("y1",r);l[0].setAttribute("y2",r);r=((GraphicalFilterEditor.validYRangeHeight*k|0)+q).toString();l[1].setAttribute("y1",r);l[1].setAttribute("y2",r);for(r=c.equivalentZonesFrequencyCount.length-2;0<r;r--)n=(((c.equivalentZonesFrequencyCount[r]+m)*k|0)+q).toString(),l[r+1].setAttribute("x1",n),l[r+1].setAttribute("x2",
n);n=p.toString()+"px";r=(4*k|0).toString();for(c=l.length-1;0<=c;c--)l[c].setAttribute("stroke-width",n),l[c].setAttribute("stroke-dasharray",r);n=(1>k?2*k:2*k|0).toString()+"px";this.svgGrayCurve.style.strokeWidth=n;this.svgCurve.style.strokeWidth=n;this.pixelRatio=g}}drawCurve(a,b,c){var d=1<devicePixelRatio?devicePixelRatio:1;d!==this.pixelRatio&&(this.scaleChanged(),d=this.pixelRatio);this.showZones!==a&&(this.showZones=a,this.svgZones.style.display=a?"":"none");var e=this.editor;a=e.filter;
d*=e.scale;e=.5*(1>d?2*d:2*d|0);const f=this.leftMargin,g=GraphicalFilterEditor.visibleBinCount;for(let h=b?1:0;0<=h;h--){const k=h||!b?a.channelCurves[c]:a.actualChannelCurve,m=h?this.svgGrayCurve:this.svgCurve;let l=1,p=0,q=k[0],n="M "+(f*d|0)+","+(q*d+e);for(;l<g;l++)k[l]!==q&&(l>p+1&&1<l&&(n+=" "+((f+l-1)*d|0)+","+(k[l-1]*d+e)),p=l,q=k[l],n+=" "+((f+p)*d|0)+","+(q*d+e));n+=" "+((f+l)*d|0)+","+(k[l-1]*d+e);m.setAttribute("d",n)}this.isActualChannelCurveNeeded!==b&&(this.isActualChannelCurveNeeded=
...
"GEMNUSEP";return h};c=function(h){const k=document.createElement("div");k.className="GEMNULBL";k.appendChild(document.createTextNode(h));return k};d=function(h,k,m,l,p,q){const n=document.createElement("div");n.className=q?"GEMNUIT GECLK "+q:"GEMNUIT GECLK";if(k)if(f&&(l&&f.radioHTML||!l&&f.checkHTML))n.innerHTML=l?f.radioHTML:f.checkHTML,k=n.firstChild,k.style.marginRight=l?f.radioMargin||"2px":f.checkMargin||"2px",m||(k.style.visibility="hidden");else{k=document.createElement("span");q=l?"\u25cf ":
"\u25a0 ";let r=null;if(f){let u=!1;l?f.radioCharacter&&(u=!0,q=f.radioCharacter,r=f.radioMargin||"2px"):f.checkCharacter&&(u=!0,q=f.checkCharacter,r=f.checkMargin||"2px");u&&(f.checkFontFamily&&(k.style.fontFamily=f.checkFontFamily),f.checkFontSize&&(k.style.fontSize=f.checkFontSize))}r&&(k.style.marginRight=r);k.appendChild(document.createTextNode(q));m||(k.style.visibility="hidden");n.appendChild(k)}n.appendChild(document.createTextNode(h));p&&(n.onclick=p);return n};this.element=a;a.className=
...
d=1-d;d*=d;d+=.5*d;.55>d?d=0:1>d&&(d=smoothStep(.55,1,d));h=1-h;h=smoothStep(0,1,h);h*=h;h+=h;1<h&&(h=1);d+=.5*h;d=255*d|0;c[64*e+g]=255<=d?255:d}}a.texImage2D(a.TEXTURE_2D,0,a.ALPHA,64,64,0,a.ALPHA,a.UNSIGNED_BYTE,c)}analyze(a){let b=a-this.lastTime;33<b&&(b=33);this.lastTime=a;a=this.program.gl;var c=.00390625*b,d=1-c;const e=this.processedData,f=this.processedDataR,g=this.fft,h=this.BG_COLUMNS,k=this.BG_PARTICLES_BY_COLUMN,m=this.COLORS,l=this.program,p=this.bgPos,q=this.bgSpeedY,n=this.bgColor,
r=this.bgTheta,u=Math.max;let t,y=44,x=116;b*=.001;this.analyzerL.getByteFrequencyData(e);this.analyzerR.getByteFrequencyData(f);for(t=0;256>t;t++){let v=u(e[t],f[t]);8>v&&(v=0);const w=g[t];v<w&&(v=c*v+d*w);g[t]=v;e[t]=255<=v?255:v}a.clear(a.COLOR_BUFFER_BIT);t=2;for(let v=0,w=0;v<h;v++){if(6>t)c=.00390625*e[t],t++;else if(20>t)c=.005859375*u(e[t],e[t+1]),t+=2;else if(36>t)c=.005859375*u(e[t],e[t+1],e[t+2],e[t+3]),t+=4;else if(100>t){for(c=0;t<y;t++)c=u(c,e[t]);c*=.0078125;y+=8}else{for(c=0;t<x;t++)c=
u(c,e[t]);c*=.009765625;x+=16}l.amplitude(1<=c?1:c);l.baseX(-.9+.06206897*v);for(c=0;c<k;c++,w++)1.2<p[(w<<1)+1]?this.fillBgParticle(w,-1.2):p[(w<<1)+1]+=q[w]*b,d=3*n[w],l.color(m[d],m[d+1],m[d+2]),d=w<<1,l.pos(p[d],p[d+1]),l.theta(r[w]),a.drawArrays(a.TRIANGLE_STRIP,0,4)}}cleanUp(){this.ptr&&cLib._freeBuffer(this.ptr);this.program&&this.program.destroy()}}SoundParticlesAnalyzer.vertexShaderSource="precision mediump float;\nattribute vec4 inPosition;\nattribute vec2 inTexCoord;\nuniform float amplitude;\nuniform float baseX;\nuniform vec2 pos;\nuniform vec2 aspect;\nuniform vec3 color;\nuniform float theta;\nvarying vec2 vTexCoord;\nvarying vec3 vColor;\n\nvoid main() {\n\tfloat a = mix(0.0625, 0.34375, amplitude);\n\tfloat bottom = 1.0 - clamp(pos.y, -1.0, 1.0);\n\tbottom = bottom * bottom * bottom * 0.125;\n\ta = (0.75 * a) + (0.25 * bottom);\n\tgl_Position = vec4(baseX + pos.x + (5.0 * (pos.y + 1.0) * pos.x * sin((2.0 * pos.y) + theta)) + (inPosition.x * aspect.x * a), pos.y + (inPosition.y * aspect.y * a), 0.0, 1.0);\n\tvTexCoord = inTexCoord;\n\tvColor = color + bottom + (0.25 * amplitude);\n}";
...
l=Strings.translate(a.getAttribute("title")||a.value);let p=a.getAttribute("id");p||(p="checkBoxControl"+CheckboxControl.internalId++,a.setAttribute("id",p));g.setAttribute("aria-label",l);g.setAttribute("aria-pressed",a.checked?"true":"false");g.setAttribute("role","button");g.setAttribute("for",p);g.setAttribute("tabindex","0");h.setAttribute("tabindex","-1");h.setAttribute("aria-hidden","true");a.setAttribute("tabindex","-1");a.setAttribute("aria-hidden","true");g.className=a.className;a.className=
...
c;a=document.createElement("div");a.className="list-container";a.setAttribute("role","rowgroup");this.container=a;this.element.appendChild(a);this._adapter=null;this.boundZoomChanged=this.zoomChanged.bind(this);this.boundRefreshVisibleItemsInternal=this.refreshVisibleItemsInternal.bind(this);this.boundAdjustScrollbarPaddingFromResize=this.adjustScrollbarPaddingFromResize.bind(this);this.element.addEventListener("focus",this.elementFocus.bind(this));this.element.addEventListener("keydown",this.elementKeyDown.bind(this));
this.element.addEventListener("keyup",this.elementKeyUp.bind(this));this.element.addEventListener("blur",this.elementBlur.bind(this));c?this.element.addEventListener("scroll",this.elementScroll.bind(this),{passive:!0}):this.boundNotifyCurrentItemChangedInternal=this.notifyCurrentItemChangedInternal.bind(this);this.resizeObserver=new ResizeObserver(this.resize.bind(this));this.resizeObserver.observe(this.element,{box:"border-box"});this.itemMargin=this.itemHeight=1;this.itemHeightAndMargin=2;this.lastIndex=
this.firstIndex=0;this.keyboardItem=this.currentItem=this.currentListItem=null;this.clientHeight=1;this.containerHeight=0;this.scrollbarPaddingScheduled=this.scrollbarPadding=!1;this.visibleCount=1;this.items=[];this.focused=this.notifyCurrentItemChangedEnqueued=this.refreshVisibleItemsEnqueued=!1;this.lastKeyboardIndex=this.keyboardIndex=-1;this.deleteMode=!1;this.onitemcontextmenu=this.onitemcontrolclick=this.onitemclick=null;this.element.onclick=this.elementClick.bind(this);this.element.oncontextmenu=
this.elementContextMenu.bind(this);this.resize();AppUI.addZoomHandler(this.boundZoomChanged)}destroy(){this._adapter&&(this._adapter.control=null);this.resizeObserver&&this.resizeObserver.unobserve(this.element);this.items&&this.items.fill(null);this.boundZoomChanged&&AppUI.removeZoomHandler(this.boundZoomChanged);zeroObject(this)}get adapter(){return this._adapter}set adapter(a){this._adapter!==a&&(this._adapter&&(this._adapter.control=null),this._adapter=a,this.clear(),a&&(a.control=this,this.prepareAdapter(),
this.useVirtualItems?this.element.setAttribute("aria-rowcount",a.list.length.toString()):a.list.length&&this.notifyItemsAdded(0,a.list.length-1)))}prepareAdapter(){const a=this._adapter;a&&(this.itemHeight=a.itemHeight,this.itemMargin=AppUI.thickBorderPX,this.itemHeightAndMargin=this.itemHeight+this.itemMargin,this.currentListItem=a.list.currentItem,this.adjustContainerHeight(),this.resize())}zoomChanged(){if(this._adapter){this.prepareAdapter();var a=this.items;for(let b=a.length-1;0<=b;b--)a[b].index=
-1;this.useVirtualItems&&this.elementScroll()}}adjustScrollbarPadding(){const a=(this.containerHeight|0)>this.clientHeight;this.scrollbarPadding!==a&&(this.scrollbarPadding=a,this.element.style.padding=this.scrollbarPadding?"":"0")}adjustScrollbarPaddingFromResize(){this.scrollbarPaddingScheduled=!1;this.adjustScrollbarPadding()}adjustContainerHeight(){var a=this._adapter;const b=this.container;a&&b&&(a=(a=a.list.length)?a*this.itemHeightAndMargin-this.itemMargin:0,this.containerHeight!==a&&(this.containerHeight=
a,b.style.height=a+"px",this.adjustScrollbarPadding()))}clear(){var a=this.container;if(a){for(;a.firstChild;)a.removeChild(a.firstChild);a=this.items;if(this.useVirtualItems)for(var b=a.length-1;0<=b;b--)a[b].reset();else{for(b=a.length-1;0<=b;b--)a[b].zero();a.splice(0)}this.lastIndex=this.firstIndex=0;this.keyboardItem=this.currentItem=this.currentListItem=null;this.containerHeight=this.element.scrollTop=0;this.container.style.height="0";this.lastKeyboardIndex=0<this.keyboardIndex?this.keyboardIndex=
0:-1;this.element.setAttribute("aria-rowcount","0");this.element.removeAttribute("aria-activedescendant");this.adjustScrollbarPadding()}}elementScroll(){var a=this._adapter,b=this.element;if(a&&b){var c=this.items,d=this.itemHeightAndMargin,e=this.firstIndex-2;b=b.scrollTop/d|0;0>e&&(e=0);this.firstIndex=b;var f=this.visibleCount+(0===b?2:1===b?3:4);f>c.length&&(f=c.length);0>(b-=2)&&(b=0);if(b>e){if((e=b-e)&&e<f)for(let p=e,q=0;p<f;p++,q++)e=c[q],c[q]=c[p],c[p]=e}else if((e-=b)&&e<f)for(let p=f-
1,q=p-e;0<=q;q--,p--)e=c[p],c[p]=c[q],c[q]=e;var g=a.list,h=g.length,k=a.list.currentItem,m=this.keyboardIndex;e=this.container;var l=0;for(let p=b*d;l<f&&b<h;l++,b++,p+=d){const q=g.item(b),n=c[l];if(n.item!==q){let r=k===q;n.current!==r&&((n.current=r)?n.element.classList.add("current"):n.element.classList.remove("current"));r=m===b;n.keyboard!==r&&((n.keyboard=r)?(n.element.classList.add("keyboard"),n.element.setAttribute("aria-selected","true"),this.element.setAttribute("aria-activedescendant",
n.element.getAttribute("id"))):(this.element.getAttribute("aria-activedescendant")===n.element.getAttribute("id")&&this.element.removeAttribute("aria-activedescendant"),n.element.classList.remove("keyboard"),n.element.setAttribute("aria-selected","false")));a.prepareElement(q,b,h,n.element);n.element.setAttribute("aria-rowindex",b.toString());n.item||e.appendChild(n.element);n.item=q}n.index!==b&&(n.index=b,n.element.style.transform="translateY("+p+"px)")}for(a=c.length;l<a;l++)d=c[l],d.item&&(d.item=
null,e.removeChild(d.element));this.lastIndex=b-1;this.lastIndex<this.firstIndex&&(this.lastIndex=this.firstIndex)}}refreshVisibleItemsInternal(){this.refreshVisibleItemsEnqueued=!1;var a=this._adapter,b=this.element;if(a&&b){this.adjustContainerHeight();b=this.items;var c=this.itemHeightAndMargin,d=a.list,e=d.length,f=a.list.currentItem,g=this.keyboardIndex,h=this.container;if(this.useVirtualItems){this.currentListItem=f;var k=0,m=this.firstIndex,l=this.visibleCount+(0===m?2:1===m?3:4);l>b.length&&
(l=b.length);0>(m-=2)&&(m=0);for(let p=m*c;k<l&&m<e;k++,m++,p+=c){const q=d.item(m),n=b[k];let r=f===q;n.current!==r&&((n.current=r)?n.element.classList.add("current"):n.element.classList.remove("current"));r=g===m;n.keyboard!==r&&((n.keyboard=r)?(n.element.classList.add("keyboard"),n.element.setAttribute("aria-selected","true"),this.element.setAttribute("aria-activedescendant",n.element.getAttribute("id"))):(this.element.getAttribute("aria-activedescendant")===n.element.getAttribute("id")&&this.element.removeAttribute("aria-activedescendant"),
n.element.classList.remove("keyboard"),n.element.setAttribute("aria-selected","false")));a.prepareElement(q,m,e,n.element);n.element.setAttribute("aria-rowindex",m.toString());n.item||h.appendChild(n.element);n.item=q;n.index!==m&&(n.index=m,n.element.style.transform="translateY("+p+"px)")}for(a=b.length;k<a;k++)d=b[k],d.item&&(d.item=null,h.removeChild(d.element))}else{h=this.visibleCount;k=0<=g&&g<b.length?b[g]:null;this.keyboardItem!==k&&(this.keyboardItem&&(this.keyboardItem.element.classList.remove("keyboard"),
this.keyboardItem.element.setAttribute("aria-selected","false")),k?(k.element.classList.add("keyboard"),k.element.setAttribute("aria-selected","true"),this.element.setAttribute("aria-activedescendant",k.element.getAttribute("id"))):this.element.removeAttribute("aria-activedescendant"),this.keyboardItem=k);for(let p=0,q=this.indexFromY(0);p<=h&&q<e;p++,q++)k=b[q].element,a.prepareElement(d.item(q),q,e,k),k.setAttribute("aria-rowindex",q.toString())}}}resize(){const a=this._adapter;var b=this.element;
if(a&&b){var c=this.clientHeight;b=b.clientHeight;0>b&&(b=0);var d=Math.ceil(b/this.itemHeightAndMargin)+1;if(this.visibleCount!==d&&(this.visibleCount=d,this.useVirtualItems)){const e=this.items;for(;d+4>e.length;)e.push(new ListControlItem(a.createEmptyElement("list-item virtual")))}c!==b&&(this.clientHeight=b,this.useVirtualItems&&this.elementScroll(),this.scrollbarPaddingScheduled||(this.scrollbarPaddingScheduled=!0,requestAnimationFrame(this.boundAdjustScrollbarPaddingFromResize)))}}elementClick(a){if(this.element&&
this._adapter&&a.target){var b=this.element.getBoundingClientRect();b=this.indexFromY(a.clientY-b.top);0<=this.keyboardIndex&&(this.keyboardIndex=-1,this.refreshVisibleItems());if(0<=b){this.lastKeyboardIndex=b;const c=this._adapter.list.item(b);if(c)if(a.target.classList.contains("list-item"))if(this.deleteMode)this._adapter.list.removeItems(b,b);else{if(this.onitemclick)this.onitemclick(c,b,a.button)}else if(this.onitemcontrolclick)this.onitemcontrolclick(c,b,a.button,a.target)}}}elementContextMenu(a){if(!(this.element&&
this._adapter&&this.onitemcontextmenu&&a.target))return cancelEvent(a);var b=this.element.getBoundingClientRect();b=this.indexFromY(a.clientY-b.top);0<=this.keyboardIndex&&(this.keyboardIndex=-1,this.refreshVisibleItems());if(0<=b){this.lastKeyboardIndex=b;const c=this._adapter.list.item(b);if(c)this.onitemcontextmenu(c,b)}return cancelEvent(a)}elementFocus(){this.focused=!0}elementKeyDown(a){var b=this._adapter;if(!(!b||a.ctrlKey||a.metaKey||a.shiftKey||a.altKey)){var c=0,d=0;switch(a.key){case "ArrowDown":case "ArrowRight":c=
1;break;case "ArrowUp":case "ArrowLeft":c=-1;break;case "PageDown":c=this.clientHeight/this.itemHeightAndMargin|0;break;case "PageUp":c=-(this.clientHeight/this.itemHeightAndMargin|0);break;case "Home":d=-1;break;case "End":d=1;break;case "Enter":a.repeat||(d=2);break;case " ":a.repeat||(d=3);break;default:return}var e=b.list.length;if(0<e){let f=this.keyboardIndex;0>f&&(f=this.lastKeyboardIndex);this.isItemVisible(f)||(f=this.isItemVisible(b.list.currentIndex)?b.list.currentIndex:this.indexFromY(0));
f=Math.min(e-1,Math.max(0,f));if(-1===d)f=0;else if(1===d)f=e-1;else{const g=f;f+=c;0>f?f=g?0:e-1:f>=e&&(f=g===e-1?0:e-1)}this.keyboardIndex=f;this.bringItemIntoView(f);this.refreshVisibleItems();if(1<d&&(c=b.list.item(f)))switch(d){case 2:if(this.deleteMode)b.list.removeItems(f,f);else if(this.onitemclick)this.onitemclick(c,f,0);break;case 3:if(this.deleteMode)b.list.removeItems(f,f);else if(this.onitemcontrolclick&&(b=this.listControlItemFromIndex(f)))this.onitemcontrolclick(c,f,0,b.element)}}else this.keyboardIndex=
-1;return cancelEvent(a)}}elementKeyUp(a){const b=this._adapter;b&&!a.ctrlKey&&!a.metaKey&&!a.altKey&&"Tab"===a.key&&this.focused&&(a=b.list.length)&&(a=Math.min(a-1,Math.max(0,this.lastKeyboardIndex)),this.isItemVisible(a)||(a=this.isItemVisible(b.list.currentIndex)?b.list.currentIndex:this.indexFromY(0)),this.keyboardIndex=a,this.bringItemIntoView(a),this.refreshVisibleItems())}elementBlur(){this.focused=!1;this.lastKeyboardIndex=this.keyboardIndex;0<=this.keyboardIndex&&(this.keyboardIndex=-1,
this.refreshVisibleItems())}listControlItemFromIndex(a){if(!this.items)return null;const b=this.items;for(let c=b.length-1;0<=c;c--)if(b[c].index===a&&b[c].item&&b[c].element)return b[c];return null}yFromIndex(a){return this.element?a*this.itemHeightAndMargin-this.element.scrollTop:0}indexFromY(a){if(!this.element||!this._adapter)return-1;a=(a+this.element.scrollTop+.9)/this.itemHeightAndMargin|0;return 0>a||a>=this._adapter.list.length?-1:a}isItemVisible(a){a=this.yFromIndex(a);return a>-this.itemHeight&&
a<this.clientHeight}bringItemIntoView(a,b){const c=this.yFromIndex(a);0>c?b?this.centerItemIntoView(a):this.element.scrollTop+=c:c>this.clientHeight-this.itemHeight&&(b?this.centerItemIntoView(a):this.element.scrollTop+=c-(this.clientHeight-this.itemHeight))}centerItemIntoView(a){this.element.scrollTop=a*this.itemHeightAndMargin-(this.clientHeight-this.itemHeight>>1)}refreshVisibleItems(){this.refreshVisibleItemsEnqueued||(this.refreshVisibleItemsEnqueued=!0,queueMicrotask(this.boundRefreshVisibleItemsInternal))}notifyCleared(){this.clear()}notifyItemsAdded(a,
b){if(this.useVirtualItems)this.refreshVisibleItems();else{const g=this._adapter;var c=b-a+1;if(!g||0>=c)return;var d=this.container;const h=this.items,k=g.list,m=k.length;var e=k.currentItem;const l=Array(c);for(var f=b;f>=a;f--){const p=k.item(f),q=new ListControlItem(g.createEmptyElement("list-item real"));g.prepareElement(p,f,m,q.element);q.element.setAttribute("aria-rowindex",f.toString());l[f-a]=q;e===p&&(this.currentItem&&(this.currentItem.current=!1,this.currentItem.element.classList.remove("current")),
this.currentItem=q,q.current=!0,q.element.classList.add("current"))}e=a>=h.length?null:h[a].element;a>=h.length?h.push(...l):h.splice(a,0,...l);if(this.items.length!==k.length)throw Error("Assertion error: this.items.length !== list.length");this.adjustContainerHeight();for(f=0;f<c;f++)d.insertBefore(l[f].element,e);for(c=h.length-1;c>b;c--)d=h[c].element,g.prepareElementIndexOrLengthChanged(k.item(c),c,m,d),d.setAttribute("aria-rowindex",c.toString());for(--a;0<=a;a--)b=h[a].element,g.prepareElementIndexOrLengthChanged(k.item(a),
a,m,b),b.setAttribute("aria-rowindex",a.toString())}this.element&&this._adapter&&this.element.setAttribute("aria-rowcount",this._adapter.list.length.toString())}notifyItemsRemoved(a,b){if(this.useVirtualItems)this.refreshVisibleItems();else{const e=this._adapter;var c=b-a+1;if(!e||0>=c)return;var d=this.container;b=this.items;const f=e.list,g=f.length;a=b.splice(a,c);for(c=a.length-1;0<=c;c--){const h=a[c];h.current&&(this.currentItem=null);d.removeChild(h.element);h.zero()}if(this.items.length!==
f.length)throw Error("Assertion error: this.items.length !== list.length");for(d=b.length-1;0<=d;d--)a=b[d].element,e.prepareElementIndexOrLengthChanged(f.item(d),d,g,a),a.setAttribute("aria-rowindex",d.toString());this.adjustContainerHeight()}this.element&&this._adapter&&this.element.setAttribute("aria-rowcount",this._adapter.list.length.toString())}notifyCurrentItemChanged(a,b){this.useVirtualItems?this.refreshVisibleItems():this.notifyCurrentItemChangedEnqueued||(this.notifyCurrentItemChangedEnqueued=
!0,queueMicrotask(this.boundNotifyCurrentItemChangedInternal))}notifyCurrentItemChangedInternal(){this.notifyCurrentItemChangedEnqueued=!1;var a=this._adapter;a&&(this.currentItem&&(this.currentItem.current=!1,this.currentItem.element.classList.remove("current")),a=a.list.currentIndex,0<=a&&a<this.items.length?(this.currentItem=this.items[a],this.currentItem.current=!0,this.currentItem.element.classList.add("current")):this.currentItem=null)}}var SliderControlValueChild;
(function(a){a[a.None=0]="None";a[a.LeftChild=1]="LeftChild";a[a.RightChild=2]="RightChild"})(SliderControlValueChild||(SliderControlValueChild={}));
class SliderControl{constructor(a,b,c,d,e,f,g,h,k,m,l,p){this.element="string"===typeof a?document.getElementById(a):a;this.element.classList.add("slider-control");f&&this.element.classList.add("vertical");this.element.setAttribute("role","slider");this.element.setAttribute("aria-label",b);this.element.setAttribute("aria-orientation",f?"vertical":"horizontal");e&&this.element.setAttribute("tabindex","0");this.mapper=c;this.valueChild=d;this.keyboardFocusable=e;this.vertical=f;this.manualAria=!!p;
...
g-1;this.percent=0;this.value=void 0===k?g:k;this.valueOnMouseDown=this._value;this.pointerHandler=new PointerHandler(c,this.mouseDown.bind(this),this.mouseMove.bind(this),this.mouseUp.bind(this));this.element.setAttribute("aria-valuemin",g.toString());this.element.setAttribute("aria-valuemax",h.toString());e&&(this.element.addEventListener("keydown",this.keyDown.bind(this)),this.element.addEventListener("focus",this.focus.bind(this)),this.element.addEventListener("blur",this.blur.bind(this)));this._rightChild=
...
a)}}}}
class Player{constructor(a,...b){this.audioContextTimeout=0;this.audioContextSuspended=!0;var c=navigator.userAgent&&0<=navigator.userAgent.indexOf("Firefox")?1:"playback";this.audioContext=window.AudioContext?new window.AudioContext({latencyHint:c}):new window.webkitAudioContext({latencyHint:c});this.audioContext.suspend();this.audioContext.onstatechange=this.audioContextStateChange.bind(this);if(b&&b.length){c=Array(b.length);for(let d=0;d<b.length;d++)c[d]=b[d](this.audioContext)}else c=[];this.intermediateNodes=
c;this.destinationNode=new DestinationNode(this.audioContext.destination);this.destinationNode.enabled=!0;this.boundPlaybackError=this.onerror=this.oncurrenttimeschange=this.onpausedchange=this.onloadingchange=this.onsongchange=null;this.boundNotifySongChange=this.notifySongChange.bind(this);this.boundCheckAudioContext=this.checkAudioContext.bind(this);this.boundAutoNext=this.next.bind(this,!0);this._alive=!0;this._loading=!1;this._paused=!0;this._currentSong=this._playlist=null;this._volume=0;this.lastObjectURL=
null;this.lastTimeS=-1;this.songStartedAutomatically=!0;this.haltOnAllErrors=!1;this.volume=void 0===a?0:a;this.sourceNode=this.audio=null;this.recreateAudioPath();(this.mediaSession=a="mediaSession"in navigator&&"MediaMetadata"in window?navigator.mediaSession:null)&&"setActionHandler"in a&&(b=this.playPause.bind(this),a.setActionHandler("previoustrack",()=>{this.previous()}),a.setActionHandler("seekbackward",this.seekBackward.bind(this)),a.setActionHandler("pause",b),a.setActionHandler("play",b),
a.setActionHandler("seekforward",this.seekForward.bind(this)),a.setActionHandler("nexttrack",()=>{this.next()}))}recreateAudioPath(){const a=this.intermediateNodes;this.sourceNode&&this.sourceNode.disconnectFromDestination();for(var b=a.length-1;0<=b;b--)a[b].disconnectFromDestination();const c=new Audio;b=this.audioContext.createMediaElementSource(c);b=new SourceNode(b);this.audio=c;this.sourceNode=b;c.loop=!1;c.controls=!1;var d=()=>{this.audio===c&&this.playbackLoadStart()};c.onwaiting=d;c.onloadstart=
d;c.oncanplay=()=>{this.audio===c&&this.playbackLoadEnd()};c.onended=()=>{this.audio===c&&this.playbackEnd()};this.boundPlaybackError=d=(e,f,g,h,k)=>{this.audio===c&&this.playbackError(e,f,g,h,k)};c.onerror=d;c.onpause=()=>{this.audio===c&&this.playbackPaused()};d=()=>{this.audio===c&&this.playbackStarted()};c.onplay=d;c.onplaying=d;d=()=>{this.audio===c&&this.playbackAborted()};c.onabort=d;c.onemptied=d;c.ondurationchange=()=>{this.audio===c&&this.playbackLengthChange()};c.ontimeupdate=()=>{this.audio===
c&&this.currentTimeChange()};b.enabled=!0;if(a.length){b.connectToDestination(a[0]);for(b=0;b<a.length-1;b++)a[b].connectToDestination(a[b+1]);a[a.length-1].connectToDestination(this.destinationNode)}else b.connectToDestination(this.destinationNode);this.volume=this._volume}destroy(a){this.stop();if(a){if(this._alive=!1,this.sourceNode&&this.sourceNode.disconnectFromDestination(),(a=this.intermediateNodes)&&a.length)for(let b=a.length-1;0<=b;b--)a[b].disconnectFromDestination()}else this._playlist&&
this._playlist.destroy(),(a=this.mediaSession)&&"setActionHandler"in a&&(a.setActionHandler("previoustrack",null),a.setActionHandler("seekbackward",null),a.setActionHandler("pause",null),a.setActionHandler("play",null),a.setActionHandler("seekforward",null),a.setActionHandler("nexttrack",null)),zeroObject(this)}get alive(){return this._alive}get loading(){return this._loading}get paused(){return this._paused}get volume(){return this._volume}set volume(a){this._volume=Math.max(Player.minVolume,Math.min(0,
a|0));this.audio&&(this.audio.volume=a<=Player.minVolume?0:Math.pow(10,this._volume/20))}get playlist(){return this._playlist}set playlist(a){this._alive&&(this.stop(),this._playlist=a)}get currentSong(){return this._currentSong}get currentTimeMS(){if(this._currentSong&&this.audio){const a=this.audio.currentTime;this.lastTimeS=a;return 1E3*a|0}return-1}get possibleResumeTimeS(){let a=0;if(this._currentSong&&this._playlist&&this._playlist.currentItem===this._currentSong){try{this.audio&&(a=this.audio.currentTime)}catch(b){}0>=
a&&(a=this.lastTimeS)}return a}handleError(a){const b=this.lastTimeS;this.stop();this.recreateAudioPath();if(this.haltOnAllErrors){if(this.onerror)this.onerror(a)}else{var c=!1;this._playlist&&this._playlist.length?0>=b&&(c=!this.songStartedAutomatically):c=!0;if(c&&this.onerror)this.onerror(a);else queueMicrotask(this.boundAutoNext)}}audioContextStateChange(){this._alive&&"running"!==this.audioContext.state&&!this.audioContextSuspended&&(this.audioContextSuspended=!0,this.playbackPaused())}playbackLoadStart(){if(this._alive&&
!this._loading&&(this._loading=!0,this.onloadingchange))this.onloadingchange(!0)}playbackLoadEnd(){if(this._alive&&this._loading&&(this._loading=!1,this.onloadingchange))this.onloadingchange(!1)}playbackEnd(){this._alive&&this.next(!0)}playbackError(a,b,c,d,e){this._alive&&this.handleError(e?e.message?e.message:"string"===typeof e?e:e.toString():"string"===typeof a?a:Strings.UnknownError)}suspendAudioContext(a){this.audioContextTimeout&&(clearTimeout(this.audioContextTimeout),this.audioContextTimeout=
0);this.audioContextSuspended||(a?this.audioContextTimeout=window.setTimeout(this.boundCheckAudioContext,5E3):(this.audioContextSuspended=!0,this.audioContext.suspend()))}resumeAudioContext(){this.audioContextTimeout&&(clearTimeout(this.audioContextTimeout),this.audioContextTimeout=0);if(this.audioContextSuspended||"running"!==this.audioContext.state)this.audioContextSuspended=!1,this.audioContext.resume()}checkAudioContext(){this.audioContextTimeout=0;this._paused?this.audioContextSuspended||(this.audioContextSuspended=
!0,this.audioContext.suspend()):this.audioContextSuspended&&(this.audioContextSuspended=!1,this.audioContext.resume())}playbackPaused(){if(this._alive&&!this._paused){this._paused=!0;this.suspendAudioContext(!0);if(this.onpausedchange)this.onpausedchange(!0);App.hostInterface&&App.hostInterface.setPaused(!0)}}playbackStarted(){if(this._alive&&this._paused){this._paused=!1;this.resumeAudioContext();if(this.onpausedchange)this.onpausedchange(!1);App.hostInterface&&App.hostInterface.setPaused(!1)}}playbackAborted(){if(this._alive){if(this._loading&&
(this._loading=!1,this.onloadingchange))this.onloadingchange(!1);if(!this._paused){this._paused=!0;this.suspendAudioContext(!0);if(this.onpausedchange)this.onpausedchange(!0);App.hostInterface&&App.hostInterface.setPaused(!0)}}}playbackLengthChange(){this._alive&&this.audio&&this._playlist&&this._currentSong&&(this._playlist.updateSongLength(this._currentSong,this.audio.duration),this.mediaSession&&0<this.audio.duration&&"setPositionState"in this.mediaSession&&this.mediaSession.setPositionState({duration:this.audio.duration}))}currentTimeChange(){if(this._alive&&
this.audio&&this._currentSong){var a=this.audio.currentTime;this.lastTimeS=a;if(this.oncurrenttimeschange)this.oncurrenttimeschange(a)}}notifySongChange(){if(this._alive){const a=this._currentSong,b=this.mediaSession;b&&(a?(b.metadata=new window.MediaMetadata({title:a.title,artist:a.artist,album:a.album,artwork:[{src:"assets/images/albumArts/64x64.png",sizes:"64x64",type:"image/png"},{src:"assets/images/albumArts/96x96.png",sizes:"96x96",type:"image/png"},{src:"assets/images/albumArts/192x192.png",
sizes:"192x192",type:"image/png"},{src:"assets/images/albumArts/256x256.png",sizes:"256x256",type:"image/png"},{src:"assets/images/albumArts/512x512.png",sizes:"512x512",type:"image/png"}]}),0<a.lengthMS&&"setPositionState"in b&&b.setPositionState({duration:a.lengthMS/1E3})):b.playbackState="none");if(this.onsongchange)this.onsongchange(a)}}previous(a){this._alive&&this._playlist&&(this._playlist.moveCurrentToPrevious(),this.play(-1,a))}seekBackward(){this._alive&&this.seekTo(-1E4,!0)}pause(){this._alive&&
(this.suspendAudioContext(!1),this._currentSong&&this.audio&&this.audio.pause())}play(a,b){if(this._alive&&this.audio){if(this._currentSong&&void 0===a){this.resumeAudioContext();var c=this.audio.play()}else if(this._playlist){void 0!==a&&0<=a&&(this._playlist.currentIndex=a);a=this._playlist.currentItem;!a&&this._playlist.length&&(this._playlist.moveCurrentToNext(),a=this._playlist.currentItem);if(!a){this.stop();return}this._currentSong=a;this.lastTimeS=-1;this.songStartedAutomatically=!!b;queueMicrotask(this.boundNotifySongChange);
for(this.resumeAudioContext();this.audio.firstChild;)this.audio.removeChild(this.audio.firstChild);c=document.createElement("source");if(a.url&&!a.url.startsWith(FileUtils.localURLPrefix))c.src=a.url;else if(a.file)this.lastObjectURL&&URL.revokeObjectURL(this.lastObjectURL),this.lastObjectURL=URL.createObjectURL(a.file),c.src=this.lastObjectURL;else{if(a.url){this.pause();const d=this._playlist.currentIndex,e=this._playlist.currentItem;FileSystemAPI.getFile(a.url.substring(FileUtils.localURLPrefix.length)).then(f=>
{e&&!e.file&&f&&(e.file=f);this._playlist&&d===this._playlist.currentIndex&&e===this._playlist.currentItem&&(f?this.play(d,b):this.handleError(Strings.FileNotFoundOrNoPermissionError))},()=>{this._playlist&&d===this._playlist.currentIndex&&e===this._playlist.currentItem&&this.handleError(Strings.FileNotFoundOrNoPermissionError)})}else this.handleError(Strings.MissingSongError);return}c.onerror=this.boundPlaybackError;this.audio.appendChild(c);this.audio.load();c=this.audio.play()}c&&c.catch(Player.nop)}}playPause(){this._alive&&
this.audio&&(!this._currentSong||this.audio.paused?this.play():this.pause())}stop(){if(this._alive&&this.audio){if(this._currentSong){for(;this.audio.firstChild;)this.audio.removeChild(this.audio.firstChild);this.audio.load();this.lastObjectURL&&(URL.revokeObjectURL(this.lastObjectURL),this.lastObjectURL=null);if(this._loading&&(this._loading=!1,this.onloadingchange))this.onloadingchange(!1);if(!this._paused){this._paused=!0;if(this.onpausedchange)this.onpausedchange(!0);App.hostInterface&&App.hostInterface.setPaused(!0)}this._currentSong=
null;this.lastTimeS=-1;this.notifySongChange()}this.suspendAudioContext(!1)}}seekForward(){this._alive&&this.seekTo(1E4,!0)}next(a){this._alive&&this._playlist&&(this._playlist.moveCurrentToNext(),this.play(-1,a))}seekTo(a,b){this._alive&&this.audio&&this._currentSong&&!(0>=this._currentSong.lengthMS)&&this.audio.seekable&&this.audio.seekable.length&&(this.lastTimeS=(a=Math.min(this.audio.duration,Math.max(0,a/1E3+(b?this.audio.currentTime:0))))||.01,this.audio.currentTime=a)}}Player.minVolume=-40;
Player.nop=function(){};
...
c);d.className="modal"+(a.fullHeight?" full-height":"");d.onsubmit=this.submit.bind(this);var e=document.createElement("div");this.modalHeaderElement=e;(a.titleHeader||e).setAttribute("id",c);e.className="modal-header padding"+(a.rightHeader?" right":"");a.title?"string"===typeof a.title?e.innerHTML=a.title:e.appendChild(a.title):e.innerHTML=a.titleStringKey?Strings.translate(a.titleStringKey):Strings.Oops;this.modalBodyElement=c=document.createElement("div");c.className="modal-body"+(a.leftBody?
" left":"");a.html||(a.html=document.createElement("div"),a.text&&Strings.changeText(a.html,a.text));if("string"===typeof a.html)c.innerHTML=a.html;else if(Array.isArray(a.html)){var f=a.html;for(var g=0;g<f.length;g++)c.appendChild(f[g])}else c.appendChild(a.html);if((f=c.getElementsByTagName("button"))&&f.length)for(g=f.length-1;0<=g;g--){const h=f[g];ButtonControl.prepare(h);h.onclick=()=>{if(!this.fading&&this.options.onbuttonclick)this.options.onbuttonclick(h.id,h)}}this.modalFooterElement=f=
document.createElement("div");f.className="modal-footer padding left-margin right-margin"+(a.buttons&&1===a.buttons.length?" right":"");this.defaultSubmitButton=this.defaultCancelButton=null;if(a.buttons)for(g=0;g<a.buttons.length;g++){const h=a.buttons[g],k=ButtonControl.create(h,!0);h.defaultCancel&&(this.defaultCancelButton=k);h.defaultSubmit&&(this.defaultSubmitButton=k);g&&(k.style.float="right");k.onclick=()=>{if(!this.fading){if(h.onclick)h.onclick(h.id,k);if(this.options.onbuttonclick)this.options.onbuttonclick(h.id,
k)}};f.appendChild(k)}d.appendChild(e);if(a.skipBody)for(;c.firstChild;)e=c.firstChild,c.removeChild(e),d.appendChild(e);else d.appendChild(c);d.appendChild(f);b.appendChild(d);document.body.appendChild(b);this.boundDocumentKeyDown=this.documentKeyDown.bind(this);document.addEventListener("keydown",this.boundDocumentKeyDown,!0);this.fading=!0;DelayControl.delayShortCB(()=>{if(a.onshowing)a.onshowing();this.containerElement.classList.add("in");DelayControl.delayFadeCB(()=>{this.fading=!1;const h=this.options.onshown&&
this.options.onshown()||this.modalElement;try{h.focus()}catch(k){}})})}static get visible(){return!!Modal.modal}static get currentModalElement(){return Modal.modal?Modal.modal.modalElement:null}static get currentModalHeaderElement(){return Modal.modal?Modal.modal.modalHeaderElement:null}static get currentModalBodyElement(){return Modal.modal?Modal.modal.modalBodyElement:null}static get currentModalFooterElement(){return Modal.modal?Modal.modal.modalFooterElement:null}static show(a){if(Modal.modal)return!1;
a.okCancel?a.buttons=[{id:"cancel",defaultCancel:!0,icon:"icon-clear",text:a.cancelText||Strings.Cancel,color:"red",onclick:a.oncancel||Modal.hide},{id:"ok",defaultSubmit:a.okCancelSubmit,icon:"icon-check",text:a.okText||Strings.OK,color:"green",onclick:a.onok||Modal.hide}]:a.buttons&&a.buttons.length||(a.buttons=[{id:"cancel",defaultCancel:!0,icon:"icon-clear",text:Strings.Close,onclick:Modal.hide}]);Modal.modal=new Modal(a);return!0}static hide(){Modal.modal&&Modal.modal.hideInternal()}static defaultCancelAction(){return Modal.modal?
Modal.modal.defaultCancelActionInternal():!1}static historyStatePopped(){if(!Modal.modal)return null;Modal.modal.fading||Modal.defaultCancelAction();return!1}hideInternal(){Modal.modal!==this||this.fading||this.options.onhiding&&!1===this.options.onhiding()||(document.removeEventListener("keydown",this.boundDocumentKeyDown,!0),this.fading=!0,this.containerElement.classList.remove("in"),DelayControl.delayFadeCB(()=>{Modal.modal=null;if(this.options.returnFocusElement)try{this.options.returnFocusElement.focus()}catch(a){}if(this.options.onhidden)this.options.onhidden();
...
class FilePicker{constructor(a,b){const c=document.createElement("div"),d=Strings.createSrOnlyText(Strings.AddSongs);c.appendChild(d);ButtonControl.create({color:"orange",icon:"icon-up",text:Strings.Up,parent:c,onclick:this.navigateUp.bind(this)});ButtonControl.create({icon:"icon-checkbox-1",text:Strings.All,parent:c,onclick:this.toggleAll.bind(this)});const e=document.createElement("div");e.className="file-picker-path padding border-bottom left";e.setAttribute("aria-atomic","true");e.setAttribute("aria-live",
"assertive");e.setAttribute("aria-relevant","all");const f=Icon.createLarge("icon-folder-open","orange hidden",null,Strings.CurrentPathLabel);e.appendChild(f);const g=document.createElement("i");g.className="icon loading large";g.appendChild(Strings.createSrOnlyText(Strings.LoadingCurrentPathLabel));e.appendChild(g);const h=document.createElement("div");h.className="file-picker-path-element small-left-padding";e.appendChild(h);const k=document.createElement("div");k.className="file-picker-list fade bottom-margin";
this.resolve=a;this.provider=App.hostType===App.hostTypeAndroid?new FilePickerAndroidProvider:new FilePickerFileSystemAPIProvider;this.list=new List;this.listAdapter=new FilePickerListAdapter(this.list);this.listControl=new ListControl(k,Strings.FileList,!0);this.listControl.element.addEventListener("keydown",this.listKeyDown.bind(this));this.listControl.onitemclick=this.itemClick.bind(this);this.listControl.onitemcontrolclick=this.itemControlClick.bind(this);this.listControl.adapter=this.listAdapter;
this.selectedFiles=null;this.fading=this.gettingFiles=!1;this.providerVersion=0;this.path=FilePicker.lastPath;this.rootLength=FilePicker.lastRootLength;this.iconFolder=f;this.iconLoading=g;this.pathElement=h;this.boundRefreshRoot=this.refreshRoot.bind(this);this.updatePathElement(this.path);if(!Modal.show({html:[e,k],title:c,titleHeader:d,returnFocusElement:b,rightHeader:!0,leftBody:!0,skipBody:!0,fullHeight:!0,okCancel:!0,onshown:this.modalShown.bind(this),onhiding:this.modalHiding.bind(this),onhidden:this.modalHidden.bind(this),
onok:this.modalOk.bind(this)}))throw Error("Assertion error: Modal.show() === false");}static isSupported(){return!!App.hostInterface||FileSystemAPI.isSupported()}static get visible(){return!!FilePicker.filePicker}static show(a){return FilePicker.filePicker||Modal.visible?Promise.resolve(null):new Promise(function(b){FilePicker.filePicker=new FilePicker(b,a)})}updatePathElement(a){a&&a.endsWith("/")&&(a=a.substring(0,a.length-1));Strings.changeText(this.pathElement,a||Strings.Storage);return a}updateIconLoading(a){this.iconFolder&&
this.iconLoading&&(a?(this.iconFolder.classList.add("hidden"),this.iconLoading.classList.remove("hidden")):(this.iconLoading.classList.add("hidden"),this.iconFolder.classList.remove("hidden")))}listKeyDown(a){a.ctrlKey||a.metaKey||a.shiftKey||a.altKey||a.repeat||"Backspace"!==a.key||this.navigateUp()}itemClick(a,b,c){this.gettingFiles||this.fading||(a.root&&!a.path&&this.provider.editableRoots()?(this.updateIconLoading(!0),this.provider.addNewRoot().then(this.boundRefreshRoot,this.boundRefreshRoot)):
a.dir?this.navigate(a.path):this.listControl&&(a.selected=!a.selected,this.listControl.refreshVisibleItems()))}itemControlClick(a,b,c,d){if(!this.gettingFiles&&!this.fading){if("INPUT"===d.tagName&&(d=d.parentNode,!d)||"SPAN"===d.tagName&&(d=d.parentNode,!d))return;if(d.classList.contains("list-item"))for(b=d.childNodes,c=0;c<b.length;c++)if(b[c]&&b[c].tagName&&!b[c].classList.contains("hidden")){d=b[c];d.getAttribute("data-check")&&CheckboxControl.setChecked(d,!CheckboxControl.isChecked(d));break}d.getAttribute("data-check")?
a.selected=CheckboxControl.isChecked(d):d.getAttribute("data-delete")&&(this.updateIconLoading(!0),this.provider.removeRoot(a).then(this.boundRefreshRoot,this.boundRefreshRoot))}}refreshRoot(a){this.path||(!0===a?this.navigate(null):this.updateIconLoading(!1))}finishNavigation(a){!this.path&&this.provider.editableRoots()&&a.push({name:Strings.AddMoreFolders,dir:0,path:"",root:!0,deletable:!1});this.updateIconLoading(!1);a.length&&(this.list.addItems(a),this.listControl.element.classList.add("in"))}navigate(a){if(FilePicker.filePicker===
this&&!this.gettingFiles&&!this.fading){var b=!this.path;this.path=a=this.updatePathElement(a);b&&(this.rootLength=a?a.length:0);this.providerVersion++;var c=this.providerVersion;this.updateIconLoading(!0);var d=null;this.listControl.element.classList.contains("in")&&(this.fading=!0,this.listControl.element.classList.remove("in"),DelayControl.delayFadeCB(()=>{FilePicker.filePicker===this&&this.provider&&c===this.providerVersion&&(this.list.clear(),this.fading=!1,d&&this.finishNavigation(d))}));this.provider.navigate(a).then(e=>
{FilePicker.filePicker===this&&this.provider&&c===this.providerVersion&&(d=e||[],this.fading||this.finishNavigation(d))},e=>{FilePicker.filePicker===this&&this.provider&&c===this.providerVersion&&(this.updateIconLoading(!1),Alert.show(e.message||("string"===typeof e.error?e.error:e.error&&e.error.message||e.toString()),!0))})}}navigateUp(){let a=this.path,b;!a||0>=(b=a.lastIndexOf("/"))?this.navigate(null):(a=a.substring(0,b),this.navigate(a.length<this.rootLength?null:a))}toggleAll(){if(FilePicker.filePicker===
this&&!this.gettingFiles&&!this.fading){var a=this.list,b=!1;for(var c=a.length-1;0<=c;c--)if(!a.item(c).selected){b=!0;break}for(c=a.length-1;0<=c;c--)a.item(c).selected=b;this.listControl.refreshVisibleItems()}}modalShown(){this.navigate(this.path);return this.listControl.element}modalHiding(){if(FilePicker.filePicker!==this)return!0;FilePicker.filePicker=null;this.provider&&this.provider.destroy();return!0}modalHidden(){const a=this.resolve,b=this.selectedFiles;this.selectedFiles=null;zeroObject(this);
a&&a(b)}modalOk(){if(FilePicker.filePicker===this&&!this.gettingFiles&&!this.fading){var a=[],b=[],c=this.list,d=c.length;if(this.path)for(let f=0;f<d;f++){const g=c.item(f);g.selected&&(g.dir?a:b).push(g)}if(this.path&&(a.length||b.length)){FilePicker.lastPath=this.path;FilePicker.lastRootLength=this.rootLength;this.gettingFiles=!0;this.providerVersion++;var e=this.providerVersion;this.updateIconLoading(!0);this.provider.getFiles(a,b).then(f=>{FilePicker.filePicker===this&&this.provider&&e===this.providerVersion&&
(this.selectedFiles=f,Modal.hide())},f=>{FilePicker.filePicker===this&&this.provider&&e===this.providerVersion&&(this.updateIconLoading(!1),this.gettingFiles=!1,Alert.show(f.message||("string"===typeof f.error?f.error:f.error&&f.error.message||f.toString()),!0))})}else Alert.show(Strings.NothingSelected)}}}FilePicker.filePicker=null;FilePicker.lastPath=null;FilePicker.lastRootLength=0;
...
AppUI.topMessageTimeout=DelayControl.delayFadeCB(function(){2===AppUI.topMessageFading&&(AppUI.topMessageFading=0,AppUI.topMessageTimeout=0)}))}))}static addFiles(a){return __awaiter(this,void 0,void 0,function*(){if(App.player&&!AppUI._loading&&!Modal.visible&&!FilePicker.visible){var b=App.hostType===App.hostTypeElectron,c=FilePicker.isSupported()?yield FilePicker.show(AppUI.playlistControl.element):yield App.showOpenDialogWeb(a);if(c&&App.player)try{AppUI._loading=!0;App.updateLoadingIcon();App.player.playlist||
(App.player.playlist=new Playlist,AppUI.preparePlaylist());const d=App.player.playlist,e=b?null:new Uint8Array(BufferedFileHandle.minBufferLength<<1),f=b?null:[new Uint8Array(256)];let g=!1;for(let h=0;h<c.length&&App.player;h++)if(b)yield d.addSong(c[h]);else{const k=d.length;(yield d.addSongWeb(c[h],e,f))&&k===d.length&&(g=!0)}g&&AppUI.playlistControl&&AppUI.playlistControl.refreshVisibleItems()}catch(d){Modal.show({text:"addFiles error: "+(d.message||d.toString()),returnFocusElement:AppUI.playlistControl.element})}finally{AppUI._loading=
!1,App.updateLoadingIcon()}}})}static toggleDeleteMode(a){if(AppUI.playlistControl){AppUI.focusBlocker&&(AppUI.focusBlocker.unblock(),AppUI.focusBlocker=null);AppUI.playlistControl.deleteMode?(AppUI.playlistControl.deleteMode=!1,AppUI.hideTopMessage(),a&&HistoryHandler.popState()):(AppUI.playlistControl.deleteMode=!0,AppUI.focusBlocker=new FocusBlocker,AppUI.focusBlocker.block(AppUI.middlePanel),AppUI.showTopMessage(Strings.DeleteModeHTML,function(b){const c=document.createElement("div");ButtonControl.create({color:"red",
icon:"icon-delete-all",text:Strings.DeleteAllSongs,parent:c,onclick:function(){App.player&&App.player.playlist&&App.player.playlist.clear();AppUI.playlistControl&&AppUI.playlistControl.deleteMode&&AppUI.toggleDeleteMode(!0)}});ButtonControl.create({color:"green",icon:"icon-check",text:Strings.Done,parent:c,onclick:function(){AppUI.playlistControl&&AppUI.playlistControl.deleteMode&&AppUI.toggleDeleteMode(!0)}});b.appendChild(c)}),HistoryHandler.pushState());try{AppUI.playlistControl.element.focus()}catch(b){}}}static checkPanelContainerToggleState(){if(!(875>=
window.innerWidth)&&AppUI.fixedPanel&&AppUI.optionalPanel){if(AppUI.panelContainerToggling){AppUI.panelContainerToggleVersion++;AppUI.panelContainerToggling=!1;const a=AppUI.cover.parentNode;a&&a.removeChild(AppUI.cover);AppUI.cover.classList.remove("in")}AppUI.panelContainerToggled&&(AppUI.panelContainerToggled=!1,AppUI.panelContainer.classList.remove("toggled"),HistoryHandler.popState())}}static toggleView(a){if(AppUI.panelContainer){AppUI.panelContainerToggleVersion++;const b=AppUI.panelContainerToggleVersion,
c=function(d,e){AppUI.panelContainerToggling=!0;AppUI.cover.classList.remove("in");AppUI.cover.parentNode||document.body.appendChild(AppUI.cover);DelayControl.delayShortCB(function(){return __awaiter(this,void 0,void 0,function*(){if(AppUI.panelContainerToggleVersion===b&&(AppUI.cover.classList.add("in"),yield DelayControl.delayFade(),AppUI.panelContainerToggleVersion===b&&(e?AppUI.panelContainer.classList.add("toggled"):AppUI.panelContainer.classList.remove("toggled"),AppUI.cover.classList.remove("in"),
yield DelayControl.delayFade(),AppUI.panelContainerToggleVersion===b))){var f=AppUI.cover.parentNode;f&&f.removeChild(AppUI.cover);AppUI.panelContainerToggling=!1;try{d.focus()}catch(g){}}})})};AppUI.panelContainerToggled?(AppUI.panelContainerToggled=!1,c(AppUI.playlistControl.element,!1),a&&HistoryHandler.popState()):(AppUI.panelContainerToggled=!0,c(ButtonControl.getDefaultFocusElement(AppUI.toggleViewButton),!0),HistoryHandler.pushState())}}static showAbout(){Modal.show({html:Strings.AboutHTML+
(App.player&&App.player.audioContext?"<br/><br/><small>Base latency: "+(App.player.audioContext.baseLatency||0).toFixed(4)+" s<br/>Output latency: "+(isNaN(App.player.audioContext.outputLatency)?"-":App.player.audioContext.outputLatency.toFixed(4)+" s")+"</small>":""),title:Strings.About+" (v"+window.CACHE_VERSION+")",returnFocusElement:AppUI.playlistControl.element})}}AppUI.primaryInputIsTouch="matchMedia"in window?window.matchMedia("(pointer: coarse)").matches:0<navigator.maxTouchPoints||0<navigator.msMaxTouchPoints;
AppUI.baseSizePX=4;AppUI.s1PX=AppUI.baseSizePX;AppUI.s2PX=2*AppUI.baseSizePX;AppUI.s3PX=3*AppUI.baseSizePX;AppUI.s4PX=4*AppUI.baseSizePX;AppUI.s5PX=5*AppUI.baseSizePX;AppUI.s6PX=6*AppUI.baseSizePX;AppUI.s7PX=7*AppUI.baseSizePX;AppUI.s8PX=8*AppUI.baseSizePX;AppUI.smallFontSizeREM=3;AppUI.smallContentsSizeREM=4;AppUI.fontSizeREM=3.5;AppUI.contentsSizeREM=6;AppUI.baseThinBorderPX=1;AppUI.baseThickBorderPX=2;AppUI.zoomHandlers=[];AppUI.rootVariables=document.getElementById("root-variables");
AppUI.cover=document.getElementById("cover");AppUI.panelContainer=document.getElementById("panel-container");AppUI.fixedPanel=document.getElementById("fixed-panel");AppUI.middlePanel=document.getElementById("middle-panel");AppUI.optionalPanel=document.getElementById("optional-panel");AppUI.iconPlay=document.getElementById("i-play");AppUI.iconPause=document.getElementById("i-pause");AppUI.ruler=document.getElementById("ruler");AppUI.titleLabel=document.getElementById("title-label");
AppUI.artistLabel=document.getElementById("artist-label");AppUI.assistiveSongLengthLabel=document.getElementById("assistive-song-length-label");AppUI.topMessage=document.getElementById("top-message");AppUI.toggleViewButton=document.getElementById("toggle-view-button");AppUI._loading=!1;AppUI.devicePixelRatio=-1;AppUI._1remInPX=1;AppUI._fontScale=1;AppUI._smallIconSizePX=Icon.baseSizePX;AppUI._largeIconSizePX=Icon.baseSizePX<<1;AppUI._thinBorderPX=AppUI.baseThinBorderPX;AppUI._thickBorderPX=AppUI.baseThickBorderPX;
AppUI._buttonSizePX=1;AppUI._contentsSizePX=1;AppUI._playlistItemSizePX=1;AppUI.directoryCancelled=!1;AppUI.topMessageFading=0;AppUI.topMessageTimeout=0;AppUI.focusBlocker=null;AppUI.panelContainerToggled=!1;AppUI.panelContainerToggling=!1;AppUI.panelContainerToggleVersion=0;
...
playerPossibleResumeTimeS:App.player.possibleResumeTimeS,graphicalFilterControlEnabled:App.graphicalFilterControl?App.graphicalFilterControl.enabled:!1,graphicalFilterControlSimpleMode:App.graphicalFilterControl?App.graphicalFilterControl.simpleMode:!0,stereoPannerControlEnabled:App.stereoPannerControl?App.stereoPannerControl.enabled:!1,monoDownMixerControlEnabled:App.monoDownMixerControl?App.monoDownMixerControl.enabled:!1,filePickerLastPath:FilePicker.lastPath,filePickerRootLength:FilePicker.lastRootLength});
App.player.destroy(!0);App.graphicalFilterControl&&App.graphicalFilterControl.saveSettings();App.stereoPannerControl&&App.stereoPannerControl.saveSettings();if(a&&a.length)for(let d=a.length-1;0<=d;d--)if(a[d]){const e=a[d]();e&&b.push(e)}c&&InternalStorage.savePlaylistWeb(c);App.hostInterface&&(b.length?Promise.all(b).then(App.destroy,App.destroy):App.destroy())}}static destroy(){App.player&&App.player.destroy();AppUI.destroy();const a=App.ipcRenderer;zeroObject(App);a&&a.invoke("mainWindowFinalClose")}static updateLoadingIcon(){App.iconLoading&&
