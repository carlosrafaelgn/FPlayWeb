...
11025;break;case 1:a.sampleRate=12E3;break;case 2:a.sampleRate=8E3}break;case 2:switch(g){case 0:a.sampleRate=22050;break;case 1:a.sampleRate=24E3;break;case 2:a.sampleRate=16E3}break;case 3:switch(g){case 0:a.sampleRate=44100;break;case 1:a.sampleRate=48E3;break;case 2:a.sampleRate=32E3}}a.channels=3===(f>>6&3)?1:2}}}catch(k){}})}static extractID3v2Andv1(a,b,c,d,e){return __awaiter(this,void 0,void 0,function*(){const f=MetadataExtractor.createBasicMetadata(a);f.url?f.url.startsWith(FileUtils.localURLPrefix)&&
(f.file=a):(f.file=a,f.fileSize=a.size,f.fileName=a.name);let g=0;var k=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==k)if(k|=b.readByte(),1380533830===k){e=!1;k=yield MetadataExtractor.extractRIFF(f,b,c[0]);if(!k)return null;if(!k[1])return f;f.lengthMS&&(g|=MetadataExtractor.LENGTH_B)}else return e&&(yield MetadataExtractor.extractSampleRateAndChannels(f,b,0,d)),yield MetadataExtractor.extractID3v1(f,b,0,c[0]),f;var h=b.readByte(),m=b.readByte();k=b.readByte();var l=b.readByte();
const n=b.readByte(),q=b.readByte(),p=b.readByte();k=(k&16?10:0)+(p&127|(q&127)<<7|(n&127)<<14|(l&127)<<21);l=10+k;if(2<(h&255)||m){for(;0<k&&g!==MetadataExtractor.ALL_B;){(h=b.fillBuffer(1024))&&(yield h);m=b.readUInt32BE();h=b.readUInt32BE();b.skip(2);if(!m||0>=h||h>k)break;switch(m){case 1414091826:g&MetadataExtractor.TITLE_B?b.skip(h):(m=MetadataExtractor.readV2Frame(b,h,c),f.title=m&&m.then?yield m:m,f.title&&(g|=MetadataExtractor.TITLE_B));break;case 1414546737:g&MetadataExtractor.ARTIST_B?
b.skip(h):(m=MetadataExtractor.readV2Frame(b,h,c),f.artist=m&&m.then?yield m:m,f.artist&&(g|=MetadataExtractor.ARTIST_B));break;case 1413565506:g&MetadataExtractor.ALBUM_B?b.skip(h):(m=MetadataExtractor.readV2Frame(b,h,c),f.album=m&&m.then?yield m:m,f.album&&(g|=MetadataExtractor.ALBUM_B));break;case 1414677323:g&MetadataExtractor.TRACK_B?b.skip(h):(m=MetadataExtractor.readV2Frame(b,h,c),f.track=m&&m.then?parseInt(yield m):parseInt(m),f.track?g|=MetadataExtractor.TRACK_B:f.track=0);break;case 1414284622:g&
MetadataExtractor.LENGTH_B?b.skip(h):(m=MetadataExtractor.readV2Frame(b,h,c),f.lengthMS=m&&m.then?parseInt(yield m):parseInt(m),f.lengthMS?g|=MetadataExtractor.LENGTH_B:f.lengthMS=0);break;case 1415136594:case 1413763651:g&MetadataExtractor.YEAR_B?b.skip(h):(m=MetadataExtractor.readV2Frame(b,h,c),f.year=m&&m.then?parseInt(yield m):parseInt(m),f.year?g|=MetadataExtractor.YEAR_B:f.year=0);break;default:b.skip(h)}k-=10+h}e&&(yield MetadataExtractor.extractSampleRateAndChannels(f,b,l,d));(g&MetadataExtractor.ALL_BUT_LENGTH_B)!==
