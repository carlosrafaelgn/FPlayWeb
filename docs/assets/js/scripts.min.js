...
super.fillBuffer},read:{get:()=>super.read}});return __awaiter(this,void 0,void 0,function*(){if("number"!==typeof a&&(a=yield a,0>=a))return e;d-=a;this.currentPageLength-=a;c+=a;for(e+=a;0<d&&!f.eof;){if(!this.currentPageLength&&(this.bufferAvailable<OggBufferedReader.maximumOggPageHeaderLength&&(yield f.fillBuffer.call(this,OggBufferedReader.maximumOggPageHeaderLength+OggBufferedReader.maximumOggPageHeaderLength+4)),!this.readNextPageLength()))return e;a=f.read.call(this,b,c,Math.min(d,this.currentPageLength));
"number"!==typeof a&&(a=yield a);if(0>=a)break;d-=a;this.currentPageLength-=a;c+=a;e+=a}this.currentPageLength||(this.bufferAvailable<OggBufferedReader.maximumOggPageHeaderLength&&(yield f.fillBuffer.call(this,OggBufferedReader.maximumOggPageHeaderLength+OggBufferedReader.maximumOggPageHeaderLength+4)),this.readNextPageLength());return e})}read(a,b,c){if(0<this.additionalSkipLength)return this.skipAdditionalSkipLength().then(()=>this.read(a,b,c));let d=0;for(;0<c&&!super.eof;){if(!this.currentPageLength){if(this.bufferAvailable<
OggBufferedReader.maximumOggPageHeaderLength)return this.readAsync(0,a,b,c,d);if(!this.readNextPageLength())return d}const e=super.read(a,b,Math.min(c,this.currentPageLength));if("number"!==typeof e)return this.readAsync(e,a,b,c,d);if(0>=e)break;c-=e;this.currentPageLength-=e;b+=e;d+=e}!this.currentPageLength&&this.bufferAvailable>OggBufferedReader.maximumOggPageHeaderLength&&this.readNextPageLength();return d}}OggBufferedReader.basicPageStructureLength=27;
OggBufferedReader.maximumOggPageHeaderLength=OggBufferedReader.basicPageStructureLength+255;OggBufferedReader.vorbisIdentifierLength=7;
