...
"Fechar",Strings.Exit="Sair",Strings.Previous="Anterior",Strings.Play="Tocar",Strings.Pause="Pausar",Strings.PlayPause="Tocar / Pausar",Strings.Stop="Parar",Strings.Next="Pr\u00f3xima",Strings.UnknownError="Erro desconhecido",Strings.AddFiles="Adicionar Arquivos",Strings.AddFolders="Adicionar Pastas",Strings.ShowFilter="Exibir Filtro",Strings.ShowPlaylist="Exibir Lista");Strings.translateChildren(document.body)}static translate(a){const b=Strings[a];return void 0!==b?b:a}static translateChildren(a){a=
a.childNodes;for(let d=a.length-1;0<=d;d--){const e=a[d];if(!e.tagName)continue;e.childNodes&&e.childNodes.length&&Strings.translateChildren(e);let g;(g=e.getAttribute("title"))&&e.setAttribute("title",Strings.translate(g));if(g=e.getAttribute("data-string")){e.removeAttribute("data-string");var b=0;do{let f=g.indexOf(";",b);f<b&&(f=g.length);var c=g.indexOf("|",b);0>c||c>=f?e.appendChild(document.createTextNode(Strings.translate(g))):(b=g.substring(b,c),c=g.substring(c+1,f),e.setAttribute(b,Strings.translate(c)));
b=f+1}while(b<g.length)}}}}Strings.language="en";Strings.DecimalSeparator=".";Strings.OppositeDecimalSeparator=",";Strings.Oops="Oops\u2026";Strings.Menu="Menu";Strings.Edit="Edit";Strings.Delete="Delete";Strings.Enable="Enable";Strings.Disable="Disable";Strings.Enabled="Enabled";Strings.Disabled="Disabled";Strings.OK="OK";Strings.Cancel="Cancel";Strings.Clear="Clear";Strings.Back="Back";Strings.Close="Close";Strings.Exit="Exit";Strings.Previous="Previous";Strings.Play="Play";Strings.Pause="Pause";
Strings.PlayPause="Play / Pause";Strings.Stop="Stop";Strings.Next="Next";Strings.Volume="Volume";Strings.UnknownError="Unknown error";Strings.AddFiles="Add Files";Strings.AddFolders="Add Folders";Strings.ShowFilter="Show Filter";Strings.ShowPlaylist="Show Playlist";
...
typeof a?MetadataExtractor.finishReadingV2Frame(d,a,e):a.then(function(g){return MetadataExtractor.finishReadingV2Frame(d,g,e)})}static async extractID3v1(a,b,c,d){try{b.seekTo(b.fileLength-128);const f=b.read(d,0,128);"number"!==typeof f&&await f;if(84==d[0]&&65==d[1]&&71==d[2]){var e;if(!(c&MetadataExtractor.TITLE_B)){var g=3;for(e=0;30>e&&d[g];)e++,g++;e&&(a.title=MetadataExtractor.textDecoderIso88591.decode(d.subarray(3,3+e)))}if(!(c&MetadataExtractor.ARTIST_B)){g=33;for(e=0;30>e&&d[g];)e++,g++;
e&&(a.artist=MetadataExtractor.textDecoderIso88591.decode(d.subarray(33,33+e)))}if(!(c&MetadataExtractor.ALBUM_B)){g=63;for(e=0;30>e&&d[g];)e++,g++;e&&(a.album=MetadataExtractor.textDecoderIso88591.decode(d.subarray(63,63+e)))}if(!(c&MetadataExtractor.YEAR_B)){g=93;for(e=0;4>e&&d[g];)e++,g++;e&&(a.year=parseInt(MetadataExtractor.textDecoderIso88591.decode(d.subarray(93,93+e))))}c&MetadataExtractor.TRACK_B||d[125]||!d[126]||(a.track=d[126]&255)}}catch(f){}}static async extractID3v2Andv1(a,b,c){a={url:Formatter.pathToURL(a.path)||
Formatter.empty,file:a};var d=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==d)if(d|=b.readByte(),1380533830===d){d=await MetadataExtractor.extractRIFF(a,b,c[0]);if(!d)return null;if(!d[1])return a}else return await MetadataExtractor.extractID3v1(a,b,0,c[0]),a;var e=b.readByte(),g=b.readByte();d=b.readByte();var f=b.readByte();const h=b.readByte(),k=b.readByte(),m=b.readByte();d=(d&16?10:0)+(m&127|(k&127)<<7|(h&127)<<14|(f&127)<<21);if(2<(e&255)||g){for(e=0;0<d&&e!==MetadataExtractor.ALL_B;){(g=
b.fillBuffer(1024))&&await g;f=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();g=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8|b.readByte();b.skip(2);if(!f||0>=g||g>d)break;switch(f){case 1414091826:e&MetadataExtractor.TITLE_B?b.skip(g):(f=MetadataExtractor.readV2Frame(b,g,c),a.title=f&&f.then?await f:f,a.title&&(e|=MetadataExtractor.TITLE_B));break;case 1414546737:e&MetadataExtractor.ARTIST_B?b.skip(g):(f=MetadataExtractor.readV2Frame(b,g,c),a.artist=f&&f.then?await f:f,a.artist&&
(e|=MetadataExtractor.ARTIST_B));break;case 1413565506:e&MetadataExtractor.ALBUM_B?b.skip(g):(f=MetadataExtractor.readV2Frame(b,g,c),a.album=f&&f.then?await f:f,a.album&&(e|=MetadataExtractor.ALBUM_B));break;case 1414677323:e&MetadataExtractor.TRACK_B?b.skip(g):(f=MetadataExtractor.readV2Frame(b,g,c),a.track=f&&f.then?parseInt(await f):parseInt(f),a.track?e|=MetadataExtractor.TRACK_B:a.track=0);break;case 1414284622:e&MetadataExtractor.LENGTH_B?b.skip(g):(f=MetadataExtractor.readV2Frame(b,g,c),a.lengthMS=
f&&f.then?parseInt(await f):parseInt(f),a.lengthMS?e|=MetadataExtractor.LENGTH_B:a.lengthMS=0);break;case 1415136594:case 1413763651:e&MetadataExtractor.YEAR_B?b.skip(g):(f=MetadataExtractor.readV2Frame(b,g,c),a.year=f&&f.then?parseInt(await f):parseInt(f),a.year?e|=MetadataExtractor.YEAR_B:a.year=0);break;default:b.skip(g)}d-=10+g}(e&MetadataExtractor.ALL_BUT_LENGTH_B)!==MetadataExtractor.ALL_BUT_LENGTH_B&&await MetadataExtractor.extractID3v1(a,b,e,c[0])}return a}static async extract(a,b,c){if(!a)return null;
...
this.biquadFilterActualMag=this.biquadFilterActualAccum=this.biquadFilterActualFrequencies=this.biquadFilterActualGains=this.biquadFilterGains=this.biquadFilterOutput=this.biquadFilterInput=this.biquadFilters=this._convolver=this.source=null;this.updateFilter(0,!0,!0);this.updateActualChannelCurve(0);this.updateBuffer();this.filterChangedCallback=c}static encodeCurve(a){const b=GraphicalFilterEditor.minimumChannelValueY,c=GraphicalFilterEditor.validYRangeHeight,d=a.length,e=Array(d<<1);let g=0;for(let f=
0;f<d;f++){let h=a[f];h=h>b?0:c-h;254>=h?e[g++]=h:(e[g++]=255,e[g++]=h-254)}e.splice(g);return btoa(String.fromCharCode(...e))}static decodeCurve(a){if(!a||a.length<4*GraphicalFilterEditor.visibleBinCount/3)return null;try{a=atob(a)}catch(g){return null}if(a.length<GraphicalFilterEditor.visibleBinCount)return null;const b=GraphicalFilterEditor.validYRangeHeight,c=a.length,d=Array(GraphicalFilterEditor.visibleBinCount);let e=0;for(let g=0;g<c;g++){const f=a.charCodeAt(g);254>=f?d[e++]=b-f:g<c-1&&(g++,
d[e++]=b-(a.charCodeAt(g)+254))}return d}get sampleRate(){return this._sampleRate}get isNormalized(){return this._isNormalized}get iirType(){return this._iirType}get convolver(){return this._convolver}get inputNode(){return this.biquadFilterInput||this._convolver}get outputNode(){return this.biquadFilterOutput||this._convolver}connectSourceAndDestination(a,b){a=this.connectSourceToInput(a);return this.connectOutputToDestination(b)&&a}connectSourceToInput(a){this.source&&this.source.disconnect();if(this.source=
...
-45;this.analyzerR.smoothingTimeConstant=0;a=(g,f)=>{this.COLORS[3*g]=f};b=(g,f)=>{this.COLORS[3*g+1]=f};c=(g,f)=>{this.COLORS[3*g+2]=f};this.processedDataPtr=this.ptr=d=cLib._allocBuffer(2240+8*this.BG_COUNT+8*this.BG_COUNT+this.BG_COUNT);this.processedData=new Uint8Array(512);this.processedDataRPtr=d+=512;this.processedDataR=new Uint8Array(512);this.fftPtr=d+=512;this.fft=new Float32Array(256);this.COLORSPtr=d+=1024;this.COLORS=new Float32Array(48);this.bgPosPtr=d+=192;this.bgPos=new Float32Array(2*
...
this.currentItem=g;var h=0,k=this.firstIndex,m=this.visibleCount+(0===k?2:1===k?3:4);0>(k-=2)&&(k=0);for(let l=k*c;h<m&&k<e;h++,k++,l+=c){const p=d.item(k),n=b[h],q=g===p;n.current!==q&&((n.current=q)?n.element.classList.add("current"):n.element.classList.remove("current"));a.prepareElement(p,k,e,n.element);n.item||f.appendChild(n.element);n.item=p;n.index!==k&&(n.index=k,n.element.style.top=l+"px")}for(a=b.length;h<a;h++)c=b[h],c.item&&(c.item=null,f.removeChild(c.element))}}resize(){const a=this._adapter;
...
class Player{constructor(a,b,c){this.audioContextTimeout=0;this.audioContextSuspended=!0;this.audioContext=window.AudioContext?new window.AudioContext:new window.webkitAudioContext;this.audioContext.suspend();this.graphicalFilterControl=new GraphicalFilterControl(a,this.audioContext,c);this.graphicalFilterControl.filterChangedCallback=this.filterChanged.bind(this);this.onerror=this.oncurrenttimeschanged=this.onpausedchanged=this.onloadingchanged=this.onsongchanged=null;this.boundPlaybackError=this.playbackError.bind(this);
this.boundNotifySongChanged=this.notifySongChanged.bind(this);this.boundCheckAudioContext=this.checkAudioContext.bind(this);this.audio=new Audio;this.audio.loop=!1;this.audio.controls=!1;this.audio.volume=1;a=this.playbackLoadStarted.bind(this);this.audio.onwaiting=a;this.audio.onloadstart=a;this.audio.oncanplay=this.playbackLoadEnded.bind(this);this.audio.onended=this.playbackEnded.bind(this);this.audio.onerror=this.boundPlaybackError;this.audio.onpause=this.playbackPaused.bind(this);a=this.playbackStarted.bind(this);
this.audio.onplay=a;this.audio.onplaying=a;a=this.playbackAborted.bind(this);this.audio.onabort=a;this.audio.onemptied=a;this.audio.ondurationchange=this.playbackLengthChanged.bind(this);this.audio.ontimeupdate=this.currentTimeChanged.bind(this);this.source=this.audioContext.createMediaElementSource(this.audio);this._alive=!0;this._loading=!1;this._paused=!0;this._currentSong=this._playlist=null;this._volume=100;this.lastObjectURL=null;this.volume=void 0===b?100:b;this.filterChanged();(this.mediaSession=
b="mediaSession"in navigator&&"MediaMetadata"in window?navigator.mediaSession:null)&&"setActionHandler"in b&&(a=this.playPause.bind(this),b.setActionHandler("previoustrack",this.previous.bind(this)),b.setActionHandler("seekbackward",this.seekBackward.bind(this)),b.setActionHandler("pause",a),b.setActionHandler("play",a),b.setActionHandler("seekforward",this.seekForward.bind(this)),b.setActionHandler("nexttrack",this.next.bind(this)))}destroy(a){this.stop();a?(this._alive=!1,this.graphicalFilterControl&&
this.graphicalFilterControl.saveSettings()):(this._playlist&&this._playlist.destroy(),(a=this.mediaSession)&&"setActionHandler"in a&&(a.setActionHandler("previoustrack",null),a.setActionHandler("seekbackward",null),a.setActionHandler("pause",null),a.setActionHandler("play",null),a.setActionHandler("seekforward",null),a.setActionHandler("nexttrack",null)),zeroObject(this))}filterChanged(){!this._alive||this.graphicalFilterControl.enabled&&this.graphicalFilterControl.editor.filter.connectSourceAndDestination(this.source,
this.audioContext.destination)||(this.source.disconnect(),this.graphicalFilterControl.editor.filter.disconnectOutputFromDestination(),this.source.connect(this.audioContext.destination,0,0))}get alive(){return this._alive}get loading(){return this._loading}get paused(){return this._paused}get volume(){return this._volume}set volume(a){a|=0;this._volume=0>=a?0:100<=a?100:a;this.audio&&(this.audio.volume=a/100)}get playlist(){return this._playlist}set playlist(a){this._alive&&(this.stop(),this._playlist=
a)}get currentSong(){return this._currentSong}get currentTimeMS(){return this._currentSong?1E3*this.audio.currentTime|0:-1}playbackLoadStarted(){if(this._alive&&!this._loading&&(this._loading=!0,this.onloadingchanged))this.onloadingchanged(!0)}playbackLoadEnded(){if(this._alive&&this._loading&&(this._loading=!1,this.onloadingchanged))this.onloadingchanged(!1)}playbackEnded(){this._alive&&this.next()}playbackError(a,b,c,d,e){if(this._alive&&(this.stop(),this.onerror))this.onerror(e?e.message?e.message:
"string"===typeof a?a:e.toString():"string"===typeof a?a:Strings.UnknownError)}suspendAudioContext(a){this.audioContextTimeout&&(clearTimeout(this.audioContextTimeout),this.audioContextTimeout=0);this.audioContextSuspended||(a?this.audioContextTimeout=window.setTimeout(this.boundCheckAudioContext,5E3):(this.audioContext.suspend(),this.audioContextSuspended=!0))}resumeAudioContext(){this.audioContextTimeout&&(clearTimeout(this.audioContextTimeout),this.audioContextTimeout=0);this.audioContextSuspended&&
(this.audioContext.resume(),this.audioContextSuspended=!1)}checkAudioContext(){this.audioContextTimeout=0;this._paused?this.audioContextSuspended||(this.audioContext.suspend(),this.audioContextSuspended=!0):this.audioContextSuspended&&(this.audioContext.resume(),this.audioContextSuspended=!1)}playbackPaused(){if(this._alive&&!this._paused&&(this._paused=!0,this.suspendAudioContext(!0),this.onpausedchanged))this.onpausedchanged(!0)}playbackStarted(){if(this._alive&&this._paused&&(this._paused=!1,this.resumeAudioContext(),
this.onpausedchanged))this.onpausedchanged(!1)}playbackAborted(){if(this._alive){if(this._loading&&(this._loading=!1,this.onloadingchanged))this.onloadingchanged(!1);if(!this._paused&&(this._paused=!0,this.suspendAudioContext(!0),this.onpausedchanged))this.onpausedchanged(!0)}}playbackLengthChanged(){this._alive&&this.audio&&this._playlist&&this._currentSong&&(this._playlist.songLengthChanged(this._currentSong,this.audio.duration),this.mediaSession&&0<this.audio.duration&&"setPositionState"in this.mediaSession&&
this.mediaSession.setPositionState({duration:this.audio.duration}))}currentTimeChanged(){if(this._alive&&this.audio&&this._currentSong&&this.oncurrenttimeschanged)this.oncurrenttimeschanged(this.audio.currentTime)}notifySongChanged(){if(this._alive){const a=this._currentSong,b=this.mediaSession;b&&(a?(b.metadata=new window.MediaMetadata({title:a.title,artist:a.artist,album:a.album,artwork:[{src:"assets/images/albumArts/64x64.png",sizes:"64x64",type:"image/png"},{src:"assets/images/albumArts/96x96.png",
sizes:"96x96",type:"image/png"},{src:"assets/images/albumArts/192x192.png",sizes:"192x192",type:"image/png"},{src:"assets/images/albumArts/256x256.png",sizes:"256x256",type:"image/png"},{src:"assets/images/albumArts/512x512.png",sizes:"512x512",type:"image/png"}]}),0<a.lengthMS&&"setPositionState"in b&&b.setPositionState({duration:a.lengthMS/1E3})):b.playbackState="none");if(this.onsongchanged)this.onsongchanged(a)}}previous(){this._alive&&this._playlist&&(this._playlist.moveCurrentToPrevious(),this.play(-1))}seekBackward(){this._alive&&
this.seekTo(-1E4,!0)}pause(){this._alive&&this._currentSong&&this.audio.pause()}play(a){if(this._alive){if(this._currentSong&&void 0===a){this.resumeAudioContext();var b=this.audio.play()}else if(this._playlist){void 0!==a&&0<=a&&(this._playlist.currentIndex=a);a=this._playlist.currentItem;!a&&this._playlist.length&&(this._playlist.moveCurrentToNext(),a=this._playlist.currentItem);if(!a){this.stop();return}this._currentSong=a;queueMicrotask(this.boundNotifySongChanged);for(this.resumeAudioContext();this.audio.firstChild;)this.audio.removeChild(this.audio.firstChild);
b=document.createElement("source");a.url?b.src=a.url:a.file&&(this.lastObjectURL&&URL.revokeObjectURL(this.lastObjectURL),this.lastObjectURL=URL.createObjectURL(a.file),b.src=this.lastObjectURL);b.onerror=this.boundPlaybackError;this.audio.appendChild(b);this.audio.load();b=this.audio.play()}b&&b.catch(Player.nop)}}playPause(){this._alive&&(!this._currentSong||this.audio.paused?this.play():this.pause())}stop(){if(this._alive){if(this._currentSong){for(;this.audio.firstChild;)this.audio.removeChild(this.audio.firstChild);
...
this._currentSong&&!(0>=this._currentSong.lengthMS)&&this.audio.seekable&&this.audio.seekable.length&&(a=a/1E3+(b?this.audio.currentTime:0),this.audio.currentTime=a>this.audio.duration?this.audio.duration:0>=a?0:a)}}Player.nop=function(){};
...
delete window.electronIpcRenderer;delete window.electronWebFrame;"serviceWorker"in navigator&&window.addEventListener("beforeinstallprompt",App.beforeInstallPrompt);window.addEventListener("resize",App.adjustCover);App.adjustCover();App.ipcRenderer?(App.ipcRenderer.on("mainWindowStateChanged",App.mainWindowStateChanged),App.ipcRenderer.on("mainWindowClosing",App.mainWindowClosing),App.triggerMainWindowStateChanged()):window.addEventListener("beforeunload",App.mainWindowClosing);App.frameless&&(App.titleBar=
document.createElement("h1"),App.titleBar.innerHTML=`
				<div></div>
				<i id="icon-main"></i>
				FPlay
...
App.ipcRenderer.invoke(App.isMaximized?"mainWindowRestore":"mainWindowMaximize")}static mainWindowClose(){App.ipcRenderer&&App.ipcRenderer.invoke("mainWindowClose")}static async readWasmLibrary(){return(await fetch("assets/lib/graphicalFilterEditor/lib.wasm")).arrayBuffer()}static async showOpenFileDialog(){if(App.fileInput||App._showingDialog)return null;try{return App._showingDialog=!0,await App.ipcRenderer.invoke("showOpenFileDialog")}finally{App._showingDialog=!1}}static convertFilePathsToAppFiles(a){return App.ipcRenderer.invoke("convertFilePathsToAppFiles",
...
function setup(){Array.prototype.fill||(Array.prototype.fill=function(a,b,c){var d=this.length|0;b|=0;c=void 0===c?d:c|0;c=0>c?Math.max(d+c,0):Math.min(c,d);for(b=0>b?Math.max(d+b,0):Math.min(b,d);b<c;)this[b++]=a;return this});window.CLib().then(a=>{cLib=a;window.main&&window.main()},a=>{alert(a);throw a;})}setup();
