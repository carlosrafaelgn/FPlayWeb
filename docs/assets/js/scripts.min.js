...
Strings.Playlist="Playlist";Strings.FileList="File list";Strings.CurrentPathLabel="Current path: ";Strings.Loading="Loading";Strings.LoadingLabel="Loading\u2026 ";Strings.LoadingCurrentPathLabel="Loading current path: ";Strings.Folder="Folder";Strings.FolderLabel="Folder: ";Strings.LeftAbbrev="L";Strings.RightAbbrev="R";Strings.Volume="Volume";Strings.Fade="Fade";Strings.DownMixToMono="Down-mix to mono";Strings.UnknownError="Something went wrong during playback. \ud83d\ude22";Strings.Add="Add";
Strings.AddFiles="Add files";Strings.AddSongs="Add songs";Strings.AddFolders="Add folders";Strings.AddMoreFolders="Add more folders\u2026";Strings.ShowEffects="Show effects";Strings.ShowPlaylist="Show playlist";Strings.NoSongsInFolder="No songs in folder. \ud83d\ude33";Strings.NoSongsFoundInPlaylist="No songs found in the playlist. \ud83d\ude33";Strings.PlaylistControlEmptyMessage=`Use the \"${Strings.AddSongs}\" button to add songs to the playlist. \ud83d\ude0a`;Strings.UpdateAvailable="Update available!";
Strings.PleaseRefresh="Please, refresh the page to update the app. \ud83d\ude0a";Strings.RGBMode="RGB Mode";Strings.AnimatedRGBMode="Animated RGB Mode";Strings.ExtraRGBMode="Extra RGB Mode";Strings.NeonMode="Neon Mode";Strings.AboutHTML='<p>FPlay Web is an experimental audio player. \ud83d\ude0a</p>\n<p>For more information about the project, its source code and dependencies, check out its repository at <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb">github.com/carlosrafaelgn/FPlayWeb</a>.</p>\n<p>This project is licensed under the <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb/blob/master/LICENSE">MIT License</a>.</p>';
...
b=a.lastIndexOf("/"),c=0<=b?a.substring(b+1):a,this.isHttpURL||(b=c.lastIndexOf("."),0<b&&(c=c.substring(0,b))));this.title=c||Formatter.none;this.artist=d||Formatter.none;this.album=e||Formatter.none;this.albumLine=f&&0<f?`${f} / ${this.album}`:this.album;this.track=f&&0<f?f:Formatter.noneInt;this.lengthMS=g&&0<g?g:Formatter.noneInt;this.year=h&&0<h?h:Formatter.noneInt;this.sampleRate=k&&0<k?k:Formatter.noneInt;this.channels=n&&0<n?n:Formatter.noneInt;this.length=Formatter.formatTimeMS(this.lengthMS);
this.fileName=m||null;this.fileSize=l||0;this.customProvider=this.fileExtension&&FileUtils.getCustomProviderByExtension(this.fileExtension)||null}get isSeekable(){return this.flags&MetadataFlags.Seekable?!0:!1}get absolutePath(){return this.isLocalURL?this.url.substring(FileUtils.localURLPrefix.length):this.isFileURL?decodeURI(this.url.substring(FileUtils.fileURLPrefix.length)):this.url}estimateSerializedLength(){return(this.url.length+this.title.length+this.artist.length+this.album.length+(this.fileName?
this.fileName.length:0)<<1)+17}serialize(a){return a.writeUint8(0).writeString(this.url).writeInt32(this.flags).writeString(this.title).writeString(this.artist).writeString(this.album).writeInt16(this.track).writeInt32(this.lengthMS).writeInt16(this.year).writeInt32(this.sampleRate).writeInt8(this.channels).writeString(this.fileName||null).writeInt32(this.fileSize||0)}serializeWeb(){return{url:this.url,flags:this.flags,title:this.title,artist:this.artist,album:this.album,track:this.track,lengthMS:this.lengthMS,
year:this.year,sampleRate:this.sampleRate,channels:this.channels,fileName:this.fileName,fileSize:this.fileSize}}normalizedInfoContainsAllTerms(a){var b=this._normalizedInfo;void 0===b&&(b=[],this.title&&this.title!==Formatter.none&&b.push(this.title),this.artist&&this.artist!==Formatter.none&&b.push(this.artist),this.albumLine&&this.albumLine!==Formatter.none&&b.push(this.albumLine),this.year&&0<this.year&&b.push(this.year.toString()),this.url&&b.push(this.url),this._normalizedInfo=b=Strings.removeDiacritics(b.join(" ")));
for(let c=a.length-1;0<=c;c--)if(!b.includes(a[c]))return!1;return!0}async readAsArrayBuffer(){if(!this.file)if(this.isLocalURL){var a=await FileSystemAPI.getFile(this.absolutePath);if(!a)return null;this.file=a}else return a=await fetch(this.url),a.ok?a.arrayBuffer():null;return this.file.arrayBuffer()}}Song._lastId=0;
