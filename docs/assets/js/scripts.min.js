...
this.audio&&this._playlist&&this._currentSong&&this._playlist.updateSongLength(this._currentSong,this.audio.duration)&&this.notifyMediaSessionChange()}currentTimeChange(){if(this._alive&&this.audio&&this._currentSong){var a=this.audio.currentTime;this.lastTimeS=a;if(this.oncurrenttimeschange)this.oncurrenttimeschange(a)}}notifyMediaSessionChange(){this.refreshMediaSession(this._currentSong)}notifySongChange(){if(this._alive){if(this.onsongchange)this.onsongchange(this._currentSong);this.notifyMediaSessionChange()}}refreshMediaSession(a){this._alive&&
this.mediaSession&&(a?this.mediaSession.setMetadata(a.id,a.title,a.artist,a.album,a.track,a.lengthMS,a.year):this.mediaSession.setMetadata(0,null,null,null,0,0,0))}setPlaylistData(){const a=this._playlist;a&&(a.currentIndexResumeTimeS=this.currentIndexResumeTimeS)}previous(a){this._alive&&this._playlist&&(this._playlist.moveCurrentToPrevious(),this.play(-1,a))}seekBackward(){this._alive&&this.seekTo(-1E4,!0)}pause(){this._alive&&(this.suspendAudioContext(!1),this._currentSong&&this.audio&&this.audio.pause())}play(a,
...
yield App.showOpenDialogWeb(a),d=null;if((c||d)&&App.player)try{App.player.playlist||(App.player.playlist=new Playlist,AppUI.preparePlaylist());const e=App.player.playlist,f=b?null:new Uint8Array(BufferedFileHandle.minBufferLength<<1),g=b?null:[new Uint8Array(256)];let h=!1;do{let k=!1;if(d){const m=yield d();if(!m)break;k=m.play;c=m.files}if(!c)break;AppUI._loading=!0;App.updateLoadingIcon();for(let m=0;m<c.length&&App.player;m++)if(b)(yield e.addSong(c[m]))&&k&&(k=!1,App.player&&App.player.play(e.length-
