...
class MetadataExtractor{static async extractRIFF(a,b,c){if(44>b.fileLength)return null;var d=b.readUInt32LE();if(null===d||b.fileLength<8+d)return null;var e=d;let f=!1,g=!1,k=d=0,h=0;a:for(;0<e;){var m=!1,l=0,p=void 0;switch(b.readUInt32BE()){case null:break a;case 1463899717:m=!0;e-=4;break;case 1279873876:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;break;case 1768174368:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;(p=b.fillBuffer(1024))&&await p;if(4<l){m=
b.readByte();var q=b.readByte();p=b.readByte();if(null===m||null===q||null===p)break a;e-=3;l-=3;if(73===m||68===q||51===p)if(d=b.fileLength-e,f&&g){d=-1;break a}}b.skip(l);(p=b.fillBuffer(1024))&&await p;continue;default:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;b.skip(l);(p=b.fillBuffer(1024))&&await p;continue}for((p=b.fillBuffer(1024))&&await p;m&&(!f||!g)||0<l;){var n=b.readUInt32BE();q=0;if(null===n)break a;e-=4;l-=4;if(1229866575!==n){q=b.readUInt32LE();if(null===q||0>
q||q>e||!m&&q>l)break a;e-=4;l-=4}1684108385!==n&&(p=b.fillBuffer(Math.min(264,8+q)))&&await p;switch(n){case 1718449184:if(!m)break;p=b.readUInt16LE();n=b.readUInt16LE();var r=b.readUInt32LE(),u=b.readUInt32LE(),t=b.readUInt16LE();const y=b.readUInt16LE();q-=16;e-=16;l-=16;if(null===p||null===n||null===r||null===u||null===t||null===y)break a;f=!0;h||(h=u);break;case 1684108385:m&&(g=!0,k||(k=q));break;case 1229866575:for(n=function(x){b.read(c,0,x);return MetadataExtractor.finishReadingV2Frame(0,
x,c)};0<l;){(p=b.fillBuffer(8))&&await p;r=b.readUInt32BE();e-=4;l-=4;if(null===r)break a;u=b.readUInt32LE();e-=4;l-=4;if(null===u||0>u||u>l)break a;if(1>=u)b.skip(u);else{t=Math.min(257,u)-1;(p=b.fillBuffer(t))&&await p;switch(r){case 1229865293:a.title=n(t);break;case 1230000708:a.album=n(t);break;case 1229017684:a.artist=n(t);break;case 1229148740:a.year=parseInt(n(t))||0;break;case 1230262859:a.track=parseInt(n(t))||0;break;default:t=0}b.skip(u-t);e-=u;l-=u}}}0<q&&(b.skip(q),e-=q,l-=q);e&&(p=
...
f=Array(a);g=Array(a);const l=Array(a);var h=.5*Math.log(2),m=this.audioContext.sampleRate;const p=2*Math.PI;for(let q=a-1;0<=q;q--){const n=p*d[q]/m;l[q]=1/(2*Math.sinh(n/Math.sin(n)*h))}for(h=a-1;0<=h;h--)m=b.createBiquadFilter(),m.type="peaking",m.frequency.value=d[h],m.Q.value=l[h],f[h]=m,h<a-1&&f[h+1].connect(f[h]);this.biquadFilters=f;this.biquadFilterInput=f[a-1];this.biquadFilterOutput=f[0]}for(b=a-1;0<=b;b--)g[b]=Math.max(-40,this.yToDB(c[e[b]]));for(b=a-1;0<=b;b--)f[b].gain.value=g[b]+(b<
...
a}}drawCurve(a,b,c){const d=this.ctx;if(d){var e=1<devicePixelRatio?devicePixelRatio:1;e!==this.pixelRatio&&(this.scaleChanged(),e=this.pixelRatio);var f=this.editor,g=f.filter;e*=f.scale;var k=this.element;f=this.leftMargin;var h=k.width,m=k.height,l=Math.round(8*e),p=Math.round(4*e),q=(h/l|0)+1,n=GraphicalFilterEditor.maximumChannelValueY*e|0,r=1>e?e:e|0;k=.5*r;d.fillStyle="#303030";d.fillRect(0,0,h,m);d.lineWidth=r;d.strokeStyle="#5a5a5a";d.beginPath();r=h+(p>>1);var u=(GraphicalFilterEditor.zeroChannelValueY*
e|0)+k;d.moveTo(r,u);for(let t=q-1;0<=t;t--)d.lineTo(r-p,u),r-=l,d.moveTo(r,u);d.stroke();d.beginPath();r=h+(p>>1);u=(GraphicalFilterEditor.validYRangeHeight*e|0)+k;d.moveTo(r,u);for(h=q-1;0<=h;h--)d.lineTo(r-p,u),r-=l,d.moveTo(r,u);d.stroke();if(a)for(a=g.equivalentZonesFrequencyCount.length-2;0<a;a--){r=((g.equivalentZonesFrequencyCount[a]+f)*e|0)+k;u=n;d.beginPath();for(d.moveTo(r,u);u<m;)d.lineTo(r,u+p),u+=l,d.moveTo(r,u);d.stroke()}r=1>e?2*e:2*e|0;k=.5*r;d.lineWidth=r;a=GraphicalFilterEditor.visibleBinCount-
...
if(a&&b&&c&&d){var e=GraphicalFilterEditorControl.controlWidth,f=GraphicalFilterEditorControl.controlHeight,g=1<devicePixelRatio?devicePixelRatio:1,k=b.scale,h=k*g,m=this.leftMargin,l=this.svgLines,p=1>h?h:h|0,q=.5*p,n=(e*h|0).toString(),r=(f*h|0).toString();d.setAttribute("width",n);d.setAttribute("height",r);d.setAttribute("viewBox",`0 0 ${n} ${r}`);d.style.transform=1===g?"":"scale("+1/g+")";this.svgGradient.setAttribute("y2",r);b.element.style.width=(e*k|0)+"px";a.style.width=(e*k|0)+"px";a.style.height=
(f*k|0)+"px";l[0].setAttribute("x2",n);l[1].setAttribute("x2",n);for(n=l.length-1;2<=n;n--)l[n].setAttribute("y2",r);r=((GraphicalFilterEditor.zeroChannelValueY*h|0)+q).toString();l[0].setAttribute("y1",r);l[0].setAttribute("y2",r);r=((GraphicalFilterEditor.validYRangeHeight*h|0)+q).toString();l[1].setAttribute("y1",r);l[1].setAttribute("y2",r);for(r=c.equivalentZonesFrequencyCount.length-2;0<r;r--)n=(((c.equivalentZonesFrequencyCount[r]+m)*h|0)+q).toString(),l[r+1].setAttribute("x1",n),l[r+1].setAttribute("x2",
n);n=p.toString()+"px";r=(4*h|0).toString();for(c=l.length-1;0<=c;c--)l[c].setAttribute("stroke-width",n),l[c].setAttribute("stroke-dasharray",r);n=(1>h?2*h:2*h|0).toString()+"px";this.svgGrayCurve.style.strokeWidth=n;this.svgCurve.style.strokeWidth=n;this.pixelRatio=g}}drawCurve(a,b,c){var d=1<devicePixelRatio?devicePixelRatio:1;d!==this.pixelRatio&&(this.scaleChanged(),d=this.pixelRatio);this.showZones!==a&&(this.showZones=a,this.svgZones.style.display=a?"":"none");var e=this.editor;a=e.filter;
d*=e.scale;e=.5*(1>d?2*d:2*d|0);const f=this.leftMargin,g=GraphicalFilterEditor.visibleBinCount;for(let k=b?1:0;0<=k;k--){const h=k||!b?a.channelCurves[c]:a.actualChannelCurve,m=k?this.svgGrayCurve:this.svgCurve;let l=1,p=0,q=h[0],n="M "+(f*d|0)+","+(q*d+e);for(;l<g;l++)h[l]!==q&&(l>p+1&&1<l&&(n+=" "+((f+l-1)*d|0)+","+(h[l-1]*d+e)),p=l,q=h[l],n+=" "+((f+p)*d|0)+","+(q*d+e));n+=" "+((f+l)*d|0)+","+(h[l-1]*d+e);m.setAttribute("d",n)}this.isActualChannelCurveNeeded!==b&&(this.isActualChannelCurveNeeded=
...
"GEMNUSEP";return k};c=function(k){const h=document.createElement("div");h.className="GEMNULBL";h.appendChild(document.createTextNode(k));return h};d=function(k,h,m,l,p,q){const n=document.createElement("div");n.className=q?"GEMNUIT GECLK "+q:"GEMNUIT GECLK";if(h)if(f&&(l&&f.radioHTML||!l&&f.checkHTML))n.innerHTML=l?f.radioHTML:f.checkHTML,h=n.firstChild,h.style.marginRight=l?f.radioMargin||"2px":f.checkMargin||"2px",m||(h.style.visibility="hidden");else{h=document.createElement("span");q=l?"\u25cf ":
"\u25a0 ";let r=null;if(f){let u=!1;l?f.radioCharacter&&(u=!0,q=f.radioCharacter,r=f.radioMargin||"2px"):f.checkCharacter&&(u=!0,q=f.checkCharacter,r=f.checkMargin||"2px");u&&(f.checkFontFamily&&(h.style.fontFamily=f.checkFontFamily),f.checkFontSize&&(h.style.fontSize=f.checkFontSize))}r&&(h.style.marginRight=r);h.appendChild(document.createTextNode(q));m||(h.style.visibility="hidden");n.appendChild(h)}n.appendChild(document.createTextNode(k));p&&(n.onclick=p);return n};this.element=a;a.className=
...
2048,e=this.visibleFrequencies,f=Analyzer.colors;var g;let k,h,m,l;this.analyzerL.getByteTimeDomainData(this.data);cLib._plainAnalyzer(this.fft4gfPtr,this.windowPtr,this.dataPtr,this.tmpPtr);let p=this.prevL;c.lineWidth=1;c.fillStyle="#000000";c.fillRect(0,0,512,512);for(h=k=0;511>h&&1024>k&&d>e[h+1]-e[h];){for(g=d*k;1024>k&&g+d<e[h];)k++,g=d*k;g=(4*p[h]+a[h]*lerp(g,b[k],g+d,b[k+1],e[h]))/2.5>>1;255<g?g=255:0>g&&(g=0);p[h]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(h-.5,256.5-g);c.lineTo(h-.5,256.5);
c.stroke();h++}for(k++;1024>k&&512>h;){l=m=0;do m+=b[k],l++,k++,g=d*k;while(g<e[h]&&1024>k);g=(4*p[h]+a[h]*m/l)/2.5>>1;255<g?g=255:0>g&&(g=0);p[h]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(h-.5,256.5-g);c.lineTo(h-.5,256.5);c.stroke();h++}this.analyzerR.getByteTimeDomainData(this.data);cLib._plainAnalyzer(this.fft4gfPtr,this.windowPtr,this.dataPtr,this.tmpPtr);p=this.prevR;for(h=k=0;511>h&&1024>k&&d>e[h+1]-e[h];){for(g=d*k;1024>k&&g+d<e[h];)k++,g=d*k;g=(4*p[h]+a[h]*lerp(g,b[k],g+d,b[k+1],e[h]))/
2.5>>1;255<g?g=255:0>g&&(g=0);p[h]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(h-.5,256.5);c.lineTo(h-.5,256.5+g);c.stroke();h++}for(k++;1024>k&&512>h;){l=m=0;do m+=b[k],l++,k++,g=d*k;while(g<e[h]&&1024>k);g=(4*p[h]+a[h]*m/l)/2.5>>1;255<g?g=255:0>g&&(g=0);p[h]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(h-.5,256.5);c.lineTo(h-.5,256.5+g);c.stroke();h++}}cleanUp(){this.ptr&&cLib._freeBuffer(this.ptr)}}
...
d=1-d;d*=d;d+=.5*d;.55>d?d=0:1>d&&(d=smoothStep(.55,1,d));k=1-k;k=smoothStep(0,1,k);k*=k;k+=k;1<k&&(k=1);d+=.5*k;d=255*d|0;c[64*e+g]=255<=d?255:d}}a.texImage2D(a.TEXTURE_2D,0,a.ALPHA,64,64,0,a.ALPHA,a.UNSIGNED_BYTE,c)}analyze(a){let b=a-this.lastTime;33<b&&(b=33);this.lastTime=a;a=this.program.gl;var c=.00390625*b,d=1-c;const e=this.processedData,f=this.processedDataR,g=this.fft,k=this.BG_COLUMNS,h=this.BG_PARTICLES_BY_COLUMN,m=this.COLORS,l=this.program,p=this.bgPos,q=this.bgSpeedY,n=this.bgColor,
...
a.square&&(c+=" square");a.opaque||(c+=" transparent");a.className&&(c+=" "+a.className);b.className=c;b=CheckboxControl.prepare(b,a.icon,a.iconColor,a.checkbox0Color,a.checkbox1Color);!1===a.keyboardFocusable&&b.setAttribute("tabindex","-1");a.parent&&a.parent.appendChild(b);return b}static prepare(a,b,c,d,e){const f=document.createElement("button"),g=document.createElement("span"),k=a.parentNode,h=b?null:a.getAttribute("data-square"),m=Strings.translate(a.getAttribute("title")||a.value);f.setAttribute("type",
"button");f.setAttribute("role","checkbox");f.setAttribute("aria-label",m);g.setAttribute("tabindex","-1");a.setAttribute("tabindex","-1");a.setAttribute("aria-label",m);f.className=a.className;a.className="";b||(b=a.getAttribute("data-icon"));b&&!c&&(c=a.getAttribute("data-icon-color"));d||(d=a.getAttribute("data-checkbox0-color"));e||(e=a.getAttribute("data-checkbox1-color"))||(e="orange");k&&(k.insertBefore(f,a),k.removeChild(a));f.appendChild(g);g.appendChild(a);g.appendChild(Icon.createLarge("icon-checkbox-0",
(h?"":"margin")+(d?" "+d:"")));g.appendChild(Icon.createLarge("icon-checkbox-1",h?e:"margin "+e));b&&g.appendChild(Icon.createLarge(b,c?"margin "+c:"margin"));h||g.appendChild(document.createTextNode(m));a.removeAttribute("value");a.removeAttribute("title");f.onclick=CheckboxControl.click;f.childInput=a;return f}static click(a){(a=this.childInput)&&a.click()}}
...
0<this.keyboardIndex?this.keyboardIndex=0:-1;this.adjustScrollbarPadding()}}elementScroll(){var a=this._adapter,b=this.element;if(a&&b){var c=this.items,d=this.itemHeightAndMargin,e=this.firstIndex-2;b=b.scrollTop/d|0;0>e&&(e=0);this.firstIndex=b;var f=this.visibleCount+(0===b?2:1===b?3:4);f>c.length&&(f=c.length);0>(b-=2)&&(b=0);if(b>e){if((e=b-e)&&e<f)for(let p=e,q=0;p<f;p++,q++)e=c[q],c[q]=c[p],c[p]=e}else if((e-=b)&&e<f)for(let p=f-1,q=p-e;0<=q;q--,p--)e=c[p],c[p]=c[q],c[q]=e;var g=a.list,k=g.length,
h=a.list.currentItem,m=this.keyboardIndex;e=this.container;var l=0;for(let p=b*d;l<f&&b<k;l++,b++,p+=d){const q=g.item(b),n=c[l];if(n.item!==q){let r=h===q;n.current!==r&&((n.current=r)?n.element.classList.add("current"):n.element.classList.remove("current"));r=m===b;n.keyboard!==r&&((n.keyboard=r)?n.element.classList.add("keyboard"):n.element.classList.remove("keyboard"));a.prepareElement(q,b,k,n.element);n.item||e.appendChild(n.element);n.item=q}n.index!==b&&(n.index=b,n.element.style.transform=
"translateY("+p+"px)")}for(a=c.length;l<a;l++)d=c[l],d.item&&(d.item=null,e.removeChild(d.element));this.lastIndex=b-1;this.lastIndex<this.firstIndex&&(this.lastIndex=this.firstIndex)}}refreshVisibleItemsInternal(){this.refreshVisibleItemsEnqueued=!1;var a=this._adapter,b=this.element;if(a&&b){this.adjustContainerHeight();b=this.items;var c=this.itemHeightAndMargin,d=a.list,e=d.length,f=a.list.currentItem,g=this.keyboardIndex,k=this.container;if(this.useVirtualItems){this.currentListItem=f;var h=
0,m=this.firstIndex,l=this.visibleCount+(0===m?2:1===m?3:4);l>b.length&&(l=b.length);0>(m-=2)&&(m=0);for(let p=m*c;h<l&&m<e;h++,m++,p+=c){const q=d.item(m),n=b[h];let r=f===q;n.current!==r&&((n.current=r)?n.element.classList.add("current"):n.element.classList.remove("current"));r=g===m;n.keyboard!==r&&((n.keyboard=r)?n.element.classList.add("keyboard"):n.element.classList.remove("keyboard"));a.prepareElement(q,m,e,n.element);n.item||k.appendChild(n.element);n.item=q;n.index!==m&&(n.index=m,n.element.style.transform=
"translateY("+p+"px)")}for(a=b.length;h<a;h++)d=b[h],d.item&&(d.item=null,k.removeChild(d.element))}else{k=this.visibleCount;for(let p=0,q=this.indexFromY(0);p<=k&&q<e;p++,q++)a.prepareElement(d.item(q),q,e,b[q].element)}}}resize(){const a=this._adapter;var b=this.element;if(a&&b){var c=this.clientHeight;b=b.clientHeight;0>b&&(b=0);var d=Math.ceil(b/this.itemHeightAndMargin)+1;if(this.visibleCount!==d&&(this.visibleCount=d,this.useVirtualItems)){const e=this.items;for(;d+4>e.length;)e.push(new ListControlItem(a.createEmptyElement("list-item virtual")))}c!==
...
e=m.list,f=e.length,g=e.currentItem,k=Array(l);for(var h=b;h>=a;h--){const p=e.item(h),q=new ListControlItem(m.createEmptyElement("list-item real"));m.prepareElement(p,h,f,q.element);k[h-a]=q;g===p&&(this.currentItem&&(this.currentItem.current=!1,this.currentItem.element.classList.remove("current")),this.currentItem=q,q.current=!0,q.element.classList.add("current"))}g=a>=d.length?null:d[a].element;a>=d.length?d.push(...k):d.splice(a,0,...k);if(this.items.length!==e.length)throw Error("Assertion error: this.items.length !== list.length");
this.adjustContainerHeight();for(h=0;h<l;h++)c.insertBefore(k[h].element,g);for(c=d.length-1;c>b;c--)m.prepareElementIndexOrLengthChanged(e.item(c),c,f,d[c].element);for(--a;0<=a;a--)m.prepareElementIndexOrLengthChanged(e.item(a),a,f,d[a].element)}}}notifyItemsRemoved(a,b){if(this.useVirtualItems)this.refreshVisibleItems();else{const g=this.adapter;var c=b-a+1;if(g&&!(0>=c)){var d=this.container;b=this.items;var e=g.list,f=e.length;a=b.splice(a,c);for(c=a.length-1;0<=c;c--){const k=a[c];k.current&&
...
AppUI.optionalPanel.classList.remove("fade"),AppUI.optionalPanel.classList.remove("in")),AppUI.panelContainerToggled&&(AppUI.panelContainerToggled=!1,AppUI.panelContainer.classList.remove("toggled"),HistoryHandler.popState()))}static toggleView(a){if(AppUI.panelContainer){AppUI.panelContainerToggleVersion++;const b=AppUI.panelContainerToggleVersion,c=function(d,e,f){AppUI.panelContainerToggling=!0;e.classList.remove("in");e.classList.add("fade");d.classList.add("in");d.classList.add("fade");DelayControl.delayShortCB(async function(){AppUI.panelContainerToggleVersion===
b&&(d.classList.remove("in"),await DelayControl.delayFade(),AppUI.panelContainerToggleVersion===b&&(f?AppUI.panelContainer.classList.add("toggled"):AppUI.panelContainer.classList.remove("toggled"),d.classList.remove("fade"),await DelayControl.delayShort(),AppUI.panelContainerToggleVersion===b&&(e.classList.add("in"),await DelayControl.delayFade(),AppUI.panelContainerToggleVersion===b&&(e.classList.remove("fade"),e.classList.remove("in"),AppUI.panelContainerToggling=!1))))})};AppUI.panelContainerToggled?
(AppUI.panelContainerToggled=!1,c(AppUI.optionalPanel,AppUI.fixedPanel,!1),a&&HistoryHandler.popState()):(AppUI.panelContainerToggled=!0,c(AppUI.fixedPanel,AppUI.optionalPanel,!0),HistoryHandler.pushState())}}static showAbout(){Modal.show({html:Strings.AboutHTML+(App.player&&App.player.audioContext?"<br/><br/><small>Base latency: "+(App.player.audioContext.baseLatency||0).toFixed(4)+" s<br/>Output latency: "+(isNaN(App.player.audioContext.outputLatency)?"-":App.player.audioContext.outputLatency.toFixed(4)+
" s")+"</small>":""),title:Strings.About+" (v"+window.CACHE_VERSION+")"})}}AppUI.primaryInputIsTouch="matchMedia"in window?window.matchMedia("(pointer: coarse)").matches:0<navigator.maxTouchPoints||0<navigator.msMaxTouchPoints;AppUI.baseSizePX=4;AppUI.s1PX=AppUI.baseSizePX;AppUI.s2PX=2*AppUI.baseSizePX;AppUI.s3PX=3*AppUI.baseSizePX;AppUI.s4PX=4*AppUI.baseSizePX;AppUI.s5PX=5*AppUI.baseSizePX;AppUI.s6PX=6*AppUI.baseSizePX;AppUI.s7PX=7*AppUI.baseSizePX;AppUI.s8PX=8*AppUI.baseSizePX;
AppUI.smallFontSizeREM=3;AppUI.smallContentsSizeREM=4;AppUI.fontSizeREM=3.5;AppUI.contentsSizeREM=6;AppUI.baseThinBorderPX=1;AppUI.baseThickBorderPX=2;AppUI.zoomHandlers=[];AppUI.rootVariables=document.getElementById("root-variables");AppUI.panelContainer=document.getElementById("panel-container");AppUI.fixedPanel=document.getElementById("fixed-panel");AppUI.middlePanel=document.getElementById("middle-panel");AppUI.optionalPanel=document.getElementById("optional-panel");AppUI.iconPlay=document.getElementById("i-play");
AppUI.iconPause=document.getElementById("i-pause");AppUI.ruler=document.getElementById("ruler");AppUI.titleLabel=document.getElementById("title-label");AppUI.artistLabel=document.getElementById("artist-label");AppUI.topMessage=document.getElementById("top-message");AppUI._loading=!1;AppUI.devicePixelRatio=-1;AppUI._1remInPX=1;AppUI._fontScale=1;AppUI._smallIconSizePX=Icon.baseSizePX;AppUI._largeIconSizePX=Icon.baseSizePX<<1;AppUI._thinBorderPX=AppUI.baseThinBorderPX;AppUI._thickBorderPX=AppUI.baseThickBorderPX;
