...
class MetadataExtractor{static extractRIFF(a,b,c){return __awaiter(this,void 0,void 0,function*(){if(44>b.totalLength)return null;var d=b.readUInt32LE();if(null===d||b.totalLength<8+d)return null;var e=d;let f=!1,g=!1,h=d=0,k=0;a:for(;0<e;){var m=!1,l=0,p=void 0;switch(b.readUInt32BE()){case null:break a;case 1463899717:m=!0;e-=4;break;case 1279873876:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;break;case 1768174368:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;
(p=b.fillBuffer(1024))&&(yield p);if(4<l){m=b.readByte();var q=b.readByte();p=b.readByte();if(null===m||null===q||null===p)break a;e-=3;l-=3;if(73===m||68===q||51===p)if(d=b.totalLength-e,f&&g){d=-1;break a}}b.skip(l);(p=b.fillBuffer(1024))&&(yield p);continue;default:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;b.skip(l);(p=b.fillBuffer(1024))&&(yield p);continue}for((p=b.fillBuffer(1024))&&(yield p);m&&(!f||!g)||0<l;){var n=b.readUInt32BE();q=0;if(null===n)break a;e-=4;l-=4;if(1229866575!==
n){q=b.readUInt32LE();if(null===q||0>q||q>e||!m&&q>l)break a;e-=4;l-=4}1684108385!==n&&(p=b.fillBuffer(Math.min(264,8+q)))&&(yield p);switch(n){case 1718449184:if(!m)break;p=b.readUInt16LE();n=b.readUInt16LE();var r=b.readUInt32LE(),t=b.readUInt32LE();const u=b.readUInt16LE(),y=b.readUInt16LE();q-=16;e-=16;l-=16;if(null===p||null===n||null===r||null===t||null===u||null===y)break a;f=!0;k||(k=t);break;case 1684108385:m&&(g=!0,h||(h=q));break;case 1229866575:function x(v){b.read(c,0,v);return MetadataExtractor.finishReadingV2Frame(0,
v,c)}for(;0<l;){(p=b.fillBuffer(8))&&(yield p);n=b.readUInt32BE();e-=4;l-=4;if(null===n)break a;r=b.readUInt32LE();e-=4;l-=4;if(null===r||0>r||r>l)break a;if(1>=r)b.skip(r);else{t=Math.min(257,r)-1;(p=b.fillBuffer(t))&&(yield p);switch(n){case 1229865293:a.title=x(t);break;case 1230000708:a.album=x(t);break;case 1229017684:a.artist=x(t);break;case 1229148740:a.year=parseInt(x(t))||0;break;case 1230262859:a.track=parseInt(x(t))||0;break;default:t=0}b.skip(r-t);e-=r;l-=r}}}0<q&&(b.skip(q),e-=q,l-=q);
...
g,c),d.year=h&&h.then?parseInt(yield h):parseInt(h),d.year?f|=MetadataExtractor.YEAR_B:d.year=0);break;default:b.skip(g)}e-=10+g}(f&MetadataExtractor.ALL_BUT_LENGTH_B)!==MetadataExtractor.ALL_BUT_LENGTH_B&&(yield MetadataExtractor.extractID3v1(d,b,f,c[0]))}return d})}static createBasicMetadata(a){return{url:FileUtils.urlOrPathToURL(a["data-path"])||"",flags:MetadataFlags.Seekable}}static extract(a,b,c){return __awaiter(this,void 0,void 0,function*(){if(!a)return null;b||(b=new Uint8Array(BufferedReader.minBufferLength));
c||(c=[new Uint8Array(256)]);if(!a.name.endsWith(".mp3")&&!a.name.endsWith(".aac")&&!a.name.endsWith(".wav")){if(a.name.endsWith(".flac"))return FLACMetadataExtractor.extract(a,b,c);if(a.name.endsWith(".ogg"))return OggMetadataExtractor.extract(a,b,c);const d=a.name.toLowerCase();if(!d.endsWith(".mp3")&&!d.endsWith(".aac")&&!d.endsWith(".wav"))return d.endsWith(".flac")?FLACMetadataExtractor.extract(a,b,c):d.endsWith(".ogg")?OggMetadataExtractor.extract(a,b,c):null}try{const d=new BufferedFileReader(a,
b);yield d.fillBuffer(-1);return yield MetadataExtractor.extractID3v2Andv1(a,d,c)}catch(d){return null}})}}MetadataExtractor.ALL_B=63;MetadataExtractor.ALL_BUT_LENGTH_B=31;MetadataExtractor.TITLE_B=1;MetadataExtractor.ARTIST_B=2;MetadataExtractor.ALBUM_B=4;MetadataExtractor.TRACK_B=8;MetadataExtractor.YEAR_B=16;MetadataExtractor.LENGTH_B=32;MetadataExtractor.textDecoderIso88591=new TextDecoder("iso-8859-1");MetadataExtractor.textDecoderUtf16=new TextDecoder("utf-16");
MetadataExtractor.textDecoderUtf16be=new TextDecoder("utf-16be");MetadataExtractor.textDecoderUtf8=new TextDecoder("utf-8");
class VorbisCommentExtractor extends MetadataExtractor{static extractVorbisComment(a,b,c,d){return __awaiter(this,void 0,void 0,function*(){var e=c.fillBuffer(1024);e&&(yield e);e=c.readUInt32LE();a-=4;if(!e||e>a)return 0;c.skip(e);a-=e;if(!a)return 1;(e=c.fillBuffer(1024))&&(yield e);let f=c.readUInt32LE();a-=4;if(null===f||0>a||f>a)return 0;let g=null,h=null,k=null;for(;0<f;){f--;(e=c.fillBuffer(4))&&(yield e);const m=c.readUInt32LE();a-=4;if(null===m||0>a||m>a)return 0;const l=Math.min(2048,m);
let p=d[0];p.length<l&&(p=new Uint8Array(l),d[0]=p);(e=c.fillBuffer(l+4))&&(yield e);c.read(p,0,l);m>l&&c.skip(m-l);a-=m;try{let q;for(q=0;q<l;q++)if(61===p[q]){if(q&&q<l-1){let n;switch(MetadataExtractor.textDecoderUtf8.decode(p.subarray(0,q)).normalize().trim().toUpperCase()){case "TITLE":if(n=MetadataExtractor.textDecoderUtf8.decode(p.subarray(q+1,l)).normalize().trim())b.title=n;break;case "ARTIST":if(n=MetadataExtractor.textDecoderUtf8.decode(p.subarray(q+1,l)).normalize().trim())b.artist=b.artist?
b.artist+(", "+n):n;break;case "PERFORMER":if(n=MetadataExtractor.textDecoderUtf8.decode(p.subarray(q+1,l)).normalize().trim())g=n;break;case "ALBUMARTIST":if(n=MetadataExtractor.textDecoderUtf8.decode(p.subarray(q+1,l)).normalize().trim())h=n;break;case "COMPOSER":if(n=MetadataExtractor.textDecoderUtf8.decode(p.subarray(q+1,l)).normalize().trim())k=n;break;case "ALBUM":if(n=MetadataExtractor.textDecoderUtf8.decode(p.subarray(q+1,l)).normalize().trim())b.album=n;break;case "TRACKNUMBER":if(n=MetadataExtractor.textDecoderUtf8.decode(p.subarray(q+
1,l)).normalize().trim())b.track=parseInt(n)||0;break;case "DATE":if(n=MetadataExtractor.textDecoderUtf8.decode(p.subarray(q+1,l)).normalize().trim())b.year=parseInt(n)||0}}break}}catch(q){}}b.artist||(g?b.artist=g:h?b.artist=h:k&&(b.artist=k));return 1})}}
class FLACMetadataExtractor extends VorbisCommentExtractor{static readHeaderAndStreamInfo(a,b,c){if(1716281667!==b.readUInt32BE())return 0;var d=b.readUInt32BE();if(!d)return 0;c=d&2147483648;if(34!==(d&2147483647))return 0;b.skip(10);d=b.readUInt32BE();let e=b.readUInt32BE();if(!d||null===e)return 0;b.skip(16);e+=4294967296*(d&15);d>>=4;b=(d&31)+1;d=d>>5>>3;if(4>b||!d)return 0;e&&(a.lengthMS=Math.floor(1E3*e/d));return c?-1:1}static readMetadataBlock(a,b,c){return __awaiter(this,void 0,void 0,function*(){var d=
b.fillBuffer(4);d&&(yield d);d=b.readUInt32BE();if(!d)return 0;const e=d&2147483648;d&=2147483647;const f=d>>24;d&=16777215;if(127===f||d+b.readPosition>b.totalLength)return 0;if(4===f)return(yield VorbisCommentExtractor.extractVorbisComment(d,a,b,c))?-1:0;b.skip(d);return e?-1:1})}static extract(a,b,c){return __awaiter(this,void 0,void 0,function*(){try{const d=new BufferedFileReader(a,b);yield d.fillBuffer(-1);const e=MetadataExtractor.createBasicMetadata(a);let f=FLACMetadataExtractor.readHeaderAndStreamInfo(e,
d,c[0]);if(!f)return null;if(0>f)return e;do if(f=yield FLACMetadataExtractor.readMetadataBlock(e,d,c),!f)return null;while(0<f);return e}catch(d){return null}})}}
class OggBufferedReader extends BufferedFileReader{constructor(a,b){super(a,b);this.additionalSkipLength=this.currentPageLength=0}readPageLength(){if(super.bufferAvailable<OggBufferedReader.basicPageStructureLength||1332176723!==super.readUInt32BE())return-1;super.skip(22);let a=super.readByte();if(super.bufferAvailable<a)return-1;if(!a)return 0;let b=0;for(;0<a--;)b+=super.readByte();return b}findInitialVorbisCommentPage(){const a=Object.create(null,{fillBuffer:{get:()=>super.fillBuffer},bufferAvailable:{get:()=>
super.bufferAvailable},readByte:{get:()=>super.readByte},readUInt32BE:{get:()=>super.readUInt32BE},readUInt16BE:{get:()=>super.readUInt16BE},skip:{get:()=>super.skip}});return __awaiter(this,void 0,void 0,function*(){for(;;){var b=a.fillBuffer.call(this,OggBufferedReader.maximumOggPageHeaderLength+OggBufferedReader.vorbisIdentifierLength);b&&(yield b);b=this.readPageLength();if(0>b)return!1;if(b)if(b>OggBufferedReader.vorbisIdentifierLength){if(a.bufferAvailable<OggBufferedReader.vorbisIdentifierLength)return!1;
if(3===a.readByte.call(this)){const c=a.readUInt32BE.call(this),d=a.readUInt16BE.call(this);if(1987015266===c&&26995===d)return this.currentPageLength=b-7,(b=this.fillBuffer(this.currentPageLength))&&(yield b),!0;a.skip.call(this,b-7)}else a.skip.call(this,b-1)}else a.skip.call(this,b)}})}seekTo(a){throw Error("Unsupported operation");}skip(a){if(!(0>=a)){if(0<this.additionalSkipLength)this.additionalSkipLength+=a;else{if(a<=this.currentPageLength){this.currentPageLength-=a;super.skip(a);return}this.additionalSkipLength=
a-this.currentPageLength;super.skip(this.currentPageLength);this.currentPageLength=0}for(;super.bufferAvailable>OggBufferedReader.maximumOggPageHeaderLength;){this.currentPageLength=this.readPageLength();if(0>this.currentPageLength){super.skip(super.totalLength);break}if(this.currentPageLength){if(this.additionalSkipLength<=this.currentPageLength){this.currentPageLength-=this.additionalSkipLength;super.skip(this.additionalSkipLength);this.additionalSkipLength=0;break}this.additionalSkipLength-=this.currentPageLength;
super.skip(this.currentPageLength);this.currentPageLength=0}}}}skipAdditionalSkipLength(){const a=Object.create(null,{fillBuffer:{get:()=>super.fillBuffer},skip:{get:()=>super.skip}});return __awaiter(this,void 0,void 0,function*(){for(;0<this.additionalSkipLength;){let b=a.fillBuffer.call(this,OggBufferedReader.maximumOggPageHeaderLength+OggBufferedReader.maximumOggPageHeaderLength+4);b&&(yield b);if(!this.currentPageLength&&!this.readNextPageLength()){this.additionalSkipLength=0;break}if(this.additionalSkipLength<=
this.currentPageLength){this.currentPageLength-=this.additionalSkipLength;a.skip.call(this,this.additionalSkipLength);this.additionalSkipLength=0;(b=a.fillBuffer.call(this,OggBufferedReader.maximumOggPageHeaderLength+OggBufferedReader.maximumOggPageHeaderLength+4))&&(yield b);break}this.additionalSkipLength-=this.currentPageLength;a.skip.call(this,this.currentPageLength);this.currentPageLength=0}})}readNextPageLength(){for(;super.bufferAvailable>OggBufferedReader.maximumOggPageHeaderLength;){this.currentPageLength=
this.readPageLength();if(0>this.currentPageLength){super.skip(super.totalLength);break}if(this.currentPageLength){if(!super.bufferAvailable)break;return!0}}return!1}fillBuffer(a){if(0<this.additionalSkipLength)return this.skipAdditionalSkipLength().then(()=>this.fillBuffer(a));const b=super.fillBuffer(Math.min(a+OggBufferedReader.maximumOggPageHeaderLength+OggBufferedReader.maximumOggPageHeaderLength+4,super.bufferLength));if(b)return b.then(()=>this.fillBuffer(a));this.currentPageLength||this.readNextPageLength();
return null}readByte(){if(!this.currentPageLength&&!this.readNextPageLength())return-1;this.currentPageLength--;return super.readByte()}readUInt32BE(){if(4<=this.currentPageLength)return this.currentPageLength-=4,super.readUInt32BE();const a=this.readByte(),b=this.readByte(),c=this.readByte(),d=this.readByte();return 0>a||0>b||0>c||0>d?null:a<<24|b<<16|c<<8|d}readUInt32LE(){if(4<=this.currentPageLength)return this.currentPageLength-=4,super.readUInt32LE();const a=this.readByte(),b=this.readByte(),
c=this.readByte(),d=this.readByte();return 0>a||0>b||0>c||0>d?null:a|b<<8|c<<16|d<<24}readUInt16BE(){if(2<=this.currentPageLength)return this.currentPageLength-=2,super.readUInt16BE();const a=this.readByte(),b=this.readByte();return 0>a||0>b?null:a<<8|b}readUInt16LE(){if(2<=this.currentPageLength)return this.currentPageLength-=2,super.readUInt16LE();const a=this.readByte(),b=this.readByte();return 0>a||0>b?null:a|b<<8}readAsync(a,b,c,d,e){const f=Object.create(null,{eof:{get:()=>super.eof},fillBuffer:{get:()=>
super.fillBuffer},read:{get:()=>super.read}});return __awaiter(this,void 0,void 0,function*(){"number"!==typeof a&&(a=yield a);d-=a;this.currentPageLength-=a;c+=a;for(e+=a;0<d&&!f.eof;){if(!this.currentPageLength&&(this.bufferAvailable<OggBufferedReader.maximumOggPageHeaderLength&&(yield f.fillBuffer.call(this,OggBufferedReader.maximumOggPageHeaderLength+OggBufferedReader.maximumOggPageHeaderLength+4)),!this.readNextPageLength()))return e;a=f.read.call(this,b,c,Math.min(d,this.currentPageLength));
"number"!==typeof a&&(a=yield a);d-=a;this.currentPageLength-=a;c+=a;e+=a}this.currentPageLength||(this.bufferAvailable<OggBufferedReader.maximumOggPageHeaderLength&&(yield f.fillBuffer.call(this,OggBufferedReader.maximumOggPageHeaderLength+OggBufferedReader.maximumOggPageHeaderLength+4)),this.readNextPageLength());return e})}read(a,b,c){if(0<this.additionalSkipLength)return this.skipAdditionalSkipLength().then(()=>this.read(a,b,c));if(c<=this.currentPageLength)return this.currentPageLength-=c,super.read(a,
b,c);let d=0;for(;0<c&&!super.eof;){if(!this.currentPageLength){if(this.bufferAvailable<OggBufferedReader.maximumOggPageHeaderLength)return this.readAsync(0,a,b,c,d);if(!this.readNextPageLength())return d}let e=super.read(a,b,Math.min(c,this.currentPageLength));if("number"!==typeof e)return this.readAsync(e,a,b,c,d);c-=e;this.currentPageLength-=e;b+=e;d+=e}!this.currentPageLength&&this.bufferAvailable>OggBufferedReader.maximumOggPageHeaderLength&&this.readNextPageLength();return d}}
OggBufferedReader.basicPageStructureLength=27;OggBufferedReader.maximumOggPageHeaderLength=OggBufferedReader.basicPageStructureLength+255;OggBufferedReader.vorbisIdentifierLength=7;
class OggMetadataExtractor extends VorbisCommentExtractor{static extract(a,b,c){return __awaiter(this,void 0,void 0,function*(){try{const d=new OggBufferedReader(a,b);if(!(yield d.findInitialVorbisCommentPage()))return null;const e=MetadataExtractor.createBasicMetadata(a);return(yield VorbisCommentExtractor.extractVorbisComment(d.totalLength-d.readPosition,e,d,c))?e:null}catch(d){return null}})}}
...
this.firstIndex=f;var g=this.visibleCount+(0===f?2:1===f?3:4);g>c.length&&(g=c.length);0>(f-=2)&&(f=0);if(f>e){if((e=f-e)&&e<g)for(let p=e,q=0;p<g;p++,q++)e=c[q],c[q]=c[p],c[p]=e}else if((e-=f)&&e<g)for(let p=g-1,q=p-e;0<=q;q--,p--)e=c[p],c[p]=c[q],c[q]=e;var h=a.list,k=h.length,m=a.list.currentItem,l=this.keyboardIndex;e=0;for(let p=f*d;e<g&&f<k;e++,f++,p+=d){const q=h.item(f),n=c[e];if(n.item!==q){let r=m===q;n.current!==r&&((n.current=r)?n.element.classList.add("current"):n.element.classList.remove("current"));
r=l===f;n.keyboard!==r&&((n.keyboard=r)?(n.element.classList.add("keyboard"),n.element.setAttribute("aria-selected","true"),this.element.setAttribute("aria-activedescendant",n.element.getAttribute("id"))):(this.element.getAttribute("aria-activedescendant")===n.element.getAttribute("id")&&this.element.removeAttribute("aria-activedescendant"),n.element.classList.remove("keyboard"),n.element.setAttribute("aria-selected","false")));a.prepareElement(q,f,k,n.element);n.element.setAttribute("aria-rowindex",
f.toString());n.item||b.appendChild(n.element);n.item=q}n.index!==f&&(n.index=f,n.element.style.transform="translateY("+p+"px)")}for(a=c.length;e<a;e++)d=c[e],d.item&&(d.item=null,b.removeChild(d.element));this.lastIndex=f-1;this.lastIndex<this.firstIndex&&(this.lastIndex=this.firstIndex)}}refreshVisibleItemsInternal(){this.refreshVisibleItemsEnqueued=!1;var a=this._adapter,b=this.element;if(a&&b){this.adjustContainerHeight();var c=this.items,d=this.itemHeightAndMargin,e=a.list,f=e.length,g=a.list.currentItem,
h=this.keyboardIndex;if(this.useVirtualItems){this.currentListItem=g;var k=0,m=this.firstIndex,l=this.visibleCount+(0===m?2:1===m?3:4);l>c.length&&(l=c.length);0>(m-=2)&&(m=0);for(let p=m*d;k<l&&m<f;k++,m++,p+=d){const q=e.item(m),n=c[k];let r=g===q;n.current!==r&&((n.current=r)?n.element.classList.add("current"):n.element.classList.remove("current"));r=h===m;n.keyboard!==r&&((n.keyboard=r)?(n.element.classList.add("keyboard"),n.element.setAttribute("aria-selected","true"),this.element.setAttribute("aria-activedescendant",
n.element.getAttribute("id"))):(this.element.getAttribute("aria-activedescendant")===n.element.getAttribute("id")&&this.element.removeAttribute("aria-activedescendant"),n.element.classList.remove("keyboard"),n.element.setAttribute("aria-selected","false")));a.prepareElement(q,m,f,n.element);n.element.setAttribute("aria-rowindex",m.toString());n.item||b.appendChild(n.element);n.item=q;n.index!==m&&(n.index=m,n.element.style.transform="translateY("+p+"px)")}for(a=c.length;k<a;k++)e=c[k],e.item&&(e.item=
null,b.removeChild(e.element))}else{b=this.visibleCount;k=0<=h&&h<c.length?c[h]:null;this.keyboardItem!==k&&(this.keyboardItem&&(this.keyboardItem.element.classList.remove("keyboard"),this.keyboardItem.element.setAttribute("aria-selected","false")),k?(k.element.classList.add("keyboard"),k.element.setAttribute("aria-selected","true"),this.element.setAttribute("aria-activedescendant",k.element.getAttribute("id"))):this.element.removeAttribute("aria-activedescendant"),this.keyboardItem=k);for(let p=
0,q=this.indexFromY(0);p<=b&&q<f;p++,q++)k=c[q].element,a.prepareElement(e.item(q),q,f,k),k.setAttribute("aria-rowindex",q.toString())}}}resize(){const a=this._adapter;var b=this.element;if(a&&b){var c=this.clientHeight;b=b.clientHeight;0>b&&(b=0);var d=Math.ceil(b/this.itemHeightAndMargin)+1;if(this.visibleCount!==d&&(this.visibleCount=d,this.useVirtualItems)){const e=this.items;for(;d+4>e.length;)e.push(new ListControlItem(a.createEmptyElement("list-item virtual")))}c!==b&&(this.clientHeight=b,
