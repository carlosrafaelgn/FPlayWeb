...
b,c,d){d=d||document.createElement("i");const e=document.createElementNS("http://www.w3.org/2000/svg","svg"),g=document.createElementNS("http://www.w3.org/2000/svg","use");g.setAttribute("href","#"+a);e.appendChild(g);c&&d.setAttribute("id",c);d.className=b?"icon "+b:"icon";d.appendChild(e);return d}static createLarge(a,b,c){return Icon.create(a,b?b+" large":"large",c)}}Icon.outerSizeREM=6;Icon.baseSizePX=12;
...
c||c>=f?e.appendChild(document.createTextNode(Strings.translate(g))):(b=g.substring(b,c),c=g.substring(c+1,f),e.setAttribute(b,Strings.translate(c)));b=f+1}while(b<g.length)}}}static changeText(a,b){if(a){null===b&&(b="");var c=a.lastChild;c?c.nodeValue=b:a.appendChild(document.createTextNode(b))}}}Strings.language="en";Strings.DecimalSeparator=".";Strings.OppositeDecimalSeparator=",";Strings.Oops="Oops\u2026";Strings.AppName="FPlay";Strings.Menu="Menu";Strings.About="About";Strings.Edit="Edit";
Strings.Delete="Delete";Strings.Enable="Enable";Strings.Disable="Disable";Strings.Enabled="Enabled";Strings.Disabled="Disabled";Strings.AdvancedFilter="Advanced filter";Strings.TraditionalFilter="Traditional filter";Strings.Missing="Missing";Strings.MissingSongError="The song is missing! \ud83d\ude22 Please, just add it again before playing it. When you add a missing song, it keeps its position in the playlist! \ud83d\ude0a";Strings.OK="OK";Strings.Cancel="Cancel";Strings.Clear="Clear";
Strings.Back="Back";Strings.Close="Close";Strings.Refresh="Refresh";Strings.Exit="Exit";Strings.Previous="Previous";Strings.Play="Play";Strings.Pause="Pause";Strings.PlayPause="Play / Pause";Strings.Stop="Stop";Strings.Next="Next";Strings.LeftAbbrev="L";Strings.RightAbbrev="R";Strings.Volume="Volume";Strings.Panning="Panning";Strings.DownMixToMono="Down-mix to mono";Strings.UnknownError="Unknown error";Strings.AddFiles="Add files";Strings.AddFolders="Add folders";Strings.ShowEffects="Show effects";
Strings.ShowPlaylist="Show playlist";Strings.UpdateAvailable="Update available!";Strings.PleaseRefresh="Please, refresh the page to update the app. \ud83d\ude0a";Strings.AboutHTML='FPlay for web is an experimental audio player. \ud83d\ude0a<br />\n<br />\nFor more information about the project, its source code and dependencies, check out its repository at <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb">github.com/carlosrafaelgn/FPlayWeb</a>.<br />\n<br />\nThis project is licensed under the <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb/blob/master/LICENSE">MIT License</a>.';
...
class Modal{constructor(a){this.options=a;this.focusBlocker=new FocusBlocker;this.focusBlocker.block();HistoryHandler.pushState();this.containerElement=document.createElement("div");this.containerElement.className=a.transparentBackground?"modal-container fade":"modal-container fade background";this.modalElement=document.createElement("form");this.modalElement.className="modal";this.modalElement.onsubmit=this.submit.bind(this);this.modalHeaderElement=document.createElement("div");this.modalHeaderElement.className=
"modal-header";this.modalHeaderElement.innerHTML=a.title||(a.titleStringKey?Strings.translate(a.titleStringKey):Strings.Oops);this.modalBodyElement=document.createElement("div");this.modalBodyElement.className="modal-body";a.html||(a.html=document.createElement("div"),a.text&&Strings.changeText(a.html,a.text));"string"===typeof a.html?this.modalBodyElement.innerHTML=a.html:this.modalBodyElement.appendChild(a.html);var b=this.modalBodyElement.getElementsByTagName("button");if(b&&b.length)for(let c=
b.length-1;0<=c;c--){const d=b[c];ButtonControl.prepare(d);d.onclick=()=>{if(!this.fading&&this.options.onbuttonclick)this.options.onbuttonclick(d.id,d)}}this.modalFooterElement=document.createElement("div");this.modalFooterElement.className=a.buttons&&1===a.buttons.length?"modal-footer right":"modal-footer";this.defaultSubmitButton=this.defaultCancelButton=null;if(a.buttons)for(b=0;b<a.buttons.length;b++){const c=a.buttons[b],d=ButtonControl.create(c,!0);c.defaultCancel&&(this.defaultCancelButton=
d);c.defaultSubmit&&(this.defaultSubmitButton=d);b&&(d.style.float="right");d.onclick=()=>{if(!this.fading){if(c.onclick)c.onclick(c.id,d);if(this.options.onbuttonclick)this.options.onbuttonclick(c.id,d)}};this.modalFooterElement.appendChild(d)}this.modalElement.appendChild(this.modalHeaderElement);this.modalElement.appendChild(this.modalBodyElement);this.modalElement.appendChild(this.modalFooterElement);this.containerElement.appendChild(this.modalElement);document.body.appendChild(this.containerElement);
this.boundDocumentKeyDown=this.documentKeyDown.bind(this);document.addEventListener("keydown",this.boundDocumentKeyDown,!0);this.fading=!0;setTimeout(()=>{if(a.onshowing)a.onshowing();this.containerElement.classList.add("in");setTimeout(()=>{this.fading=!1;if(this.options.onshown)this.options.onshown()},320)},20)}static get visible(){return!!Modal.modal}static get currentModalElement(){return Modal.modal?Modal.modal.modalElement:null}static get currentModalHeaderElement(){return Modal.modal?Modal.modal.modalHeaderElement:
null}static get currentModalBodyElement(){return Modal.modal?Modal.modal.modalBodyElement:null}static get currentModalFooterElement(){return Modal.modal?Modal.modal.modalFooterElement:null}static show(a){if(Modal.modal)return!1;a.okcancel?a.buttons=[{id:"cancel",defaultCancel:!0,icon:"icon-clear",text:a.canceltext||Strings.Cancel,color:"red",onclick:a.oncancel||Modal.hide},{id:"ok",defaultSubmit:a.okcancelsubmit,icon:"icon-check",text:a.oktext||Strings.OK,color:"green",onclick:a.onok||Modal.hide}]:
a.buttons&&a.buttons.length||(a.buttons=[{id:"cancel",defaultCancel:!0,icon:"icon-clear",text:Strings.Close,onclick:Modal.hide}]);Modal.modal=new Modal(a);return!0}static hide(){Modal.modal&&Modal.modal.hideInternal()}static defaultCancelAction(){return Modal.modal?Modal.modal.defaultCancelActionInternal():!1}static historyStatePopped(){if(!Modal.modal)return null;Modal.modal.fading||Modal.defaultCancelAction();return!1}hideInternal(){Modal.modal!==this||this.fading||this.options.onhiding&&!1===this.options.onhiding()||
(document.removeEventListener("keydown",this.boundDocumentKeyDown,!0),this.fading=!0,this.containerElement.classList.remove("in"),setTimeout(()=>{Modal.modal=null;if(this.options.onhidden)this.options.onhidden();document.body.removeChild(this.containerElement);HistoryHandler.popState();this.focusBlocker&&this.focusBlocker.unblock();if(this.options.buttons)for(let a=this.options.buttons.length-1;0<=a;a--)zeroObject(this.options.buttons[a]);zeroObject(this.options);zeroObject(this)},320))}documentKeyDown(a){"Escape"===
a.key&&this.defaultCancelActionInternal()}defaultCancelActionInternal(){return this.defaultCancelButton?(this.defaultCancelButton.click(),!0):!1}submit(a){cancelEvent(a);this.defaultSubmitButton&&this.defaultSubmitButton.click();return!1}}Modal.modal=null;
...
App.player&&App.player.previous(),cancelEvent(a);case "F2":return!a.repeat&&App.player&&App.player.playPause(),cancelEvent(a);case "F3":return!a.repeat&&App.player&&App.player.stop(),cancelEvent(a);case "F4":return!a.repeat&&App.player&&App.player.next(),cancelEvent(a)}}static preInit(a,b){AppUI.webFrame=a;window.addEventListener("keydown",AppUI.globalKeyHandler,!0);a&&b.devicePixelRatio&&b.devicePixelRatio!==devicePixelRatio&&a.setZoomFactor(b.devicePixelRatio);ButtonControl.init();CheckboxControl.init();
AppUI.seekSlider=new SliderControl("seek-slider",!1,!1,0,1);AppUI.seekSlider.disabled=!0;AppUI.seekSlider.onvaluechanged=AppUI.seekSliderValueChanged;AppUI.seekSlider.ondragended=AppUI.seekSliderDragEnded;AppUI.currentTimeLabel=document.createElement("span");AppUI.currentTimeLabel.className="seek-label";AppUI.currentTimeS=0;Strings.changeText(AppUI.currentTimeLabel,Formatter.none);AppUI.seekSlider.leftChild=AppUI.currentTimeLabel;AppUI.songLengthLabel=document.createElement("span");AppUI.songLengthLabel.className=
"seek-label";Strings.changeText(AppUI.songLengthLabel,Formatter.none);AppUI.seekSlider.rightChild=AppUI.songLengthLabel;AppUI.volumeSlider=new SliderControl("volume-slider",!0,!1,0,Player.maxVolume,b.playerVolume);AppUI.volumeSlider.leftChild=Icon.createLarge("icon-volume","green small-right-margin");AppUI.volumeLabel=document.createElement("span");AppUI.volumeLabel.className="small-left-margin";AppUI.volumeLabel.setAttribute("id","volume-label");Strings.changeText(AppUI.volumeLabel,AppUI.volumeStr(AppUI.volumeSlider.value));
AppUI.volumeSlider.rightChild=AppUI.volumeLabel;AppUI.volumeSlider.onvaluechanged=AppUI.volumeSliderValueChanged;AppUI.playlistControl=new ListControl("playlist-control",!0);AppUI.playlistControl.onitemclicked=AppUI.playlistControlItemClicked;AppUI.playlistControl.onitemcontextmenu=AppUI.playlistControlItemContextMenu;AppUI.graphicalFilterControlType=document.getElementById("graphical-filter-control-type");ButtonControl.setText(AppUI.graphicalFilterControlType,b.graphicalFilterControlSimpleMode?Strings.TraditionalFilter:
Strings.AdvancedFilter);AppUI.graphicalFilterControlType.onclick=AppUI.graphicalFilterControlTypeClicked;AppUI.graphicalFilterControlEnabled=document.getElementById("graphical-filter-control-enabled");AppUI.graphicalFilterControlEnabled.checked=b.graphicalFilterControlEnabled||!1;AppUI.graphicalFilterControlEnabled.onclick=AppUI.graphicalFilterControlEnabledClicked;AppUI.stereoPannerControlEnabled=document.getElementById("stereo-panner-control-enabled");AppUI.stereoPannerControlEnabled.checked=b.stereoPannerControlEnabled||
!1;AppUI.stereoPannerControlEnabled.onclick=AppUI.stereoPannerControlEnabledClicked;MonoDownMixerControl.isSupported()?(AppUI.monoDownMixerControlEnabled=document.getElementById("mono-down-mixer-control-enabled"),AppUI.monoDownMixerControlEnabled.checked=b.monoDownMixerControlEnabled||!1,AppUI.monoDownMixerControlEnabled.onclick=AppUI.monoDownMixerControlEnabledClicked):(a=document.getElementById("mono-down-mixer-control-container"),a.parentNode.removeChild(a));App.frameless||AppUI.panelContainer.classList.add("web");
window.addEventListener("resize",AppUI.adjustWindow,{passive:!0});AppUI.adjustWindow()}static init(a){App.player&&(AppUI.volumeSlider.value=App.player.volume,App.player.onsongchanged=AppUI.playerSongChanged,App.player.onloadingchanged=AppUI.playerLoadingChanged,App.player.onpausedchanged=AppUI.playerPausedChanged,App.player.oncurrenttimeschanged=AppUI.playerCurrentTimeSChanged,App.player.onerror=AppUI.playerError,AppUI.preparePlaylist(),AppUI.playerSongChanged(App.player.currentSong),App.player.playlist&&
0<=App.player.playlist.currentIndex&&AppUI.playlistControl.centerItemIntoView(App.player.playlist.currentIndex),HistoryHandler.init(Menu.historyStatePopped,Modal.historyStatePopped))}static destroy(){zeroObject(AppUI)}static get loading(){return AppUI._loading}static get thinBorderPX(){return AppUI._thinBorderPX}static get thickBorderPX(){return AppUI._thickBorderPX}static addZoomHandler(a){a&&AppUI.zoomHandlers.push(a)}static removeZoomHandler(a){if(a)for(let b=AppUI.zoomHandlers.length-1;0<=b;b--)if(AppUI.zoomHandlers[b]===
a){AppUI.zoomHandlers.splice(b,1);break}}static factorToZoom(a){return 1>=a?0:Math.round(4*a)-4}static zoomToFactor(a){return 0>=a?1:.25*(a+4)}static remToPX(a){return a*AppUI.rem}static pxToREM(a){return a/AppUI.rem}static playerSongChanged(a){App.player&&AppUI.playlistControl&&(Strings.changeText(AppUI.artistLabel,a&&a.artist||Formatter.none),Strings.changeText(AppUI.titleLabel,a&&a.title||Formatter.none),App.player.playlist&&0<=App.player.playlist.currentIndex&&AppUI.playlistControl.bringItemIntoView(App.player.playlist.currentIndex),
AppUI.currentTimeS=0,a?(Strings.changeText(AppUI.currentTimeLabel,Formatter.zero),Strings.changeText(AppUI.songLengthLabel,a.length),AppUI.seekSlider&&(AppUI.seekSlider.value=0,0<a.lengthMS?(AppUI.seekSlider.disabled=!1,AppUI.seekSlider.max=a.lengthMS):AppUI.seekSlider.disabled=!0)):(Strings.changeText(AppUI.currentTimeLabel,Formatter.none),Strings.changeText(AppUI.songLengthLabel,Formatter.none),AppUI.seekSlider&&(AppUI.seekSlider.disabled=!0,AppUI.seekSlider.value=0)))}static playerLoadingChanged(a){App.updateLoadingIcon()}static playerPausedChanged(a){AppUI.iconPlay&&
AppUI.iconPause&&(a?(AppUI.iconPause.classList.add("hidden"),AppUI.iconPlay.classList.remove("hidden")):(AppUI.iconPlay.classList.add("hidden"),AppUI.iconPause.classList.remove("hidden")))}static playerCurrentTimeSChanged(a){if(AppUI.seekSlider&&!AppUI.seekSlider.dragging){var b=a|0;AppUI.currentTimeS!==b&&(AppUI.currentTimeS=b,Strings.changeText(AppUI.currentTimeLabel,Formatter.formatTimeS(b)));AppUI.seekSlider.value=1E3*a}}static playerError(a){Modal.show({text:a})}static playlistSongLengthChanged(a){App.player&&
(a===App.player.currentSong&&(Strings.changeText(AppUI.songLengthLabel,a.length),AppUI.seekSlider&&(0<a.lengthMS?(AppUI.seekSlider.disabled=!1,AppUI.seekSlider.max=a.lengthMS):(AppUI.seekSlider.value=0,AppUI.seekSlider.disabled=!0))),AppUI.playlistControl&&AppUI.playlistControl.refreshVisibleItems())}static seekSliderValueChanged(a){AppUI.seekSlider&&AppUI.seekSlider.dragging&&(a=a/1E3|0,AppUI.currentTimeS!==a&&(AppUI.currentTimeS=a,Strings.changeText(AppUI.currentTimeLabel,Formatter.formatTimeS(a))))}static seekSliderDragEnded(a){App.player&&
App.player.currentSong&&App.player.seekTo(a)}static volumeStr(a){return(a>=Player.maxVolume?"-0":a?a-Player.maxVolume:GraphicalFilterEditorStrings.MinusInfinity)+" dB"}static volumeSliderValueChanged(a){App.player&&(App.player.volume=a);AppUI.volumeLabel&&Strings.changeText(AppUI.volumeLabel,AppUI.volumeStr(a))}static playlistControlItemClicked(a,b,c){App.player&&!c&&App.player.play(b)}static playlistControlItemContextMenu(a,b){}static graphicalFilterControlTypeClicked(){App.player&&(App.player.graphicalFilterControl.simpleMode=
!App.player.graphicalFilterControl.simpleMode,ButtonControl.setText(AppUI.graphicalFilterControlType,App.player.graphicalFilterControl.simpleMode?Strings.TraditionalFilter:Strings.AdvancedFilter))}static graphicalFilterControlEnabledClicked(){App.player&&(App.player.graphicalFilterControl.enabled=AppUI.graphicalFilterControlEnabled.checked)}static stereoPannerControlEnabledClicked(){App.player&&(App.player.stereoPannerControl.enabled=AppUI.stereoPannerControlEnabled.checked)}static monoDownMixerControlEnabledClicked(){App.player&&
(App.player.monoDownMixerControl.enabled=AppUI.monoDownMixerControlEnabled.checked)}static async addFiles(a){if(App.player&&!AppUI._loading){var b=App.hostType===App.hostTypeElectron;if((a=b?await App.showOpenFileDialog():await App.showOpenDialogWeb(a))&&App.player)try{AppUI._loading=!0;App.updateLoadingIcon();App.player.playlist||(App.player.playlist=new Playlist,AppUI.preparePlaylist());const c=App.player.playlist,d=b?null:new Uint8Array(BufferedFileHandle.minBufferLength<<1),e=b?null:[new Uint8Array(256)];
let g=!1;for(let f=0;f<a.length&&App.player;f++)if(b)await c.addSong(a[f]);else{const k=c.length;await c.addSongWeb(a[f],d,e)&&k===c.length&&(g=!0)}g&&AppUI.playlistControl&&AppUI.playlistControl.refreshVisibleItems()}catch(c){Modal.show({text:"addFiles error: "+(c.message||c.toString())})}finally{AppUI._loading=!1,App.updateLoadingIcon()}}}static async addDirectory(a){a=await App.listDirectory(a);if(!App.player||!App.player.playlist||AppUI.directoryCancelled)return!1;if(!a)return!0;for(let b=0;b<
a.length;b++)if(a[b].isDirectory){if(!await AppUI.addDirectory(a[b].fileURL))return!1}else{if(!App.player||!App.player.playlist||AppUI.directoryCancelled)return!1;await App.player.playlist.addSong(a[b])}return!0}static async addDirectories(){if(App.player&&!AppUI._loading){if(App.hostType!==App.hostTypeElectron)return AppUI.addFiles(!0);var a=await App.showOpenDirectoryDialog();if(a&&App.player)try{AppUI._loading=!0;AppUI.directoryCancelled=!1;App.updateLoadingIcon();App.player.playlist||(App.player.playlist=
new Playlist,AppUI.preparePlaylist());for(let b=0;b<a.length&&await AppUI.addDirectory(a[b]);b++);}catch(b){Modal.show({text:"addDirectories error: "+(b.message||b.toString())})}finally{AppUI._loading=!1,AppUI.directoryCancelled=!1,App.updateLoadingIcon()}}}static switchView(){AppUI.panelContainer&&AppUI.panelContainer.classList.toggle("toggled")}static showAbout(){Modal.show({html:Strings.AboutHTML+(App.player&&App.player.audioContext?"<br/><br/><small>Base latency: "+(App.player.audioContext.baseLatency||
0).toFixed(4)+" s<br/>Output latency: "+(isNaN(App.player.audioContext.outputLatency)?"-":App.player.audioContext.outputLatency.toFixed(4)+" s")+"</small>":""),title:Strings.About+" (v"+window.CACHE_VERSION+")"})}}AppUI.primaryInputIsTouch="matchMedia"in window?window.matchMedia("(pointer: coarse)").matches:0<navigator.maxTouchPoints||0<navigator.msMaxTouchPoints;AppUI.rem=4;AppUI.buttonRegularSizeREM=8;AppUI.buttonRegularSizePX=AppUI.remToPX(AppUI.buttonRegularSizeREM);
AppUI.buttonSizeREM=AppUI.buttonRegularSizeREM*(AppUI.primaryInputIsTouch?1.5:1);AppUI.buttonSizePX=AppUI.remToPX(AppUI.buttonSizeREM);AppUI.optionalPanelClientWidthREM=128;AppUI.optionalPanelClientWidthPX=AppUI.remToPX(AppUI.optionalPanelClientWidthREM);AppUI.scrollbarSizeREM=AppUI.primaryInputIsTouch?5:3;AppUI.minWidthREM=216;AppUI.minWidthPX=AppUI.remToPX(AppUI.minWidthREM);AppUI.baseThinBorderPX=1;AppUI.baseThickBorderPX=2;AppUI.zoomHandlers=[];AppUI.rootVariables=document.getElementById("root-variables");
