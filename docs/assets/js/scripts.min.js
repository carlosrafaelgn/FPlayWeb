...
Strings.AddSongs="Adicionar m\u00fasicas",Strings.AddFolders="Adicionar pastas",Strings.AddMoreFolders="Adicionar mais pastas\u2026",Strings.ShowEffects="Exibir efeitos",Strings.ShowPlaylist="Exibir playlist",Strings.UpdateAvailable="Atualiza\u00e7\u00e3o dispon\u00edvel!",Strings.PleaseRefresh="Por favor, recarregue a p\u00e1gina para atualizar a aplica\u00e7\u00e3o. \ud83d\ude0a",Strings.RGBMode="Modo RGB",Strings.AnimatedRGBMode="Modo RGB Animado",Strings.ExtraRGBMode="Modo RGB Extra",Strings.NeonMode=
"Modo Neon",Strings.AboutHTML='<p>FPlay Web \u00e9 um player de \u00e1udio experimental. \ud83d\ude0a</p>\n<p>Para mais informa\u00e7\u00f5es sobre o projeto, seu c\u00f3digo-fonte e depend\u00eancias, confira seu reposit\u00f3rio em <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb">github.com/carlosrafaelgn/FPlayWeb</a>.</p>\n<p>Este projeto \u00e9 licenciado sob a <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb/blob/master/LICENSE">MIT License</a>.</p>',Strings.DeleteModeHTML=
...
(a=App.player&&App.player.currentSong);a?Modal.show({html:`<div class="selectable-text">
			...
			</div>`,title:Strings.SongInfo,returnFocusElement:AppUI._playlistControl}):Alert.show(Strings.NoSongPlaying)}static showAbout(){const a=document.createElement("div"),b=function(){c.checked=AppUI.rgbMode;d.checked=AppUI.animatedRGBMode;e.checked=AppUI.extraRGBMode},c=ButtonControl.create({text:Strings.RGBMode,checkable:!0,checked:AppUI.rgbMode,parent:a,onclick:function(){AppUI.rgbMode=c.checked;b()}}),d=ButtonControl.create({text:Strings.AnimatedRGBMode,checkable:!0,checked:AppUI.animatedRGBMode,
parent:a,onclick:function(){AppUI.animatedRGBMode=d.checked;b()}}),e=ButtonControl.create({text:Strings.ExtraRGBMode,checkable:!0,checked:AppUI.extraRGBMode,parent:a,onclick:function(){AppUI.extraRGBMode=e.checked;b()}}),f=ButtonControl.create({text:Strings.NeonMode,checkable:!0,checked:AppUI.neonMode,parent:a,onclick:function(){AppUI.neonMode=f.checked}});a.insertAdjacentHTML("beforeend",`
