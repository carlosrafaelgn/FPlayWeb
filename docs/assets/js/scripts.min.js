...
a.replace(Strings._regExpAmp,"&amp;").replace(Strings._regExpLT,"&lt;").replace(Strings._regExpGT,"&gt;").replace(Strings._regExpQuot,"&#34;").replace(Strings._regExpApos,"&#39;").replace(Strings._regExpGrave,"&#96;"):""}}Strings._regExpAmp=/&/g;Strings._regExpLT=/</g;Strings._regExpGT=/>/g;Strings._regExpQuot=/"/g;Strings._regExpApos=/'/g;Strings._regExpGrave=/`/g;Strings.language="en";Strings.decimalSeparator=".";Strings.oppositeDecimalSeparator=",";Strings.Oops="Oops\u2026";Strings.AppName="FPlay";
Strings.Menu="Menu";Strings.About="About";Strings.Options="Options";Strings.Edit="Edit";Strings.Delete="Delete";Strings.DeleteSongs="Delete songs";Strings.DeleteAllSongs="Delete all";Strings.Enable="Enable";Strings.Disable="Disable";Strings.Enabled="Enabled";Strings.Disabled="Disabled";Strings.Selected="Selected";Strings.AdvancedFilter="Advanced filter";Strings.TraditionalFilter="Traditional filter";Strings.Missing="Missing";Strings.MissingSongError="The song is missing! \ud83d\ude22 Please, just add it again before playing it. When you add a missing song, it keeps its position in the playlist! \ud83d\ude0a";
...
Strings.Track="Track";Strings.TrackLabel="Track: ";Strings.Year="Year";Strings.YearLabel="Year: ";Strings.SampleRate="Sample rate";Strings.SampleRateLabel="Sample rate: ";Strings.Channels="Channels";Strings.ChannelsLabel="Channels: ";Strings.ShowInfo="Show information";Strings.SongInfo="Song information";Strings.NoSongPlaying="No song playing! \ud83d\ude05";Strings.Playlist="Playlist";Strings.FileList="File list";Strings.CurrentPathLabel="Current path: ";Strings.Loading="Loading";
Strings.LoadingLabel="Loading\u2026 ";Strings.LoadingCurrentPathLabel="Loading current path: ";Strings.Folder="Folder";Strings.FolderLabel="Folder: ";Strings.LeftAbbrev="L";Strings.RightAbbrev="R";Strings.Volume="Volume";Strings.Panning="Panning";Strings.DownMixToMono="Down-mix to mono";Strings.UnknownError="Something went wrong during playback. \ud83d\ude22";Strings.Add="Add";Strings.AddFiles="Add files";Strings.AddSongs="Add songs";Strings.AddFolders="Add folders";Strings.AddMoreFolders="Add more folders\u2026";
Strings.ShowEffects="Show effects";Strings.ShowPlaylist="Show playlist";Strings.UpdateAvailable="Update available!";Strings.PleaseRefresh="Please, refresh the page to update the app. \ud83d\ude0a";Strings.RGBMode="RGB Mode";Strings.ExtraRGBMode="Extra RGB Mode";Strings.NeonMode="Neon Mode";Strings.AboutHTML='<p>FPlay Web is an experimental audio player. \ud83d\ude0a</p>\n<p>For more information about the project, its source code and dependencies, check out its repository at <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb">github.com/carlosrafaelgn/FPlayWeb</a>.</p>\n<p>This project is licensed under the <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb/blob/master/LICENSE">MIT License</a>.</p>';
...
class MetadataExtractor{static async extractRIFF(a,b,c){if(44>b.totalLength)return null;var d=b.readUInt32LE();if(null===d||b.totalLength<8+d)return null;var e=d;let f=!1,g=!1,h=d=0,k=0;a:for(;0<e;){var p=!1,l=0,m=void 0;switch(b.readUInt32BE()){case null:break a;case 1463899717:p=!0;e-=4;break;case 1279873876:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;break;case 1768174368:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;(m=b.fillBuffer(1024))&&await m;if(4<l){p=
b.readByte();var n=b.readByte();m=b.readByte();if(null===p||null===n||null===m)break a;e-=3;l-=3;if(73===p||68===n||51===m)if(d=b.totalLength-e,f&&g){d=-1;break a}}b.skip(l);(m=b.fillBuffer(1024))&&await m;continue;default:l=b.readUInt32LE();if(null===l)break a;e-=8;if(0>l||l>e)break a;b.skip(l);(m=b.fillBuffer(1024))&&await m;continue}for((m=b.fillBuffer(1024))&&await m;p&&(!f||!g)||0<l;){var q=b.readUInt32BE();n=0;if(null===q)break a;e-=4;l-=4;if(1229866575!==q){n=b.readUInt32LE();if(null===n||
0>n||n>e||!p&&n>l)break a;e-=4;l-=4}1684108385!==q&&(m=b.fillBuffer(Math.min(264,8+n)))&&await m;switch(q){case 1718449184:if(!p)break;m=b.readUInt16LE();q=b.readUInt16LE();var r=b.readUInt32LE(),t=b.readUInt32LE();const u=b.readUInt16LE(),y=b.readUInt16LE();n-=16;e-=16;l-=16;if(null===m||null===q||null===r||null===t||null===u||null===y)break a;f=!0;k||(k=t);a.sampleRate=r;a.channels=q;break;case 1684108385:p&&(g=!0,h||(h=n));break;case 1229866575:function x(v){b.read(c,0,v);return MetadataExtractor.finishReadingV2Frame(0,
v,c)}for(;0<l;){if(4>l){b.skip(l);(m=b.fillBuffer(8))&&await m;break}(m=b.fillBuffer(8))&&await m;q=b.readUInt32BE();e-=4;l-=4;if(null===q)break a;r=b.readUInt32LE();e-=4;l-=4;if(null===r||0>r||r>l)b.skip(l),e-=l,l=0;else if(1>=r)b.skip(r),e-=r,l-=r;else{t=Math.min(257,r)-1;(m=b.fillBuffer(t))&&await m;switch(q){case 1229865293:a.title=x(t);break;case 1230000708:a.album=x(t);break;case 1229017684:a.artist=x(t);break;case 1229148740:a.year=parseInt(x(t))||0;break;case 1230262859:a.track=parseInt(x(t))||
0;break;default:t=0}b.skip(r-t);e-=r;l-=r}}}0<n&&(b.skip(n),e-=n,l-=n);e&&(m=b.fillBuffer(8))&&await m}}return f&&g?(d&&(0<d&&b.seekTo(d),(e=b.fillBuffer(1024))&&await e),a.lengthMS=Math.floor(1E3*h/k),[a,!!d]):null}static finishReadingV2Frame(a,b,c){let d=0;var e=b-1;a:for(;0<b;)switch(c[d]){case 0:case 9:case 10:case 11:case 12:case 13:case 32:case 133:case 160:b--;d++;break;default:break a}a:for(;0<b;)switch(c[e]){case 0:case 9:case 10:case 11:case 12:case 13:case 32:case 133:case 160:b--;e--;
...
e.length?e:null}static readV2Frame(a,b,c){if(2>b)return a.skip(b),null;const d=a.readByte();b--;if(0>d||3<d)return a.skip(b),null;let e=c[0];b>e.length&&(e=new Uint8Array(b+16),c[0]=e);a=a.read(e,0,b);return"number"===typeof a?MetadataExtractor.finishReadingV2Frame(d,a,e):a.then(function(f){return MetadataExtractor.finishReadingV2Frame(d,f,e)})}static async extractID3v1(a,b,c,d){try{b.seekTo(b.totalLength-128);const g=b.read(d,0,128);"number"!==typeof g&&await g;if(84==d[0]&&65==d[1]&&71==d[2]){var e;
if(!(c&MetadataExtractor.TITLE_B)){var f=3;for(e=0;30>e&&d[f];)e++,f++;e&&(a.title=MetadataExtractor.textDecoderIso88591.decode(d.subarray(3,3+e)))}if(!(c&MetadataExtractor.ARTIST_B)){f=33;for(e=0;30>e&&d[f];)e++,f++;e&&(a.artist=MetadataExtractor.textDecoderIso88591.decode(d.subarray(33,33+e)))}if(!(c&MetadataExtractor.ALBUM_B)){f=63;for(e=0;30>e&&d[f];)e++,f++;e&&(a.album=MetadataExtractor.textDecoderIso88591.decode(d.subarray(63,63+e)))}if(!(c&MetadataExtractor.YEAR_B)){f=93;for(e=0;4>e&&d[f];)e++,
f++;e&&(a.year=parseInt(MetadataExtractor.textDecoderIso88591.decode(d.subarray(93,93+e))))}c&MetadataExtractor.TRACK_B||d[125]||!d[126]||(a.track=d[126]&255)}}catch(g){}}static async extractSampleRateAndChannels(a,b,c,d){try{b.seekTo(c);c=4092;var e=b.fillBuffer(c+4);e&&await e;for(e=0;0<=c;){const f=b.readByte();if(0>f)break;if(f){255===f&&(e=f<<24|b.readByte()<<16|b.readByte()<<8|b.readByte());break}c--}if(d){if(e&&4095===(e>>20&4095)&&(b=e>>10&15,!(13<=b))){switch(b){case 0:a.sampleRate=96E3;
break;case 1:a.sampleRate=88200;break;case 2:a.sampleRate=64E3;break;case 3:a.sampleRate=48E3;break;case 4:a.sampleRate=44100;break;case 5:a.sampleRate=32E3;break;case 6:a.sampleRate=24E3;break;case 7:a.sampleRate=22050;break;case 8:a.sampleRate=16E3;break;case 9:a.sampleRate=12E3;break;case 10:a.sampleRate=11025;break;case 11:a.sampleRate=8E3;break;default:a.sampleRate=7350}e=e>>6&7;switch(e){case 0:a.channels=2;break;case 7:a.channels=8;break;default:a.channels=e}}}else if(e&&2047===(e>>21&2047)&&
(b=e>>19&3,1!==b&&(d=e>>10&3,3!==d))){switch(b){case 0:switch(d){case 0:a.sampleRate=11025;break;case 1:a.sampleRate=12E3;break;case 2:a.sampleRate=8E3}break;case 2:switch(d){case 0:a.sampleRate=22050;break;case 1:a.sampleRate=24E3;break;case 2:a.sampleRate=16E3}break;case 3:switch(d){case 0:a.sampleRate=44100;break;case 1:a.sampleRate=48E3;break;case 2:a.sampleRate=32E3}}a.channels=3===(e>>6&3)?1:2}}catch(f){}}static async extractID3v2Andv1(a,b,c,d,e){const f=MetadataExtractor.createBasicMetadata(a);
f.url?f.url.startsWith(FileUtils.localURLPrefix)&&(f.file=a):(f.file=a,f.fileSize=a.size,f.fileName=a.name);a=0;var g=b.readByte()<<24|b.readByte()<<16|b.readByte()<<8;if(1229206272!==g)if(g|=b.readByte(),1380533830===g){e=!1;g=await MetadataExtractor.extractRIFF(f,b,c[0]);if(!g)return null;if(!g[1])return f;f.lengthMS&&(a|=MetadataExtractor.LENGTH_B)}else return e&&await MetadataExtractor.extractSampleRateAndChannels(f,b,0,d),await MetadataExtractor.extractID3v1(f,b,0,c[0]),f;var h=b.readByte(),
k=b.readByte();g=b.readByte();var p=b.readByte();const l=b.readByte(),m=b.readByte(),n=b.readByte();g=(g&16?10:0)+(n&127|(m&127)<<7|(l&127)<<14|(p&127)<<21);p=10+g;if(2<(h&255)||k){for(;0<g&&a!==MetadataExtractor.ALL_B;){(h=b.fillBuffer(1024))&&await h;k=b.readUInt32BE();h=b.readUInt32BE();b.skip(2);if(!k||0>=h||h>g)break;switch(k){case 1414091826:a&MetadataExtractor.TITLE_B?b.skip(h):(k=MetadataExtractor.readV2Frame(b,h,c),f.title=k&&k.then?await k:k,f.title&&(a|=MetadataExtractor.TITLE_B));break;
case 1414546737:a&MetadataExtractor.ARTIST_B?b.skip(h):(k=MetadataExtractor.readV2Frame(b,h,c),f.artist=k&&k.then?await k:k,f.artist&&(a|=MetadataExtractor.ARTIST_B));break;case 1413565506:a&MetadataExtractor.ALBUM_B?b.skip(h):(k=MetadataExtractor.readV2Frame(b,h,c),f.album=k&&k.then?await k:k,f.album&&(a|=MetadataExtractor.ALBUM_B));break;case 1414677323:a&MetadataExtractor.TRACK_B?b.skip(h):(k=MetadataExtractor.readV2Frame(b,h,c),f.track=k&&k.then?parseInt(await k):parseInt(k),f.track?a|=MetadataExtractor.TRACK_B:
f.track=0);break;case 1414284622:a&MetadataExtractor.LENGTH_B?b.skip(h):(k=MetadataExtractor.readV2Frame(b,h,c),f.lengthMS=k&&k.then?parseInt(await k):parseInt(k),f.lengthMS?a|=MetadataExtractor.LENGTH_B:f.lengthMS=0);break;case 1415136594:case 1413763651:a&MetadataExtractor.YEAR_B?b.skip(h):(k=MetadataExtractor.readV2Frame(b,h,c),f.year=k&&k.then?parseInt(await k):parseInt(k),f.year?a|=MetadataExtractor.YEAR_B:f.year=0);break;default:b.skip(h)}g-=10+h}e&&await MetadataExtractor.extractSampleRateAndChannels(f,
b,p,d);(a&MetadataExtractor.ALL_BUT_LENGTH_B)!==MetadataExtractor.ALL_BUT_LENGTH_B&&await MetadataExtractor.extractID3v1(f,b,a,c[0])}return f}static createBasicMetadata(a){return{url:FileUtils.urlOrPathToURL(a["data-path"])||"",flags:MetadataFlags.Seekable}}static async extract(a,b,c){if(!a)return null;b||(b=new Uint8Array(BufferedReader.minBufferLength));c||(c=[new Uint8Array(256)]);let d=!1;if(!a.name.endsWith(".mp3")&&!(d=a.name.endsWith(".aac"))&&!a.name.endsWith(".wav")){if(a.name.endsWith(".flac"))return FLACMetadataExtractor.extract(a,
b,c);if(a.name.endsWith(".ogg"))return OggMetadataExtractor.extract(a,b,c);const e=a.name.toLowerCase();if(!e.endsWith(".mp3")&&!(d=e.endsWith(".aac"))&&!e.endsWith(".wav"))return e.endsWith(".flac")?FLACMetadataExtractor.extract(a,b,c):e.endsWith(".ogg")?OggMetadataExtractor.extract(a,b,c):null}try{const e=new BufferedFileReader(a,b);await e.fillBuffer(-1);return await MetadataExtractor.extractID3v2Andv1(a,e,c,d,!0)}catch(e){return null}}}MetadataExtractor.ALL_B=63;
...
class VorbisCommentExtractor extends MetadataExtractor{static async extractVorbisComment(a,b,c,d){var e=c.fillBuffer(1024);e&&await e;e=c.readUInt32LE();a-=4;if(!e||e>a)return!1;c.skip(e);a-=e;if(!a)return!0;(e=c.fillBuffer(1024))&&await e;let f=c.readUInt32LE();a-=4;if(null===f||0>a||f>a)return!1;let g=null,h=null,k=null;for(;0<f;){f--;(e=c.fillBuffer(4))&&await e;const p=c.readUInt32LE();a-=4;if(null===p||0>a||p>a)return!1;const l=Math.min(2048,p);let m=d[0];m.length<l&&(m=new Uint8Array(l),d[0]=
m);(e=c.fillBuffer(l+4))&&await e;c.read(m,0,l);p>l&&c.skip(p-l);a-=p;try{let n;for(n=0;n<l;n++)if(61===m[n]){if(n&&n<l-1){let q;switch(MetadataExtractor.textDecoderUtf8.decode(m.subarray(0,n)).normalize().trim().toUpperCase()){case "TITLE":if(q=MetadataExtractor.textDecoderUtf8.decode(m.subarray(n+1,l)).normalize().trim())b.title=q;break;case "ARTIST":if(q=MetadataExtractor.textDecoderUtf8.decode(m.subarray(n+1,l)).normalize().trim())b.artist=b.artist?b.artist+(", "+q):q;break;case "PERFORMER":if(q=
MetadataExtractor.textDecoderUtf8.decode(m.subarray(n+1,l)).normalize().trim())g=q;break;case "ALBUMARTIST":if(q=MetadataExtractor.textDecoderUtf8.decode(m.subarray(n+1,l)).normalize().trim())h=q;break;case "COMPOSER":if(q=MetadataExtractor.textDecoderUtf8.decode(m.subarray(n+1,l)).normalize().trim())k=q;break;case "ALBUM":if(q=MetadataExtractor.textDecoderUtf8.decode(m.subarray(n+1,l)).normalize().trim())b.album=q;break;case "TRACKNUMBER":if(q=MetadataExtractor.textDecoderUtf8.decode(m.subarray(n+
1,l)).normalize().trim())b.track=parseInt(q)||0;break;case "DATE":if(q=MetadataExtractor.textDecoderUtf8.decode(m.subarray(n+1,l)).normalize().trim())b.year=parseInt(q)||0}}break}}catch(n){}}b.artist||(g?b.artist=g:h?b.artist=h:k&&(b.artist=k));return!0}}
...
b,c){var d=b.fillBuffer(4);d&&await d;d=b.readUInt32BE();if(!d)return 0;const e=d&2147483648;d&=2147483647;const f=d>>24;d&=16777215;if(127===f||d+b.readPosition>b.totalLength)return 0;if(4===f)return await VorbisCommentExtractor.extractVorbisComment(d,a,b,c)?-1:0;b.skip(d);return e?-1:1}static async extract(a,b,c){try{const d=new BufferedFileReader(a,b);await d.fillBuffer(-1);const e=MetadataExtractor.createBasicMetadata(a);let f=FLACMetadataExtractor.readHeaderAndStreamInfo(e,d,c[0]);if(!f)return null;
if(0>f)return e;do if(f=await FLACMetadataExtractor.readMetadataBlock(e,d,c),!f)return null;while(0<f);return e}catch(d){return null}}}
...
class OggMetadataExtractor extends VorbisCommentExtractor{static async extract(a,b,c){try{const d=new OggBufferedReader(a,b),e=MetadataExtractor.createBasicMetadata(a);return await d.findInitialVorbisCommentPage(e)?await VorbisCommentExtractor.extractVorbisComment(d.totalLength-d.readPosition,e,d,c)?e:null:null}catch(d){return null}}}
...
class Song{static isPathHttp(a){return a.startsWith("http:")||a.startsWith("https:")||a.startsWith("icy:")}static deserialize(a){a.readUint8();return new Song(a.readString(),a.readInt32(),a.readString(),a.readString(),a.readString(),a.readInt16(),a.readInt32(),a.readInt16(),a.readInt32(),a.readInt8(),a.readString(),a.readInt32())}constructor(a,b,c,d,e,f,g,h,k,p,l,m){if("string"!==typeof a){m=a;a=m.url;b=m.flags;c=m.title;d=m.artist;e=m.album;f=m.track;g=m.lengthMS;h=m.year;k=m.sampleRate;p=m.channels;
if(m.file){if(!a||a.startsWith(FileUtils.localURLPrefix))this.file=m.file;c||(c=m.file.name.lastIndexOf("."),c=0<c?m.file.name.substring(0,c):m.file.name)}l=m.fileName;m=m.fileSize}this.id=++Song._lastId;this.url=a;this.flags=b||0;this.isHttp=Song.isPathHttp(this.url);c||(a=decodeURI(a),b=a.lastIndexOf("/"),c=0<=b?a.substring(b+1):a,this.isHttp||(b=c.lastIndexOf("."),0<b&&(c=c.substring(0,b))));this.title=c||Formatter.none;this.artist=d||Formatter.none;this.album=e||Formatter.none;this.track=f&&0<
f?f:Formatter.noneInt;this.lengthMS=g&&0<g?g:Formatter.noneInt;this.year=h&&0<h?h:Formatter.noneInt;this.sampleRate=k&&0<k?k:Formatter.noneInt;this.channels=p&&0<p?p:Formatter.noneInt;this.length=Formatter.formatTimeMS(this.lengthMS);this.fileName=l||null;this.fileSize=m||0}get isSeekable(){return this.flags&MetadataFlags.Seekable?!0:!1}estimateSerializedLength(){return(this.url.length+this.title.length+this.artist.length+this.album.length+(this.fileName?this.fileName.length:0)<<1)+17}serialize(a){return a.writeUint8(0).writeString(this.url).writeInt32(this.flags).writeString(this.title).writeString(this.artist).writeString(this.album).writeInt16(this.track).writeInt32(this.lengthMS).writeInt16(this.year).writeInt32(this.sampleRate).writeInt8(this.channels).writeString(this.fileName||
null).writeInt32(this.fileSize||0)}serializeWeb(){return{url:this.url,flags:this.flags,title:this.title,artist:this.artist,album:this.album,track:this.track,lengthMS:this.lengthMS,year:this.year,sampleRate:this.sampleRate,channels:this.channels,fileName:this.fileName,fileSize:this.fileSize}}}Song._lastId=0;
...
e=this.equivalentZonesFrequencyCount;a=GraphicalFilterEditor.equivalentZoneCount;let f=this._biquadFilters,g=this._biquadFilterGains,h=!1;if(!f||!g){h=!0;f=Array(a);g=Array(a);const l=Array(a);var k=.5*Math.log(2),p=this._audioContext.sampleRate;const m=2*Math.PI;for(let n=a-1;0<=n;n--){const q=m*d[n]/p;l[n]=1/(2*Math.sinh(q/Math.sin(q)*k))}for(k=a-1;0<=k;k--)p=b.createBiquadFilter(),p.type="peaking",p.frequency.value=d[k],p.Q.value=l[k],f[k]=p,k<a-1&&f[k+1].connect(f[k]);this._biquadFilters=f;this._biquadFilterInput=
...
b;this._rangeImage=a}}drawCurve(a,b,c){const d=this._ctx;if(d){var e=1<devicePixelRatio?devicePixelRatio:1;e!==this._pixelRatio&&(this.scaleChanged(),e=this._pixelRatio);var f=this.editor,g=f.filter;e*=f.scale;var h=this.element;f=this.leftMargin;var k=h.width,p=h.height,l=Math.round(8*e),m=Math.round(4*e),n=(k/l|0)+1,q=GraphicalFilterEditor.maximumChannelValueY*e|0,r=1>e?e:e|0;h=.5*r;d.fillStyle="#303030";d.fillRect(0,0,k,p);d.lineWidth=r;d.strokeStyle="#5a5a5a";d.beginPath();r=k+(m>>1);var t=(GraphicalFilterEditor.zeroChannelValueY*
e|0)+h;d.moveTo(r,t);for(let u=n-1;0<=u;u--)d.lineTo(r-m,t),r-=l,d.moveTo(r,t);d.stroke();d.beginPath();r=k+(m>>1);t=(GraphicalFilterEditor.validYRangeHeight*e|0)+h;d.moveTo(r,t);for(k=n-1;0<=k;k--)d.lineTo(r-m,t),r-=l,d.moveTo(r,t);d.stroke();if(a)for(a=g.equivalentZonesFrequencyCount.length-2;0<a;a--){r=((g.equivalentZonesFrequencyCount[a]+f)*e|0)+h;t=q;d.beginPath();for(d.moveTo(r,t);t<p;)d.lineTo(r,t+m),t+=l,d.moveTo(r,t);d.stroke()}r=1>e?2*e:2*e|0;h=.5*r;d.lineWidth=r;a=GraphicalFilterEditor.visibleBinCount-
1;for(p=b?1:0;0<=p;p--){l=p||!b?g.channelCurves[c]:g.actualChannelCurve;d.strokeStyle=p?"#707070":this._rangeImage;d.beginPath();d.moveTo(f*e|0,l[0]*e+h);for(r=1;r<a;r++)d.lineTo((f+r)*e|0,l[r]*e+h);d.lineTo((f+r+1)*e|0,l[r]*e+h);d.stroke()}}}}
...
this._svg;if(a&&b&&c&&d){var e=GraphicalFilterEditorControl.controlWidth,f=GraphicalFilterEditorControl.controlHeight,g=1<devicePixelRatio?devicePixelRatio:1,h=b.scale,k=h*g,p=this.leftMargin,l=this._svgLines,m=1>k?k:k|0,n=.5*m,q=(e*k|0).toString(),r=(f*k|0).toString();d.setAttribute("width",q);d.setAttribute("height",r);d.setAttribute("viewBox",`0 0 ${q} ${r}`);d.style.transform=1===g?"":"scale("+1/g+")";this._svgGradient.setAttribute("y2",r);b.element.style.width=(e*h|0)+"px";a.style.width=(e*h|
0)+"px";a.style.height=(f*h|0)+"px";l[0].setAttribute("x2",q);l[1].setAttribute("x2",q);for(q=l.length-1;2<=q;q--)l[q].setAttribute("y2",r);r=((GraphicalFilterEditor.zeroChannelValueY*k|0)+n).toString();l[0].setAttribute("y1",r);l[0].setAttribute("y2",r);r=((GraphicalFilterEditor.validYRangeHeight*k|0)+n).toString();l[1].setAttribute("y1",r);l[1].setAttribute("y2",r);for(r=c.equivalentZonesFrequencyCount.length-2;0<r;r--)q=(((c.equivalentZonesFrequencyCount[r]+p)*k|0)+n).toString(),l[r+1].setAttribute("x1",
q),l[r+1].setAttribute("x2",q);q=m.toString()+"px";r=(4*k|0).toString();for(c=l.length-1;0<=c;c--)l[c].setAttribute("stroke-width",q),l[c].setAttribute("stroke-dasharray",r);q=(1>k?2*k:2*k|0).toString()+"px";this._svgGrayCurve.style.strokeWidth=q;this._svgCurve.style.strokeWidth=q;this._pixelRatio=g}}drawCurve(a,b,c){var d=1<devicePixelRatio?devicePixelRatio:1;d!==this._pixelRatio&&(this.scaleChanged(),d=this._pixelRatio);this._showZones!==a&&(this._showZones=a,this._svgZones.style.display=a?"":"none");
var e=this.editor;a=e.filter;d*=e.scale;e=.5*(1>d?2*d:2*d|0);const f=this.leftMargin,g=GraphicalFilterEditor.visibleBinCount;for(let h=b?1:0;0<=h;h--){const k=h||!b?a.channelCurves[c]:a.actualChannelCurve,p=h?this._svgGrayCurve:this._svgCurve;let l=1,m=0,n=k[0],q="M "+(f*d|0)+","+(n*d+e);for(;l<g;l++)k[l]!==n&&(l>m+1&&1<l&&(q+=" "+((f+l-1)*d|0)+","+(k[l-1]*d+e)),m=l,n=k[l],q+=" "+((f+m)*d|0)+","+(n*d+e));q+=" "+((f+l)*d|0)+","+(k[l-1]*d+e);p.setAttribute("d",q)}this._isActualChannelCurveNeeded!==
...
"GEMNUSEP";return h};c=function(h){const k=document.createElement("div");k.className="GEMNULBL";k.appendChild(document.createTextNode(h));return k};d=function(h,k,p,l,m,n){const q=document.createElement("div");q.className=n?"GEMNUIT GECLK "+n:"GEMNUIT GECLK";if(k)if(f&&(l&&f.radioHTML||!l&&f.checkHTML))q.innerHTML=l?f.radioHTML:f.checkHTML,k=q.firstChild,k.style.marginRight=l?f.radioMargin||"2px":f.checkMargin||"2px",p||(k.style.visibility="hidden");else{k=document.createElement("span");n=l?"\u25cf ":
"\u25a0 ";let r=null;if(f){let t=!1;l?f.radioCharacter&&(t=!0,n=f.radioCharacter,r=f.radioMargin||"2px"):f.checkCharacter&&(t=!0,n=f.checkCharacter,r=f.checkMargin||"2px");t&&(f.checkFontFamily&&(k.style.fontFamily=f.checkFontFamily),f.checkFontSize&&(k.style.fontSize=f.checkFontSize))}r&&(k.style.marginRight=r);k.appendChild(document.createTextNode(n));p||(k.style.visibility="hidden");q.appendChild(k)}q.appendChild(document.createTextNode(h));m&&(q.onclick=m);return q};this.element=a;a.className=
...
this.fs);for(b=0;b<d.length;b++)a.bindAttribLocation(this.program,b,d[b]);a.linkProgram(this.program);for(a=0;a<e.length;a++)this.prepareUniform(e[a],f[a])}getAttribsAndUniforms(a,b,c,d){a=a.split("\n");for(let p=0;p<a.length;p++){var e=a[p].trim();if("uniform"===e.substring(0,7)){e=e.split(" ");var f=e[1];for(var g=2;g<e.length;g++){var h=e[g];if(";"===h)break;var k=h.charAt(h.length-1);const l=";"===k;if(","===k||l)h=h.substring(0,h.length-1);","!==h&&h.length&&(c.push(h),d.push(f));if(l)break}}else if("attribute"===
...
2048,e=this.visibleFrequencies,f=Analyzer.colors;var g;let h,k,p,l;this.analyzerL.getByteTimeDomainData(this.data);cLib._plainAnalyzer(this.fft4gfPtr,this.windowPtr,this.dataPtr,this.tmpPtr);let m=this.prevL;c.lineWidth=1;c.fillStyle="#000000";c.fillRect(0,0,512,512);for(k=h=0;511>k&&1024>h&&d>e[k+1]-e[k];){for(g=d*h;1024>h&&g+d<e[k];)h++,g=d*h;g=(4*m[k]+a[k]*lerp(g,b[h],g+d,b[h+1],e[k]))/2.5>>1;255<g?g=255:0>g&&(g=0);m[k]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(k-.5,256.5-g);c.lineTo(k-.5,256.5);
c.stroke();k++}for(h++;1024>h&&512>k;){l=p=0;do p+=b[h],l++,h++,g=d*h;while(g<e[k]&&1024>h);g=(4*m[k]+a[k]*p/l)/2.5>>1;255<g?g=255:0>g&&(g=0);m[k]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(k-.5,256.5-g);c.lineTo(k-.5,256.5);c.stroke();k++}this.analyzerR.getByteTimeDomainData(this.data);cLib._plainAnalyzer(this.fft4gfPtr,this.windowPtr,this.dataPtr,this.tmpPtr);m=this.prevR;for(k=h=0;511>k&&1024>h&&d>e[k+1]-e[k];){for(g=d*h;1024>h&&g+d<e[k];)h++,g=d*h;g=(4*m[k]+a[k]*lerp(g,b[h],g+d,b[h+1],e[k]))/
2.5>>1;255<g?g=255:0>g&&(g=0);m[k]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(k-.5,256.5);c.lineTo(k-.5,256.5+g);c.stroke();k++}for(h++;1024>h&&512>k;){l=p=0;do p+=b[h],l++,h++,g=d*h;while(g<e[k]&&1024>h);g=(4*m[k]+a[k]*p/l)/2.5>>1;255<g?g=255:0>g&&(g=0);m[k]=g;c.beginPath();c.strokeStyle=f[g];c.moveTo(k-.5,256.5);c.lineTo(k-.5,256.5+g);c.stroke();k++}}cleanUp(){this.ptr&&cLib._freeBuffer(this.ptr)}}
...
class ListControl extends HTMLElement{constructor(){super();this._useVirtualItems=!0;this._adapter=null;this._boundZoomChanged=this.zoomChanged.bind(this);this._boundRefreshVisibleItemsInternal=this.refreshVisibleItemsInternal.bind(this);this._boundAdjustScrollbarPaddingFromResize=this.adjustScrollbarPaddingFromResize.bind(this);const a=document.createElement("div");a.className="f-list-container";this._container=a;this._useVirtualItems||(this._boundNotifyCurrentItemChangedInternal=this.notifyCurrentItemChangedInternal.bind(this));
this._resizeObserver=new ResizeObserver(this.resize.bind(this));this._itemMargin=this._itemHeight=1;this._itemHeightAndMargin=2;this._ignoreFirstIndex=!1;this._lastIndex=this._firstIndex=0;this._keyboardItem=this._currentItem=this._currentListItem=null;this._clientHeight=1;this._containerHeight=0;this._scrollbarPaddingScheduled=this._scrollbarPadding=!1;this._visibleCount=1;this._items=[];this._focused=this._initialized=this._notifyCurrentItemChangedEnqueued=this._refreshVisibleItemsEnqueued=!1;this._lastKeyboardIndex=
this._keyboardIndex=-1;this.deleteMode=!1;this.onitemcontextmenu=this.onitemcontrolclick=this.onitemclick=null}destroy(){this._adapter&&(this._adapter.control=null);this._resizeObserver&&this._resizeObserver.unobserve(this);this._items&&this._items.fill(null);this._boundZoomChanged&&AppUI.removeZoomHandler(this._boundZoomChanged);zeroObject(this)}get adapter(){return this._adapter}set adapter(a){this._adapter!==a&&(this._adapter&&(this._adapter.control=null),this._adapter=a,this.clear(),a&&(a.control=
this,this.prepareAdapter(),this._useVirtualItems?this.ariaRowCount=a.list.length.toString():a.list.length&&this.notifyItemsAdded(0,a.list.length-1)))}prepareAdapter(){const a=this._adapter;a&&(this._itemHeight=a.itemHeight,this._itemMargin=AppUI.thickBorderPX,this._itemHeightAndMargin=this._itemHeight+this._itemMargin,this._currentListItem=a.list.currentItem,this.adjustContainerHeight(),this.resize())}zoomChanged(){if(this._adapter){this.prepareAdapter();var a=this._items;for(let b=a.length-1;0<=
b;b--)a[b].index=-1;this._useVirtualItems&&this.elementScroll()}}adjustScrollbarPadding(){const a=(this._containerHeight|0)>this._clientHeight;this._scrollbarPadding!==a&&(this._scrollbarPadding=a,this._useVirtualItems?a?this.classList.add("virtual-padding"):this.classList.remove("virtual-padding"):this.style.padding=a?"":"0")}adjustScrollbarPaddingFromResize(){this._scrollbarPaddingScheduled=!1;this.adjustScrollbarPadding()}adjustContainerHeight(){var a=this._adapter;const b=this._container;a&&b&&
(a=(a=a.list.length)?a*this._itemHeightAndMargin-this._itemMargin:0,this._containerHeight!==a&&(this._containerHeight=a,b.style.height=a+"px",this.adjustScrollbarPadding()))}clear(){if(this._container){var a=this._items;for(var b=a.length-1;0<=b;b--)if(a[b].element){const c=a[b].element.parentNode;c&&c.removeChild(a[b].element)}if(this._useVirtualItems)for(b=a.length-1;0<=b;b--)a[b].reset();else{for(b=a.length-1;0<=b;b--)a[b].zero();a.splice(0)}this._lastIndex=this._firstIndex=0;this._keyboardItem=
this._currentItem=this._currentListItem=null;this._containerHeight=this.scrollTop=0;this._container.style.height="0";this._lastKeyboardIndex=0<this._keyboardIndex?this._keyboardIndex=0:-1;this.ariaRowCount="0";this.removeAttribute("aria-activedescendant");this.adjustScrollbarPadding()}}elementScroll(){var a=this._adapter;if(a){var b=this._items,c=this._itemHeightAndMargin,d=this._firstIndex-2,e=this.scrollTop/c|0;0>d&&(d=0);if(this._ignoreFirstIndex)this._ignoreFirstIndex=!1;else if(this._firstIndex===
e)return;this._firstIndex=e;var f=this._visibleCount+(0===e?2:1===e?3:4);f>b.length&&(f=b.length);0>(e-=2)&&(e=0);if(e>d){if((d=e-d)&&d<f)for(let l=d,m=0;l<f;l++,m++)d=b[m],b[m]=b[l],b[l]=d}else if((d-=e)&&d<f)for(let l=f-1,m=l-d;0<=m;m--,l--)d=b[l],b[l]=b[m],b[m]=d;var g=a.list,h=g.length,k=a.list.currentItem,p=this._keyboardIndex;d=0;for(let l=e*c;d<f&&e<h;d++,e++,l+=c){const m=g.item(e),n=b[d];if(n.item!==m){let q=k===m;n.current!==q&&((n.current=q)?n.element.classList.add("current"):n.element.classList.remove("current"));
q=p===e;n.keyboard!==q&&((n.keyboard=q)?(n.element.classList.add("keyboard"),n.element.ariaSelected="true",this.setAttribute("aria-activedescendant",n.element.id)):(this.getAttribute("aria-activedescendant")===n.element.id&&this.removeAttribute("aria-activedescendant"),n.element.classList.remove("keyboard"),n.element.ariaSelected="false"));a.prepareElement(m,e,h,n.element);n.element.ariaRowIndex=e.toString();n.item||this.appendChild(n.element);n.item=m}n.index!==e&&(n.index=e,n.element.style.transform=
"translateY("+l+"px)")}for(a=b.length;d<a;d++)c=b[d],c.item&&(c.item=null,this.removeChild(c.element));this._lastIndex=e-1;this._lastIndex<this._firstIndex&&(this._lastIndex=this._firstIndex)}}refreshVisibleItemsInternal(){this._refreshVisibleItemsEnqueued=!1;var a=this._adapter;if(a){this.adjustContainerHeight();var b=this._items,c=this._itemHeightAndMargin,d=a.list,e=d.length,f=a.list.currentItem,g=this._keyboardIndex;if(this._useVirtualItems){this._currentListItem=f;var h=0,k=this._firstIndex,
p=this._visibleCount+(0===k?2:1===k?3:4);p>b.length&&(p=b.length);0>(k-=2)&&(k=0);for(let l=k*c;h<p&&k<e;h++,k++,l+=c){const m=d.item(k),n=b[h];let q=f===m;n.current!==q&&((n.current=q)?n.element.classList.add("current"):n.element.classList.remove("current"));q=g===k;n.keyboard!==q&&((n.keyboard=q)?(n.element.classList.add("keyboard"),n.element.ariaSelected="true",this.setAttribute("aria-activedescendant",n.element.id)):(this.getAttribute("aria-activedescendant")===n.element.id&&this.removeAttribute("aria-activedescendant"),
n.element.classList.remove("keyboard"),n.element.ariaSelected="false"));a.prepareElement(m,k,e,n.element);n.element.ariaRowIndex=k.toString();n.item||this.appendChild(n.element);n.item=m;n.index!==k&&(n.index=k,n.element.style.transform="translateY("+l+"px)")}for(a=b.length;h<a;h++)d=b[h],d.item&&(d.item=null,this.removeChild(d.element))}else{h=this._visibleCount;g=0<=g&&g<b.length?b[g]:null;this._keyboardItem!==g&&(this._keyboardItem&&(this._keyboardItem.element.classList.remove("keyboard"),this._keyboardItem.element.ariaSelected=
"false"),g?(g.element.classList.add("keyboard"),g.element.ariaSelected="true",this.setAttribute("aria-activedescendant",g.element.id)):this.removeAttribute("aria-activedescendant"),this._keyboardItem=g);for(let l=0,m=this.indexFromY(0);l<=h&&m<e;l++,m++)g=b[m].element,a.prepareElement(d.item(m),m,e,g),g.ariaRowIndex=m.toString()}}}resize(){const a=this._adapter;if(a){var b=this._clientHeight,c=this.clientHeight;0>c&&(c=0);var d=Math.ceil(c/this._itemHeightAndMargin)+1;if(this._visibleCount!==d&&(this._visibleCount=
...
this._adapter;var c=b-a+1;if(!g||0>=c)return;const h=this._items,k=g.list,p=k.length;var d=k.currentItem,e=Array(c);for(var f=b;f>=a;f--){const l=k.item(f),m=new ListControlItem(g.createEmptyElement("f-list-item real"));g.prepareElement(l,f,p,m.element);m.element.ariaRowIndex=f.toString();e[f-a]=m;d===l&&(this._currentItem&&(this._currentItem.current=!1,this._currentItem.element.classList.remove("current")),this._currentItem=m,m.current=!0,m.element.classList.add("current"))}d=a>=h.length?null:h[a].element;
a>=h.length?h.push(...e):h.splice(a,0,...e);if(this._items.length!==k.length)throw Error("Assertion error: this.items.length !== list.length");this.adjustContainerHeight();for(f=0;f<c;f++)this.insertBefore(e[f].element,d);for(c=h.length-1;c>b;c--)e=h[c].element,g.prepareElementIndexOrLengthChanged(k.item(c),c,p,e),e.ariaRowIndex=c.toString();for(--a;0<=a;a--)b=h[a].element,g.prepareElementIndexOrLengthChanged(k.item(a),a,p,b),b.ariaRowIndex=a.toString()}this._adapter&&(this.ariaRowCount=this._adapter.list.length.toString())}notifyItemsRemoved(a,
...
this.addEventListener("focus",this.elementFocus.bind(this));this.addEventListener("keydown",this.elementKeyDown.bind(this));this.addEventListener("keyup",this.elementKeyUp.bind(this));this.addEventListener("blur",this.elementBlur.bind(this));this._useVirtualItems&&this.addEventListener("scroll",this.elementScroll.bind(this),{passive:!0});this._resizeObserver.observe(this,{box:"border-box"});this.addEventListener("click",this.elementClick.bind(this));this.addEventListener("contextmenu",this.elementContextMenu.bind(this));
this.resize();AppUI.addZoomHandler(this._boundZoomChanged)}}}customElements.define("f-list",ListControl);var SliderControlValueChild;(function(a){a[a.None=0]="None";a[a.LeftChild=1]="LeftChild";a[a.RightChild=2]="RightChild"})(SliderControlValueChild||(SliderControlValueChild={}));
class SliderControl extends HTMLElement{static create(a,b,c,d,e,f,g,h,k,p,l,m){const n=document.createElement("f-slider");a&&(n.ariaLabel=a);k&&(n.className=k);n.leftChild=p||null;n.rightChild=l||null;n.mapper=b;n.valueChild=c;n.unfocusable=d;n.vertical=e;n.manualAria=!!m;f|=0;g|=0;g<f&&(g=f);n.min=f;n.max=g;n.value=Math.max(f,Math.min(g,void 0===h?f:h|0));return n}constructor(){super();this._pointerHandler=this._innerElements=this._rightChild=this._leftChild=null;this._onvaluechangeEnabled=!0;this._mapper=
...
a;else if(this._leftChild!==a){var b=this._innerElements.focusContainer;a?this._leftChild?b.replaceChild(a,this._leftChild):b.insertBefore(a,b.firstChild):this._leftChild&&b.removeChild(this._leftChild);(this._leftChild=a)&&this._valueChild===SliderControlValueChild.LeftChild&&!this._manualAria&&Strings.changeText(a,this.ariaValueText||this.ariaValueNow)}}get rightChild(){return this._rightChild}set rightChild(a){if(!this._innerElements)this._rightChild=a;else if(this._rightChild!==a){var b=this._innerElements.focusContainer;
a?this._rightChild?b.replaceChild(a,this._rightChild):b.appendChild(a):this._rightChild&&b.removeChild(this._rightChild);(this._rightChild=a)&&this._valueChild===SliderControlValueChild.RightChild&&!this._manualAria&&Strings.changeText(a,this.ariaValueText||this.ariaValueNow)}}get dragging(){return this._forcedDragging||(this._pointerHandler?this._pointerHandler.captured:!1)}get mapper(){return this._mapper}set mapper(a){this._innerElements?this._mapper!==a&&(this._mapper=a,this._onvaluechangeEnabled=
!1,a=this._value,this._value=this._min-1,this.value=a,this._onvaluechangeEnabled=!0):this._mapper=a}get disabled(){return this._disabled}set disabled(a){a?this.setAttribute("disabled",""):this.removeAttribute("disabled")}get unfocusable(){return this._unfocusable}set unfocusable(a){a?this.setAttribute("unfocusable",""):this.removeAttribute("unfocusable")}get valueChild(){return this._valueChild}set valueChild(a){this.setAttribute("value-child",a.toString())}get vertical(){return this._vertical}set vertical(a){a?
this.setAttribute("vertical",""):this.removeAttribute("vertical")}get manualAria(){return this._manualAria}set manualAria(a){a?this.setAttribute("manual-aria",""):this.removeAttribute("manual-aria")}get min(){return this._min}set min(a){this.setAttribute("min",a.toString())}get max(){return this._max}set max(a){this.setAttribute("max",a.toString())}get value(){return this._value}set value(a){a|=0;if(this._innerElements){a<this._min?a=this._min:a>this._max&&(a=this._max);var b=this._value;this._value=
a;this._percent=100*(a-this._min)/this._delta;var c=this._percent+"%",d=this._innerElements;d&&(this.vertical?d.filledRuler.style.top=100-this._percent+"%":d.filledRuler.style.right=100-this._percent+"%",this.vertical?d.ruler.style.bottom=c:d.ruler.style.left=c,this.vertical?d.thumb.style.bottom=c:d.thumb.style.left=c);if(a!==b){if(!this._manualAria)switch(this._mapper?(this.ariaValueText=b=this._mapper(a),this.ariaValueNow=a.toString()):this.ariaValueNow=b=a.toString(),this._valueChild){case SliderControlValueChild.LeftChild:this._leftChild&&
Strings.changeText(this._leftChild,b);break;case SliderControlValueChild.RightChild:this._rightChild&&Strings.changeText(this._rightChild,b)}this.dragging&&(this._valueChangedDragging=!0);if(this.onvaluechange&&this._onvaluechangeEnabled)this.onvaluechange(a)}}else this._value=a}elementMouseDown(a){if(a.button||this._disabled||!this._innerElements)return!1;this._innerElements.focusContainer.focus();this._innerElements.container.classList.add("active");this._forcedDragging=!0;this._valueChangedDragging=
!1;this.elementMouseMove(a);this._forcedDragging=!1;return!0}elementMouseMove(a){if(this._innerElements){var b=this._innerElements.innerContainer.getBoundingClientRect();if(this.vertical){var c=b.bottom-b.top;a=c-(a.clientY-(b.top-3))}else c=b.right-b.left,a=a.clientX-(b.left+4);this.value=0>=c?this._min:this._min+this._delta*a/c}}elementMouseUp(a){if(this._innerElements){this._innerElements.container.classList.remove("active");if(this.ondragchangecommit&&this._valueChangedDragging)this.ondragchangecommit(this._value);
this._valueChangedDragging=!1}}elementKeyDown(a){if(!(this._pointerHandler&&this._pointerHandler.captured||this._disabled||a.ctrlKey||a.metaKey||a.shiftKey||a.altKey)){var b=this._value;switch(a.key){case "ArrowDown":case "ArrowLeft":this.value=b-1;if(this.onkeyboardchange&&this._value!==b)this.onkeyboardchange(this._value);break;case "ArrowUp":case "ArrowRight":this.value=b+1;if(this.onkeyboardchange&&this._value!==b)this.onkeyboardchange(this._value);break;case "PageDown":this.value=b-.1*this._delta;
if(this.onkeyboardchange&&this._value!==b)this.onkeyboardchange(this._value);break;case "PageUp":this.value=b+.1*this._delta;if(this.onkeyboardchange&&this._value!==b)this.onkeyboardchange(this._value);break;default:return}return cancelEvent(a)}}elementFocus(){this._innerElements?.container.classList.add("active")}elementBlur(){this._innerElements?.container.classList.remove("active")}manuallyChangeAll(a,b,c){this.value=a;this.manuallyChangeAria(b,c)}manuallyChangeAria(a,b){this.ariaValueText=a;this.ariaValueNow=
this._value.toString();switch(b){case SliderControlValueChild.LeftChild:this._leftChild&&Strings.changeText(this._leftChild,a);break;case SliderControlValueChild.RightChild:this._rightChild&&Strings.changeText(this._rightChild,a)}}connectedCallback(){if(!this._innerElements){this.role="slider";var a=this._vertical?" vertical":"",b=document.createElement("span");b.className="f-slider-focus-container"+a;b.tabIndex=-1;var c=document.createElement("span");c.className="f-slider-container"+a;b.appendChild(c);
var d=document.createElement("span");d.className="f-slider-inner-container"+a;c.appendChild(d);var e=document.createElement("span");e.className="f-slider-ruler"+a;d.appendChild(e);var f=document.createElement("span");f.className="f-slider-color f-slider-filled-ruler"+a;d.appendChild(f);var g=document.createElement("span");g.className="f-slider-color f-slider-thumb"+a;d.appendChild(g);this._innerElements={focusContainer:b,container:c,innerContainer:d,ruler:e,filledRuler:f,thumb:g};this.appendChild(b);
this._pointerHandler=new PointerHandler(c,this.elementMouseDown.bind(this),this.elementMouseMove.bind(this),this.elementMouseUp.bind(this));this._disabled=!this._disabled;this.attributeChangedCallback("disabled",null,this._disabled?null:"");this._unfocusable=!this._unfocusable;this.attributeChangedCallback("unfocusable",null,this._unfocusable?null:"");this.ariaValueMin=this._min.toString();this.ariaValueMax=this._max.toString();this._delta=this._max-this._min;this._delta||(this._delta=1);this._vertical=
!this._vertical;this.attributeChangedCallback("vertical",null,this._vertical?null:"");if(a=this._leftChild)this._leftChild=null,this.leftChild=a;if(a=this._rightChild)this._rightChild=null,this.rightChild=a}}attributeChangedCallback(a,b,c){b=this._innerElements;switch(a){case "disabled":a=null!==c;if(this._disabled===a)break;this._disabled=a;if(!b)break;a?this.removeAttribute("tabindex"):this._unfocusable||(this.tabIndex=0);a?this.classList.add("disabled"):this.classList.remove("disabled");break;
case "unfocusable":a=null!==c;if(this._unfocusable===a)break;this._unfocusable=a;if(!b)break;a?(this.removeAttribute("tabindex"),this.removeEventListener("keydown",this._boundKeyDown),this.removeEventListener("focus",this._boundFocus),this.removeEventListener("blur",this._boundBlur)):(this._disabled||(this.tabIndex=0),this.addEventListener("keydown",this._boundKeyDown),this.addEventListener("focus",this._boundFocus),this.addEventListener("blur",this._boundBlur));break;case "value-child":b=parseInt(c)||
0;if(1>b||2<b)b=SliderControlValueChild.None;if(this._valueChild===b)break;this._valueChild=b;this._manualAria||(this._leftChild&&this._valueChild===SliderControlValueChild.LeftChild?Strings.changeText(this._leftChild,this.ariaValueText||this.ariaValueNow):this._rightChild&&this._valueChild===SliderControlValueChild.RightChild&&Strings.changeText(this._rightChild,this.ariaValueText||this.ariaValueNow));break;case "vertical":a=null!==c;if(this._vertical===a)break;this._vertical=a;if(!b)break;a?(this.classList.add("vertical"),
b.focusContainer.classList.add("vertical"),b.container.classList.add("vertical"),b.innerContainer.classList.add("vertical"),b.ruler.classList.add("vertical"),b.filledRuler.classList.add("vertical"),b.thumb.classList.add("vertical"),b.filledRuler.style.right="",b.ruler.style.left="",b.thumb.style.left=""):(this.classList.remove("vertical"),b.focusContainer.classList.remove("vertical"),b.container.classList.remove("vertical"),b.innerContainer.classList.remove("vertical"),b.ruler.classList.remove("vertical"),
b.filledRuler.classList.remove("vertical"),b.thumb.classList.remove("vertical"),b.filledRuler.style.top="",b.ruler.style.bottom="",b.thumb.style.bottom="");this.ariaOrientation=a?"vertical":"horizontal";this._onvaluechangeEnabled=!1;b=this._value;this._value=this._min-1;this.value=b;this._onvaluechangeEnabled=!0;break;case "manual-aria":this._manualAria=null!=c;break;case "min":a=parseInt(c)||0;if(this._min===a)break;this._min=a;if(!b){this._max<a&&(this._max=a);break}this._max<a&&(this._max=a,this.ariaValueMax=
a.toString());this._delta=this._max-a;this._delta||(this._delta=1);this.ariaValueMin=a.toString();this.value=this._value;break;case "max":a=parseInt(c)||0;if(this._max===a)break;this._max=a;if(!b){this._min>a&&(this._min=a);break}this._min>a&&(this._min=a,this.ariaValueMin=a.toString());this._delta=a-this._min;this._delta||(this._delta=1);this.ariaValueMax=a.toString();this.value=this._value;break;case "value":this.value=parseInt(c)||0}}}SliderControl.disabledFeatures=["shadow"];
SliderControl.observedAttributes="disabled unfocusable value-child vertical manual-aria min max value".split(" ");customElements.define("f-slider",SliderControl);class Menu{static historyStatePopped(){return null}}
...
function(){};HostMediaSession._browserWrapper={setPaused:function(e,f,g){b=e;a.playbackState=b||c?"paused":"playing";d(f,g)},setLoading:function(e,f,g){c=e;a.playbackState=b||c?"paused":"playing";d(f,g)},setMetadata:function(e,f,g,h,k,p,l,m){0<e?(a.metadata=new window.MediaMetadata({title:f,artist:g,album:h,artwork:[{src:"assets/images/albumArts/64x64.png",sizes:"64x64",type:"image/png"},{src:"assets/images/albumArts/96x96.png",sizes:"96x96",type:"image/png"},{src:"assets/images/albumArts/192x192.png",
sizes:"192x192",type:"image/png"},{src:"assets/images/albumArts/256x256.png",sizes:"256x256",type:"image/png"},{src:"assets/images/albumArts/512x512.png",sizes:"512x512",type:"image/png"}]}),"none"==a.playbackState&&(a.playbackState="paused"),d(l,m)):(a.metadata=null,a.playbackState="none")},cleanUpMediaSession:function(){HostMediaSession.cleanUpMediaSession(a)}}}}return HostMediaSession._browserWrapper}}HostMediaSession._browserWrapper=null;
...
const p=document.createElement("f-list");p.className="file-picker-list fade";this._callback=c||null;this._resolve=a;this._provider=App.hostType===App.hostTypeAndroid?new FilePickerAndroidProvider:new FilePickerFileSystemAPIProvider;this._list=new List;this._listAdapter=new FilePickerListAdapter(this._list);this._listControl=p;this._listControl.addEventListener("keydown",this.listKeyDown.bind(this));this._listControl.onitemclick=this.itemClick.bind(this);this._listControl.onitemcontrolclick=this.itemControlClick.bind(this);
this._listControl.adapter=this._listAdapter;this._selectedFiles=null;this._fading=this._gettingFiles=!1;this._providerVersion=0;this._path=FilePicker.lastPath;this._rootLength=FilePicker.lastRootLength;this._iconFolder=g;this._iconLoading=h;this._pathElement=k;this._boundRefreshRoot=this.refreshRoot.bind(this);this.updatePathElement(this._path);a={html:[f,p],title:d,titleHeader:e,returnFocusElement:b,skipBody:!0,fullHeight:!0,onshown:this.modalShown.bind(this),onhiding:this.modalHiding.bind(this),
...
a&&((AppUI._neonMode=a)?document.body.classList.add("neon"):document.body.classList.remove("neon"))}static addZoomHandler(a){a&&AppUI._zoomHandlers.push(a)}static removeZoomHandler(a){if(a)for(let b=AppUI._zoomHandlers.length-1;0<=b;b--)if(AppUI._zoomHandlers[b]===a){AppUI._zoomHandlers.splice(b,1);break}}static factorToZoom(a){return 1>=a?0:Math.round(4*a)-4}static zoomToFactor(a){return 0>=a?1:.25*(a+4)}static remToPX(a){return a*AppUI._1remInPX}static pxToREM(a){return a/AppUI._1remInPX}static playerSongChange(a,
b){App.player&&AppUI._playlistControl&&(document.title=a&&a.title?a.title+" - FPlay":"FPlay",Strings.changeText(AppUI._titleLabel,a&&a.title||Formatter.none),Strings.changeText(AppUI._artistLabel,a&&a.artist||Formatter.none),App.player.playlist&&0<=App.player.playlist.currentIndex&&!AppUI._playlistControl.deleteMode&&a&&AppUI._playlistControl.bringItemIntoView(App.player.playlist.currentIndex),0>b&&(b=0),AppUI._currentTimeS=b|0,a?(Strings.changeText(AppUI._songLengthLabel,a.length),Strings.changeText(AppUI._assistiveSongLengthLabel,
a.length),AppUI._seekSlider&&(0<a.lengthMS?(AppUI._seekSlider.disabled=!1,AppUI._seekSlider.max=a.lengthMS):AppUI._seekSlider.disabled=!0,AppUI._seekSlider.manuallyChangeAll(1E3*b,Formatter.formatTimeS(AppUI._currentTimeS),SliderControlValueChild.LeftChild))):(Strings.changeText(AppUI._songLengthLabel,Formatter.none),Strings.changeText(AppUI._assistiveSongLengthLabel,Formatter.none),AppUI._seekSlider&&(AppUI._seekSlider.disabled=!0,AppUI._seekSlider.manuallyChangeAll(0,Formatter.none,SliderControlValueChild.LeftChild))))}static playerLoadingChange(a){App.updateLoadingIcon()}static playerPausedChange(a){AppUI._playButton&&
(AppUI._playButton.iconName=a?"icon-play":"icon-pause")}static playerCurrentTimeSChange(a){if(AppUI._seekSlider&&!AppUI._seekSlider.dragging&&App.player){0>a&&(a=0);var b=a|0;if(AppUI._currentTimeS!==b){AppUI._currentTimeS=b;a=1E3*b;if(App.player.currentSong){const c=App.player.currentSong.lengthMS-a;5500>c&&2500<c&&App.player.preloadNextSong()}AppUI._seekSlider.manuallyChangeAll(a,Formatter.formatTimeS(b),SliderControlValueChild.LeftChild)}else AppUI._seekSlider.value=1E3*a}}static playerError(a){Modal.show({text:a,
returnFocusElement:AppUI._playlistControl})}static playlistSongLengthChange(a){App.player&&(a===App.player.currentSong&&(Strings.changeText(AppUI._songLengthLabel,a.length),Strings.changeText(AppUI._assistiveSongLengthLabel,a.length),AppUI._seekSlider&&(0<a.lengthMS?(AppUI._seekSlider.disabled=!1,AppUI._seekSlider.max=a.lengthMS):(AppUI._seekSlider.value=0,AppUI._seekSlider.disabled=!0))),AppUI._playlistControl&&AppUI._playlistControl.refreshVisibleItems())}static seekSliderValueChange(a){AppUI._seekSlider&&
AppUI._seekSlider.dragging&&(a=a/1E3|0,AppUI._currentTimeS!==a&&(AppUI._currentTimeS=a,AppUI._seekSlider.manuallyChangeAria(Formatter.formatTimeS(a),SliderControlValueChild.LeftChild)))}static seekSliderDragChangeCommit(a){App.player&&App.player.seekTo(a)}static volumeSliderValueChange(a){App.player&&(App.player.volume=a)}static playlistControlItemClick(a,b,c){App.player&&!c&&App.player.play(b)}static playlistControlItemContextMenu(a,b){}static graphicalFilterControlTypeClick(){App.graphicalFilterControl&&
...
await App.showOpenDialogWeb(a),c=null;if((a||c)&&App.player)try{App.player.playlist||(App.player.playlist=new Playlist,AppUI.preparePlaylist());const d=App.player.playlist,e=b?null:new Uint8Array(BufferedReader.minBufferLength),f=b?null:[new Uint8Array(2048)];let g=!1;do{let h=!1;if(c){const k=await c();if(!k)break;h=k.play;a=k.files}if(!a)break;AppUI._loading=!0;App.updateLoadingIcon();for(let k=0;k<a.length&&App.player;k++)if(b)await d.addSong(a[k])&&h&&(h=!1,App.player&&App.player.play(d.length-
1));else{const p=d.length;await d.addSongWeb(a[k],e,f)&&(p==d.length?g=!0:h&&(h=!1,App.player&&App.player.play(p)))}AppUI._loading=!1;App.updateLoadingIcon()}while(c);g&&AppUI._playlistControl&&AppUI._playlistControl.refreshVisibleItems()}catch(d){Modal.show({text:"addFiles error: "+(d.message||d.toString()),returnFocusElement:AppUI._playlistControl})}finally{AppUI._loading=!1,App.updateLoadingIcon()}}}static toggleDeleteMode(a){if(AppUI._playlistControl){AppUI._focusBlocker&&(AppUI._focusBlocker.unblock(),
...
(a=App.player&&App.player.currentSong);a?Modal.show({html:`<div class="selectable-text">
			...
			</div>`,title:Strings.SongInfo,returnFocusElement:AppUI._playlistControl}):Alert.show(Strings.NoSongPlaying)}static showAbout(){const a=document.createElement("div"),b=ButtonControl.create({text:Strings.RGBMode,checkable:!0,checked:AppUI.rgbMode,parent:a,onclick:function(){AppUI.rgbMode=b.checked;c.checked=AppUI.extraRGBMode}}),c=ButtonControl.create({text:Strings.ExtraRGBMode,checkable:!0,checked:AppUI.extraRGBMode,parent:a,onclick:function(){AppUI.extraRGBMode=c.checked;b.checked=AppUI.rgbMode}}),
d=ButtonControl.create({text:Strings.NeonMode,checkable:!0,checked:AppUI.neonMode,parent:a,onclick:function(){AppUI.neonMode=d.checked}});a.insertAdjacentHTML("beforeend",`
