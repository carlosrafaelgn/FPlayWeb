...
class InternalStorage{static async cacheGet(a,b){a=await caches.open(a);b=b?InternalStorage.cachePrefix+b:InternalStorage.cachePrefix;return(b=await a.match(b))?b.arrayBuffer():null}static async cachePut(a,b,c){a=await caches.open(a);b=b?InternalStorage.cachePrefix+b:InternalStorage.cachePrefix;return a.put(b,c)}static loadAppSettings(){try{const a=localStorage.getItem("appSettings");if(a){const b=JSON.parse(a);if(b)return b}}catch(a){}return{playerVolume:100,graphicalFilterControlEnabled:!1,graphicalFilterControlSimpleMode:!1,
stereoPannerControlEnabled:!1}}static saveAppSettings(a){a?localStorage.setItem("appSettings",JSON.stringify(a)):localStorage.removeItem("appSettings")}static loadGraphicalFilterEditorSettings(){try{const a=localStorage.getItem("graphicalFilterEditorSettings");if(a){const b=JSON.parse(a);if(b)return b}}catch(a){}return{currentChannelIndex:0,editMode:GraphicalFilterEditorControl.editModeShelfEq,isActualChannelCurveNeeded:!0,isNormalized:!1,isSameFilterLR:!0,showZones:!0}}static saveGraphicalFilterEditorSettings(a){a?
localStorage.setItem("graphicalFilterEditorSettings",JSON.stringify(a)):localStorage.removeItem("graphicalFilterEditorSettings")}static loadStereoPannerSettings(){return Math.max(-StereoPannerControl.maxAbsoluteValue,Math.min(StereoPannerControl.maxAbsoluteValue,parseInt(localStorage.getItem("stereoPannerSettings"))|0))}static saveStereoPannerSettings(a){localStorage.setItem("stereoPannerSettings",(a|0).toString())}static async loadPlaylist(a){a=await InternalStorage.cacheGet(InternalStorage.cacheNamePlaylists,
