...
0;do{let f=g.indexOf(";",b);f<b&&(f=g.length);var c=g.indexOf("|",b);0>c||c>=f?e.appendChild(document.createTextNode(Strings.translate(g))):(b=g.substring(b,c),c=g.substring(c+1,f),e.setAttribute(b,Strings.translate(c)));b=f+1}while(b<g.length)}}}static changeText(a,b){if(a){null===b&&(b="");var c=a.lastChild;c?c.nodeValue=b:a.appendChild(document.createTextNode(b))}}}Strings.language="en";Strings.DecimalSeparator=".";Strings.OppositeDecimalSeparator=",";Strings.Oops="Oops\u2026";
Strings.AppName="FPlay";Strings.Menu="Menu";Strings.About="About";Strings.Edit="Edit";Strings.Delete="Delete";Strings.DeleteSongs="Delete songs";Strings.DeleteAllSongs="Delete all";Strings.Enable="Enable";Strings.Disable="Disable";Strings.Enabled="Enabled";Strings.Disabled="Disabled";Strings.AdvancedFilter="Advanced filter";Strings.TraditionalFilter="Traditional filter";Strings.Missing="Missing";Strings.MissingSongError="The song is missing! \ud83d\ude22 Please, just add it again before playing it. When you add a missing song, it keeps its position in the playlist! \ud83d\ude0a";
Strings.OK="OK";Strings.Cancel="Cancel";Strings.Clear="Clear";Strings.Back="Back";Strings.Close="Close";Strings.Refresh="Refresh";Strings.Exit="Exit";Strings.Done="Done";Strings.Previous="Previous";Strings.Play="Play";Strings.Pause="Pause";Strings.PlayPause="Play / Pause";Strings.Stop="Stop";Strings.Next="Next";Strings.LeftAbbrev="L";Strings.RightAbbrev="R";Strings.Volume="Volume";Strings.Panning="Panning";Strings.DownMixToMono="Down-mix to mono";Strings.UnknownError="Something went wrong during playback. \ud83d\ude22";
Strings.AddFiles="Add files";Strings.AddFolders="Add folders";Strings.ShowEffects="Show effects";Strings.ShowPlaylist="Show playlist";Strings.UpdateAvailable="Update available!";Strings.PleaseRefresh="Please, refresh the page to update the app. \ud83d\ude0a";Strings.AboutHTML='FPlay for web is an experimental audio player. \ud83d\ude0a<br />\n<br />\nFor more information about the project, its source code and dependencies, check out its repository at <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb">github.com/carlosrafaelgn/FPlayWeb</a>.<br />\n<br />\nThis project is licensed under the <a target="_blank" href="https://github.com/carlosrafaelgn/FPlayWeb/blob/master/LICENSE">MIT License</a>.';
Strings.DeleteModeHTML="Click songs to delete them.";
...
a.splice(0)}this.lastIndex=this.firstIndex=0;this.currentItem=this.currentListItem=null;this.containerHeight=this.element.scrollTop=0;this.container.style.height="0"}}scroll(){var a=this._adapter,b=this.element;if(a&&b){var c=this.items,d=this.itemHeightAndMargin,e=this.firstIndex-2;b=b.scrollTop/d|0;0>e&&(e=0);this.firstIndex=b;var g=this.visibleCount+(0===b?2:1===b?3:4);g>c.length&&(g=c.length);0>(b-=2)&&(b=0);if(b>e){if((e=b-e)&&e<g)for(let l=e,p=0;l<g;l++,p++)e=c[p],c[p]=c[l],c[l]=e}else if((e-=
b)&&e<g)for(let l=g-1,p=l-e;0<=p;p--,l--)e=c[l],c[l]=c[p],c[p]=e;var f=a.list,k=f.length,h=a.list.currentItem;e=this.container;var m=0;for(let l=b*d;m<g&&b<k;m++,b++,l+=d){const p=f.item(b),n=c[m];if(n.item!==p){const q=h===p;n.current!==q&&((n.current=q)?n.element.classList.add("current"):n.element.classList.remove("current"));a.prepareElement(p,b,k,n.element);n.item||e.appendChild(n.element);n.item=p}n.index!==b&&(n.index=b,n.element.style.transform="translateY("+l+"px)")}for(a=c.length;m<a;m++)d=
c[m],d.item&&(d.item=null,e.removeChild(d.element));this.lastIndex=b-1;this.lastIndex<this.firstIndex&&(this.lastIndex=this.firstIndex)}}refreshVisibleItemsInternal(){this.refreshVisibleItemsEnqueued=!1;var a=this._adapter,b=this.element;if(a&&b){this.adjustContainerHeight();b=this.items;var c=this.itemHeightAndMargin,d=a.list,e=d.length,g=a.list.currentItem,f=this.container;if(this.useVirtualItems){this.currentListItem=g;var k=0,h=this.firstIndex,m=this.visibleCount+(0===h?2:1===h?3:4);m>b.length&&
(m=b.length);0>(h-=2)&&(h=0);for(let l=h*c;k<m&&h<e;k++,h++,l+=c){const p=d.item(h),n=b[k],q=g===p;n.current!==q&&((n.current=q)?n.element.classList.add("current"):n.element.classList.remove("current"));a.prepareElement(p,h,e,n.element);n.item||f.appendChild(n.element);n.item=p;n.index!==h&&(n.index=h,n.element.style.transform="translateY("+l+"px)")}for(a=b.length;k<a;k++)d=b[k],d.item&&(d.item=null,f.removeChild(d.element))}else{f=this.visibleCount;for(let l=0,p=this.indexFromY(0);l<=f&&p<e;l++,
p++)a.prepareElement(d.item(p),p,e,b[p].element)}}}resize(){const a=this._adapter;var b=this.element;if(a&&b){var c=this.clientHeight;b=b.clientHeight;0>b&&(b=0);var d=Math.ceil(b/this.itemHeightAndMargin)+1;if(this.visibleCount!==d&&(this.visibleCount=d,this.useVirtualItems)){const e=this.items;for(;d+4>e.length;)e.push(new ListControlItem(a.createEmptyElement("list-item virtual")))}c!==b&&(this.clientHeight=b,this.useVirtualItems&&this.scroll())}}containerClick(a){if(this.element&&this.adapter&&
this.onitemclicked){var b=this.element.getBoundingClientRect();b=this.indexFromY(a.clientY-b.top);if(0<=b){const c=this.adapter.list.item(b);if(c)if(this.deleteMode)this.adapter.list.removeItems(b,b);else this.onitemclicked(c,b,a.button)}}}containerContextMenu(a){if(!this.element||!this.adapter||!this.onitemcontextmenu)return cancelEvent(a);var b=this.element.getBoundingClientRect();b=this.indexFromY(a.clientY-b.top);if(0<=b){const c=this.adapter.list.item(b);if(c)this.onitemcontextmenu(c,b)}return cancelEvent(a)}yFromIndex(a){return this.element?
a*this.itemHeightAndMargin-this.element.scrollTop:0}indexFromY(a){if(!this.element||!this.adapter)return-1;a=(a+this.element.scrollTop+.9)/this.itemHeightAndMargin|0;return 0>a||a>=this.adapter.list.length?-1:a}isItemVisible(a){a=this.yFromIndex(a);return 0<=a&&a<=this.clientHeight-this.itemHeight}bringItemIntoView(a,b){const c=this.yFromIndex(a);0>c?b?this.centerItemIntoView(a):this.element.scrollTop+=c:c>this.clientHeight-this.itemHeight&&(b?this.centerItemIntoView(a):this.element.scrollTop+=c-
(this.clientHeight-this.itemHeight))}centerItemIntoView(a){this.element.scrollTop=a*this.itemHeightAndMargin-(this.clientHeight-this.itemHeight>>1)}refreshVisibleItems(){this.refreshVisibleItemsEnqueued||(this.refreshVisibleItemsEnqueued=!0,queueMicrotask(this.boundRefreshVisibleItemsInternal))}notifyCleared(){this.clear()}notifyItemsAdded(a,b){if(this.useVirtualItems)this.refreshVisibleItems();else{const m=this.adapter,l=b-a+1;if(m&&!(0>=l)){var c=this.container,d=this.items,e=m.list,g=e.length,
f=e.currentItem,k=Array(l);for(var h=b;h>=a;h--){const p=e.item(h),n=new ListControlItem(m.createEmptyElement("list-item real"));m.prepareElement(p,h,g,n.element);k[h-a]=n;f===p&&(this.currentItem&&(this.currentItem.current=!1,this.currentItem.element.classList.remove("current")),this.currentItem=n,n.current=!0,n.element.classList.add("current"))}f=a>=d.length?null:d[a].element;a>=d.length?d.push(...k):d.splice(a,0,...k);if(this.items.length!==e.length)throw Error("Assertion error: this.items.length !== list.length");
this.adjustContainerHeight();for(h=0;h<l;h++)c.insertBefore(k[h].element,f);for(c=d.length-1;c>b;c--)m.prepareElementIndexOrLengthChanged(e.item(c),c,g,d[c].element);for(--a;0<=a;a--)m.prepareElementIndexOrLengthChanged(e.item(a),a,g,d[a].element)}}}notifyItemsRemoved(a,b){if(this.useVirtualItems)this.refreshVisibleItems();else{const f=this.adapter;var c=b-a+1;if(f&&!(0>=c)){var d=this.container;b=this.items;var e=f.list,g=e.length;a=b.splice(a,c);for(c=a.length-1;0<=c;c--){const k=a[c];k.current&&
(this.currentItem=null);d.removeChild(k.element);k.zero()}if(this.items.length!==e.length)throw Error("Assertion error: this.items.length !== list.length");for(d=b.length-1;0<=d;d--)f.prepareElementIndexOrLengthChanged(e.item(d),d,g,b[d].element);this.adjustContainerHeight()}}}notifyCurrentItemChanged(a,b){this.useVirtualItems?this.refreshVisibleItems():this.notifyCurrentItemChangedEnqueued||(this.notifyCurrentItemChangedEnqueued=!0,queueMicrotask(this.boundNotifyCurrentItemChangedInternal))}notifyCurrentItemChangedInternal(){this.notifyCurrentItemChangedEnqueued=
!1;var a=this.adapter;a&&(this.currentItem&&(this.currentItem.current=!1,this.currentItem.element.classList.remove("current")),a=a.list.currentIndex,0<=a&&a<this.items.length?(this.currentItem=this.items[a],this.currentItem.current=!0,this.currentItem.element.classList.add("current")):this.currentItem=null)}}
...
!0);a&&b.devicePixelRatio&&b.devicePixelRatio!==devicePixelRatio&&a.setZoomFactor(b.devicePixelRatio);App.hostType===App.hostTypeAndroid&&(a=document.getElementById("add-folder-button"),a.parentNode.removeChild(a));ButtonControl.init();CheckboxControl.init();AppUI.seekSlider=new SliderControl("seek-slider",!1,!1,0,1);AppUI.seekSlider.disabled=!0;AppUI.seekSlider.onvaluechanged=AppUI.seekSliderValueChanged;AppUI.seekSlider.ondragended=AppUI.seekSliderDragEnded;AppUI.currentTimeLabel=document.createElement("span");
AppUI.currentTimeLabel.className="seek-label";AppUI.currentTimeS=0;Strings.changeText(AppUI.currentTimeLabel,Formatter.none);AppUI.seekSlider.leftChild=AppUI.currentTimeLabel;AppUI.songLengthLabel=document.createElement("span");AppUI.songLengthLabel.className="seek-label";Strings.changeText(AppUI.songLengthLabel,Formatter.none);AppUI.seekSlider.rightChild=AppUI.songLengthLabel;AppUI.volumeSlider=new SliderControl("volume-slider",!0,!1,0,Player.maxVolume,b.playerVolume);AppUI.volumeSlider.leftChild=
Icon.createLarge("icon-volume","green small-right-margin");AppUI.volumeLabel=document.createElement("span");AppUI.volumeLabel.className="small-left-margin";AppUI.volumeLabel.setAttribute("id","volume-label");Strings.changeText(AppUI.volumeLabel,AppUI.volumeStr(AppUI.volumeSlider.value));AppUI.volumeSlider.rightChild=AppUI.volumeLabel;AppUI.volumeSlider.onvaluechanged=AppUI.volumeSliderValueChanged;AppUI.playlistControl=new ListControl("playlist-control",!0);AppUI.playlistControl.onitemclicked=AppUI.playlistControlItemClicked;
AppUI.playlistControl.onitemcontextmenu=AppUI.playlistControlItemContextMenu;AppUI.graphicalFilterControlType=document.getElementById("graphical-filter-control-type");ButtonControl.setText(AppUI.graphicalFilterControlType,b.graphicalFilterControlSimpleMode?Strings.TraditionalFilter:Strings.AdvancedFilter);AppUI.graphicalFilterControlType.onclick=AppUI.graphicalFilterControlTypeClicked;AppUI.graphicalFilterControlEnabled=document.getElementById("graphical-filter-control-enabled");AppUI.graphicalFilterControlEnabled.checked=
b.graphicalFilterControlEnabled||!1;AppUI.graphicalFilterControlEnabled.onclick=AppUI.graphicalFilterControlEnabledClicked;AppUI.stereoPannerControlEnabled=document.getElementById("stereo-panner-control-enabled");AppUI.stereoPannerControlEnabled.checked=b.stereoPannerControlEnabled||!1;AppUI.stereoPannerControlEnabled.onclick=AppUI.stereoPannerControlEnabledClicked;MonoDownMixerControl.isSupported()?(AppUI.monoDownMixerControlEnabled=document.getElementById("mono-down-mixer-control-enabled"),AppUI.monoDownMixerControlEnabled.checked=
b.monoDownMixerControlEnabled||!1,AppUI.monoDownMixerControlEnabled.onclick=AppUI.monoDownMixerControlEnabledClicked):(b=document.getElementById("mono-down-mixer-control-container"),b.parentNode.removeChild(b));App.frameless||AppUI.panelContainer.classList.add("web");window.addEventListener("resize",AppUI.adjustWindow,{passive:!0});AppUI.adjustWindow()}static init(a){App.player&&(AppUI.volumeSlider.value=App.player.volume,App.player.onsongchanged=AppUI.playerSongChanged,App.player.onloadingchanged=
AppUI.playerLoadingChanged,App.player.onpausedchanged=AppUI.playerPausedChanged,App.player.oncurrenttimeschanged=AppUI.playerCurrentTimeSChanged,App.player.onerror=AppUI.playerError,AppUI.preparePlaylist(),AppUI.playerSongChanged(App.player.currentSong),AppUI.centerCurrentSongIntoView(),HistoryHandler.init(Menu.historyStatePopped,Modal.historyStatePopped,AppUI.historyStatePopped))}static centerCurrentSongIntoView(){App.player&&App.player.playlist&&0<=App.player.playlist.currentIndex&&AppUI.playlistControl.centerItemIntoView(App.player.playlist.currentIndex)}static destroy(){zeroObject(AppUI)}static get loading(){return AppUI._loading}static get thinBorderPX(){return AppUI._thinBorderPX}static get thickBorderPX(){return AppUI._thickBorderPX}static addZoomHandler(a){a&&
AppUI.zoomHandlers.push(a)}static removeZoomHandler(a){if(a)for(let b=AppUI.zoomHandlers.length-1;0<=b;b--)if(AppUI.zoomHandlers[b]===a){AppUI.zoomHandlers.splice(b,1);break}}static factorToZoom(a){return 1>=a?0:Math.round(4*a)-4}static zoomToFactor(a){return 0>=a?1:.25*(a+4)}static remToPX(a){return a*AppUI.rem}static pxToREM(a){return a/AppUI.rem}static playerSongChanged(a){App.player&&AppUI.playlistControl&&(Strings.changeText(AppUI.titleLabel,a&&a.title||Formatter.none),Strings.changeText(AppUI.artistLabel,
...
(App.stereoPannerControl.enabled=AppUI.stereoPannerControlEnabled.checked)}static monoDownMixerControlEnabledClicked(){App.monoDownMixerControl&&(App.monoDownMixerControl.enabled=AppUI.monoDownMixerControlEnabled.checked)}static hideTopMessage(){0>AppUI.topMessageFading||!AppUI.topMessage||(AppUI.topMessageTimeout&&clearTimeout(AppUI.topMessageTimeout),AppUI.topMessageFading=-1,AppUI.topMessage.classList.remove("in"),AppUI.topMessageTimeout=setTimeout(function(){0<=AppUI.topMessageFading||(AppUI.topMessageFading=
0,AppUI.topMessageTimeout=0,AppUI.topMessage.style.visibility="",AppUI.topMessage.innerHTML="",AppUI.titleLabel&&AppUI.titleLabel.classList.remove("behind"),AppUI.artistLabel&&AppUI.artistLabel.classList.remove("behind"))},320))}static showTopMessage(a,b){AppUI.topMessage&&(AppUI.topMessageTimeout&&clearTimeout(AppUI.topMessageTimeout),AppUI.topMessageFading=1,AppUI.titleLabel&&AppUI.titleLabel.classList.add("behind"),AppUI.artistLabel&&AppUI.artistLabel.classList.add("behind"),AppUI.topMessage.innerHTML=
a,b&&b(AppUI.topMessage),AppUI.topMessage.style.visibility="visible",AppUI.topMessageTimeout=setTimeout(function(){0>=AppUI.topMessageFading||1!==AppUI.topMessageFading||(AppUI.topMessageFading=2,AppUI.topMessage.classList.add("in"),AppUI.topMessageTimeout=setTimeout(function(){2===AppUI.topMessageFading&&(AppUI.topMessageFading=0,AppUI.topMessageTimeout=0)},320))},20))}static async addFiles(a){if(App.player&&!AppUI._loading){var b=App.hostType===App.hostTypeElectron;if((a=b?await App.showOpenFileDialog():
await App.showOpenDialogWeb(a))&&App.player)try{AppUI._loading=!0;App.updateLoadingIcon();App.player.playlist||(App.player.playlist=new Playlist,AppUI.preparePlaylist());const c=App.player.playlist,d=b?null:new Uint8Array(BufferedFileHandle.minBufferLength<<1),e=b?null:[new Uint8Array(256)];let g=!1;for(let f=0;f<a.length&&App.player;f++)if(b)await c.addSong(a[f]);else{const k=c.length;await c.addSongWeb(a[f],d,e)&&k===c.length&&(g=!0)}g&&AppUI.playlistControl&&AppUI.playlistControl.refreshVisibleItems()}catch(c){Modal.show({text:"addFiles error: "+
(c.message||c.toString())})}finally{AppUI._loading=!1,App.updateLoadingIcon()}}}static async addDirectory(a){a=await App.listDirectory(a);if(!App.player||!App.player.playlist||AppUI.directoryCancelled)return!1;if(!a)return!0;for(let b=0;b<a.length;b++)if(a[b].isDirectory){if(!await AppUI.addDirectory(a[b].fileURL))return!1}else{if(!App.player||!App.player.playlist||AppUI.directoryCancelled)return!1;await App.player.playlist.addSong(a[b])}return!0}static async addDirectories(){if(App.player&&!AppUI._loading){if(App.hostType!==
App.hostTypeElectron)return AppUI.addFiles(!0);var a=await App.showOpenDirectoryDialog();if(a&&App.player)try{AppUI._loading=!0;AppUI.directoryCancelled=!1;App.updateLoadingIcon();App.player.playlist||(App.player.playlist=new Playlist,AppUI.preparePlaylist());for(let b=0;b<a.length&&await AppUI.addDirectory(a[b]);b++);}catch(b){Modal.show({text:"addDirectories error: "+(b.message||b.toString())})}finally{AppUI._loading=!1,AppUI.directoryCancelled=!1,App.updateLoadingIcon()}}}static toggleDeleteMode(a){AppUI.playlistControl&&
(AppUI.playlistControl.deleteMode?(AppUI.playlistControl.deleteMode=!1,AppUI.hideTopMessage(),a&&HistoryHandler.popState()):(AppUI.playlistControl.deleteMode=!0,AppUI.showTopMessage(Strings.DeleteModeHTML,function(b){const c=document.createElement("div");ButtonControl.create({color:"red",icon:"icon-delete-all",stringKey:"DeleteAllSongs",parent:c,onclick:function(){App.player&&App.player.playlist&&App.player.playlist.clear();AppUI.playlistControl&&AppUI.playlistControl.deleteMode&&AppUI.toggleDeleteMode(!0)}});
ButtonControl.create({color:"green",icon:"icon-check",stringKey:"Done",parent:c,onclick:function(){AppUI.playlistControl&&AppUI.playlistControl.deleteMode&&AppUI.toggleDeleteMode(!0)}});b.appendChild(c)}),HistoryHandler.pushState()))}static switchView(){AppUI.panelContainer&&AppUI.panelContainer.classList.toggle("toggled")}static showAbout(){Modal.show({html:Strings.AboutHTML+(App.player&&App.player.audioContext?"<br/><br/><small>Base latency: "+(App.player.audioContext.baseLatency||0).toFixed(4)+
" s<br/>Output latency: "+(isNaN(App.player.audioContext.outputLatency)?"-":App.player.audioContext.outputLatency.toFixed(4)+" s")+"</small>":""),title:Strings.About+" (v"+window.CACHE_VERSION+")"})}}AppUI.primaryInputIsTouch="matchMedia"in window?window.matchMedia("(pointer: coarse)").matches:0<navigator.maxTouchPoints||0<navigator.msMaxTouchPoints;AppUI.rem=4;AppUI.buttonRegularSizeREM=8;AppUI.buttonRegularSizePX=AppUI.remToPX(AppUI.buttonRegularSizeREM);
...
AppUI.panelContainer=document.getElementById("panel-container");AppUI.fixedPanel=document.getElementById("fixed-panel");AppUI.optionalPanel=document.getElementById("optional-panel");AppUI.iconPlay=document.getElementById("i-play");AppUI.iconPause=document.getElementById("i-pause");AppUI.artistLabel=document.getElementById("artist-label");AppUI.titleLabel=document.getElementById("title-label");AppUI.topMessage=document.getElementById("top-message");AppUI._loading=!1;AppUI.devicePixelRatio=-1;
AppUI._smallIconSizePX=Icon.baseSizePX;AppUI._largeIconSizePX=Icon.baseSizePX<<1;AppUI._thinBorderPX=AppUI.baseThinBorderPX;AppUI._thickBorderPX=AppUI.baseThickBorderPX;AppUI.directoryCancelled=!1;AppUI.topMessageFading=0;AppUI.topMessageTimeout=0;
...
if(a&&a.length)for(let d=a.length-1;0<=d;d--)if(a[d]){const e=a[d]();e&&b.push(e)}c&&InternalStorage.savePlaylistWeb(c);App.ipcRenderer&&(b.length?Promise.all(b).then(App.destroy,App.destroy):App.destroy())}}static destroy(){App.player&&App.player.destroy();AppUI.destroy();const a=App.ipcRenderer;zeroObject(App);a&&a.invoke("mainWindowFinalClose")}static updateLoadingIcon(){App.iconLoading&&(App.iconLoading.style.display=App.loading?"":"none")}static get loading(){return(App.player?App.player.loading:
!1)||AppUI.loading||App._loading}static set loading(a){App._loading!==a&&(App._loading=a,App.updateLoadingIcon())}static get installPromptReady(){return!!App.installPrompt}static showInstallPrompt(){const a=App.installPrompt;if(a&&a.prompt)try{App.installPrompt=null,a.prompt()}catch(b){}}static beforeInstallPrompt(a){"preventDefault"in a&&a.preventDefault();App.installPrompt=a}static adjustCover(){const a=document.getElementById("cover");if(a){const b=document.body.getBoundingClientRect();a.style.transform=
`scale(${Math.ceil(.5*b.right)}, ${Math.ceil(.5*b.bottom)})`}}static sortFiles(a){a.length&&(a[0]["data-path"]?a.sort(function(b,c){return b["data-path"].localeCompare(c["data-path"])}):a[0].webkitRelativePath?a.sort(function(b,c){return b.webkitRelativePath.localeCompare(c.webkitRelativePath)}):a.sort(function(b,c){return b.name.localeCompare(c.name)}));return a}static preInit(){Strings.init();Icon.init();GraphicalFilterEditorStrings.init(Strings.language);Strings.toFixed=GraphicalFilterEditorStrings.toFixed;
...
(App.monoDownMixerControl.multiplier=1/(1+d))};return App.stereoPannerControl},function(c){App.monoDownMixerControl=new MonoDownMixerControl(c);App.monoDownMixerControl.enabled=MonoDownMixerControl.isSupported()&&!!a.monoDownMixerControlEnabled;return App.monoDownMixerControl});var b=InternalStorage.loadPlaylistWeb();b&&(App.player.playlist=b);AppUI.init(a);(b=document.getElementById("cover"))&&b.classList.remove("in");setTimeout(function(){AppUI.centerCurrentSongIntoView();setTimeout(function(){window.removeEventListener("resize",
App.adjustCover);const c=document.getElementById("cover");c&&document.body.removeChild(c)},310)},10);App.loading=!1}}static triggerMainWindowStateChanged(){App.ipcRenderer&&App.ipcRenderer.invoke("triggerMainWindowStateChanged")}static mainWindowMinimize(){App.ipcRenderer&&App.ipcRenderer.invoke("mainWindowMinimize")}static mainWindowRestoreOrMaximize(){App.ipcRenderer&&App.ipcRenderer.invoke(App.isMaximized?"mainWindowRestore":"mainWindowMaximize")}static mainWindowClose(){App.ipcRenderer&&App.ipcRenderer.invoke("mainWindowClose")}static async showOpenFileDialog(){if(App.fileInput||
