...
localStorage.setItem("graphicalFilterEditorSettings",JSON.stringify(a)):localStorage.removeItem("graphicalFilterEditorSettings")}static loadStereoPannerSettings(){return Math.max(-10,Math.min(10,parseInt(localStorage.getItem("stereoPannerSettings"))|0))}static saveStereoPannerSettings(a){localStorage.setItem("stereoPannerSettings",(a|0).toString())}static async loadPlaylist(a){a=await InternalStorage.cacheGet(InternalStorage.cacheNamePlaylists,a);if(!a)return null;try{return Playlist.deserialize(new DataReader(a))}catch(b){return null}}static async savePlaylist(a,
b){return InternalStorage.cachePut(InternalStorage.cacheNamePlaylists,b,new Response(a.serialize().trimmedArrayBuffer))}}InternalStorage.cachePrefix="https://fplay.com.br/";InternalStorage.cacheNamePlaylists="playlists";
